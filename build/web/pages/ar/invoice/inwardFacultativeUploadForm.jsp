...
<%@ taglib prefix="c" uri="crux" %><c:frame title="UPLOAD INWARD FACULTATIF" >
    <%
    ...
    <c:evaluate when="<%=!superType%>">
        ...
        <c:evaluate when="<%=enablePolis%>">
            <td class=row1><c:field name="<%="details.[$index$].details.["+i+"].stAttrPolicyNo"%>" caption="Pol No" width="200" type="string" readonly="false" /></td>
            <td class=row1><c:field name="<%="details.[$index$].details.["+i+"].dtAttrPolicyPeriodStart"%>" caption="Period Start" width="200" type="date" readonly="false" /></td>
            <td class=row1><c:field name="<%="details.[$index$].details.["+i+"].dtAttrPolicyPeriodEnd"%>" caption="Period End" width="200" type="date" readonly="false" /></td>
            <td class=row1><c:field name="<%="details.[$index$].details.["+i+"].stAttrPolicyName"%>" caption="Pol Name" width="200" type="string" readonly="false" /></td>
            <td class=row1><c:field name="<%="details.[$index$].details.["+i+"].stAttrPolicyAddress"%>" caption="Address" width="200" type="string" readonly="false" /></td>
            <td class=row1><c:field name="<%="details.[$index$].details.["+i+"].dbAttrPolicyTSITotal"%>" caption="TSI" type="money16.2" readonly="false" /></td>
            <td class=row1><c:field name="<%="details.[$index$].details.["+i+"].dbAttrPolicyTSI"%>" caption="TSI 2" type="money16.2" readonly="false" /></td>
        </c:evaluate>
        <%
            }
        %>
    ...
    <tr align="center">
        <td>
            <c:button text="Hitung Ulang" event="recalculateInwardFacultativeUpload" validate="false" />
            <c:evaluate when="<%=hasTRX&&!isApprovedMode%>">
                <c:button text="Simpan" event="clickSaveInwardFacultativeUpload" confirm="Yakin ingin di simpan?" validate="true" />
            </c:evaluate>
            <c:evaluate when="<%=isApprovedMode%>">
                <c:button text="Setujui" event="clickSaveInwardTreaty" validate="true" />
            </c:evaluate>
