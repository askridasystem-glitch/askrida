                                    ...
                                    <td colspan="10">
                                        <table>
                                            ...
                                            <tr class="row1">
                                                ...
                                                <c:evaluate when="<%=!isPembayaranKomisi%>">
                                                <td class=row1 >
                                                    <c:field  width="160" clientchangeaction="<%="selectTitipanPremi($index$," + i + ")"%>" name="<%="listInvoices.[$index$].listTitipan.[" + i + "].stTitipanPremiID"%>" readonly="false" popuplov="true" lov="LOV_TitipanPremiReinsurance" caption="Titipan" type="string" >
                                                        <c:param name="cc_code" value="<%=receipt.getStCostCenterCode()%>" />
                                                    </c:field>
                                                </td>
                                                </c:evaluate>
                                                ...
                                                <td align="center" class=row1>
                                                    <b><%=rclTitip.getTitipanPremiReinsurance()!=null?rclTitip.getTitipanPremiReinsurance().getStCounter():""%></b>
                                                </td>
    ...
    <td align=center>
        <c:evaluate when="<%=!readOnly%>" >
            <c:evaluate when="<%=phase >= 3%>">
                ...
                <c:button text="Simpan" event="doSaveTPReinsurance" validate="true" confirm="Do you want to save ?" />
            </c:evaluate>
        ...
        <c:evaluate when="<%=form.isReverseMode()%>" >
            <c:button text="Reverse" event="reverseTPReinsurance"/>
        </c:evaluate>
        <c:evaluate when="<%=readOnly%>" >
            <c:button text="Tutup" event="doClose"/>
        </c:evaluate>
        <c:evaluate when="<%=form.isApproveMode()%>">
            <c:button text="Setujui"  event="doApproveTPReinsurance" confirm="Do you want to approve ?" />
        </c:evaluate>
    </td>
</tr>
</table>
