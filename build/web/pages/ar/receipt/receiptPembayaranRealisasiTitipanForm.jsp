            ...
            <td>
                ...
                <table cellpadding=2 cellspacing=1>
                    ...
                    <tr>
                        <td>
                                ...
                                <c:evaluate when="<%=useCheckFlag%>" >
                                    <c:listcol title="Metode">
                                        <c:evaluate when="<%=showTrxMethod%>" >
                                            <c:field name="<%="listInvoices.[$index$].stTransactionMethod"%>" mandatory="false" caption="Bayar" type="string" width="110" lov="VS_RECEIPT_TRX_METHOD" />
                                        </c:evaluate>
                                    </c:listcol>
                                </c:evaluate>
                            ...
                            <tr>
                                ...
                                <td class=row1></td>
                            <td class=row1></td>
                            <td class=row1><strong><%=jspUtil.print(subTotal2, 2)%></strong></td>
                            <td class=row1></td>
                            <td class=row1><strong><%=jspUtil.print(subTotal3, 2)%></strong></td>
                            <td class=row1></td>
                            <td class=row1><strong><%=jspUtil.print(subTotal4, 2)%></strong></td>
                            <td class=row1></td>
                            <td class=row1><strong><%=jspUtil.print(subTotal5, 2)%></strong></td>
                            <td class=row1></td>
                            <td class=row1><strong><%=jspUtil.print(subTotal6, 2)%></strong></td>
                                    ...
                                    <td colspan="21">
                                        <table>
                                            ...
                                            <tr class="row1">
                                                ...
                                                <td class=row1 >
                                                    <c:field  width="160" clientchangeaction="<%="selectTitipanPremi($index$," + i + ")"%>" name="<%="listInvoices.[$index$].listTitipan.[" + i + "].stTitipanPremiID"%>" readonly="false" popuplov="true" lov="LOV_TitipanPremi2" caption="Titipan" type="string" >
                                                        <c:param name="cc_code" value="<%=receipt.getStCostCenterCode()%>" />
                                                    </c:field>
                                                </td>
                                                </c:evaluate>
                                                ...
                                                <td align="center" class=row1>
                                                    <b><%=rclTitip.getTitipanPremi()!=null?rclTitip.getTitipanPremi().getStCounter():""%></b>
                                                </td>
                    ...
                    <tr>
                        <td>
                            <c:button text="Del All" confirm="Yakin ingin dihapus semua?" event="onDeleteAll" validate="false" enabled="<%=!readOnly%>"/>
<%--<c:button text="Surat Hutang Komisi" clientEvent="addnewsurathutangcomm()" validate="false" enabled="<%=!readOnly%>"/>        --%>              
                            <c:evaluate when="<%=suratHutang%>">
                                <c:button text="Surat Hutang" clientEvent="addnewsurathutang()" validate="false" enabled="<%=!readOnly%>"/>
                            </c:evaluate>
                            <c:button text="Titipan Tanpa No Polis" clientEvent="addnewinvoice()" validate="false" enabled="<%=!readOnly%>"/>
