<%@ page import="com.webfin.insurance.form.ProductionReinsuranceReportForm,
...
<%@ taglib prefix="c" uri="crux" %><c:frame>
    <%
                final ProductionReinsuranceReportForm f = (ProductionReinsuranceReportForm) frame.getForm();
                ...
                final boolean PFL_TREATYNOR = StringTools.indexOf(((String) r1.get("TREATYNOR")), "O") >= 0;
                ...
                final boolean PFL_REINS_DATE = StringTools.indexOf(((String) r1.get("REINS_DATE")), "O") >= 0;
                ...
                final boolean PFL_POLCREDIT = StringTools.indexOf(((String) r1.get("POLCREDIT")), "O") >= 0;
                final boolean PFL_NONCREDIT = StringTools.indexOf(((String) r1.get("NONCREDIT")), "O") >= 0;
                final boolean PFL_JOURNAL_DATE = StringTools.indexOf(((String) r1.get("JOURNAL_DATE")), "O") >= 0;
                final boolean PFL_CURRENCY = StringTools.indexOf(((String) r1.get("CURRENCY")), "O") >= 0;
                final boolean PFL_TREATY = StringTools.indexOf(((String) r1.get("TREATY")), "O") >= 0;
                final boolean PFL_POLICY_GROUP_SOA = StringTools.indexOf(((String) r1.get("POLICY_GROUP_SOA")), "O") >= 0;
                final boolean PFL_TREATY_GROUP = StringTools.indexOf(((String) r1.get("TREATY_GROUP")), "O") >= 0;
                final boolean PFL_POLJENAS = StringTools.indexOf(((String) r1.get("POLJENAS")), "O") >= 0;
                ...
                final boolean PFM_REINS_DATE = StringTools.indexOf(((String) r1.get("REINS_DATE")), "M") >= 0;
                final boolean PFM_RISLIP = StringTools.indexOf(((String) r1.get("RISLIP")), "M") >= 0;
                final boolean PFM_TRIWULAN = StringTools.indexOf(((String) r1.get("TRIWULAN")), "O") >= 0;
                final boolean PFM_POLCREDIT = StringTools.indexOf(((String) r1.get("POLCREDIT")), "M") >= 0;
                final boolean PFM_NONCREDIT = StringTools.indexOf(((String) r1.get("NONCREDIT")), "M") >= 0;
                final boolean PFM_JOURNAL_DATE = StringTools.indexOf(((String) r1.get("JOURNAL_DATE")), "M") >= 0;
            ...
            <td>
                <table cellpadding=2 cellspacing=1>
                    ...
                    <c:evaluate when="<%=rptSelected%>" >
                        ...
                        <c:evaluate when="<%=PFL_REINS_DATE%>" >      
                            <tr>
                                <td>R/I Date</td>
                                <td>:</td>
                                <td>
                                    <c:field name="ReinsDateFrom" type="date" caption="R/I From"  />
                                    To <c:field name="ReinsDateTo" type="date" caption="R/I To" />
                                </td>
                            </tr>
                        </c:evaluate>
                        <c:evaluate when="<%=PFL_JOURNAL_DATE%>" >
                            <tr>
                                <td>Journal Date</td>
                                <td>:</td>
                                <td>
                                    <c:field name="journalDateFrom" type="date" caption="Journal From"  />
                                    To <c:field name="journalDateTo" type="date" caption="Journal To" />
                                </td>
                            </tr>
                        </c:evaluate>
                        ...
                        <c:evaluate when="<%=PFL_POLICY_GROUP_SOA%>" >
                            <c:field width="300" lov="LOV_GROUPSOA" caption="Policy Group SOA" name="stPolTypeGrpSoaID" descfield="stPolTypeGrpSoaDesc" type="string" presentation="standard" loveall="true"/>
                        </c:evaluate>

                        <c:evaluate when="<%=PFL_NONCREDIT%>" >
                            <c:field name="stNonCreditID" type="string" descfield="stNonCreditName" width="200" lov="LOV_CREDITLIST" caption="Jenis Asuransi" presentation="standard" />
                        </c:evaluate> 
                        ...
                        <c:evaluate when="<%=PFL_BRANCH%>" >
                            <c:field width="200" caption="Branch" lov="LOV_Branch" name="stBranch" descfield="stBranchDesc" readonly="<%=cabang%>" type="string" presentation="standard" changeaction="onChangeBranchGroup"/>
                            <c:field show="<%=f.getStBranch() != null%>" width="200" caption="Region" lov="LOV_Region" name="stRegion" descfield="stRegionDesc" readonly="<%=region%>" type="string" presentation="standard" >
                        ...
                        <c:evaluate when="<%=PFL_TREATYNOR%>" >
                             <tr>
                                ...
                                <td>
                                    <c:field name="stFltTreatyType" type="string" width="200" descfield="stFltTreatyTypeDesc" caption="Treaty Type"  lov="LOV_TreatyType2" loveall="true"/>
                                    &nbsp;<c:button text="+" name="bprintx"  event="addTreatyType" />
                                </td>
                            </tr>
                            ...
                            <c:field name="treatyTypeList" type="string" width="400" rows="3" caption="Treaty Type List" readonly="true" presentation="standard"/>

                        <c:evaluate when="<%=PFL_TREATY%>" >
                            <c:field name="stTreatyYearID" type="string" width="200" descfield="stTreatyYearDesc" caption="Treaty Year" presentation="standard" lov="LOV_Treaty2" loveall="true"/>
                        </c:evaluate>
                        <c:evaluate when="<%=PFL_TREATY_GROUP%>" >
                            <c:field name="stTreatyYearGrpID" type="string" width="200" descfield="stTreatyYearGrpDesc" caption="Treaty Group Year" presentation="standard" lov="LOV_TreatyGroup" loveall="true"/>
                        </c:evaluate>
                        ...
                        <c:evaluate when="<%=PFL_CHECK%>" >
                            <c:field caption="{L-ENGFlag-L}{L-INAFlag-L} " name="stABAFlag" type="check" mandatory="false" presentation="standard" />
                        </c:evaluate>
                        ...
                        <c:evaluate when="<%=PFL_POLCREDIT%>" >
                            <c:field name="stPolCredit" type="string" width="200" caption="Special Type" lov="LOV_POL_CREDIT" mandatory="false" presentation="standard"/>
                        </c:evaluate>
                        <c:evaluate when="<%=PFL_POLJENAS%>" >
                            <c:field name="stPolJenas" type="string" width="200" mandatory="false" caption="Special Type" presentation="standard" />
                        </c:evaluate>
                        <c:evaluate when="<%=PFL_CURRENCY%>" >
                            <c:field name="stCurrency" type="string" width="200" caption="Currency" lov="LOV_Currency2" mandatory="false" presentation="standard"/>
                        </c:evaluate>
                    </c:evaluate>
