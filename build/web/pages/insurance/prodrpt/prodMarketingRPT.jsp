<%@ page import="com.webfin.insurance.form.ProductionMarketingReportForm,
...
<%@ taglib prefix="c" uri="crux" %><c:frame>
    <%
                final ProductionMarketingReportForm f = (ProductionMarketingReportForm) frame.getForm();
                ...
                final boolean PFL_INSCOMPANYPROD = StringTools.indexOf(((String) r1.get("INSCOMPANYPROD")), "O") >= 0;
                ...
                final boolean PFL_TRIWULAN = StringTools.indexOf(((String) r1.get("TRIWULAN")), "O") >= 0;
                final boolean PFL_VALIDASI = StringTools.indexOf(((String) r1.get("VALIDASI")), "O") >= 0;
                final boolean PFL_F_FACULTATIF = StringTools.indexOf(((String) r1.get("F_FACULTATIF")), "O") >= 0;
                final boolean PFL_MARKETER_OFFICER = StringTools.indexOf(((String) r1.get("MARKETER_OFFICER")), "O") >= 0;
                final boolean PFL_PROFILE = StringTools.indexOf(((String) r1.get("PROFILE")), "O") >= 0;
                final boolean PFL_GROUP_JENIS = StringTools.indexOf(((String) r1.get("GROUP_JENIS")), "O") >= 0;
                final boolean PFL_GROUP_OUTGO = StringTools.indexOf(((String) r1.get("GROUP_OUTGO")), "O") >= 0;
                final boolean PFL_PERDATE = StringTools.indexOf(((String) r1.get("PERDATE")), "O") >= 0;
                final boolean PFL_LOSSPROFILE = StringTools.indexOf(((String) r1.get("LOSSPROFILE")), "O") >= 0;
                ...
                final boolean PFL_FILTERADD = StringTools.indexOf(((String) r1.get("FILTERADD")), "O") >= 0;
                final boolean PFL_POLICY_CLASS_LIST = StringTools.indexOf(((String) r1.get("POLICY_CLASS_LIST")), "O") >= 0;
                final boolean PFL_BUSINESS_SOURCE = StringTools.indexOf(((String) r1.get("BUSINESS_SOURCE")), "O") >= 0;
                ...
                final boolean PFM_INSCOMPANYPROD = StringTools.indexOf(((String) r1.get("INSCOMPANYPROD")), "M") >= 0;
                ...
                final boolean PFM_TRIWULAN = StringTools.indexOf(((String) r1.get("TRIWULAN")), "M") >= 0;
                final boolean PFM_VALIDASI = StringTools.indexOf(((String) r1.get("VALIDASI")), "M") >= 0;
                final boolean PFM_F_FACULTATIF = StringTools.indexOf(((String) r1.get("F_FACULTATIF")), "M") >= 0;
                final boolean PFM_MARKETER_OFFICER = StringTools.indexOf(((String) r1.get("MARKETER_OFFICER")), "M") >= 0;
                final boolean PFM_PROFILE = StringTools.indexOf(((String) r1.get("PROFILE")), "M") >= 0;
                final boolean PFM_GROUP_JENIS = StringTools.indexOf(((String) r1.get("GROUP_JENIS")), "M") >= 0;
                final boolean PFM_GROUP_OUTGO = StringTools.indexOf(((String) r1.get("GROUP_OUTGO")), "M") >= 0;
                final boolean PFM_PERDATE = StringTools.indexOf(((String) r1.get("PERDATE")), "M") >= 0;
                final boolean PFM_LOSSPROFILE = StringTools.indexOf(((String) r1.get("LOSSPROFILE")), "M") >= 0;
                final boolean PFM_BUSSPOLTYPE = StringTools.indexOf(((String) r1.get("BUSSPOLTYPE")), "M") >= 0;
                final boolean PFM_BUSSPOLTYPECOB = StringTools.indexOf(((String) r1.get("BUSSPOLTYPECOB")), "M") >= 0;
                final boolean PFM_BUSINESS_SOURCE = StringTools.indexOf(((String) r1.get("BUSINESS_SOURCE")), "M") >= 0;
                ...
                System.out.print("$$$$$$$$$$$$$$$ " + f.getStFilterAdd());
                ...
                <table cellpadding=2 cellspacing=1>
                    ...
                    <c:evaluate when="<%=rptSelected%>" >
                        ...
                        <c:evaluate when="<%=!PFL_FILTERADD%>" >
                            ...
                            <c:evaluate when="<%=PFL_ENTRY_DATE%>" >
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        To <c:field name="entryDateTo" type="date" caption="Approved To" />
                                    </td>
                                </tr>
                            </c:evaluate>
                            ...
                            <c:evaluate when="<%=PFM_PERDATE%>" >
                                <c:field name="perDateFrom" type="date" caption="Per Tanggal" presentation="standard"/>
                            </c:evaluate>
                            ...
                            <c:evaluate when="<%=PFM_YEAR%>" >
                                <c:field name="year" type="string" caption="Year" lov="LOV_GL_Years2" mandatory="false" include="<%=PFL_YEAR%>" presentation="standard"/>
                            </c:evaluate>
                            ...
                            <c:evaluate when="<%=PFL_POLICY_CLASS_LIST%>" >
                                <c:field width="300" changeaction="onChangePolicyTypeGroup" lov="LOV_PolicyTypeGroup" caption="Policy Class" name="stPolicyTypeGroupID" descfield="stPolicyTypeGroupDesc" type="string" mandatory="<%=PFM_POLICY_CLASS%>" presentation="standard" loveall="true" />
                                <c:evaluate when="<%=f.getStPolicyTypeGroupID() != null%>" >
                                    <tr>
                                        <td>
                                            Policy Type
                                        </td>
                                        ...
                                        <td>
                                            <c:field width="300" lov="LOV_PolicyType" caption="Policy Type" name="stPolicyTypeID" descfield="stPolicyTypeDesc" type="string" mandatory="<%=PFM_POLICY_CLASS%>">
                                                <c:lovLink name="polgroup" link="stPolicyTypeGroupID" clientLink="false" />
                                            </c:field>&nbsp;<c:button text="+" name="bprintx"  event="addPolicyType" /> &nbsp;*Lebih dari 1 pilihan
                                        </td>
                                    </tr>
                                    <c:field name="policyTypeList" type="string" width="400" rows="3" caption="Policy Type List" readonly="true" presentation="standard"/>
                                </c:evaluate>
                            </c:evaluate>
                            ...
                            <c:evaluate when="<%=PFL_BRANCH%>" >
                                ...
                                <c:evaluate when="<%=f.getStBranch() != null%>" >
                                    <c:field show="<%=!f.getStBranch().equalsIgnoreCase("80")%>" width="200" caption="Region" lov="LOV_Region" name="stRegion" descfield="stRegionDesc" type="string" presentation="standard" >
                                        <c:lovLink name="cc_code" link="stBranch" clientLink="false"/>
                                    </c:field>
                                </c:evaluate>

                                <c:evaluate when="<%=f.getStBranch() != null%>" >
                                    <c:field show="<%=f.getStBranch().equalsIgnoreCase("80")%>" width="200" caption="Branch Source" lov="LOV_CostCenterSource" name="stBranchSource" descfield="stBranchSourceDesc" type="string" presentation="standard" changeaction="onChangeBranchGroup"/>
                                    <c:field show="<%=f.getStBranchSource() != null%>" width="200" caption="Region Source" lov="LOV_RegionSource" name="stRegionSource" descfield="stRegionSourceDesc" type="string" presentation="standard" >
                                        <c:lovLink name="cc_code_source" link="stBranchSource" clientLink="false"/>
                                    </c:field>
                                </c:evaluate>
                            </c:evaluate>
                            ...
                            <c:evaluate when="<%=PFL_MARKETER_OFFICER%>" >
                                <c:field name="stMarketerOffID" type="string" descfield="stMarketerOffName" width="200" popuplov="true"  lov="LOV_Entity" mandatory="false" caption="Marketer Officer" presentation="standard" />
                            </c:evaluate>
                            <c:evaluate when="<%=PFL_INSCOMPANY%>" >
                                <c:field name="stCompanyID" type="string" descfield="stCompanyName" width="200" popuplov="true"  lov="LOV_COMPANYGROUP" mandatory="false" caption="Company Group Customer" presentation="standard" />
                            </c:evaluate>
                            <c:evaluate when="<%=PFL_INSCOMPANYPROD%>" >
                                <c:field name="stCompanyProdID" type="string" descfield="stCompanyProdName" width="200" popuplov="true"  lov="LOV_COMPANYGROUP" mandatory="false" caption="Company Group Marketer" presentation="standard" />
                            </c:evaluate>
                            ...
                            <c:evaluate when="<%=PFL_VALIDASI%>" >
                                <c:field name="stValidasi" type="string" width="300" caption="Validasi" lov="LOV_VALIDASI" loveall="true" presentation="standard" />
                            </c:evaluate>
                            ...
                            <c:evaluate when="<%=PFL_PROFILE%>" >
                                <c:field name="stProfileID" type="string" descfield="stProfileName" width="200" loveall="true" lov="LOV_ABA_PROFILE" mandatory="false" caption="Profile" presentation="standard" />
                            </c:evaluate>
                            <c:evaluate when="<%=PFL_GROUP_JENIS%>" >
                                <c:field name="stGroupJenisID" type="string" descfield="stGroupJenisName" width="200" loveall="true" lov="LOV_ABA_GROUP_JENIS" mandatory="false" caption="Group Jenis" presentation="standard" />
                            </c:evaluate>
                            <c:evaluate when="<%=PFL_GROUP_OUTGO%>" >
                                <c:field name="stGroupOutgoID" type="string" descfield="stGroupOutgoName" width="200" loveall="true" lov="LOV_ABA_GROUP_OUTGO" mandatory="false" caption="Group Jenis" presentation="standard" />
                            </c:evaluate>
                            <c:evaluate when="<%=PFL_LOSSPROFILE%>" >
                                <c:field name="stLossProfile" type="string" descfield="stLossProfileName" width="100" lov="LOV_LOSSPROFILE" mandatory="false" caption="Level" presentation="standard" />
                            </c:evaluate>
                            ...
                            <c:evaluate when="<%=PFL_TRIWULAN%>" >
                                <c:field name="stTriwulan" type="string" width="200" caption="Triwulan" lov="LOV_Triwulan" mandatory="false" presentation="standard"/>
                            </c:evaluate>
                            <c:evaluate when="<%=PFL_F_FACULTATIF%>" >
                                <c:field caption="{L-ENG Facultatif -L}{L-INA Facultatif -L} " name="stFFac" type="check" mandatory="false" presentation="standard" />
                            </c:evaluate>
                        </c:evaluate>
                        ...
                        <c:evaluate when="<%=PFL_FILTERADD%>" >
                            ...
                            <c:evaluate when="<%=Tools.isYes(f.getStFilterAdd())%>" >
                                <c:evaluate when="<%=PFL_PERIOD%>" >
                                    <tr>
                                        <td>Period Start</td>
                                        <td>:</td>
                            ...
                            <c:field caption="Filter Tambahan" name="stFilterAdd" type="check" mandatory="false" presentation="standard" changeaction="refresh" />
                            ...
                            <c:evaluate when="<%=Tools.isYes(f.getStFilterAdd())%>" >
                                ...
                                <c:evaluate when="<%=PFL_BUSINESS_SOURCE%>" >
                                    <c:field name="stBussinessSourceID" type="string" descfield="stBussinessSourceName" width="200" loveall="true" lov="LOV_BUSSINESS_SOURCE" mandatory="false" caption="Klasifikasi" presentation="standard" />
                                </c:evaluate>
                                <c:evaluate when="<%=PFL_LOSSPROFILE%>" >
                                    <c:field name="stLossProfile" type="string" descfield="stLossProfileName" width="100" lov="LOV_LOSSPROFILE" mandatory="false" caption="Level" presentation="standard" />
                                </c:evaluate>
