...
<%
            ...
            final DTOList objectsAll = pol.getObjects();

            String namaPrincipal="";
            String alamatPrincipal ="";

            for (int i = 0; i < objectsAll.size(); i++) {
                    InsurancePolicyObjectView io = (InsurancePolicyObjectView) objectsAll.get(i);

                    InsurancePolicyObjDefaultView object1 = (InsurancePolicyObjDefaultView) io;

                    namaPrincipal = object1.getStReference1();
                    alamatPrincipal = object1.getStReference3();
             }
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(namaPrincipal)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Address-L}{L-INA Alamat-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(alamatPrincipal)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                                        ...
                                        <fo:table-body>
                                            ...
                                            <%
                                                                     ...
                                                                     for (int j = 0; j < coverage.size(); j++) {
                                                                         ...
                                                                         if (BDUtil.isZeroOrNull(cover.getDbPremi())) {
                                                                             continue;
                                                                         }
                                            ...
                                            <fo:table-row>
                                                <fo:table-cell number-columns-spanned="11"><fo:block text-align="start">{L-ENG PREMIUM CALCULATION :-L}{L-INA PERHITUNGAN PREMI :-L}</fo:block></fo:table-cell>
                                            </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell>
                                <fo:block text-align = "center">
                                    <fo:external-graphic background-color="transparent"
                                                         content-height="scale-to-fit"
                                                         height="1.00in" content-width="1.00in"
