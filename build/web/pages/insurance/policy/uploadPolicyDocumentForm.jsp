...
<%@ page import="com.webfin.gl.form.GLJournalForm,
         ...
         com.webfin.insurance.form.DocumentUploadForm,
         com.webfin.insurance.model.PolicyDocumentUploadHeaderView,
         com.webfin.gl.ejb.CurrencyManager"%>
<%@ taglib prefix="c" uri="crux" %><c:frame title="UPLOAD DOKUMEN POLIS" >
    <%

                final DocumentUploadForm form = (DocumentUploadForm) request.getAttribute("FORM");

                final PolicyDocumentUploadHeaderView header = form.getTitipan();

                boolean readOnly = form.isReadOnly();

                int jumlah = header.getDetails().size();
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding=2 cellspacing=1>
                                            ...
                                            <c:evaluate when="<%=header.getStRegionID()!=null%>">
                                            <c:field name="titipan.stFilePhysic" caption="File Konversi Excel" type="file" thumbnail="true"
                                    ...
                                    <td>
                                        <table cellpadding=2 cellspacing=1>
                                            <c:evaluate when="<%=header.getStRegionID()!=null%>">
                                                <c:field name="titipan.stInsuranceDocumentTypeID" caption="Jenis Dokumen" type="string" lov="LOV_PolicyDocumentType" width="200"
                                                      readonly="false" presentation="standard" mandatory="true"/>
                                                <c:field name="titipan.stDokumenUpload" caption="Dokumen Upload" type="file" thumbnail="true"
                                                      readonly="false" presentation="standard" mandatory="true"/>
                            ...
                            <table>
                                ...
                                <c:listbox name="details"  paging="true" >
                                    ...
                                    <c:listcol title="Keterangan" >
                                        <c:field name="details.[$index$].stDescription" width="250" caption="Deskripsi" mandatory="false" type="string" readonly="true" />
                                    </c:listcol>
                                    <%--
