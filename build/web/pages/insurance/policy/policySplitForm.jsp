<%@ page import="com.webfin.insurance.form.PolicySplitForm,
com.crux.util.Tools,
...
<%
final PolicySplitForm form = (PolicySplitForm) frame.getForm();

final InsuranceSplitPolicyView policy = form.getPolicy();

final InsuranceSplitPolicyObjectView selectedObject = form.getSelectedObject();
                    ...
                    <td>
                        <table cellpadding=2 cellspacing=1>
                            ...
                            <c:field width="200" show="<%=policy.getStClaimStatus()!=null%>"
                                     ...
                                     mandatory="false" readonly="true" presentation="standard"/>
                           <c:field width="200" show="<%=showPolicyNo%>" caption="{L-ENGPolicy No-L}{L-INANomor Rekap-L}"
                        ...
                        <table cellpadding=2 cellspacing=1>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <c:field width="550" rows="5" caption="{L-ENGWarranty-L}{L-INAWarranty-L}&nbsp &nbsp &nbsp"
...
<tr>
                                            ...
                                            <tr class=row0>
                                                <td>
                                                    <table cellpadding=2 cellspacing=1>
                                                        ...
                                                        <c:field clientchangeaction="selectCustomer2();setFeeBase();" name="selectedObject.stEntityID" type="string" width="300"
                                                popuplov="true" lov="LOV_Entity" mandatory="true"
                                                        caption="<%=policy.getPolicyType().getStEntityMasterLabel()%>" presentation="standard"/>
                                                          <c:field clientchangeaction="selectProducer2()" name="selectedObject.stProducerID" type="string" width="300"
                                     popuplov="true" lov="LOV_Entity" mandatory="true" caption="{L-ENGMarketer-L}{L-INAPemasar-L}"
                                     readonly="false" presentation="standard"/>
                                                           <c:field name="selectedObject.dbBiayaPolis" type="money16.2" width="300"
                                                mandatory="true"
                                                        caption="Biaya Polis" presentation="standard"/>
                                                           <c:field name="selectedObject.dbBiayaMaterai" type="money16.2" width="300"
                                                mandatory="true"
                                                        caption="Biaya Materai" presentation="standard"/>
                                                           <c:field name="selectedObject.dbFeebasePct" type="money16.2" width="300"
                                                mandatory="true"
                                                        caption="Feebase Pct" presentation="standard"/>
                                                           <c:field name="selectedObject.dbKomisiPct" type="money16.2" width="300"
                                                mandatory="true"
                                                        caption="Komisi Pct" presentation="standard"/>

                                                           <c:field clientchangeaction="selectProducer2()" name="selectedObject.stKomisiEntityID" type="string" width="300"
                                     popuplov="true" lov="LOV_Entity" mandatory="true" caption="Penerima Komisi"
                                     readonly="false" presentation="standard"/>

                                                           <c:field name="selectedObject.dbBrokerFeePct" type="money16.2" width="300"
                                                mandatory="true"
                                                        caption="Broker Fee Pct" presentation="standard"/>
                                                            <c:field name="selectedObject.dbHandlingFeePct" type="money16.2" width="300"
                                                mandatory="true"
                                                        caption="Handling Fee Pct" presentation="standard"/>

                                                            <c:field name="selectedObject.stPaymentCompanyID" type="string" width="300"
                                                                 popuplov="true" lov="LOV_Entity" mandatory="false" caption="Tagihan Kepada"
                                                                 readonly="false" presentation="standard"/>

                                                           <c:field name="selectedObject.dtPeriodStart" type="date" width="300"
                                                mandatory="true"
                                                        caption="Periode Awal" presentation="standard"/>

                                                           <c:field name="selectedObject.dtPeriodEnd" type="date" width="300"
                                                mandatory="true"
                                                        caption="Periode Akhir" presentation="standard"/>
                                                        ...
                                                        <c:evaluate when="<%=form.getSelectedObject() instanceof InsuranceSplitPolicyObjDefaultView%>">
                                                        ...
                                                        <c:field lov="LOV_RiskCategory" caption="{L-ENGRisk Code / Category-L}{L-INAKode Resiko / Kategori-L}"
                                                                 name="selectedObject.stRiskCategoryID" type="string" mandatory="false" readonly="false"
                                                                 width="400" presentation="standard" popuplov="true" refresh="true">
                                                            <c:lovLink name="datestart" link="selectedObject.stReference1" clientLink="false"/>
                                            ...
                                            <tr class=row0>
                                                <td align=right>
                                                    ...
                                                    <c:listbox name="selectedObject.suminsureds">
                                                        <%
                                                        final InsuranceSplitPolicyTSIView tsix = (InsuranceSplitPolicyTSIView) current;
                                                ...
                                                <tr class=row0>
                                                    <td>
                                                        ...
                                                        <c:listbox name="selectedObject.coverage">
                                                            <%
                                                            final InsuranceSplitPolicyCoverView cover = (InsuranceSplitPolicyCoverView) current;
                                                            ...
                                                            %>
                                                            <c:listcol title="">
                                                                <c:evaluate when="<%=!((InsuranceSplitPolicyCoverView)current).isMainCover()%>">
    ...
    <c:evaluate when="<%=hasCoIns%>">
        ...
        <c:tabpage name="TAB_OPTIONS">
                      ...
                      <table cellpadding=2 cellspacing=1 class=header>
                        <tr>
                            <td align=center> History Reverse</td>
                        </tr>
                        <tr>
                            <td>
                                <c:listbox name="reverse">
                                    ...
                                    <c:listcol title="User Reverse" name="stReverseWho"/>
                                    <c:listcol title="User Name" name="stReverseName"/>
                                    <c:listcol title="Tanggal Reverse" name="stReverseTime"/>
