<%@ page import="com.webfin.insurance.form.DocumentUploadList,
         com.crux.util.Tools,
         com.webfin.insurance.model.PolicyDocumentUploadHeaderView"%>
<%@ taglib prefix="c" uri="crux" %><c:frame title="UPLOAD DOKUMEN POLIS" >

    <%
                DocumentUploadList form = (DocumentUploadList) request.getAttribute("FORM");
    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr>
            <td>
                ...
                <c:listbox name="list" selectable="true" paging="true" view="com.webfin.insurance.model.PolicyDocumentUploadHeaderView" autofilter="true">
        ...
        <tr>
            <td>
                ...
                <c:button show="<%=form.isCanApprove()%>" text="Proses" event="uploadDocumentToPolisProses" confirm="Yakin ingin diproses ?" />
            </td> 
        </tr>
    </table>
