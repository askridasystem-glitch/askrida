                        ...
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                ...
                                <c:field width="200" changeaction="changeBranch" lov="LOV_CostCenter"
                                         ...
                                         mandatory="true" readonly="true" presentation="standard"/>

                                <c:field show="<%=policy.getStCostCenterCode() != null%>" width="200" lov="LOV_Region"
                                         caption="{L-ENGRegion-L}{L-INADaerah-L}"
                                         name="policy.stRegionID" type="string" mandatory="true"
                                ...
                                <c:field clientchangeaction="selectCustomer()" name="policy.stEntityID" type="string" width="200"
                                         popuplov="true" lov="LOV_Entity" mandatory="true" readonly="false" caption="Sumber Bisnis" presentation="standard"/>
                                <c:field width="200" rows="2" caption="Sumber Bisnis"
                                         name="policy.stCustomerName" type="string" mandatory="true" readonly="false" presentation="standard"/>
                                ...
                                <c:field width="200" show="<%=showPolicyNo%>" caption="{L-ENGAskrida No-L}{L-INANomor PKS Askrida-L}"
                                         name="stPolicyNo" type="string" mandatory="true" readonly="true" presentation="standard"/>
                                <c:field width="200" show="<%=showPolicyNo%>" caption="{L-ENGBank No-L}{L-INANomor PKS Bank-L}"
                                         name="stBankNo" type="string" mandatory="true" readonly="true" presentation="standard"/>
                                <c:field caption="{L-ENGRemark Date-L}{L-INATanggal Penandatanganan-L}" name="dtPolicyDate" type="date"
                                         mandatory="true" readonly="true" presentation="standard"/>
                                <c:field caption="{L-ENGReceive Date-L}{L-INATanggal Penerimaan-L}" name="dtReceiveDate" type="date"
                                         mandatory="true" readonly="true" presentation="standard"/>
                                <c:field caption="{L-ENGPeriod Start-L}{L-INAPeriode Awal-L}" name="dtPeriodStart" type="date"
                                         mandatory="true" readonly="true" presentation="standard"/>
                                <c:field caption="{L-ENGPeriod End-L}{L-INAPeriode Akhir-L}" name="dtPeriodEnd" type="date"
                                         mandatory="true" readonly="true" presentation="standard"/>
                                <c:field name="stFilePhysic" mandatory="true" type="file" thumbnail="true" caption="Lampiran PKS Awal" presentation="standard" />
                            </table>
                        </td>
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                ...
                                <c:field show="<%=policy.getStPolicyTypeGroupID() != null%>" width="300" changeaction="onChangePolicyType" lov="LOV_PolicyType" readonly="true"
                                ...
                                <c:field width="200" rows="2" caption="{L-ENGAddress-L}{L-INAAlamat-L}" name="policy.stProducerAddress"
                                         type="string" mandatory="true" readonly="false" presentation="standard"/>
                                <c:field width="200" show="<%=showPolicyNo%>" caption="No Addendum"
                                ...
                                <c:field caption="Tanggal Addendum" name="policy.dtPolicyDate" type="date"
                                         mandatory="true" readonly="false" presentation="standard"/>
                                <c:field caption="Tanggal Addendum" name="policy.dtReceiveDate" type="date"
                                         mandatory="true" readonly="false" presentation="standard"/>
                                <c:field caption="J. Waktu Addendum" name="policy.dtPeriodStart" type="date"
                                         mandatory="true" readonly="false" presentation="standard"/>
                                <c:field caption="J. Waktu Addendum" name="policy.dtPeriodEnd" type="date"
                                         mandatory="true" readonly="false" presentation="standard"/>
                                <c:field name="policy.stFilePhysic" mandatory="true" type="file" thumbnail="true" caption="Lampiran Addendum" presentation="standard" />
                            </table>
                        </td>
                    </tr>                    
                    <tr>
                        <td colspan=2>
                            <table cellpadding=2 cellspacing=1>
                                <c:field width="700" rows="3" caption="{L-ENGNotes-L}{L-INACatatan-L}"
