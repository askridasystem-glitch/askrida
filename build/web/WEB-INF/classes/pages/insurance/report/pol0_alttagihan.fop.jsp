                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%= JSPUtil.printX(pol.getCostCenter(pol.getCostCenter(pol.getStCostCenterCode()).getStSubCostCenterCode()).getStDescription())%>, <%= DateUtil.getDateStr(pol.getDtPolicyDate(), "d ^^ yyyy")%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <%--
                                                <fo:table-row>
                                                    <fo:table-cell number-columns-spanned="7" ><fo:block text-align="justify" space-after.optimum="10pt">
                                                            ...
                                                            ke rekening kami No. <% if (pol.getCostCenter3().getStEntityID() != null) {%> <%=pol.getCostCenter3().getEntity().getStRcNo()%> <%=JSPUtil.printX(pol.getCostCenter3().getEntity().getStEntityName())%><% } else {%> ... <% }%> atas nama PT. ASURANSI BANGUN ASKRIDA.
                                                        </fo:block></fo:table-cell>
                                                </fo:table-row>
                        --%>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="7" ><fo:block text-align="justify" space-after.optimum="10pt">
                                    Bersama surat ini, kami dari PT. ASURANSI BANGUN ASKRIDA memberitahukan, bahwa sesuai dengan catatan kami, POLIS Asuransi Bapak/Ibu/Saudara <%= pol.getStPolicyNo().substring(0, 4) + "-" + pol.getStPolicyNo().substring(4, 8) + "-" + pol.getStPolicyNo().substring(8, 12) + "-" + pol.getStPolicyNo().substring(12, 16) + "-" + pol.getStPolicyNo().substring(16, 18)%> sampai saat ini belum tercatat
                                    pembayarannya di rekening kami, dengan premi sebesar <%= pol.getStCurrencyCode()%> <%= JSPUtil.printX(pol.getDbTotalDue(), 2)%>. Untuk itu kami harapkan agar Bapak/Ibu/Saudara dapat membayar per kas atau di transfer
                                    ke rekening kami No. ..................................... <%=JSPUtil.printX(pol.getCostCenter3().getEntity().getStEntityName())%> atas nama PT. ASURANSI BANGUN ASKRIDA.
                                </fo:block></fo:table-cell>
                        </fo:table-row>
