                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell border-left-style="solid" padding="1pt" number-columns-spanned="4">
                                <fo:block text-align="center" font-size="9pt"><fo:inline text-decoration="underline">DEFINITIVE LOSS ADVICE</fo:inline></fo:block>
                                <fo:block text-align="center" font-size="9pt">LAPORAN KERUGIAN PASTI</fo:block>
                            </fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-right-style="solid" padding="1pt">
                                ...
                                <fo:block text-align="start" font-size="9pt"><%=JSPUtil.printX(pol.getStDLANo())%></fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell >
                                <fo:block ><fo:inline text-decoration="underline">Settled Claim Amount (100%)</fo:inline></fo:block>
                                <fo:block >Jumlah Kerugian Pasti (100%)</fo:block>
                            </fo:table-cell>
                            <fo:table-cell ><fo:block text-align="center">:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block >                                    
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                <%
                                                                                    ...
                                                                                    for (int q = 0; q < claimItems.size(); q++) {
                                                                                        InsurancePolicyItemsView ci = (InsurancePolicyItemsView) claimItems.get(q);
                                                ...
                                                <%
                                                                                    ...
                                                                                    for (int w = 0; w < claimItems.size(); w++) {
                                                                                        InsurancePolicyItemsView ci = (InsurancePolicyItemsView) claimItems.get(w);
