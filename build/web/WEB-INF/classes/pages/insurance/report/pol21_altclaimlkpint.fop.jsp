...
BigDecimal coinsClaim = new BigDecimal(0);
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        for(int r = 0;r<coinsurer.size();r++){
                            ...
                            if (Tools.compare(coi.getDbClaimAmount(),BDUtil.zero)>0)
                                coinsClaim = coi.getDbClaimAmount();
                        }
                        %>
                        
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Gross Claim-L}{L-INA Klaim Bruto-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(coinsClaim,2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell >
                                <fo:block text-align="center"><fo:inline text-decoration="underline"><%= Parameter.readString("KABAG_KLAIM")%></fo:inline></fo:block>
