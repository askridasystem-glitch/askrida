    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <%
                        ...
                        InsurancePolicyObjDefaultView iob = (InsurancePolicyObjDefaultView) objects.get(0);
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Departure -L}{L-INA Asal Keberangakatan-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(iob.getStReference21())%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Destination -L}{L-INA Tempat Tujuan-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(iob.getStReference8())%></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>Manfaat</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                    ...
                                    <fo:block font-size="6pt">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid"><fo:block text-align="center">No.</fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid"><fo:block text-align="center">Jaminan</fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="center">Limit of Liability (<%=JSPUtil.printX(pol.getStCurrencyCode())%>)</fo:block></fo:table-cell>
                                                </fo:table-row>
                                                ...
                                                <%
                                                                            final DTOList coverage = iob.getCoverage();
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid"><fo:block text-align="center"><%=String.valueOf(j + 1)%></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid"><fo:block text-align="start"><%=JSPUtil.printX(cov.getInsuranceCoverage().getStDescription())%></fo:block></fo:table-cell>
                                                    <%if (Tools.compare(cov.getDbInsuredAmount(), new BigDecimal(0)) > 0) {%>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end"><%=JSPUtil.printX(cov.getDbInsuredAmount(), 0)%></fo:block></fo:table-cell>
                                                    <% } else {%>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="start" font-size="4pt"><%=JSPUtil.xmlEscape(cov.getStDescription())%></fo:block></fo:table-cell>
                                                    <%}%>
                                                </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>Manfaat Tambahan</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>
                                    <fo:block font-size="6pt">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid"><fo:block text-align="center">1</fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid"><fo:block text-align="start"><%=JSPUtil.printX(cov.getInsuranceCoverage().getStDescription())%></fo:block></fo:table-cell>
                                                    <%if (Tools.compare(cov.getDbInsuredAmount(), new BigDecimal(0)) > 0) {%>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end"><%=JSPUtil.printX(cov.getDbInsuredAmount(), 0)%></fo:block></fo:table-cell>
                                                    <% } else {%>
            ...
            <% if (!iob.getStReference18().equalsIgnoreCase("3")) {%>
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    <fo:table-column column-width="35mm"/>
                    <fo:table-column column-width="2mm"/>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>
                                    ...
                                    <%
                                         BigDecimal dedAmount = null;
                                         if (pol.getStCurrencyCode().equalsIgnoreCase("IDR")) {
                                             dedAmount = new BigDecimal("250000");
                                         } else if (pol.getStCurrencyCode().equalsIgnoreCase("USD")) {
                                             dedAmount = new BigDecimal("20");
                                         }
                                    %>

                                    <%=JSPUtil.printX(pol.getStCurrencyCode())%> <%=JSPUtil.printX(dedAmount, 2)%>,- masing-masing untuk :

                                    <%
                                         final DTOList deductibles = iob.getDeductibles();
                                         for (int j = 0; j < deductibles.size(); j++) {
                                             ...
                                             out.print(JSPUtil.xmlEscape(ded.getStClaimCauseDesc()));
