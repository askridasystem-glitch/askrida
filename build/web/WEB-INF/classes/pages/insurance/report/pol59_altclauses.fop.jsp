                    ...
                    <fo:table-body>
                        ...
                        for (int i = 0; i < clausules.size(); i++) {
                            ...
                            if (cl.getStWordingNew()!=null) {
                                desc = cl.getStWordingNew().replaceAll("%S%",pol.getEntity().getStEntityName());
                            } else {
                                desc = cl.getStWording().replaceAll("%S%",pol.getEntity().getStEntityName());
                            }
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="3">
                                <fo:block font-size="<%=fontsize%>" wrap-option="yes-wrap" linefeed-treatment="preserve"
