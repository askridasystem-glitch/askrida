                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Maka kami TERJAMIN dan PENJAMIN dengan ini mengikatkan diri untuk melakukan pembayaran jumlah tersebut diatas dengan baik dan benar bilamana TERJAMIN tidak memenuhi kewajiban sebagaimana ditetapkan dalam Dokumen Pengadaan -L} <% if (obj.getStReference10() != null) {%> <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference10())%></fo:inline> {L-ENG XXX -L}{L-INA tanggal -L} <%=DateUtil.getDateStr(obj.getDtReference1(), "d ^^ yyyy")%> <% }%> {L-ENG XXX -L}{L-INA untuk pelaksanaan pelelangan pekerjaan -L} <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference11())%></fo:inline> {L-ENG XXX -L}{L-INA yang diselenggarakan oleh PENERIMA JAMINAN. -L}. </fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA terlibat Korupsi, Kolusi dan Nepotisme (KKN); atau -L}</fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG d. -L}{L-INA d. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA melakukan penipuan /pemalsuan atas informasi yang disampaikan dalam Dokumen Penawaran -L}</fo:block></fo:table-cell>
                        </fo:table-row>
