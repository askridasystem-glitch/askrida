                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG Name of Debitur -L}{L-INA Nama Debitur -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Address of Debitur -L}{L-INA Alamat Debitur -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Author of Debitur -L}{L-INA Pejabat Debitur -L}</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStReference3Desc())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStReference15())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStReference16())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStReference1Desc())%></fo:block></fo:table-cell>
