                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < objects.size(); i++) {
                                        ...
                                        t[n] = BDUtil.add(t[n++], obj.getDbObjectPremiTotalAmount());
                                        ...
                                        if (obj.getStPolicyObjectRefID() != null) {
                                            ...
                                            if (!obj.getStReference7().equalsIgnoreCase(polObj.getStReference7())) {
                                                isEndorse = true;
                                            }
                        ...
                        <fo:table-row>
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" ><%=JSPUtil.printX(no)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="start" line-height="5mm"><fo:inline color="white">.</fo:inline><%=JSPUtil.printX(obj.getStReference1())%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(obj.getDtReference2())%> - <%=JSPUtil.printX(obj.getDtReference3())%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" >--</fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(obj.getDbReference2(), 2)%><fo:inline color="white">.</fo:inline></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(t[0], 2)%><fo:inline color="white">.</fo:inline></fo:block> </fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.add(t[1], t[2]), 2)%><fo:inline color="white">.</fo:inline></fo:block> </fo:table-cell>
                        </fo:table-row>
