        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <%
                        ...
                        for (int p = 0; p < objects.size(); p++) {
                            InsurancePolicyObjDefaultView io = (InsurancePolicyObjDefaultView) objects.get(p);
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=DateUtil.getDateStr(io.getDtReference1(), "d ^^ yyyy")%> {L-ENG up to-L}{L-INA s/d-L} <%=DateUtil.getDateStr(io.getDtReference2(), "d ^^ yyyy")%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block> {L-ENG Object-L}{L-INA Debitur-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(io.getStOrderNo())%>. <%=JSPUtil.printX(io.getStReference11())%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Sum Insured-L}{L-INA Harga Pertanggungan-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%> <%=JSPUtil.printX(io.getDbObjectInsuredAmount(), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Premium-L}{L-INA Premi Bruto-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%> <%=JSPUtil.printX(io.getDbObjectPremiTotalAmount(), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <%--
                        ...
                        <%
                                                        ...
                                                        for (int i = 0; i < details.size(); i++) {
                                                            ...
                                                            disc = BDUtil.add(disc, det.getDbAmount());
                        %>
                        ...
                        <%
                                                        for (int i = 0; i < details.size(); i++) {
                                                            ...
                                                            //if (!det.isStampFee()||!det.isPolicyCost()) continue;
                        /*
                                                            String rate = "";

                                                            rate = JSPUtil.printX(det.getDbRate(),2) + "%";
                                                             */
                                                            item = BDUtil.add(item, det.getDbAmount());
                        %>
                        <fo:table-row>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.div(io.getDbObjectPremiTotalAmount(), new BigDecimal(installment.size())), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <% }%>
                    </fo:table-body>
                </fo:table>
