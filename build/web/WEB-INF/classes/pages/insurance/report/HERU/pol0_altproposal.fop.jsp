   ...
   <!-- GARIS  -->
     <fo:block border-width="0.75pt" border-style="solid" border-before-precedence="0" line-height="0.75pt" space-before.optimum="40pt"></fo:block>
      ...
      <fo:block font-size="18pt" line-height="16pt" space-after.optimum="2pt"
            ...
            text-align="center"
            padding-top="10pt">
       {L-INA Asuransi -L}<%=pol.getStPolicyTypeDesc()%>{L-ENG Insurance -L} 
      </fo:block>
...
<!-- DYNAMIC HEADER WORDING -->
   ...
   <!-- ROW -->
      ...
      <fo:block font-size="10pt">
       ...
       <fo:block font-size="12pt" space-before.optimum="10pt">
       {L-ENG CLAUSES ATTACHED-L}{L-INA KLAUSULA TERLEKAT-L}
      </fo:block>

   <!-- ROW -->
      <fo:block font-size="10pt" font-family="SANS-SERIF" line-height="10pt" space-after.optimum="2pt" text-align="justify" > </fo:block>
...
%>
   ...
   <!-- ROW -->
      ...
      <fo:block font-size="12pt" line-height="10pt" space-after.optimum="2pt" color="black" text-align="left" padding-top="10pt">{L-ENG PREMIUM CALCULATION :-L}{L-INA PERHITUNGAN PREMI :-L} </fo:block>
...
<% } %>
       ...
       <fo:block font-size="10pt" space-after.optimum="2pt"> </fo:block>
<%} %>
...
<% } %>
                    ...
                    <fo:table-row>
                      ...
                      <fo:table-cell ></fo:table-cell>
                      <fo:table-cell number-columns-spanned="2" >
                           <fo:block border-width="0.75pt" border-style="solid" border-before-precedence="0" line-height="0.75pt" space-after.optimum="2pt"></fo:block>
                      </fo:table-cell>
                    </fo:table-row>
       ...
       <fo:block font-size="10pt" space-after.optimum="5pt"></fo:block>
