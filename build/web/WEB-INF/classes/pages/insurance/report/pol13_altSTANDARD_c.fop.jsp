...
<%
            ...
            String polInduk = null;
            if (pol.getStReference2() != null) {
                if (pol.getStParentPolicy().getStPolicyNo().length() == 16) {
                    polInduk = pol.getStParentPolicy().getStPolicyNo().substring(0, 4) + "-" + pol.getStParentPolicy().getStPolicyNo().substring(4, 8) + "-" + pol.getStParentPolicy().getStPolicyNo().substring(8, 12) + "-" + pol.getStParentPolicy().getStPolicyNo().substring(12, 16);
                }
                if (pol.getStParentPolicy().getStPolicyNo().length() == 18) {
                    polInduk = pol.getStParentPolicy().getStPolicyNo().substring(0, 4) + "-" + pol.getStParentPolicy().getStPolicyNo().substring(4, 8) + "-" + pol.getStParentPolicy().getStPolicyNo().substring(8, 12) + "-" + pol.getStParentPolicy().getStPolicyNo().substring(12, 16) + "-" + pol.getStParentPolicy().getStPolicyNo().substring(16, 18);
                }
            }
%>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>  <%=polInduk%></fo:block></fo:table-cell>
                            <% } else {%>
                            <% }%>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell ><fo:block>Terlampir <%=JSPUtil.xmlEscape(tsi.getStDescriptionAuto())%></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
