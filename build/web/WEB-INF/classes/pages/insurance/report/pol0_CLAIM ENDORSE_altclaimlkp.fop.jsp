                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>: <%= pol.getStClaimCurrency()%> <%=JSPUtil.printX(pol.getDbClaimAmountEstimate())%></fo:block></fo:table-cell>
                        </fo:table-row>  
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    BigDecimal taxBengkel = new BigDecimal(0);
                                    BigDecimal amtItem = new BigDecimal(0);
                                    BigDecimal amtTotal = new BigDecimal(0);
                                    BigDecimal amtTotalItem = new BigDecimal(0);
                                    String itemID = null;
                                    ...
                                    for (int i = 0; i < claimItems.size(); i++) {
                                        ...
                                        if (ci.getStTaxCode() != null) {
                                            if (ci.getStTaxCode().equalsIgnoreCase("10")) {
                                                taxBengkel = ci.getDbTaxAmount();
                                            } else {
                                        ...
                                        if (ci.getStTaxCode() != null) {
                                            itemName = ci.getTax().getStDescription();
                                        }
                                        ...
                                        amtTotalItem = pol.getDbClaimAmount();
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>: <%= pol.getStClaimCurrency()%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end">(<%=JSPUtil.printX(taxBengkel, 2)%>)</fo:block></fo:table-cell>
                        </fo:table-row>
                        <% }%>

                        <% if (ci.getStInsItemID().equalsIgnoreCase("50") || ci.getStInsItemID().equalsIgnoreCase("81") || ci.getStInsItemID().equalsIgnoreCase("77")) {%>
                        <fo:table-row>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(itemName)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>: <%= pol.getStClaimCurrency()%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>: <%= pol.getStClaimCurrency()%></fo:block></fo:table-cell>
                            <%--<fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(amtTotalItem, tax), 2)%></fo:block></fo:table-cell>--%>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(amtTotalItem, 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
