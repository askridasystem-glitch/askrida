                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block wrap-option="yes-wrap" linefeed-treatment="preserve"
                                                      white-space-treatment="preserve" white-space-collapse="false"><%=JSPUtil.printX(desc)%></fo:block></fo:table-cell>
                                <%--<fo:block><%=JSPUtil.printX(desc)%></fo:block>--%>
                        </fo:table-row>
                        <%
                                                                         }
                                                                     else {
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <%--<fo:block><%=JSPUtil.xmlEscape(tsi.getStDescriptionAuto())%></fo:block>--%>
                                                    <fo:table-cell ><fo:block font-weight="bold"><%=JSPUtil.xmlEscape(tsi.getStInsuranceTSIDesc())%> </fo:block>
                                                        <fo:block wrap-option="yes-wrap" linefeed-treatment="preserve"
                                                                  white-space-treatment="preserve" white-space-collapse="false"><%=JSPUtil.xmlEscape(tsi.getStTSICategoryDescription())%> </fo:block>
                                                        <fo:block wrap-option="yes-wrap" linefeed-treatment="preserve"
                                                                  white-space-treatment="preserve" white-space-collapse="false"><%=JSPUtil.xmlEscape(tsi_desc)%></fo:block>
                                                    </fo:table-cell>
                                                    <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                            ...
                                            <fo:table-body>
                                                <%
                                                                     ...
                                                                     for (int j = 0; j < coverage.size(); j++) {
                                                                         InsurancePolicyCoverView tsi = (InsurancePolicyCoverView) coverage.get(j);

                                                                         if (tsi.getStDescription() != null) {
                                                                             cover_desc = tsi.getStDescription();
                                                                         } else {
                                                                             cover_desc = "";
                                                                         }
                                                ...
                                                <fo:table-row>
                                                    <%--<fo:block><%=JSPUtil.xmlEscape(tsi.getStDescriptionAuto())%></fo:block>--%>
                                                    <fo:table-cell ><fo:block font-weight="bold"><%=JSPUtil.xmlEscape(tsi.getStInsuranceCoverDesc())%> </fo:block>
                                                        <fo:block wrap-option="yes-wrap" linefeed-treatment="preserve"
                                                                  white-space-treatment="preserve" white-space-collapse="false"><%=JSPUtil.xmlEscape(cover_desc)%> </fo:block>
                        ...
                        <%--
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell >
                                                        <fo:block font-weight="bold"><%=JSPUtil.xmlEscape(cover.getStInsuranceCoverDesc())%></fo:block>
                                                        <fo:block wrap-option="yes-wrap" linefeed-treatment="preserve"
