    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="16pt" font-family="TAHOMA" line-height="16pt" color="red" text-align="center">
                {L-ENG FACULTATIVE CLAIM OFFER-L}{L-INA PENAWARAN KLAIM FAKULTATIF-L}
            </fo:block>
            <% } else {%>
            <fo:block font-size="16pt" font-family="TAHOMA" line-height="16pt" color="black" text-align="center">
                {L-ENG FACULTATIVE REINSURANCE CLAIM NOTE-L}{L-INA NOTA KLAIM REASURANSI FAKULTATIF-L}
            </fo:block>
            <% }%>
                    ...
                    <fo:table-body>
                                    ...
                                    <fo:table table-layout="fixed">
                                        ...
                                        <fo:table-body>
                                            ...
                                            <fo:table-row>
                                                ...
                                                <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(co.getDbAmount(), 2)%></fo:block></fo:table-cell>
                                            </fo:table-row>
                                            <% }%>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block wrap-option="yes-wrap" linefeed-treatment="preserve"
                                    ...
                                    <%=JSPUtil.printX(ri.getStNotes())%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Reinsurance Claim -L}{L-INA Klaim Reasuransi -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>
                                    <fo:table table-layout="fixed">
                                        <fo:table-column column-width="35mm"/>
