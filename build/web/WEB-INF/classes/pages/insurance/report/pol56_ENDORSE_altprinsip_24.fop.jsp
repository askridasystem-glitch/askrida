...
//boolean effective = pol.isEffective();
            boolean effective = pol.getParentPolicy().getStEffectiveFlag().equalsIgnoreCase("Y");
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="14pt" font-family="TAHOMA" line-height="0pt" space-after.optimum="10pt"
                      ...
                      text-align="center"
                      padding-top="10pt">
                PERUBAHAN PERSETUJUAN PRINSIP JAMINAN KONTRA BANK GARANSI
            </fo:block>
            ...
            <!-- GARIS  -->
            <fo:block border-width="0.50pt" border-style="solid" border-before-precedence="10" line-height="0.50pt" space-before.optimum="1pt" space-after.optimum="1pt" text-align="justify"></fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block><%=JSPUtil.print(obj.getStReference1())%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA No Rekening -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%if (pol.getEntity2(obj.getStReference2()).getStRcNo() != null) {%><%=JSPUtil.printX(pol.getEntity2(obj.getStReference2()).getStRcNo())%><%}%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                            <fo:table-cell><fo:block><%if (pol.getEntity2(obj.getStReference2()).getStFunctionaryPosition() != null) {%><%=JSPUtil.printX(pol.getEntity2(obj.getStReference2()).getStFunctionaryPosition())%><%}%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block space-after.optimum="5pt"><%if (pol.getEntity2(obj.getStReference2()).getStFunctionaryName() != null) {%><%=JSPUtil.printX(pol.getEntity2(obj.getStReference2()).getStFunctionaryName())%><%}%></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Secara prinsip dapat kami setujui untuk dijamin, dengan penjaminan 100% dengan ketentuan sebagai berikut : -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block> Bentuk form Bank Garansi standard <%=pol.getStCustomerName()%> (terlampir)</fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(pol.getEntity().getCompany().getStVSCompanyGroup())%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(obj.getDbReference5(), pol.getDbPremiTotalAfterDisc()), 2)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(obj.getDbReference6(), pol.getDbTotalItemAmount("PCOST")), 2)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(obj.getDbReference7(), pol.getDbTotalItemAmount("SFEE")), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalItemAmount("SFEE"), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <%
                                                    final BigDecimal jasaJaminanBank = BDUtil.sub(obj.getDbReference5(), pol.getDbPremiTotalAfterDisc());
                                                    final BigDecimal biayaAdmBank = BDUtil.sub(obj.getDbReference6(), obj.getDbReference6());
                                                    final BigDecimal biayaMateraiBank = BDUtil.sub(obj.getDbReference7(), pol.getDbTotalItemAmount("SFEE"));
                                                    final BigDecimal jumlahBank = BDUtil.add(BDUtil.add(jasaJaminanBank, biayaAdmBank), biayaMateraiBank);
                        %>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(jumlahBank, 2)%></fo:block></fo:table-cell>
