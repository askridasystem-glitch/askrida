    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                for (int i = 0; i < objects.size(); i++) {
                                                    ...
                                                    address = io.getStReference2Desc();
                                                    wording = io.getStReference3();
                                                    riskclass = io.getStRiskClass();
                                                %>
                                                
                                                <fo:table-row>
                                                    <fo:table-cell ><fo:block text-align = "start"><%=JSPUtil.xmlEscape(io.getStReference1())%></fo:block></fo:table-cell>
                                                </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Earthquake Zone-L}{L-INA Zona Gempa-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(address)%></fo:block></fo:table-cell>
                        </fo:table-row>                        
                        
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Class Construction-L}{L-INA Kelas Konstruksi -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(wording)%></fo:block></fo:table-cell>
                        </fo:table-row>                        
                        
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Earthquake Class Construction-L}{L-INA Kelas Konstruksi Gempa-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(riskclass)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        InsurancePolicyObjectView io = (InsurancePolicyObjectView) objects.get(0);
                        %>
                            ...
                            <fo:table-cell ><fo:block>
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                <%
                                                final DTOList suminsureds = io.getSumTSIAmount();
                                                ...
                                                <fo:table-row>
                                                    ...
                                                    <fo:table-cell ><fo:block font-size="<%=fontsize%>"><%=JSPUtil.xmlEscape(tsi.getStDescription())%></fo:block></fo:table-cell>
                                                    <% } else { %>
                                                    <fo:table-cell ><fo:block font-size="<%=fontsize%>"><%=JSPUtil.xmlEscape(tsi.getStInsuranceTSIDesc())%></fo:block></fo:table-cell>
                                                    <% } %>
                                                    <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <%
                                                final DTOList coverage = io.getSumCoverage();%>
                            ...
                            <fo:table-cell >
                                <fo:list-block space-after.optimum="5pt">
                                    ...
                                    for (int ii = 0; ii < clausules.size(); ii++) {
                                        ...
                                        if(cl.getStKeterangan()!=null) desc = desc + " " + cl.getStKeterangan();
            ...
            --%>
                                            ...
                                            <fo:table-row>
                                                <fo:table-cell ><fo:block>{L-ENG PREMIUM CALCULATION-L}{L-INA PERHITUNGAN PREMI-L}</fo:block></fo:table-cell>
                                                <fo:table-cell ><fo:block text-align="center">-</fo:block></fo:table-cell>
                                                <fo:table-cell ><fo:block text-align="center"></fo:block></fo:table-cell>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell >
                                ...
                                <% } else { %>  
                                <fo:block text-align="center">{L-ENG Signed at-L}{L-INA Dibuat di-L} 
                                <%= JSPUtil.printX(pol.getCostCenter(pol.getCostCenter(pol.getStCostCenterCode()).getStSubCostCenterCode()).getStDescription())%>, {L-ENG On-L}{L-INA pada tanggal-L} <%=DateUtil.getDateStr(pol.getDtPolicyDate(),"d ^^ yyyy")%></fo:block>
                                <% } %>             
