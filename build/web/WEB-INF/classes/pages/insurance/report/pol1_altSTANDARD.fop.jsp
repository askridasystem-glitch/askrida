...
<%
            ...
            BarcodeQRCode my_code = new BarcodeQRCode("KANTOR_ASKRIDA_" + pol.getStCostCenterCode() + "_" + pol.getStPolicyNo(), 3, 3, null);
                                        ...
                                        <fo:table-body>
                                            ...
                                            <%
                                                        ...
                                                        for (int i = 0; i < details.size(); i++) {
                                                            ...
                                                            if (!item.isFee() || item.isPPNFeeBase() || item.isPPN()) {
                                                                continue;
                                                            }
                                            %>
                                            <fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-size="<%=fontsize%>" text-align = "center"><fo:inline text-decoration="underline"><%= pol.getUserIDSignName()%> aa</fo:inline></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                        </fo:table-row>
