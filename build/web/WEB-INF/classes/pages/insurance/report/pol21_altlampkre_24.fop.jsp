                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>         
                        ...
                        for(int k = 0; k < cover.size(); k++) {
                            ...
                            if (cov.getStInsuranceCoverID().equalsIgnoreCase("124")) PHK = cov.getStInsuranceCoverDesc2();
                            
                            if (cov.getStInsuranceCoverID().equalsIgnoreCase("125")) PAW = cov.getStInsuranceCoverDesc2();
                        }        
