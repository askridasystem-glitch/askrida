...
<%
            ...
            final InsurancePolicyView induk = pol.getStParentPolicy();
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="16pt"
                      text-align="center">
                {L-ENG Policy No.-L}{L-INA No. Polis -L} <%= induk.getStPolicyNo().substring(0, 4) + "-" + induk.getStPolicyNo().substring(4, 8) + "-" + induk.getStPolicyNo().substring(8, 12) + "-" + induk.getStPolicyNo().substring(12, 16) + "-" + induk.getStPolicyNo().substring(16, 18)%>
            </fo:block>
            ...
            <fo:block font-size="16pt"
                      ...
                      text-align="center"
                      padding-top="10pt">
                {L-INA IKHTISAR PERTANGGUNGAN -L}{L-ENG POLICY SCHEDULE -L} INDUK
            </fo:block>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block wrap-option="yes-wrap" linefeed-treatment="preserve"
                                                      white-space-treatment="preserve" white-space-collapse="false"><%= JSPUtil.printX(induk.getStWarranty())%></fo:block></fo:table-cell>
                        </fo:table-row>
