...
<%
            ...
            boolean cekLKP = pol.isStatusClaimDLA();
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <%
                        ...
                        for (int z = 0; z < objects.size(); z++) {
                            InsurancePolicyObjDefaultView objs = (InsurancePolicyObjDefaultView) objects.get(z);

                            final DTOList treatyDetails = objs.getTreatyDetails();
                            ...
                            for (int m = 0; m < treatyDetails.size(); m++) {
                                ...
                                for (int n = 0; n < shares.size(); n++) {
                                    ...
                                    BigDecimal share = ri.getDbClaimAmount();
            ...
            <%
                 // final DTOList objectSs = pol.getObjectsClaim();
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(pol.getStDLARemark())%></fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block  text-align="end"><%=JSPUtil.printX(BDUtil.sub(amt3, tax3), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Share-L}{L-INA Share-L} <%= reasuradur.getStShortName()%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>   :</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block space-after.optimum="10pt" text-align="end"><%=JSPUtil.printX(BDUtil.sub(share, tax3), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed" space-before.optimum="10pt" space-after.optimum="10pt">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block ></fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="2"><fo:block text-align="center" >Insured</fo:block></fo:table-cell>
