...
<%
      ...
      for (int i = 0; i < objects.size(); i++) {
         ...
         for (int j = 0; j < treatyDetails.size(); j++) {
            ...
            final boolean nonProportional = Tools.isEqual(trd.getTreatyDetail().getTreatyType().getDbTreatyTypeLevel(), new BigDecimal(9));
...
<% if (!effective) {%>
      <fo:block font-size="16pt" font-family="TAHOMA" line-height="16pt" color="red" text-align="center">
       {L-ENG SURPLUS CLAIM OFFER-L}{L-INA PENAWARAN SURPLUS FAKULTATIF-L}
      </fo:block>
<% }else {%>
      <fo:block font-size="16pt" font-family="TAHOMA" line-height="16pt" color="black" text-align="center">
       {L-ENG SURPLUS REINSURANCE CLAIM NOTE-L}{L-INA NOTA KLAIM REASURANSI SURPLUS-L}
      </fo:block>
<% }%>
