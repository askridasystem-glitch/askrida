...
<!-- DYNAMIC HEADER WORDING -->
   ...
   <!-- ROW -->
      ...
      <fo:block font-size="<%=fontsize%>" font-family="TAHOcMA">
...
%>
            ...
            <fo:table-row>
             ...
             <fo:table-cell ><fo:block>
               <fo:block font-size="<%=fontsize%>">
              <fo:table table-layout="fixed">
               <fo:table-column column-width="40mm"/><!-- ITEM -->
               <fo:table-column column-width="3mm"/>  <!-- : -->
               <fo:table-column column-width="10mm"/>   <!-- IDR -->
               <fo:table-column column-width="30mm"/>   <!-- VALUE -->
...
%>
           ...
           <fo:table-row>
             ...
             <fo:table-cell ><fo:block>
               <fo:block font-size="<%=fontsize%>">
              <fo:table table-layout="fixed">
               <fo:table-column column-width="40mm"/> <!-- COVER -->
               <fo:table-column column-width="3mm"/>   <!-- : -->
               <fo:table-column column-width="20mm"/>  <!-- RATE --> 
               <fo:table-body>
<%
        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
            <fo:table-row>
             <fo:table-cell ><fo:block>
               <fo:table table-layout="fixed">
                  <fo:table-column column-width="35mm"/>  <!-- PERHIT  -->
                  <fo:table-column column-width="3mm"/>    <!-- : -->
                  <fo:table-column column-width="5mm"/>    <!-- IDR -->
                  <fo:table-column column-width="30mm"/>  <!-- TSI -->
                  <fo:table-column column-width="3mm"/>    <!-- X -->
                  <fo:table-column column-width="15mm"/>   <!-- RATE -->
                  <fo:table-column column-width="3mm"/>  <!-- X -->
                  <fo:table-column column-width="10mm"/>  <!-- JW -->
                  <fo:table-column column-width="5mm"/>    <!-- = -->
                  <fo:table-column column-width="5mm"/>    <!-- IDR -->
                  <fo:table-column column-width="30mm"/>  <!-- VALUE -->
                  <fo:table-body>
        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
            <fo:table-row>
             ...
             <fo:table-cell ><fo:block>
               <fo:table table-layout="fixed">
                  <fo:table-column column-width="2mm"/>  <!-- TAB  -->
                  <fo:table-column column-width="70mm"/>  <!-- TAB  -->
                  <fo:table-column column-width="5mm"/>  <!-- =  -->
                  <fo:table-column column-width="5mm"/>   <!-- IDR -->
                  <fo:table-column column-width="30mm"/>   <!-- VALUE  -->
                  <fo:table-body>
