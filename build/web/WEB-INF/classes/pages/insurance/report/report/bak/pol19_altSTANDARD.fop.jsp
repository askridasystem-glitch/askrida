    ...
    for (int i = 0; i < objects.size(); i++) {
        InsurancePolicyObjectView io = (InsurancePolicyObjectView) objects.get(i);
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    ...
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block text-align="center">{L-ENG Declare Value-L}{L-INA Declare Value-L}</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
            ...
            <fo:block font-size="<%=fontsize%>" space-before.optimum="10pt" space-after.optimum="10pt" font-weight="italic">
                (Sistem Penutupan Asuransi <%= pol.getStPolicyTypeDesc2() %> First Loss Limit 30% Of Declare Value)
            </fo:block>
            <% } else { %>
            <fo:block font-size="<%=fontsize%>" space-before.optimum="10pt" space-after.optimum="10pt" font-weight="italic">
                (Sistem Penutupan Asuransi <%= pol.getStPolicyTypeDesc2() %> First Loss Limit 50% Of Declare Value)
            </fo:block>
            <% }
            }
            %>     
