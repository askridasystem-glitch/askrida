...
ref-id="end-of-document"/>
   ...
   <!-- ROW -->
      ...
      <!-- \<fo:block-container height="5cm" width="2cm" top="0cm" left="14.5cm" position="absolute"> -->
            ...
            <fo:block-container height="1.25cm" width="3.8cm" top="5.5cm" left="16.3cm" padding="1mm" position="absolute">
                <fo:table>
                    <fo:table-column column-width="5mm"/>
                    <fo:table-column column-width="5mm"/>
                    <fo:table-column column-width="30mm"/>
            ...
            <fo:block-container height="1.25cm" width="3.8cm" top="7cm" left="16.3cm" padding="1mm" position="absolute">
                <fo:table>
                    <fo:table-column column-width="5mm"/>
                    <fo:table-column column-width="5mm"/>
                    <fo:table-column column-width="30mm"/>
            ...
            <fo:block-container height="1.25cm" width="14.45cm" top="9cm" left="1cm" padding="1mm" position="absolute">
                 <fo:table>
                    <fo:table-column />
                    <fo:table-body font-family="sans-serif" font-weight="normal" font-size="8pt">     
                ...
                <fo:table>
                    ...
                    <fo:table-body font-family="sans-serif" font-weight="normal" font-size="8pt">     
   					...
   					<fo:table-row line-height="12pt">
                            ...
                            <fo:table-cell padding="2pt">
                                <fo:block text-align="end"><%= JSPUtil.printX(pol.getDbTotalDue(),2) %></fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                     </fo:table-body>
                    </fo:table> 
