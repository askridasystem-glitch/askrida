            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2"><fo:block>{L-ENG xxx -L}{L-INA Yang bertanda tangan dibawah ini : -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Name -L}{L-INA Nama -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>: <fo:inline font-weight="bold"><%=pol.getUserApproved().getStUserName().toUpperCase()%></fo:inline></fo:block></fo:table-cell>
                        </fo:table-row>
                        
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG xxx -L}{L-INA dalam jabatan selaku -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>: <fo:inline font-weight="bold"><%=pol.getUserApproved().getStRolesName(pol.getStApprovedWho())%></fo:inline></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2"><fo:block >
                                    sejumlah uang <fo:inline font-weight="bold"><%=pol.getStCurrencyCode()%> <%=pol.getDbInsuredAmount()%></fo:inline> terbilang (<%=NumberSpell.readNumber(JSPUtil.printX(pol.getDbInsuredAmount(),2))%> <%=JSPUtil.printX(pol.getCurrency().getStCcyDescription())%>)
                                    atas dasar tuntutan/klaim yang diajukan secara tertulis dimana berisikan pernyataan bahwa YANG DIJAMIN wanprestasi oleh PEMEGANG JAMINAN atau yang diberikan kuasa dalam jangka waktu pengajuan tuntutan yang ditetapkan dalam Jaminan Bank ini, apabila :
                            </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2"><fo:block >
                                    ternyata sampai batas waktu yang ditentukan, namun tidak melebihi tanggal batas waktu berlakunya Jaminan Bank ini, lalai tidak memenuhi kewajiban kepada PEMEGANG JAMINAN atas pelaksanaan pekerjaan sesuai dengan Kontrak 
                                    No.<fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference14())%></fo:inline> tanggal <fo:inline font-weight="bold"><%=DateUtil.getDateStr(obj.getDtReference3(),"d ^^ yyyy")%></fo:inline>.
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2"><fo:block >
                                    Jaminan Bank ini berlaku terhitung mulai tanggal <fo:inline font-weight="bold"><%=DateUtil.getDateStr(pol.getDtPeriodStart(),"d ^^ yyyy")%></fo:inline> sampai dengan tanggal <fo:inline font-weight="bold"><%=DateUtil.getDateStr(pol.getDtPeriodEnd(),"d ^^ yyyy")%></fo:inline>
                            </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2"><fo:block >
                                    Tuntutan/klaim harus diajukan secara tertulis segera setelah timbul Wanprestasi atau kelalaian yang dilakukan oleh YANG DIJAMIN dengan menyerahkan Warkat Jaminan Bank.
                            </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2"><fo:block >
                                    Penerima Jaminan mengajukan tuntutan/klaim penagihan kepada Penjamin paling lambat 30 (tigapuluh) hari kalender setelah berakhirnya Jaminan Bank atau paling lambat tanggal <fo:inline font-weight="bold"><%=DateUtil.getDateStr(obj.getDtReference3(),"d ^^ yyyy")%></fo:inline> apabila tuntutan/klaim dilakukan oleh Penerima Jaminan.
                            </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2"><fo:block >
                                    Apabila dalam dan/atau sampai habis batas waktu pengajuan tuntutan/klaim tersebut diatas, PEMEGANG JAMINAN atau yang diberi kuasa tidak mengajukan tuntutan/klaim, maka Jaminan Bank ini tidak mengikat lagi terhadap PENJAMIN.
                            </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2"><fo:block >
                                    Untuk keperluan pemberian Jaminan Bank ini beserta akibat yang timbul dari padanya, Bank memilih domisili yang umum dan tetap pada Kantor Panitera Pengadilan Negeri <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference15())%></fo:inline>.
                            </fo:block></fo:table-cell>
                        </fo:table-row>
