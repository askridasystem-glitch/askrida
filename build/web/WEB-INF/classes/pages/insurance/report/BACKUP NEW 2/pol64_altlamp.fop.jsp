                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">Yang Dipertanggungkan</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">No. KTP</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Jenis Kelamin</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Umur</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Awal Pertanggungan</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Akhir Pertanggungan</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Asal Berangkat</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Tujuan</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Paket Travel</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Tipe Travel</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Nilai Tertanggung</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Premi</fo:block></fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="start"><%=JSPUtil.printX(obj.getStReference1())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getStReference3())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getStReference5Desc())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getStReference19())%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getStReference21())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getStReference8())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getDesc("stReference17"))%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getDesc("stReference18"))%></fo:block></fo:table-cell>
