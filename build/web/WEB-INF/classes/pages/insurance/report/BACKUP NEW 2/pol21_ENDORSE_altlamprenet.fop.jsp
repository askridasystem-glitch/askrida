                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" >{L-ENG Premium Netto-L}{L-INA Premi Netto-L}</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>   
                        ...
                        for (int i = 0; i < objects2.size(); i++) {
                            ...
                            if(!Tools.isEqual(obj2.getDbReference6(), new BigDecimal(0)))
                                isEndorse = true;
                            
                            if(!Tools.isEqual(obj2.getDbObjectPremiTotalAmount(), new BigDecimal(0)))
                                isEndorse = true;
