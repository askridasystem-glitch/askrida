                                            ...
                                            <%
                                                  ...
                                                  for (int t = 0; t < polObject.size(); t++) {
                                                      ...
                                                      for (int y = 0; y < treatyDetails2.size(); y++) {
                                                          ...
                                                          if (!nonProportional2.equalsIgnoreCase("BPPDAN")) {
                                                              continue;
                                                          }
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell >
                                <fo:block text-align="center"><%= JSPUtil.printX(pol.getStCostCenterDesc())%>, <%=DateUtil.getDateStr(pol.getDtPLADate(), "d ^^ yyyy")%></fo:block>
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">Jakarta, <%=DateUtil.getDateStr(pol.getDtPLADate(), "d ^^ yyyy")%></fo:block></fo:table-cell>
                        </fo:table-row>
