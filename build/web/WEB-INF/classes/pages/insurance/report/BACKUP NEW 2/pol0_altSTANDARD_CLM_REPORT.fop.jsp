...
<% 
   if(isAttached){%>
       ...
       {L-ENG CLAIM CALCULATION -L}{L-INA PERHITUNGAN KLAIM -L}
      </fo:block>
         ...
         for (int j = 0; j < treatyDetails.size(); j++) {
          ...
          <fo:table-row>
             <fo:table-cell ><fo:block ></fo:block></fo:table-cell>
          	 ...
          	 <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"></fo:block></fo:table-cell>
          	 <fo:table-cell border-width="0.5pt" border-right-style="solid"><fo:block text-align="center" line-height="5mm">{L-ENG Claim Reinsurer-L}{L-INA Klaim Reinsurer-L}</fo:block></fo:table-cell>
          </fo:table-row>
...
final DTOList shares = trd.getShares();
         ...
         //      calculator.add("PRESPTOT",trd.getDbPremiAmount());
           ...
           t[n] = BDUtil.add(t[n++], ri.getDbClaimAmount());
 ...
 %>
                  ...
                  <fo:table-row>
                   ...
                   <% } %>
                   <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                   <fo:table-cell border-width="0.5pt" border-right-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(ri.getDbClaimAmount(),2)%> </fo:block></fo:table-cell>
                  </fo:table-row>
