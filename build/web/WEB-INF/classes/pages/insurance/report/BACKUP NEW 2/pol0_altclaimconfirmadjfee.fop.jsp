...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">Adjuster Fee</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="end"><%= JSPUtil.printX(BDUtil.sub(pol.getDbClaimAmount(), tax3), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" line-height="12pt" text-align="justify" space-before.optimum="20pt" space-after.optimum="10pt">
            ...
            <fo:block font-size="<%=fontsize%>" line-height="12pt" text-align="justify" space-before.optimum="10pt">
