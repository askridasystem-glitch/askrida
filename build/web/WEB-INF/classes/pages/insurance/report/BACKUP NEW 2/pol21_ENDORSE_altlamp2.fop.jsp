            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>   
                        ...
                        <%--
                        <fo:table-row>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" ><%=String.valueOf(i+1)%></fo:block></fo:table-cell>
                            ...
                            <% }  else { %>    
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block line-height="5mm" text-align="end"><%=JSPUtil.printX(obj2.getDbReference4(),0)%></fo:block></fo:table-cell>
                            <% } %>
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block line-height="5mm" text-align="end"><%=JSPUtil.printX(obj2.getDbReference6(),0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        --%>
