            ...
            <fo:block font-size="<%=fontsize%>">
                ...
                //if (desc==null) continue;
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>Terlampir <%=objects.size()%> Unit</fo:block></fo:table-cell>
                        </fo:table-row>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell ><fo:block><%=objects.size()%> Unit <%=JSPUtil.xmlEscape(tsi.getStDescriptionAuto())%></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
