                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block padding-top="5pt" text-align="center" line-height="5mm" >{L-ENG Coins Premium -L}{L-INA Premi Koas -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <%
                             ...
                             for (int i = 0; i < objects.size(); i++) {
                                 ...
                                 if (Tools.compare(obj.getDbReference6(), obj.getDbReference2()) > 0) {
                                     continue;
                                 }
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block line-height="5mm" text-align="end"><%=JSPUtil.printX(obj.getDbReference2(), 0)%></fo:block></fo:table-cell>
                        </fo:table-row>
