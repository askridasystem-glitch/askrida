    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:static-content flow-name="xsl-region-before">
            <fo:block text-align="end"
                      ...
                      font-family="serif"
                      line-height="12pt" >
                Insurance Policy - PT. Asuransi Bangun Askrida NOM : <%=JSPUtil.printX(pol.getStNomerator())%> PrintCode:<%=pol.getStPrintCode()%> Page:<fo:page-number/>
            </fo:block>
        </fo:static-content>
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="16pt"
                      ...
                      text-align="center"
                      padding-top="0pt">
                <%=pol.getStPolicyTypeDesc2()%> INSURANCE
            </fo:block>
            ...
            <fo:block font-size="16pt"
                      ...
                      text-align="start"
                      padding-top="0pt">
                Policy No <%= pol.getStPolicyNo().substring(0, 4) + "-" + pol.getStPolicyNo().substring(4, 8) + "-" + pol.getStPolicyNo().substring(8, 12) + "-" + pol.getStPolicyNo().substring(12, 16) + "-" + pol.getStPolicyNo().substring(16, 18)%>
            </fo:block>
            ...
            <fo:block font-family="monospace" wrap-option="no-wrap" linefeed-treatment="preserve"
                      ...
                      space-before="6pt" padding="6pt" font-size="<%=fontsize%>">
            ...
            <fo:block font-size="<%=fontsize%>"
                      font-family="sans-serif"
                      line-height="15pt" white-space-treatment="preserve"
                      space-after.optimum="15pt" white-space-collapse="false" linefeed-treatment="preserve" space-before="6pt"
                      text-align="start">
                <%=FOPUtil.printAutoBlock(pol.getPolicyType().getStWording1())%>
                <%--<fo:basic-link external-destination="normal.pdf">normal.pdf</fo:basic-link>--%>
            </fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(pol.getStPeriodLength())%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>Endorse Amount</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(pol.getDbInsuredAmountEndorse())%></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" font-family="sans-serif">
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    ...
                                                    <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printPct(cover.getDbRatePct(), 5)%> %</fo:block></fo:table-cell>
                                        ...
                                        <fo:table-body>
                                            ...
                                            <fo:table-row>
                                                ...
                                                <fo:table-cell number-columns-spanned="2" >
                                                    <fo:block border-width="1pt" border-style="solid" border-before-precedence="0" line-height="1pt" space-after.optimum="1pt"></fo:block>
                                                </fo:table-cell>
                                            </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>"
                      ...
                      space-after.optimum="15pt"
                      text-align="center" >
                TERBILANG : <%=NumberSpell.readNumber(JSPUtil.printX(pol.getDbTotalDue(), 2), "RUPIAH", NumberSpell.INDONESIA)%>
            </fo:block>
