    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="16pt" line-height="5pt" space-after.optimum="5pt"
                      ...
                      text-align="center"
                      padding-top="10pt">
                {L-ENG List of Attachement -L}{L-INA Lampiran Polis Asuransi -L}
            </fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG Interest Insured -L}{L-INA Nama Pertangguungan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Business -L}{L-INA Jenis Usaha -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Location of Risk -L}{L-INA Lokasi Risiko -L}</fo:block></fo:table-cell>
