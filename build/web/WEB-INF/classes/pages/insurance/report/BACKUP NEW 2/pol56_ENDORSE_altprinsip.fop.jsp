                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=DateUtil.getDateStr(pol.getDtPeriodStart(), "d ^^ yyyy")%> {L-ENG XXX -L}{L-INA s/d -L}<%=DateUtil.getDateStr(pol.getDtPeriodEnd(), "d ^^ yyyy")%>( <%=String.valueOf(day + 1)%> hari) -L}{L-INA hari sejak tanggal penerbitan Bank Garansi)</fo:block></fo:table-cell>
                        </fo:table-row>
