                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG Vehicle -L}{L-INA Merek -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Type of Vehicle -L}{L-INA Type -L}</fo:block></fo:table-cell>
