...
%>
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>Terlampir <%=objects.size()%> Unit Kendaraan Bermotor</fo:block></fo:table-cell>
                        </fo:table-row>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell ><fo:block><%=objects.size()%> Unit Kendaraan Bermotor <%=JSPUtil.xmlEscape(tsi.getStDescriptionAuto())%></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
...
%>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell >
                                                        <fo:block><%=JSPUtil.xmlEscape(cover.getStInsuranceCoverDesc())%>
