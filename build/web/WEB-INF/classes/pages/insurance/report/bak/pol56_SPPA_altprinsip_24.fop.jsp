                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%if(pol.getEntity2(obj.getStReference2()).getStRekening()!=null){%><%=JSPUtil.printX(pol.getEntity2(obj.getStReference2()).getStRekening())%><%}%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
