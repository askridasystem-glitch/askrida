...
BigDecimal parentLKS = new BigDecimal(0);
        ...
        <fo:flow flow-name="xsl-region-body">            
            ...
            for (int i = 0; i < objects.size(); i++) {
                ...
                for (int j = 0; j < treatyDetails.size(); j++) {
                    ...
                    if (!nonProportional.equalsIgnoreCase("BPPDAN")) continue;
            ...
            <fo:block font-size="16pt" line-height="16pt" color="black" text-align="center">
                {L-ENG PRELIMINARY LOSS ADVICE -L}{L-INA LAPORAN KERUGIAN SEMENTARA-L}
            </fo:block>
            
            <fo:block font-size="<%=fontsize%>" line-height="16pt" space-after.optimum="10pt" color="black" text-align="center"> NO. <%=JSPUtil.printX(pol.getStPLANo())%>
            </fo:block>
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block space-after.optimum="10pt">{L-ENG Share-L}{L-INA Share -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>
                                    ...
                                    <fo:table table-layout="fixed">
                                        ...
                                        <fo:table-body>
                                            ...
                                            <fo:table-row>
                                                <fo:table-cell ><fo:block>BPPDAN</fo:block></fo:table-cell>
                                                <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                <fo:table-cell ><fo:block number-columns-spanned="2"><%=JSPUtil.printX(trd.getDbTSIPct(),2)%> %</fo:block></fo:table-cell>
                                            </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block space-after.optimum="10pt">{L-ENG Estimated Claim Amount -L}{L-INA Jumlah Kerugian Sementara-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>
                                    <fo:table table-layout="fixed">
                                        <fo:table-column column-width="35mm"/>
                            ...
                            <fo:table-cell ><fo:block>
                                    <fo:table table-layout="fixed">
                                        ...
                                        <fo:table-body>
                                            ...
                                            final DTOList polObject = pol.getParentPolicy().getObjectsClaim();
                                            
                                            for (int t = 0; t < polObject.size(); t++) {
                                                InsurancePolicyObjDefaultView obj2 = (InsurancePolicyObjDefaultView) polObject.get(t);
                                                
                                                final DTOList treatyDetails2 = obj2.getTreatyDetails();
                                                
                                                for (int y = 0; y < treatyDetails2.size(); y++) {
                                                    InsurancePolicyTreatyDetailView trd2 = (InsurancePolicyTreatyDetailView) treatyDetails2.get(y);
                                                    
                                                    String nonProportional2 = trd2.getTreatyDetail().getTreatyType().getStInsuranceTreatyTypeName();
                                                    
                                                    if (!nonProportional2.equalsIgnoreCase("BPPDAN")) continue;
                                                    
                                                    parentLKS = trd2.getDbClaimAmount();
                                                    
                                                }
                                            }
                                            
                                            
                                            final DTOList claimItems = pol.getParentPolicy().getClaimItems();
                                    ...
                                    <fo:table table-layout="fixed">
                                        ...
                                        <fo:table-body>
                                            ...
                                            <fo:table-row>
                                                <fo:table-cell number-columns-spanned="2" ><fo:block ></fo:block></fo:table-cell>                           
                                                <fo:table-cell ><fo:block ><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                                                <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(parentLKS,2)%></fo:block></fo:table-cell>
                                            </fo:table-row>
