...
ref-id="end-of-document"/>
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="16pt" font-family="TAHOMA" line-height="5pt" space-after.optimum="5pt"
            ...
            text-align="center"
            padding-top="10pt">
       {L-ENG List of Attachement -L}{L-INA Lampiran Polis Asuransi -L} <%=pol.getStPolicyTypeDesc()%> {L-ENG Insurance -L}{L-INA -L}
      </fo:block>
        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
           ...
           <fo:table-row>
             ...
             <fo:table-cell><fo:block>{L-ENG Name of Insured -L}{L-INA Nama Terjamin -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG SPKBG No. -L}{L-INA No. SPKBG  -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Name of Obligee -L}{L-INA Nama Obligee  -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Name of Project -L}{L-INA Nama Proyek -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Contract No. -L}{L-INA No. Kontrak  -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Contract Value -L}{L-INA Nilai Proyek  -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Type of Guarantee -L}{L-INA Jenis Agunan  -L}</fo:block></fo:table-cell>
...
%>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getDesc("stReference5"))%></fo:block></fo:table-cell>
             ...
             <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getDbReference3())%></fo:block></fo:table-cell>
