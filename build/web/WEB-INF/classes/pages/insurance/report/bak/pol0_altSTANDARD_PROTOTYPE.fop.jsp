...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
 ...
 --%>
            ...
            <fo:block font-size="6pt"
                      ...
                      text-align="justify" >
                <%if(false){%>Dokumen ini diterbitkan tidak memerlukan tanda tangan basah/asli. Tanda tangan ini dicetak langsung dan dianggap sah.<%}%>

                <%if(true){%>Dokumen ini diterbitkan tidak memerlukan tanda tangan basah/asli, dicetak secara sistem dan dinyatakan sah. <%}%>
            </fo:block>
            <% } %>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell >
                                ...
                                <%if(false){%><fo:block text-align="center">{L-ENG Authorized-L}{L-INA Tanda Tangan Yang Berwenang-L}</fo:block>
                                <%}%>
                            </fo:table-cell>
                        </fo:table-row>
