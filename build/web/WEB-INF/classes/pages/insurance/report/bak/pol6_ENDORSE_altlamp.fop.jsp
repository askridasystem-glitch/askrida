                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG Interest Insured -L}{L-INA Nama Pertanggungan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Title of Project -L}{L-INA Nama Proyek -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Risk Location -L}{L-INA Alamat Resiko -L}</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell><fo:block>{L-ENG Maintenance Periode -L}{L-INA Masa Pemeliharaan -L}</fo:block></fo:table-cell>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        <fo:table-row>
                            ...
                            <fo:table-cell >
                                <fo:block text-align="center"><%= JSPUtil.printX(pol.getStCostCenterDesc())%><%if(tanpaTanggal){%>, {L-ENG On-L}{L-INA pada tanggal-L} <%=DateUtil.getDateStr(pol.getDtPolicyDate(),"d ^^ yyyy")%><%}%></fo:block>
