  ...
  <fo:page-sequence master-reference="only" initial-page-number="1">
    ...
    <fo:static-content flow-name="xsl-region-before">
      <fo:block text-align="end"
            ...
            font-family="serif"
            line-height="12pt" >
        Insurance Policy - PT. Asuransi Bangun Askrida
      </fo:block>
        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
           ...
           <fo:table-row>
             ...
             <fo:table-cell><fo:block>{L-ENG No. L/C -L}{L-INA No. L/C -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Bank -L}{L-INA Bank -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Consignee -L}{L-INA Penerima Barang -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG From / To -L}{L-INA Dari / Ke -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Transhipment at -L}{L-INA Pindah Kapal di -L}</fo:block></fo:table-cell>
