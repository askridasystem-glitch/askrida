        ...
        <fo:flow flow-name="xsl-region-body">
           ...
           <fo:table-row>
             ...
             --%>
                      ...
                      --%>
                            <fo:table-cell></fo:table-cell>
                            <fo:table-cell number-columns-spanned="1" ><fo:block text-align="end"><%=JSPUtil.printX(insured,0)%></fo:block>
                            </fo:table-cell><fo:table-cell number-columns-spanned="1" ><fo:block text-align="end"><%=JSPUtil.printX(premi,0)%></fo:block></fo:table-cell>
                        </fo:table-row>
