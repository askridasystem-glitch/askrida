    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">\
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="10pt" text-align="justify">
                PT. Asuransi Bangun Askrida berkedudukandi Pusat Niaga Cempaka Mas Blok M1/36 Jl. Letjen Soeprapto Jakarta 10640 yang selanjutnya disebut sebagai <fo:inline font-weight="bold">PENJAMIN</fo:inline>.
            </fo:block>
