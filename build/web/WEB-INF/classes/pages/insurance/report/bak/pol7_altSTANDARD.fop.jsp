                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell number-columns-spanned="2">
                                                        <fo:block>
                                                            <fo:inline text-decoration="none"><%=JSPUtil.xmlEscape(tsi.getStInsuranceTSIDesc())%></fo:inline>
                                                        </fo:block>
                                                    </fo:table-cell>
                                                    
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block><%if(tsi.getStDescription()==null){%><%=JSPUtil.printX(pol.getStCurrencyCode())%><%}%></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block text-align="end"><%if(tsi.getStDescription()==null){%><%=JSPUtil.printX(tsi.getDbInsuredAmount(),2)%><%}%></fo:block></fo:table-cell>
                                                </fo:table-row>
                                                
                                                <%if(tsi.getStDescription()!=null){%>
                                                <fo:table-row>
                                                    <fo:table-cell number-columns-spanned="2">
                                                        <fo:inline text-decoration="none"><%=JSPUtil.xmlEscape(tsi.getStDescription())%></fo:inline>
                                                        <fo:block wrap-option="yes-wrap" linefeed-treatment="preserve"
                                                                  white-space-treatment="preserve" white-space-collapse="false"><%=JSPUtil.xmlEscape(tsi.getStDescription())%></fo:block>
                                                    </fo:table-cell>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                String desc = ded.getStAutoDesc().replace(".000.00 null",".00");

                                                if(ded.getStDescription()!=null)
                                                desc = desc + " " + ded.getStDescription();
                                                %>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block wrap-option="yes-wrap" linefeed-treatment="preserve"
                                                      white-space-treatment="preserve" white-space-collapse="false"><%= JSPUtil.xmlEscape(pol.getStDescription()) %></fo:block></fo:table-cell>
                        </fo:table-row>
