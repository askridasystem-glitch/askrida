...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <%
            final DTOList dets = pol.getDetails();
            
            int ln=0;
            
            for (int i = 0; i < dets.size(); i++) {
                InsurancePolicyItemsView dt = (InsurancePolicyItemsView) dets.get(i);
            ...
            <fo:block border-width="0.15pt" border-style="solid" border-before-precedence="0" space-before.optimum="3pt" space-after.optimum="10pt" line-height="0.15pt"></fo:block>
    ...
    <fo:page-sequence master-reference="first">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block border-width="0.15pt" border-style="solid" border-before-precedence="0" space-before.optimum="5pt" space-after.optimum="5pt" line-height="0.15pt"></fo:block>
