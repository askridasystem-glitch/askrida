                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < objects.size(); i++) {
                                        ...
                                        if (!Tools.isEqual(obj.getDbReference1(),  polObj.getDbReference1())) {
                                            isEndorse = true;
                                        }

                                        if (!Tools.isEqual(obj.getDbReference3(),  polObj.getDbReference3())) {
                                            isEndorse = true;
                                        }
                        ...
                        <%
                                        //subTotalInsured = BDUtil.add(subTotalInsured,obj.getDbReference2());
