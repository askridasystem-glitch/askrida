        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
           ...
           <fo:table-row>
             ...
             <fo:table-cell><fo:block>{L-ENG Birth Place -L}{L-INA T. Lahir -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Birth Date -L}{L-INA Tgl. Lahir -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG ID Number -L}{L-INA No. Pengenal -L}</fo:block></fo:table-cell>
