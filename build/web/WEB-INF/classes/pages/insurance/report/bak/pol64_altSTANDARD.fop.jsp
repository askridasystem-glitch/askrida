                    ...
                    <fo:table-body>
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    ...
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid"><fo:block text-align="start"><%=JSPUtil.printX(tsi.getInsuranceTSI().getStDescription())%></fo:block></fo:table-cell>
                                                    <%if (Tools.compare(tsi.getDbInsuredAmount(), new BigDecimal(0)) > 0) {%>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end"><%=JSPUtil.printX(tsi.getDbInsuredAmount(),0)%></fo:block></fo:table-cell>
                                                    <% } else {%>
                                                    <fo:table-cell border-width="0.15pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="start" font-size="4pt"><%=JSPUtil.xmlEscape(tsi.getStTSICategoryDescription())%></fo:block></fo:table-cell>
                                                    <%}%>
                                                </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>
                                    ...
                                    <%=JSPUtil.printX(pol.getStCurrencyCode())%> <%=JSPUtil.printX(dedAmount, 2)%> - Untuk Jaminan
