...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">\
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        <fo:table-row>
                            <fo:table-cell >
                                <fo:list-block space-before.optimum="5pt" space-after.optimum="5pt">
            ...
            <fo:block font-size="<%=fontsize%>" text-align="justify">
                Dicatat dan disepakati oleh anggota konsorsium, untuk penerimaan premi didistribusikan oleh Leader dan pembayaran klaim dilakukan oleh masing-masing anggota konsorsium sesuai dengan saham masing-masing anggota kepada Leader.
            </fo:block>
