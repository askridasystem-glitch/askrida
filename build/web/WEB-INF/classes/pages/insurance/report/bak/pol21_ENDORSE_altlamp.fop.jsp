                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>   
                        ...
                        for (int i = 0; i < objects.size(); i++) {
                            ...
                            insured = BDUtil.add(insured, obj.getDbObjectInsuredAmount());
                            premi = BDUtil.add(premi, obj.getDbReference6());                
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="0.5pt" border-left-style="solid"><fo:block text-align="end"  line-height="5mm"><%=JSPUtil.printX(insured,0)%></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end"  line-height="5mm"><%=JSPUtil.printX(premi,0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(insured,0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                            <fo:table-cell><fo:block>JUMLAH PREMI</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>= <%=JSPUtil.print(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(premi,0)%></fo:block></fo:table-cell>
                        </fo:table-row>
