                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStCoverageDesc())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStDeductibleDesc())%></fo:block></fo:table-cell>
                            <%--
             <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getDbObjectInsuredAmount(),2)%></fo:block></fo:table-cell>
...
--%>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="13"><fo:block text-align="center">Subtotal</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="13"><fo:block text-align="center">Total</fo:block></fo:table-cell>
