                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <% if (pol.getStCoverTypeCode().equalsIgnoreCase("COINSIN")) {
                                                                ...
                                                                BigDecimal insuredFull = BDUtil.div(pol.getDbInsuredAmount(), BDUtil.getRateFromPct(pol.getDbSharePct()));
                        %>
                                    ...
                                    <fo:table table-layout="fixed">
                                        ...
                                        <fo:table-body>
                                            ...
                                            <fo:table-row>
                                                ...
                                                <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                <fo:table-cell ><fo:block><%=JSPUtil.print(pol.getDbSharePct(), 2)%>% p.o <%=JSPUtil.print(pol.getStCurrencyCode())%> <%=JSPUtil.print(insuredFull, 2)%></fo:block></fo:table-cell>
                                            </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block wrap-option="yes-wrap" linefeed-treatment="preserve"
                                    ...
                                    <%=JSPUtil.xmlEscape(ri.getStNotes())%></fo:block></fo:table-cell>
                        </fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>
                                    <fo:table table-layout="fixed">
                                        ...
                                        <fo:table-body>
                                            ...
                                            <% if (Tools.compare(ri.getDbRICommAmount(), new BigDecimal(0)) != 0) {%>
