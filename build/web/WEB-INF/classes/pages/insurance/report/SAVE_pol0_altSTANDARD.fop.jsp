...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1" force-page-count="no-force">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="16pt"
                      ...
                      text-align="center"
                      padding-top="10pt">
               {L-INA IKHTISAR PERTANGGUNGAN -L}{L-ENG POLICY SCHEDULE -L} SAVE TO ARSIP
            </fo:block>
 ...
 --%>
            ...
            <!-- ALAMAT ASKRIDA -->
            <fo:block text-align = "center" space-before.optimum="15pt">
                      <fo:external-graphic
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        for (int i = 0; i < details.size(); i++) {
                            ...
                            if (!dtu.isDiscount()) continue;

                            String rate = "";

                            if (dtu.isEntryByRate()) rate = JSPUtil.printX(dtu.getDbRate(),2) + "%";
                        %>
                        ...
                        for (int i = 0; i < details.size(); i++) {
                            ...
                            if (!dti.isFee()||dti.isPPN()) continue;
                        /*
                        String rate = "";
