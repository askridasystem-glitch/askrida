                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell>
                                <fo:block font-size="12pt" line-height="12pt" text-align="center" space-after.optimum="5pt">	 
                                    BULAN : <%=DateUtil.getDateStr(form.getReinsDateTo(), "^^ yyyy")%>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        //	if (Tools.compare(pol.getDbPremiBPDAN(), BDUtil.zero)>0) continue;
%>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center">IDR</fo:block></fo:table-cell>
                        ...
                        <% if (!Tools.isEqual(PremiUSD, BDUtil.zero)) {%>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center">USD</fo:block></fo:table-cell>
                        ...
                        <% if (!Tools.isEqual(PremiEUR, BDUtil.zero)) {%>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center">EUR</fo:block></fo:table-cell>
                        ...
                        <% if (!Tools.isEqual(PremiGBP, BDUtil.zero)) {%>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center">GBP</fo:block></fo:table-cell>
                        ...
                        <% if (!Tools.isEqual(PremiSGD, BDUtil.zero)) {%>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center">SGD</fo:block></fo:table-cell>
                        ...
                        <% if (!Tools.isEqual(PremiJPY, BDUtil.zero)) {%>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center">JPY</fo:block></fo:table-cell>
