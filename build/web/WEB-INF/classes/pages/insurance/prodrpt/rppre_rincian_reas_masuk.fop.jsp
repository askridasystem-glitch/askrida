...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
 ...
 <!-- bikin kolom headernye -->
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-rows-spanned="2" display-align="center" border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Nama Perusahaan Ceding</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>
                                 ...
                                 subTotalDanaReas = BigDecimal.ZERO;
                                    ...
                                    <!-- ini bikin isi nye masing" row -->
                                        ...
                                        <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" ><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX(pol.getDbPremiSPL(),0)%></fo:block></fo:table-cell>
                                         <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" ><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX("-")%></fo:block></fo:table-cell>
                                          <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" ><fo:block text-align="center" font-size="6pt"><%=JSPUtil.printX("-")%></fo:block></fo:table-cell>
                                           <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" ><fo:block text-align="center" font-size="6pt"><%=JSPUtil.printX("-")%></fo:block></fo:table-cell>
                                        <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX("-")%></fo:block></fo:table-cell>

                                        <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" ><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX(pol.getDbCommQS().add(pol.getDbCommSPL()),0)%></fo:block></fo:table-cell>
                                    ...
                                    <%
                                             ...
                                             subTotalCommisi = BDUtil.add(subTotalCommisi, pol.getDbCommQS().add(pol.getDbCommSPL()));
                               ...
                               y++;
                                 ...
                                 subTotalDanaReasx = BigDecimal.ZERO;
                                    ...
                                    <% 
                                             ...
                                             subTotalCommisix = BDUtil.add(subTotalCommisix, pol.getDbCommQS().add(pol.getDbCommSPL()));
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" border-bottom-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(subTotalCommisi.add(subTotalCommisix),0)%></fo:block></fo:table-cell>
            ...
            <fo:block 
                      ...
                      line-height="12pt"
                      font-style="bold">
                rppre_rincian_reas_masuk - PT. Asuransi Bangun Askrida
            </fo:block>
