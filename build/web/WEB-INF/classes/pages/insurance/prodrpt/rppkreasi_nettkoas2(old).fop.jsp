            ...
            <fo:block font-size="10pt"> 
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"><fo:block font-weight="bold"> REKAPITULASI DAFTAR PESERTA ASURANSI PA KREASI</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block font-weight="bold"><%=DateUtil.getDateStr(form.getPolicyDateFrom(),"dd ^^ yyyy")%> ( <%=DateUtil.getDateStr(form.getPolicyDateFrom(),"dd ^^ yyyy")%> s/d <%=DateUtil.getDateStr(form.getPolicyDateTo(),"dd ^^ yyyy")%> )</fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block line-height="5mm" line-weight="5mm"><fo:inline color="white">.</fo:inline> <%=String.valueOf(i+1)%>/AK.21/<%=JSPUtil.printX(pol.getEntity2(form.getStCoinsurerID()).getStRefEntityID())%>/<%=DateUtil.getMonthRomawi(form.getPolicyDateTo())%>/<%=DateUtil.getYear2Digit(form.getPolicyDateTo())%></fo:block></fo:table-cell>    <!-- No --><!-- The Insured -->     <!-- No --><!-- Policy No --> 
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(BDUtil.sub(t[1],t[3]),0)%> <fo:inline color="white">.</fo:inline></fo:block></fo:table-cell><!-- Total Premi --> 
