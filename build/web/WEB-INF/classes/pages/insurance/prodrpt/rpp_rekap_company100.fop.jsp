        ...
        <fo:flow flow-name="xsl-region-body"> 
            ...
            <fo:block font-size="8pt"> 
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-column column-width="90mm"/><!-- Policy Type -->
                    ...
                    <fo:table-header>  
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center">{L-ENG Company Name-L}{L-INA Nama Perusahaan-L}</fo:block></fo:table-cell>  
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(Custname)%></fo:block></fo:table-cell>    <!-- No --><!-- Period --> 
