        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="8pt" line-height="10pt" space-after.optimum="10pt">
                ...
                sqa.addSelect("	* from ( select "+
                        "	a.pol_no,a.policy_date,a.cust_name,b.ref1,substr(b.ref7d,1,12) as ref7d,c.ins_risk_cat_code,cekrisk(substr(b.ref7d,1,12),substr(c.description,1,12)) as cekrisk"
                        );
