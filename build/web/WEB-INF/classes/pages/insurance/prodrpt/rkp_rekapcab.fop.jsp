    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">  
        ...
        <fo:static-content flow-name="xsl-region-before">  
            ...
            <fo:block text-align="center" font-size="16pt" font-family="tahoma" line-height="16pt" >  
                {L-ENG Definity Loss Advice Recapitulation per Branch-L}{L-INA Register Klaim Pasti Rekap per Cabang-L}
            </fo:block>  
                            ...
                            <%  
                                {final Iterator it = custcategory.getIterator();
                                 while (it.hasNext()) {
                                     ...
                                     BigDecimal amt = vpol==null?null:vpol.getDbClaimAmountApproved();
