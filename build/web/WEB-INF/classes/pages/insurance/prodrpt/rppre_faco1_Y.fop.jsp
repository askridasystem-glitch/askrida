            ...
            <fo:block font-size="12pt">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>    
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block text-align="start">{L-ENG BORDERAUX PERIOD -L}{L-INA SESI BULAN -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="start">
                                    : <%=DateUtil.getDateStr(form.getPolicyDateFrom(),"MMMM yyyy")%> sd <%=DateUtil.getDateStr(form.getPolicyDateTo(),"MMMM yyyy")%> 
