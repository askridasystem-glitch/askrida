    ...
    <fo:page-sequence master-reference="only" initial-page-number="1"> 
        ...
        <fo:static-content flow-name="xsl-region-before"> 
            ...
            <fo:block text-align="center" font-size="16pt" line-height="16pt" > 
                {L-ENG RECAPITULATION PRODUCTION PREMIUM PER TYPE 100%-L}{L-INA REKAPITULASI PRODUKSI PREMI PER JENIS 100%-L}
            </fo:block> 
            
            <fo:block text-align="center" font-size="9pt" line-height="16pt" > 
                {L-ENG (Premium Gross after disc)-L}{L-INA (Premi Gross setelah diskon)-L}
            </fo:block>
        ...
        <fo:flow flow-name="xsl-region-body">
                ...
                <fo:table table-layout="fixed"> 
                    ...
                    <fo:table-body> 
                        ...
                        <fo:table-row> 
                            ...
                            <fo:table-cell number-rows-spanned="2" display-align="center"><fo:block>JENIS</fo:block></fo:table-cell>
			...
			--%>
                        ...
                        while (regit.hasNext()) {
                            ...
                            {final Iterator it = custcategory.getIterator();
                             while (it.hasNext()) {
                                 ...
                                 BigDecimal amt = vpol==null?null:BDUtil.sub(vpol.getDbPremiTotalAfterDisc(), BDUtil.add(vpol.getDbNDDisc1(), vpol.getDbNDDisc2()));
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            BigDecimal amt = BDUtil.sub(pol.getDbPremiTotalAfterDisc(), BDUtil.add(pol.getDbNDDisc1(), pol.getDbNDDisc2()));
