        ...
        <fo:flow flow-name="xsl-region-body"> 
            ...
            <fo:block font-size="8pt"> 
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-column column-width="35mm"/><!-- Insured -->
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="15">
                                <fo:block font-family="tahoma" font-weight="bold" font-size="20pt" text-align="center">             
                                    DETIL PRODUKSI PER JENIS ASURANSI
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[12], 0)%></fo:block></fo:table-cell><!-- Total Premi -->
