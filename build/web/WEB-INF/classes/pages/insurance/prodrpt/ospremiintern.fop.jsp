                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header> 
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="15">
                                <fo:block font-family="serif" font-weight="bold" font-size="20pt" text-align="center">             
                                    LAPORAN OUTSTANDING PREMI INTERN
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Inst.-L}{L-INA Inst. -L}</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Ppn -L}{L-INA Ppn -L}</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>      
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        if (pol.getStEntityID() != null) {
                                            if (pol.getStEntityID().equalsIgnoreCase("94")
                                                    || pol.getStEntityID().equalsIgnoreCase("96")
                                                    || pol.getStEntityID().equalsIgnoreCase("2000")
                                                    || pol.getStEntityID().equalsIgnoreCase("2001")
                                                    || pol.getStEntityID().equalsIgnoreCase("2002")) {
                                                kodeko = pol.getStEntityID();
                                            } else {
                                                kodeko = new String("1");
                                            }
                                        }
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            <fo:table-cell number-columns-spanned="6" border-left-style="solid" padding="2pt" ><fo:block text-align="center">SUBTOTAL</fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalPremiBruto, 0)%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.add(subTotalComm, subTotalTax), 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalBfee, 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalHfee, 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalPPn, 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalTax, 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalPremiNetto, 0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(pol.getStSPPANo())%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDPPN(), 0)%></fo:block></fo:table-cell>
                        ...
                        <%
                                        ...
                                        subTotalPPn = BDUtil.add(subTotalPPn, pol.getDbNDPPN());
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[5], 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[10], 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[6], 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[9], 0)%></fo:block></fo:table-cell>
                        </fo:table-row>   
