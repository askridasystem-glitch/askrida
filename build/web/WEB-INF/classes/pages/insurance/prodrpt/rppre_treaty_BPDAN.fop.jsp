...
if (form.getStYearTreaty()!=null) {
    
    dateEnd = String.valueOf(Integer.parseInt(form.getStYearTreaty()) + 1);
}
%>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            //DateTime startDate = new DateTime(pol.getDtReinsuranceApprovedDate());
                        ...
                        <fo:table-row>
                            ...
                            <% if (form.getStYearTreaty()!=null){ %>
                            <fo:table-cell><fo:block text-align="center"><%=DateUtil.getDateStr(pol.getDtPeriodStart(),"dd/MM")%>/<%=JSPUtil.printX(form.getStYearTreaty())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%=DateUtil.getDateStr(pol.getDtPeriodEnd(),"dd/MM")%>/<%=JSPUtil.printX(dateEnd)%></fo:block></fo:table-cell>
                            <% }else{ %>
