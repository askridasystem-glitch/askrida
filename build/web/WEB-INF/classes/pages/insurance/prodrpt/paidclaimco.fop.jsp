                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header> 
                        ...
                        <fo:table-row>  
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Receipt No.-L}{L-INA No. Bayar -L}</fo:block></fo:table-cell>  
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Claim Coins-L}{L-INA Klaim Koas-L}</fo:block></fo:table-cell> 
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Claim Coins Paid-L}{L-INA Bayar Klaim Koas-L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG O/S Claim Coins-L}{L-INA Hutang Klaim Koas-L}</fo:block></fo:table-cell>  
                    ...
                    <fo:table-body>      
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            int n=0;
                            t[n] = BDUtil.add(t[n++], pol.getDbNDTaxComm3());
                            t[n] = BDUtil.add(t[n++], pol.getDbNDTaxComm4());
                            
                            outstandingClaim = BDUtil.sub(pol.getDbNDTaxComm3(),pol.getDbNDTaxComm4());
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(pol.getEntity2(pol.getStEntityID()).getStRefEntityID())%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDTaxComm3(),0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDTaxComm4(),0)%></fo:block></fo:table-cell>
                        ...
                        <% 
                        subTotalClaim       = BDUtil.add(subTotalClaim,pol.getDbNDTaxComm3());
                        subTotalClaimPaid  = BDUtil.add(subTotalClaimPaid,pol.getDbNDTaxComm4());
                        subTotalOutsClaim   = BDUtil.add(subTotalOutsClaim,subTotalClaimPaid);
                        } %>    
