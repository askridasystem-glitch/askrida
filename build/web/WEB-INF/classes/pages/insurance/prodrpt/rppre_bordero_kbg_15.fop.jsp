                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="2" border-width="0.5pt" border-left-style="solid"><fo:block line-height="5mm" text-align="center">Insured Name</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="11"><fo:block text-align="end" line-height="5mm">IDR Gross Premium</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="4"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(t[3], 2)%></fo:block></fo:table-cell>
                        </fo:table-row> 
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="11"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(comm, 2)%>% R/I Comm</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="4"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(t[4], 2)%></fo:block></fo:table-cell>
                        </fo:table-row> 
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="11"><fo:block text-align="end" line-height="5mm">Net Premium Due To You</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="4"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(t[6], 2)%></fo:block></fo:table-cell>
                        </fo:table-row> 
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="15" ><fo:block>Demikian disampaikan, terima kasih atas kerjasamanya</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="15" ><fo:block>Jakarta, <%=DateUtil.getDateStr(new Date(), "dd MMMM yyyy")%> </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="15" ><fo:block>PT. ASURANSI BANGUN ASKRIDA</fo:block></fo:table-cell>
                        </fo:table-row>
