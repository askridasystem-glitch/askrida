                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header> 
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="10">
                                <fo:block font-family="serif" font-weight="bold" font-size="20pt" text-align="center">             
                                    LAPORAN OUTSTANDING REASURANSI
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>  
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Reinsurance-L}{L-INA Reasuradur -L}</fo:block></fo:table-cell>   
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Reins No.-L}{L-INA No. Reas -L}</fo:block></fo:table-cell>      
                    ...
                    <fo:table-body>      
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            outstandingPremi = BDUtil.sub(pol.getDbNDBrok1(),pol.getDbNDBrok1Pct());
                            t[n] = BDUtil.add(t[n++], outstandingPremi); //total tagihan komisi
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(no_polis)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(pol.getEntity().getStShortName())%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDBrok2(),0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(outstandingPremi,0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDBrok1Pct(),0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(pol.getCreateUser().getStShortName())%></fo:block></fo:table-cell>
                        </fo:table-row>   
                        
                        <% 
                        subTotalPremi       = BDUtil.add(subTotalPremi,pol.getDbNDBrok1());
                        subTotalComm      = BDUtil.add(subTotalComm,pol.getDbNDBrok2());
                        subTotalPremiPaid   = BDUtil.add(subTotalPremiPaid,pol.getDbNDBrok1Pct());
