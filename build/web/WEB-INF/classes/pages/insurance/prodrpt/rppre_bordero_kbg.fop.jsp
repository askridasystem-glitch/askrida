                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="11">
                                <fo:block font-weight="bold" font-size="20pt" text-align="center">  	 
                                    BORDERO PREMI <%= JSPUtil.printX(form.getStPolicyTypeGroupDesc())%>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="11">
                                <fo:block font-weight="bold" font-size="20pt" text-align="center">  	 
                                    NO : <% if(form.getStPolicyTypeID()!=null) { %>
                                    <%= JSPUtil.printX(form.getStPolicyTypeGroupID())%>
                                    <% }else{ %>
                                    <%= JSPUtil.printX(form.getStPolicyTypeGroupID())%><% } %>/04R/<%=DateUtil.getMonth2Digit(form.getPolicyDateFrom())%>-<%=DateUtil.getYear2Digit(form.getPolicyDateFrom())%>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Principal</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Jenis Polis</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Nilai Jaminan</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Biaya Jasa 100%</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Nilai Jasa 38.5%</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Biaya Komisi Reas 35%</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm">Saldo Untuk Saudara</fo:block></fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(pol.getStPolicyTypeDesc())%></fo:block></fo:table-cell>
