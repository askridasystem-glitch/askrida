            ...
            <fo:block font-size="10pt" space-after.optimum="10pt">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="6"><fo:block text-align="center">{L-ENG NOTA PREMI REASURANSI-L}{L-INA NOTA PREMI REASURANSI-L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        
                        <fo:table-row>
                            <fo:table-cell></fo:table-cell>
                            <fo:table-cell><fo:block>NOTA</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell></fo:table-cell>
                            <fo:table-cell><fo:block>BULAN</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="6"><fo:block text-align="center" space-after.optimum="20pt"></fo:block></fo:table-cell>
                        </fo:table-row> 
            ...
            <fo:block font-size="10pt">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>   
                            <fo:table-cell number-columns-spanned="6"><fo:block text-align="end" font-weight="bold">{L-ENG (In IDR)-L}{L-INA (dalam rupiah)-L}</fo:block></fo:table-cell>  
                        </fo:table-row>  
                        ...
                        <fo:table-row>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">{L-ENG Jenis Pertanggungan -L}{L-INA Jenis Pertanggungan -L}</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Remarks</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Gross Premi</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Pct(%)</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Komisi</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm">Netto</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            if (pol.getStParentID().equalsIgnoreCase("1"))
                                remarks = "OGR";
                            else
                                remarks = "ONR";
                        %> 
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(remarks)%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(pol.getDbNDBrok1Pct(),2)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"></fo:table-cell>
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center">BAGIAN REASURANSI</fo:block></fo:table-cell>
                        </fo:table-row> 
