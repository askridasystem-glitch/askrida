                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block font-weight="bold">:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-weight="bold"><%= JSPUtil.printX(form.getStKreasiName()) %></fo:block></fo:table-cell>
                        </fo:table-row>
