...
ref-id="end-of-document"/>
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="13pt" line-height="12pt" text-align="center">{L-ENG Premium Coinsurance Report-L}{L-INA Laporan Produksi Premi Koasuransi-L}</fo:block>
...
*/
   ...
   sqa.addSelect(
           ...
           " g.share_pct,g.premi_amt,coalesce(g.comm_amount,0) as comm_amount,a.create_who");   
    sqa.addQuery(
           	" from ins_policy a"+
			" left join ent_master b on b.ent_id = a.entity_id"+
			"   inner join ins_pol_coins g on g.policy_id = a.pol_id"+
   ...
   final FOPTableSource fopTableSource = new FOPTableSource(
      ...
      public Object getColumnValue(int rowNo, int columnNo) {
         ...
         switch(columnNo) {
            ...
            case 5: return h.getFieldValueByFieldNameBD("premi_amt");
