...
ref-id="end-of-document"/>
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="12pt" line-height="12pt" text-align="center">Reinsurance Claim for <%=form.getStPolicyTypeID()==null?"ALL":form.getStPolicyTypeDesc()%> policy type</fo:block>
