...
ref-id="end-of-document"/>
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="13pt" line-height="12pt" text-align="center">{L-ENG Premium Per Coverage-L}{L-INA Premi Langsung Per Coverage-L}</fo:block>
...
/*
select l.group_name,a.pol_no,a.policy_date,b.ent_name,e.description,
d.insured_amount,d.premi,d.cover_category,d.ins_cover_id,a.create_who
from ins_policy a
...
where a.status IN ('POLICY','CLAIM','ENDORSE') and a.effective_flag = 'Y' 
...
*/
   ...
   sqa.addSelect(
           " l.group_name,a.pol_no,a.policy_date,b.ent_name,e.description,"+
           " d.insured_amount,d.premi,d.cover_category,d.ins_cover_id,a.create_who");   
    sqa.addQuery(
           	" from ins_policy a"+
			" left join ent_master b on b.ent_id = a.entity_id"+
   ...
   tot.setFieldValueByFieldName("insured_amount", r.getTotal("insured_amount"));
   ...
   final FOPTableSource fopTableSource = new FOPTableSource(
      ...
      public Object getColumnValue(int rowNo, int columnNo) {
         ...
         switch(columnNo) {
            ...
            case 4: return h.getFieldValueByFieldNameBD("insured_amount");
            case 5: return h.getFieldValueByFieldNameBD("premi");
            case 6: return h.getFieldValueByFieldNameST("description");
            case 7: return h.getFieldValueByFieldNameST("cover_category");
            case 8: return h.getFieldValueByFieldNameST("create_who");
         }
         return "?";
      }
