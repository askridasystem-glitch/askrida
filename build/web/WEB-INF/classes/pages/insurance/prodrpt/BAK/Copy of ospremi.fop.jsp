...
BigDecimal premiFee = new BigDecimal(0);
            ...
            <fo:block font-size="8pt"> 
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header> 
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="12">
                                <fo:block font-family="tahoma" font-weight="bold" font-size="16pt" text-align="center">
                    ...
                    <fo:table-body>      
                        ...
                        BigDecimal subTotalBrokPaid = null;
                        BigDecimal subTotalOutsPremi = null;
                        BigDecimal subTotalOutsComm = null;
                        BigDecimal subTotalOutsBrok = null;
                        
                        
                        for (int i = 0; i < l.size(); i++) {
                            InsurancePolicyView pol = (InsurancePolicyView) l.get(i);
                            
                            BigDecimal biayaAdmin = BDUtil.zero;
                            if(pol.getDbTotalFee()!=null)
                                biayaAdmin = pol.getDbTotalFee();
                            ...
                            outstandingPremi = BDUtil.sub(pol.getDbPremiOuts(), pol.getDbPremiPaid());
                            ...
                            premiFee = BDUtil.add(pol.getDbPremiTotal(),pol.getDbTotalFee());
                            t[n] = BDUtil.add(t[n++], premiFee);
                            t[n] = BDUtil.add(t[n++], pol.getDbTotalComm2());
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.add(subTotalPremi,subTotalFee),0)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(premiFee,0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(biayaAdmin,0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalDisc(),0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalComm2(),0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTax(),0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbPremiOuts(),0)%></fo:block></fo:table-cell>
                        ...
                        subTotalFee 	= BDUtil.add(subTotalFee,pol.getDbTotalFee());
                        subTotalDisc 	= BDUtil.add(subTotalDisc,pol.getDbTotalDisc());
                        subTotalKomisi 	= BDUtil.add(subTotalKomisi,pol.getDbTotalComm2());
                        ...
                        subTotalNetto 	= BDUtil.add(subTotalNetto,pol.getDbPremiOuts());
                        ...
                        subTotalBrokPaid 	= BDUtil.add(subTotalBrokPaid,pol.getDbAPBrokP());
                        ...
                        subTotalOutsBrok 	= BDUtil.add(subTotalOutsBrok,outstandingBroker);
