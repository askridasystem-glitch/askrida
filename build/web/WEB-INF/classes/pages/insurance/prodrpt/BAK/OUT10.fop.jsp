...
<% 
   ...
   BigDecimal premiPaid = new BigDecimal(0);
   BigDecimal outstandingComm = new BigDecimal(0);
   BigDecimal outstandingBroker = new BigDecimal(0);
...
<fo:block-container height="1cm" width="15cm" top="0cm" left="0cm" position="absolute">    <fo:block>
    ...
    <fo:static-content flow-name="xsl-region-after"> 
      <fo:block text-align="end" 
            ...
            font-family="serif"
            line-height="12pt">
        Outstanding Premium Report - PT. Asuransi Bangun Askrida 
      </fo:block> 
    <fo:block text-align="end"
         ...
         <fo:table-body>   
           <fo:table-row>   
			 ...
			 <fo:table-cell ><fo:block text-align="center">{L-ENG Net Premium-L}{L-INA Premi Netto-L}</fo:block></fo:table-cell>  
			  <fo:table-cell ><fo:block text-align="center">{L-ENG Premi Paid-L}{L-INA Premi Dibayar-L}</fo:block></fo:table-cell>  
           	 <fo:table-cell ><fo:block text-align="center">{L-ENG Comm Paid-L}{L-INA Komisi Dibayar-L}</fo:block></fo:table-cell>  
			 <fo:table-cell ><fo:block text-align="center">{L-ENG Brokerage Paid-L}{L-INA Brokerage Dibayar-L}</fo:block></fo:table-cell>  
			<fo:table-cell ><fo:block text-align="center">{L-ENG Outstanding Premi-L}{L-INA Outstanding Premi-L}</fo:block></fo:table-cell>  		
           	<fo:table-cell ><fo:block text-align="center">{L-ENG Outstanding Commission-L}{L-INA Outstanding Komisi-L}</fo:block></fo:table-cell>  		
			<fo:table-cell ><fo:block text-align="center">{L-ENG Outstanding Brokerage-L}{L-INA Outstanding Brokerage-L}</fo:block></fo:table-cell>  		
           </fo:table-row>   
...
<%   
   ...
   BigDecimal [] t = new BigDecimal[31];   
   ...
   for (int i = 0; i < l.size(); i++) {   
      ...
      //premiPaid = BDUtil.add(pol.getDbPremiPaid(),pol.getDbTaxAmount4());
       t[n] = BDUtil.add(t[n++], pol.getDbPremiPaid());
        t[n] = BDUtil.add(t[n++], pol.getDbAPComisP());
         t[n] = BDUtil.add(t[n++], pol.getDbAPBrokP());
         
         
      //outstandingPremi = BDUtil.sub(BDUtil.add(pol.getDbPremiNetto(),pol.getDbTotalFee()),pol.getDbPremiPaid());
      outstandingPremi = BDUtil.sub(pol.getDbPremiNetto(), pol.getDbPremiPaid());
      t[n] = BDUtil.add(t[n++], outstandingPremi);
      
      outstandingComm = BDUtil.sub(pol.getDbAPComis(),pol.getDbAPComisP());
      t[n] = BDUtil.add(t[n++], outstandingComm); //total tagihan komisi
      outstandingBroker = BDUtil.sub(pol.getDbAPBrok(),pol.getDbAPBrokP());
      t[n] = BDUtil.add(t[n++], outstandingBroker); //total tagihan brokerage
...
%>   
            <fo:table-row>   
			 ...
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbPremiPaid(),2)%></fo:block></fo:table-cell>
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbAPComisP(),2)%></fo:block></fo:table-cell>
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbAPBrokP(),2)%></fo:block></fo:table-cell>
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(outstandingPremi,2)%></fo:block></fo:table-cell>
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(outstandingComm,2)%></fo:block></fo:table-cell>
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(outstandingBroker,2)%></fo:block></fo:table-cell>
           </fo:table-row>   
 ...
 //     }   
   ...
   <!-- GARIS DALAM KOLOM -->   
           ...
           <fo:table-row>   
             ...
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[25],2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[26],2)%></fo:block></fo:table-cell> 
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[27],2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[28],2)%></fo:block></fo:table-cell>    
           	 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[29],2)%></fo:block></fo:table-cell>    
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[30],2)%></fo:block></fo:table-cell>    
