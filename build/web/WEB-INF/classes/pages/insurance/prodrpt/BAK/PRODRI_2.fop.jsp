...
ref-id="end-of-document"/>
  ...
  <fo:static-content flow-name="xsl-region-after">
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="13pt" line-height="12pt" text-align="center">{L-ENG R/I Premium (Spreading)-L}{L-INA Premi Reas Per Saham-L}</fo:block>
...
*/
   ...
   sqa.addSelect(
           ...
           " a.insured_amount as tsi_polis,h.tsi_amount,h.premi_amount,"+
   ...
   final FOPTableSource fopTableSource = new FOPTableSource(
      ...
      public Object getColumnValue(int rowNo, int columnNo) {
         ...
         switch(columnNo) {
            ...
            case 5: return h.getFieldValueByFieldNameBD("tsi_amount");
            case 6: return h.getFieldValueByFieldNameBD("premi_amount");
            case 7: return h.getFieldValueByFieldNameST("treaty_type");            
         }
         return "?";
      }
