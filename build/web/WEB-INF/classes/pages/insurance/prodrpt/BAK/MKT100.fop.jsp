...
<fo:block-container height="1cm" width="15cm" top="0cm" left="0cm" position="absolute">    <fo:block>
  ...
  <fo:static-content flow-name="xsl-region-after">
      <fo:block text-align="end" 
            ...
            font-family="serif"
            line-height="12pt">
        Production Report MKT00 - PT. Asuransi Bangun Askrida
      </fo:block> 
      <fo:block text-align="end"
     ...
     <fo:block border-width="0.75pt" border-style="solid" border-before-precedence="0" line-height="0.75pt" space-before.optimum="1pt" space-after.optimum="10pt"></fo:block>  
      ...
      <fo:block font-size="8pt"> 
        <fo:table table-layout="fixed">  
         ...
         <fo:table-column column-width="30mm"/><!-- Adm Fee --> 
   ...
   for (int i = 0; i < l.size(); i++) { 
     ...
     //  	 tax1 = new BigDecimal(3);
      ...
      if(pol.getDbNDHFee() == null){
      	t[n] = BDUtil.add(t[n++], new BigDecimal(0));   //23 Total Broker HFee
...
%>   
			 ...
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalFee(),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Premium --> 
		<%-- <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalItemAmount("PCOST"),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Policy Cost --> 
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalItemAmount("SFEE"),0)%></fo:block></fo:table-cell> --%>  <!-- No --><!-- Stamp Duty --> 
       		 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalDisc(),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Discount --> 
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalComm(),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Total Comm --> 
			 ...
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTaxAmount3(),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Broker 1 -->
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbPremiNetto(),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Premi Net --> 
...
<%   
   ...
   <!-- GARIS DALAM KOLOM -->   
		...
		<%-- <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[2],0)%></fo:block></fo:table-cell><!-- Total Fee --> 
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[3],0)%></fo:block></fo:table-cell> --%><!-- Total Disc --> 
 			 ...
 			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[23],0)%></fo:block></fo:table-cell><!-- Total Disc --> 
 			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[21],0)%></fo:block></fo:table-cell><!-- Total Disc --> 
			 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[24],0)%></fo:block></fo:table-cell><!-- Total Disc -->
