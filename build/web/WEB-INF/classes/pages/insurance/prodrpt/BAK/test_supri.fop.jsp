  ...
  <fo:page-sequence master-reference="only" initial-page-number="1"> 
    ...
    <fo:static-content flow-name="xsl-region-before"> 
      <fo:block text-align="end" 
            ...
            font-family="serif"
            line-height="12pt">
        Production Report - PT. Asuransi Bangun Askrida Page:<fo:page-number/> 
      </fo:block> 
    </fo:static-content> 
    ...
    <fo:flow flow-name="xsl-region-body"> 
      ...
      <fo:block font-size="18pt"
            ...
            text-align="center"
            padding-top="10pt">
       {L-ENG Production Premium Report All Field-L}{L-INA Laporan Produksi Premi Semua Field-L} 
      </fo:block> 
      ...
      <fo:block font-size="8pt"> 
         Tanggal : <%=DateUtil.getDateStr(new Date(),"d MMM yyyy")%>  
      </fo:block>  
        ...
        <fo:table table-layout="fixed">  
         ...
         <fo:table-body>   
           <fo:table-row>   
             ...
             <fo:table-cell ><fo:block text-align="center">{L-ENG Period-L}{L-INA J. Waktu-L}</fo:block></fo:table-cell>  
   ...
   <!-- GARIS DALAM KOLOM -->   
                    ...
                    <fo:table-row>   
                      <fo:table-cell number-columns-spanned="50" >   
...
%>   
            <fo:table-row>   
             ...
             <fo:table-cell ><fo:block><%=JSPUtil.printX(pol.getDtPolicyDate())%></fo:block></fo:table-cell>    <!-- No --><!-- Policy Date --> 
