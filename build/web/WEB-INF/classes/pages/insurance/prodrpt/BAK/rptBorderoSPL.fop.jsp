...
<%
   ...
   sqa.addSelect(
           "a.pol_no,c.description,c.ref3 as desc,a.period_start,a.period_end,a.insured_amount,d.rate,l.group_name,"+
			"e.description,d.cover_category,d.ins_cover_id,a.policy_date,b.ent_name,j.treaty_type,h.base_tsi_amount,"+
			"h.premi_amount,coalesce(((h.premi_amount/a.premi_total)*d.premi_new),0) as premi_share");
   sqa.addQuery(
           "  from ins_policy a"+
   ...
   sqa.addClause("j.treaty_type IN (?,?,?)");
   sqa.addPar("SPL");
   sqa.addPar("QS");
   sqa.addPar("QSKR");
   ...
   sqa.addOrder(" a.pol_no asc,a.policy_date,d.ins_pol_cover_id");
   ...
   final FOPTableSource fopTableSource = new FOPTableSource(
      ...
      public Object getColumnValue(int rowNo, int columnNo) {
         ...
         switch(columnNo) {
            ...
            case 2: return JSPUtil.printX(h.getFieldValueByFieldNameST("description"));
