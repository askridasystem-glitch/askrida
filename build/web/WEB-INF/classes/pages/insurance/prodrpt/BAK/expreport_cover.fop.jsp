  ...
  <fo:page-sequence master-reference="only" initial-page-number="1">
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="18pt" line-height="16pt" space-after.optimum="2pt"
            ...
            text-align="center"
            padding-top="10pt">
       {L-ENG Expired Date Report (per Cover)-L}{L-INA Laporan Polis Jatuh Temp (per Cover)-L}
      </fo:block>
      ...
      <fo:block font-size="8pt">
         {L-ENG Type of Cover :-L}{L-INA Jenis Penutupan :-L}<%=JSPUtil.printX(form.getStFltCoverTypeDesc())%>
      </fo:block>
