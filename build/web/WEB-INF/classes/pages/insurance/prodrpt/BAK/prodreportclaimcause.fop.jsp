...
ref-id="end-of-document"/>
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="13pt" line-height="12pt" text-align="center">{L-ENG Claim Per Cause-L}{L-INA Laporan Klaim Per Kejadian-L}</fo:block>
...
/*
select a.policy_date,a.pol_no,l.group_name,
a.insured_amount as tsi_polis,
a.cust_name,a.create_who,m.cause_desc,coalesce(a.claim_amount_approved,0) as claim_amount
from ins_policy a
...
*/
   ...
   sqa.addSelect(
           " a.policy_date,a.pol_no,l.group_name,"+
           " a.insured_amount as tsi_polis,"+
           " a.cust_name,a.create_who,m.cause_desc,coalesce(a.claim_amount_approved,0) as claim_amount");   
    sqa.addQuery(
           "   from ins_policy a"+
   ...
   tot.setFieldValueByFieldName("tsi_polis", r.getTotal("tsi_polis"));
   ...
   final FOPTableSource fopTableSource = new FOPTableSource(
      ...
      public Object getColumnValue(int rowNo, int columnNo) {
         ...
         switch(columnNo) {
            ...
            case 5: return h.getFieldValueByFieldNameBD("claim_amount");
            case 6: return h.getFieldValueByFieldNameST("create_who");
         }
         return "?";
      }
