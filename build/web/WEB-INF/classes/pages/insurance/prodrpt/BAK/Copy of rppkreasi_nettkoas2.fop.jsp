...
final EntityView entity = policy.getEntity2(form.getStCoinsurerID());
            ...
            <fo:block font-size="10pt"> 
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"><fo:block font-weight="bold"> REKAPITULASI DAFTAR PESERTA ASURANSI <%= JSPUtil.printX(form.getStPolicyTypeDesc().toUpperCase()) %></fo:block></fo:table-cell>
                        </fo:table-row>
                        
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"><fo:block font-weight="bold">PT. ASURANSI BANGUN ASKRIDA</fo:block></fo:table-cell>
                        </fo:table-row>
                        
                        <fo:table-row>
                            <fo:table-cell><fo:block font-weight="bold">BULAN</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-weight="bold">:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-weight="bold"><%=DateUtil.getDateStr(form.getPolicyDateTo(),"^^ yyyy")%> ( <%=DateUtil.getDateStr(form.getPolicyDateFrom(),"d ^^ yyyy")%> s/d <%=DateUtil.getDateStr(form.getPolicyDateTo(),"d ^^ yyyy")%> )</fo:block></fo:table-cell>
                        </fo:table-row>
                        
                        <% if (form.getStNoUrut()!=null) { %>   
                        
                        <fo:table-row>
                            <fo:table-cell><fo:block font-weight="bold">NO. REK</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-weight="bold">:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-weight="bold"><%= JSPUtil.printX(form.getStNoUrut()) %>/<%= JSPUtil.printX(entity.getStShortName()) %>.<%= JSPUtil.printX(entity.getStRefEntityID()) %>/AK.21/<%=DateUtil.getMonthRomawi(form.getPolicyDateTo())%>/<%=DateUtil.getYear2Digit(form.getPolicyDateTo())%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block font-weight="bold">NO. REK</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-weight="bold">:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-weight="bold"><%= JSPUtil.printX(form.getStRekapNo()) %></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3">
                                <fo:block space-after.optimum="3pt">
                                    ...
                                    UNTUK <%= JSPUtil.printX(form.getStCoinsurerName()) %>
                                    <% } %>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>      
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">PREMI NETTO</fo:block></fo:table-cell> 
                    ...
                    <fo:table-body>
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            /*
                            createWho = pol.getStCreateWho();
                            
                            if(createWho.equalsIgnoreCase("administrator"))
                                subTSI = BDUtil.add(pol.getDbAmount(), subTSI);
                            else
                                subTSI = BDUtil.add(pol.getDbInsuredAmount(), subTSI);
                            */
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(BDUtil.sub(subTotalPremiKo, subTotalComm), 0)%> <fo:inline color="white">.</fo:inline></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block line-height="5mm" line-weight="5mm"><fo:inline color="white">.</fo:inline> <%=String.valueOf(i+1)%>/AK.<%=JSPUtil.printX(pol.getStPolicyTypeID())%>/<%=JSPUtil.printX(pol.getEntity().getStRefEntityID())%>/<%=DateUtil.getMonthRomawi(form.getPolicyDateTo())%>/<%=DateUtil.getYear2Digit(form.getPolicyDateTo())%></fo:block></fo:table-cell>    <!-- No --><!-- The Insured -->     <!-- No --><!-- Policy No --> 
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm" line-weight="5mm"><%=JSPUtil.printX(BDUtil.sub(pol.getDbPremiKo(), pol.getDbNDComm1()),0)%> <fo:inline color="white">.</fo:inline></fo:block></fo:table-cell>    <!-- No --><!-- Discount --> <!-- No --><!-- Premium --> 
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(BDUtil.sub(t[1], t[2]),0)%> <fo:inline color="white">.</fo:inline></fo:block></fo:table-cell><!-- Total Premi --> 
