                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header> 
                        ...
                        <fo:table-row>  
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Claim Reins Paid-L}{L-INA Bayar Klaim Reas-L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG O/S Claim Reins-L}{L-INA Hutang Klaim Reas-L}</fo:block></fo:table-cell>  	
                    ...
                    <fo:table-body>      
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            t[n] = BDUtil.add(t[n++], pol.getDbNDTaxComm2());
                            
                            outstandingClaim = BDUtil.sub(pol.getDbNDTaxComm1(),pol.getDbNDTaxComm2());
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDTaxComm1(),0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDTaxComm2(),0)%></fo:block></fo:table-cell>
                        ...
                        <% 
                        subTotalClaim       = BDUtil.add(subTotalClaim,pol.getDbNDTaxComm1());
                        subTotalClaimPaid  = BDUtil.add(subTotalClaimPaid,pol.getDbNDTaxComm2());
