                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header> 
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG O/S Tax-L}{L-INA Hutang Pajak-L}</fo:block></fo:table-cell>  	
                            ...
                            <fo:table-cell border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Receipt No.-L}{L-INA No. Bukti-L}</fo:block></fo:table-cell> 			
                        </fo:table-row>
                        <fo:table-row>   
                            <fo:table-cell number-columns-spanned="14">  
                    ...
                    <fo:table-body>      
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            outstandingTax = BDUtil.sub(pol.getDbAPTax(),pol.getDbAPTaxP());
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(t[13],t[14]),0)%></fo:block></fo:table-cell>
