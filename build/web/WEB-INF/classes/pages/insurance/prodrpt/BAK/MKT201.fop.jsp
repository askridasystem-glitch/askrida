  ...
  <fo:page-sequence master-reference="only" initial-page-number="1"> 
    ...
    <fo:flow flow-name="xsl-region-body"> 
      ...
      <fo:block font-size="18pt"
       ...
       {L-ENG Bussiness Source Marketing Production Premium Report-L}{L-INA Laporan Produksi Premi Marketing Per Sumbis-L}
      </fo:block>
        ...
        <fo:table table-layout="fixed">  
         ...
         <fo:table-body>   
           <fo:table-row>   
             ...
             <fo:table-cell ><fo:block text-align="center">{L-ENG BUSSINESS TYPE.-L}{L-INA JENIS BISNIS -L}</fo:block></fo:table-cell>  
