                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="10">
                                <fo:block font-family="tahoma" space-after-optimum="40pt" font-weight="bold" font-size="20pt" text-align="center">             
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="10">
                                <fo:block font-weight="bold">
                                    ...
                                    Pelunasan Bulan <%=DateUtil.getMonth(form.getPolicyDateFrom())%> <%=DateUtil.getYear(form.getPolicyDateTo())%> s/d <%=DateUtil.getMonth(form.getPolicyDateTo())%> <%=DateUtil.getYear(form.getPolicyDateTo())%>
                                    <% } %>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(BDUtil.negate(subTotalPremium),0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="10" >
                                <fo:block border-width="0.15pt" border-style="solid" border-before-precedence="0" line-height="0.15pt"></fo:block>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block line-height="5mm"><%=JSPUtil.printX(pol.getStPolicyNo())%></fo:block></fo:table-cell>       <!-- No --><!-- No --> 
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" font-weight="bold"><%=JSPUtil.printX(BDUtil.negate(t[2]),0)%></fo:block></fo:table-cell><!-- Total Fee --> 
                        </fo:table-row>   
