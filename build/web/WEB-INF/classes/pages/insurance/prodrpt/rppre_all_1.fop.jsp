                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-top-style="solid"><fo:block text-align="center" line-height="5mm">Commision</fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-top-style="solid"><fo:block text-align="center" line-height="5mm">Sum Insured</fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-top-style="solid"><fo:block text-align="center" line-height="5mm">Premium</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-top-style="solid"><fo:block text-align="center" line-height="5mm">Commision</fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-top-style="solid"><fo:block text-align="center" line-height="5mm">Sum Insured</fo:block></fo:table-cell> 
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-top-style="solid"><fo:block text-align="center" line-height="5mm">Sum Insured</fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-top-style="solid"><fo:block text-align="center" line-height="5mm">Premium</fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-top-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm">Commision</fo:block></fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(subTotalCommFAC,0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="21" >
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="0.5pt" border-right-style="solid" ><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(t[11],0)%></fo:block></fo:table-cell>
                        </fo:table-row> 
