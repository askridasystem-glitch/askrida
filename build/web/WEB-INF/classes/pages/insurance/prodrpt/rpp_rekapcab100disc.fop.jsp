    ...
    <fo:page-sequence master-reference="only" initial-page-number="1"> 
        ...
        <fo:static-content flow-name="xsl-region-before"> 
            ...
            <fo:block text-align="center" font-size="16pt" line-height="16pt" > 
                {L-ENG RECAPITULATION PRODUCTION PREMIUM PER BRANCH 100%-L}{L-INA REKAPITULASI PRODUKSI PREMI PER CABANG 100%-L}
            </fo:block> 
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="9pt">
                ...
                Group Jenis : <%=JSPUtil.printX(form.getStPolicyTypeGroupDesc())%>
                <% } %>
            </fo:block>
