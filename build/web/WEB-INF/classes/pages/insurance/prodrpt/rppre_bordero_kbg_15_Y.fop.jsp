                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>    
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block text-align="start">: WPC 30 DAYS FROM {L-ENG <%=DateUtil.getDateStr(new Date(),"MMMM dd yyyy")%>-L}{L-INA <%=DateUtil.getDateStr(new Date(),"dd MMMM yyyy")%>-L}</fo:block></fo:table-cell>
                        </fo:table-row>
