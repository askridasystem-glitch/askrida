...
%>        
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="start"><%=JSPUtil.printX(pol.getStClaimPersonName())%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbPremiTotal(), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block color="white">.</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(t[3], 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(t[4], 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(t[5], 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ></fo:table-cell>
                            <fo:table-cell ></fo:table-cell>
                        </fo:table-row> 
