...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="12pt" line-height="12pt" text-align="center">{L-ENG Preliminary Loss Advice R/I for <%=form.getStPolicyTypeID()==null?"ALL":form.getStPolicyTypeDesc()%>-L}{L-INA Register Klaim Sementara R/I for <%=form.getStPolicyTypeID()==null?"ALL":form.getStPolicyTypeDesc()%>-L}</fo:block>
            ...
            <fo:block font-size="8pt" line-height="10pt" >
                ...
                sqa.addSelect(
                "member_ent_id, coalesce(d.short_name, d.ent_name) as ent_name, a.claim_amount, c.description, a.ricomm_amt as comission, a.premi_amount-a.ricomm_amt as netto");
                sqa.addQuery(
                "   from ins_pol_ri a\n" +
                ...
                String q =
                "select member_ent_id, ent_name, sum(claim_amount) as claim_amount, description, sum(comission) as comission, sum(netto) as netto from (" +
                sqa.getSQL()+
