                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header> 
                        ...
                        <fo:table-row>  
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Claim Approved-L}{L-INA Jumlah Klaim-L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Deductible-L}{L-INA Deductible-L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Adjuster-L}{L-INA Adjuster-L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Claim Paid-L}{L-INA Bayar Klaim-L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG O/S Claim-L}{L-INA Hutang Klaim-L}</fo:block></fo:table-cell>  
                    ...
                    <fo:table-body>      
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            outstandingClaim = BDUtil.sub(pol.getDbNDComm1(),pol.getDbNDComm4());
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(subTotalDeduct,0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(subTotalAdjuster,0)%></fo:block></fo:table-cell>
                        ...
                        <% 
                        subTotalClaim       = BDUtil.add(subTotalClaim,pol.getDbNDComm1());
                        subTotalDeduct      = BDUtil.add(subTotalDeduct,pol.getDbNDComm2());
                        subTotalAdjuster    = BDUtil.add(subTotalAdjuster,pol.getDbNDComm3());
                        subTotalClaimPaid   = BDUtil.add(subTotalClaimPaid,pol.getDbNDComm4());
                        subTotalOutsClaim   = BDUtil.add(subTotalOutsClaim,outstandingClaim);
                        } %>    
