                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-body>      
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            outstandingPremi = BDUtil.sub(pol.getDbReference1(),pol.getDbReference2());
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(subTotalBfee,0)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbReference1(),0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbReference3(),0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(new BigDecimal(0),0)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(new BigDecimal(0),0)%></fo:block></fo:table-cell>
                        ...
                        <% 
                        subTotalPremi       = BDUtil.add(subTotalPremi,pol.getDbReference1());
                        subTotalComm      = BDUtil.add(subTotalComm,pol.getDbReference3());
                        subTotalBfee    = BDUtil.add(subTotalBfee,new BigDecimal(0));
                        subTotalHfee    = BDUtil.add(subTotalHfee,new BigDecimal(0));
                        subTotalPremiPaid   = BDUtil.add(subTotalPremiPaid,pol.getDbReference2());
