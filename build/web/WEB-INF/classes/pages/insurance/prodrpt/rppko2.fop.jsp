    ...
    <fo:page-sequence master-reference="only" initial-page-number="1"> 
        ...
        <fo:static-content flow-name="xsl-region-before"> 
            ...
            <fo:block text-align="center" font-size="16pt" font-family="tahoma" line-height="16pt" > 
                {L-ENG Register of Co-Insurance Premium List-L}{L-INA Register Produksi Premi Ko-Asuransi-L}
            </fo:block> 
        ...
        <fo:flow flow-name="xsl-region-body">
			...
			--%>
                        ...
                        while (regit.hasNext()) {
                            ...
                            {final Iterator it = custcategory.getIterator();
                             while (it.hasNext()) {
                                 ...
                                 final InsurancePolicyCoinsView vpol = (InsurancePolicyCoinsView)amountMap.get(regCode+"/"+cod);
                                 
                                 BigDecimal amt = vpol==null?null:vpol.getDbPremiAmount();
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            InsurancePolicyCoinsView pol = (InsurancePolicyCoinsView) l.get(i);
