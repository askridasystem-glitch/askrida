            ...
            <fo:block font-size="8pt">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="12">
                                <fo:block font-family="tahoma" font-weight="bold" font-size="10pt" text-align="center">
                                    ...
                                    Period : <%=JSPUtil.printX(form.getPeriodFrom())%> S/D <%=JSPUtil.printX(form.getPeriodTo())%>
                                    <% }%>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="12"><fo:block space-after.optimum="20pt"></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="10">
                                <fo:block font-weight="bold"> :
                                    ...
                                    <% }%>
                                    <% } else {%>
                                    {L-ENG All Treaty -L}{L-INA Semua Treaty -L}
                                    <% }%>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="10">
                                <fo:block font-weight="bold"> :
                                    ...
                                    <%= JSPUtil.printX(form.getStPolicyTypeGroupDesc())%> - <%= JSPUtil.printX(form.getStPolicyTypeDesc())%>
                                    <% } else {%>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="12"><fo:block text-align="end" space-before.optimum="10pt">(dalam Rupiah)</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="2" display-align="center" border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">{L-ENG PREMIUM -L}{L-INA PREMI -L}</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="2" display-align="center" border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">R/I COMM</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="2" display-align="center" border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm">{L-ENG NETT -L}{L-INA NETTO -L}</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        //if (BDUtil.isZeroOrNull(pol.getDbPremiNetto())||BDUtil.isZeroOrNull(pol.getDbNDComm2())) {
                                        //    continue;
                                        //}
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="5" border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">SUBTOTAL</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="5" border-width="0.5pt" border-left-style="solid"></fo:table-cell>
