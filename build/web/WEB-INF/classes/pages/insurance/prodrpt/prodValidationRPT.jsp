<%@ page import="com.webfin.insurance.form.ProductionValidationReportForm,
...
<%@ taglib prefix="c" uri="crux" %><c:frame>
    <%
    final ProductionValidationReportForm f = (ProductionValidationReportForm) frame.getForm();
    ...
    final boolean PFL_RECEIPT_DATE = StringTools.indexOf(((String) r1.get("RECEIPT_DATE")),"O")>=0;
    ...
    final boolean PFM_RECEIPT_DATE = StringTools.indexOf(((String) r1.get("RECEIPT_DATE")),"M")>=0;
        ...
        <tr>
            <td>
                <table cellpadding=2 cellspacing=1>
                    ...
                    <c:field width="450" changeaction="onChangeReport" caption="Jenis Validasi" lov="LOV_MARKETINGREPORT" name="stReport"  descfield="stReportDesc" type="string" presentation="standard" >
                    ...
                    <c:evaluate when="<%=rptSelected%>" >
                        ...
                        <c:evaluate when="<%=PFL_RECEIPT_DATE%>" >
                            <tr>
                                <td>Tanggal Pembukuan</td>
                                <td>:</td>
                                <td>
                                    <c:field name="receiptDateFrom" type="date" caption="Receipt From"  />
                                    To <c:field name="receiptDateTo" type="date" caption="Receipt To" />
                                </td>
                            </tr>
                        </c:evaluate>
