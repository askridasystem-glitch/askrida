                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="7">
                                <fo:block font-family="serif" font-weight="bold" font-size="20pt" text-align="center">
                                    <%=JSPUtil.printX(form.getStReportDesc().replace("2. RKAP", " ").toUpperCase())%>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        int n = 0;
                                        t[n] = BDUtil.add(t[n++], BDUtil.negate(pol.getDbAmount()));
                                        ...
                                        amount = BDUtil.add(amount, BDUtil.negate(pol.getDbAmount()));
...
%>
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.negate(pol.getDbAmount()), 2)%></fo:block></fo:table-cell>
