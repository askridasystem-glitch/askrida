<%@ page import="com.webfin.approval.forms.ApprovalMasterForm,
com.webfin.approval.model.ApprovalView" %>
<%@ taglib prefix="c" uri="crux" %><c:frame title="Notifikasi Approval" >
    <%
    final ApprovalMasterForm form = (ApprovalMasterForm)request.getAttribute("FORM");
    
    final ApprovalView entity = form.getEntity();
                    ...
                    <c:tab name="tabs">
                        <c:tabpage name="TAB0">
                            <table cellpadding=2 cellspacing=1>
                                ...
                                <c:field width="200" name="entity.stRefNo" mandatory="true" caption="{L-ENG Reference No-L}{L-INA Nomor Notifikasi-L}" type="string" presentation="standard" />
                                <c:field width="200" name="entity.stPolicyID" mandatory="true" caption="Pol ID" type="string" presentation="standard" />
                                ...
                                <c:field width="200" name="entity.dtLetterDate" caption="{L-ENG Send Date-L}{L-INA Tanggal Kirim-L}" type="date" presentation="standard"  />
