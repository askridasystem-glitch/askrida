...
<fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-ENG 9. -L}{L-INA 9. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Kuasa Pengguna Anggaran atau Pejabat Pembuat Komitmen yang menerbitkan SP2D uang muka, berdasarkan surat kuasa pemegang Jaminan atau Obligee dapat mengajukan tuntutan/klaim penagihan kepada penjamin sampai dengan berakhirnya masa klaim Jaminan Uang Muka. -L}</fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="6pt" space-after.optimum="15pt">
                <%if (!tanpaTanggal) {%>
