...
<%
            ...
            String originalWatermarkPath = Parameter.readString("DIGITAL_NOTA_ORI_PIC_OLD");
            String duplicateWatermarkPath = Parameter.readString("DIGITAL_NOTA_DUPLICATE_PIC_OLD");
            String copyWatermarkPath = Parameter.readString("DIGITAL_NOTA_COPY_PIC_OLD");
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block-container height="2cm" width="14cm" top="3.5cm" left="1cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="8pt">
                    <%=JSPUtil.xmlEscape(agent.getStEntityName())%>
                </fo:block>
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="8pt">
                    <%=JSPUtil.xmlEscape(agent.getStAddress())%>
                </fo:block>
            </fo:block-container>
                ...
                <fo:table>
                    ...
                    <fo:table-body font-family="sans-serif" font-weight="normal" font-size="8pt">     
                        ...
                        <fo:table-row line-height="12pt">
                            ...
                            <% } else {%>
                            <fo:table-cell padding="2pt"><fo:block><%=fee_base%></fo:block></fo:table-cell>
                            <% }%>
                            <fo:table-cell padding="2pt">
            ...
            <!-- ALAMAT ASKRIDA -->
            <fo:block-container height="1.7cm" width="16cm" top="10cm" left="1cm" position="absolute">
                <fo:block text-align = "center">
                    <fo:external-graphic
            ...
            <fo:block-container height="2cm" width="14cm" top="3.5cm" left="1cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="8pt">
                    <%=JSPUtil.xmlEscape(pol.getStCustomerName())%></fo:block>
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="8pt">
                    <%=JSPUtil.xmlEscape(pol.getStCustomerAddress())%></fo:block>
            </fo:block-container>
            ...
            <fo:block-container height="0.5cm" width="4cm" top="8.5cm" left="12cm" padding="1mm" position="absolute">
                <fo:table>
                    ...
                    <fo:table-body font-family="sans-serif" font-weight="normal" font-size="8pt">     
                        ...
                        <fo:table-row line-height="12pt">
                            <fo:table-cell padding="2pt">
                                <fo:block text-align="start"><%=fee_base%></fo:block>
                            </fo:table-cell>
                            <fo:table-cell padding="2pt">
                                <fo:block text-align="center"></fo:block>
                            </fo:table-cell>
                ...
                <fo:table>
                    ...
                    <fo:table-body font-family="sans-serif" font-weight="normal" font-size="8pt">     
                        ...
                        <fo:table-row line-height="12pt">
                            ...
                            <fo:table-cell padding="2pt">
                                <fo:block text-align="end"><%=JSPUtil.printX(BDUtil.add(pol.getDbTotalDue(), pol.getDbNDPPN()), 2)%></fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    </fo:table-body>
                </fo:table> 
