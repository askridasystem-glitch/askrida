...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="14pt" line-height="5pt" space-after.optimum="5pt"
                      color="black"
                      text-align="center"
                      padding-top="10pt">
                {L-ENG List of Attachement -L}{L-INA Lampiran Polis Asuransi -L} <%=coverDesc%> {L-ENG Insurance -L}{L-INA -L}
            </fo:block>
            ...
            <fo:block font-size="<%=fontsize%>" line-height="5pt" space-after.optimum="20pt"
                      color="black"
                      text-align="center"
                      padding-top="10pt">
                {L-ENG Policy No. : -L}{L-INA Nomor Polis : -L}<%= pol.getStPolicyNo()%>
            </fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG Business-L}{L-INA Bisnis-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Make of Safe-L}{L-INA Buatan-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Premises-L}{L-INA Alamat Risiko-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Circumstance or Situation-L}{L-INA Kondisi atau Situasi-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Period Start-L}{L-INA Tanggal Awal-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Period End-L}{L-INA Tanggal Akhir-L}</fo:block></fo:table-cell>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell ><fo:block text-align="start"><%=JSPUtil.printX(tsi.getStDescription())%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell >
                                ...
                                <fo:block text-align="center">{L-ENG Signed at-L}{L-INA Dibuat di-L}
                                    ...
                                    <% } else {%>
                                    <%if (pol.getStCostCenterCode().equalsIgnoreCase("18")) {%>
                                <fo:block text-align="center">{L-ENG Signed at-L}{L-INA Dibuat di-L}
                                    Palembang<%if (!tanpaTanggal) {%>, {L-ENG On-L}{L-INA pada tanggal-L} <%=DateUtil.getDateStr(pol.getDtPolicyDate(), "d ^^ yyyy")%><%}%></fo:block>
                                    <% } else {%>
                                <fo:block text-align="center">{L-ENG Signed at-L}{L-INA Dibuat di-L}
