                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG Serial Number-L}{L-INA Serial Number-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Risk Code-L}{L-INA Kode Risiko-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Risk Location-L}{L-INA Alamat Risiko-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Electricity-L}{L-INA Penerangan-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Post Code -L}{L-INA Kode Pos -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Risk Card No.-L}{L-INA No. Kartu Risiko-L}</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getStReference6())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getStReference7())%></fo:block></fo:table-cell>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell >
                                                        <fo:block font-size="6pt"><%=JSPUtil.printX(tsi.getStInsuranceTSIDesc())%></fo:block>
                                                        <fo:block font-size="6pt"><%=JSPUtil.printX(tsi.getStDescription())%></fo:block>
                                                    </fo:table-cell>
