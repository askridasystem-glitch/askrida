                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell>
                                <fo:block><%=JSPUtil.printX(obj.getStReference13())%> </fo:block>
                                <fo:block>Tanggal : <%=DateUtil.getDateStr(obj.getDtReference5(), "dd ^^ yyyy")%></fo:block>
                            </fo:table-cell>
                        </fo:table-row>
