                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Maka kami, TERJAMIN dan PENJAMIN dengan ini mengikatkan diri untuk melakukan pembayaran jumlah tersebut diatas dengan baik dan benar bilamana TERJAMIN tidak memenuhi kewajiban dalam melaksanakan Pekerjaan : -L} <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference11())%> </fo:inline> {L-ENG XXX -L}{L-INA yang telah dipercayakan kepadanya atas dasar Dokumen Pengadaan dari Penerima Jaminan No.:-L} <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference10())%> </fo:inline> tanggal <fo:inline font-weight="bold"> <%=DateUtil.getDateStr(obj.getDtReference1(), "d ^^ yyyy")%> </fo:inline>  </fo:block></fo:table-cell>
                        </fo:table-row>
