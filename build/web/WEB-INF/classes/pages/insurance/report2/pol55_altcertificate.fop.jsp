    ...
    <fo:page-sequence master-reference="only">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="14pt" font-family="TAHOMA" line-height="0pt" space-after.optimum="5pt"
                      ...
                      text-align="center"
                      padding-top="10pt">
                <%=JSPUtil.printX(pol.getStPolicyTypeDesc2().substring(38, 55))%>
            </fo:block>
            ...
            <fo:block font-size="<%=fontsize%>" text-align="justify" space-after.optimum="10pt">Sertifikat Penjaminan Bank Garansi <%=JSPUtil.printX(pol.getStPolicyTypeDesc2().substring(38, 55))%> ini diterbitkan oleh PENJAMIN sehubungan dengan akan diterbitkannya BANK GARANSI oleh PENERIMA JAMINAN untuk kepentingan TERJAMIN guna keperluan
                <%= JSPUtil.xmlEscape(obj.getStReference6())%> berdasarkan Nomor <% if (obj.getStReference13() != null) {%><%=JSPUtil.printX(obj.getStReference13())%> tanggal <%=DateUtil.getDateStr(obj.getDtReference5(), "d ^^ yyyy")%> <% } else {%> <%=JSPUtil.printX(obj.getStReference7())%> tanggal <%=DateUtil.getDateStr(obj.getDtReference2(), "d ^^ yyyy")%> <% }%> dengan harga kontrak sebesar Rp. <%=JSPUtil.printX(obj.getDbReference3(), 0)%> (<%=NumberSpell.readNumber(JSPUtil.printX(obj.getDbReference3(), 0), "", NumberSpell.INDONESIA)%> RUPIAH)
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block >Adanya pernyataan dari PENERIMA JAMINAN dan TERJAMIN yang menyatakan telah selesainya hal yang dijamin dalam BANK GARANSI tersebut yang dituangkan dalam Surat Pernyataan Bermaterai serta ditandatangani oleh kedua belah pihak.</fo:block></fo:table-cell>
                        </fo:table-row>
