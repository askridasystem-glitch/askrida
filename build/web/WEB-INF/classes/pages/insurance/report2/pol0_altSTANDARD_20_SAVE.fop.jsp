                                            ...
                                            <fo:table-body>
                                                ...
                                                <%
                                                                     ...
                                                                     for (int j = 0; j < deductibles.size(); j++) {
                                                                         ...
                                                                         if (ded.getStAutoDesc() != null) {
                                                                             desc2 = ded.getStAutoDesc().replace(".000.00 null", ".00");
                                                                         }
                                                ...
                                                <fo:table-row>
                                                    ...
                                                    <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block><%=JSPUtil.printX(desc2.replace("null", " "))%> <%=JSPUtil.xmlEscape(desc)%>
                                                        </fo:block></fo:table-cell>
