      ...
      <% } %>
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <%
                                                                            for (int y = 0; y < coverage.size(); y++) {
                                                                                InsurancePolicyCoverView cover2 = (InsurancePolicyCoverView) coverage.get(0);

                                                                                isFlag = cover2.isFlag();

                                                                                if (cover2.getStInsCoverDesc() != null) {
                                                                                    firstLoss = cover2.getStInsCoverDesc().equalsIgnoreCase("fl30") ? true : false;
                                                                                }
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell ><fo:block text-align="center">{L-ENG Sum Insured-L}{L-INA Harga Pertanggungan-L}</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block text-align="center">{L-ENG Full Value-L}{L-INA Full Value-L}</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <%--   		 <fo:table-cell ><fo:block text-align="center">{L-ENG First Loss Limit (30%)-L}{L-INA First Loss Limit (30%)-L}</fo:block></fo:table-cell>--%>

                                                    <% if (firstLoss) {%>
                                                    <fo:table-cell ><fo:block text-align="center">{L-ENG First Loss Limit (30%)-L}{L-INA First Loss Limit (30%)-L}</fo:block></fo:table-cell>
                                                    <% } else {%>
                                                    <fo:table-cell ><fo:block text-align="center">{L-ENG First Loss Limit (50%)-L}{L-INA First Loss Limit (50%)-L}</fo:block></fo:table-cell>
                                                    <% }%> 
                                                ...
                                                <fo:table-row>
                                                    ...
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                                                    <%--			 <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(BDUtil.mul(tsi.getDbInsuredAmount(), new BigDecimal(0.3)),2)%></fo:block></fo:table-cell>--%>

                                                    <% if (firstLoss) {%>
                                                    <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(tsi.getDbInsuredAmount(), new BigDecimal(0.3)), 2)%></fo:block></fo:table-cell>
                                                    <% } else {%>
                                                    <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(tsi.getDbInsuredAmount(), new BigDecimal(0.5)), 2)%></fo:block></fo:table-cell>
                                                    <% }%>
                                                ...
                                                <fo:table-row>
                                                    ...
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                                                    <%--	 	 <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(io.getDbObjectInsuredAmount(), new BigDecimal(0.3)),2)%></fo:block></fo:table-cell>--%>

                                                    <% if (firstLoss) {%>
                                                    <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(io.getDbObjectInsuredAmount(), new BigDecimal(0.3)), 2)%></fo:block></fo:table-cell>
                                                    <% } else {%>
                                                    <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(io.getDbObjectInsuredAmount(), new BigDecimal(0.5)), 2)%></fo:block></fo:table-cell>
                                                    <% }%>
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <%
                                                                                                                        ...
                                                                                                                        for (int q = 0; q < suminsureds.size(); q++) {
                                                                                                                            InsurancePolicyTSIView tsi = (InsurancePolicyTSIView) suminsureds.get(q);
                                                %>
            ...
            <fo:table-row>
             ...
             <fo:table-cell ><fo:block text-align="end">
                 <%=hasRate?(JSPUtil.printPct(s(),3)+" "+pol.getStRateMethodDesc()+" "+pol.getStCurrencyCode()+" "+JSPUtil.print(cover.getDbInsuredAmount(),2)):(pol.getStCurrencyCode()+" "+JSPUtil.print(cover.getDbInsuredAmount(),2))%>
             </fo:block></fo:table-cell>
            </fo:table-row> --%>
                                                <%
                                    ...
                                    <fo:table table-layout="fixed">
                                        ...
                                        <fo:table-body>
                                            ...
                                            <%
                                                                                                ...
                                                                                                for (int b = 0; b < coverage.size(); b++) {
                                                                                                    InsurancePolicyCoverView cover = (InsurancePolicyCoverView) coverage.get(b);
            ...
            <% if (firstLoss) {%>
            <fo:block font-size="<%=fontsize%>" space-before.optimum="10pt" space-after.optimum="10pt" font-weight="italic">
                (Sistem Penutupan Asuransi <%= pol.getStPolicyTypeDesc2()%> First Loss Limit 30% Of Full Value)
            </fo:block>
            <% } else {%>
            <fo:block font-size="<%=fontsize%>" space-before.optimum="10pt" space-after.optimum="10pt" font-weight="italic">
                (Sistem Penutupan Asuransi <%= pol.getStPolicyTypeDesc2()%> First Loss Limit 50% Of Full Value)
            </fo:block>
            <% }
                                }
            %>     
