                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Maka kami TERJAMIN dan PENJAMIN dengan ini mengikatkan diri untuk melakukan pembayaran jumlah tersebut diatas dengan baik dan benar bilamana TERJAMIN tidak memenuhi kewajiban dalam melaksanakan pekerjaan -L}<fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference11())%></fo:inline> {L-ENG XXX -L}{L-INA sebagaimana ditetapkan berdasarkan PHO/BAST -L} <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference10())%></fo:inline> {L-ENG XXX -L}{L-INA tanggal -L}<fo:inline font-weight="bold"><%=DateUtil.getDateStr(obj.getDtReference1(), "d ^^ yyyy")%></fo:inline> {L-ENG XXX -L}{L-INA dari PENERIMA JAMINAN. -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell>
                                <fo:block>{L-ENG XXX -L}{L-INA Jaminan ini berlaku apabila : -L}</fo:block>
                                <fo:block>{L-ENG XXX -L}{L-INA TERJAMIN tidak memenuhi kewajibannya melakukan pemeliharaan sebagaimana ditentukan dalam Dokumen Kontrak. -L}</fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA PENJAMIN akan membayar kepada PENERIMA JAMINAN sejumlah nilai jaminan tersebut di atas dalam waktu paling lambat 14 (empat belas) hari kerja tanpa syarat (UNCONDITIONAL) setelah menerima tuntutan pencairan secara tertulis dari PENERIMA JAMINAN mengenai pengenaan sanksi akibat TERJAMIN cidera janji. -L}</fo:block></fo:table-cell>
                        </fo:table-row>
