...
%>
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>Terlampir <%=objects.size()%> Objek Pertanggungan</fo:block></fo:table-cell>
                        </fo:table-row>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell ><fo:block><%=objects.size()%> Objek Pertanggungan <%=JSPUtil.xmlEscape(tsi.getStDescriptionAuto())%></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell number-columns-spanned="3" ><fo:block><%=JSPUtil.xmlEscape(cover.getStInsuranceCoverDesc())%> <%=JSPUtil.print(cover.getDbRate(), 2)%>%</fo:block></fo:table-cell>
                                                   <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
