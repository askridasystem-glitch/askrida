                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Jika PRINCIPAL telah melakukan pembayaran kembali kepada OBLIGEE seluruh jumlah Uang Muka dimaksud (yang dinyatakan dalam surat tanda bukti penerimaan olehnya) atau sisa Uang Muka yang wajib dibayar menurut Kontrak tersebut, maka surat Jaminan ini menjadi batal dan tidak berlaku ; sebaliknya jika tidak maka Surat Jaminan ini tetap berlaku dan efektif mulai dari tanggal -L}<%=DateUtil.getDateStr(pol.getDtPeriodStart(), "d ^^ yyyy")%> {L-ENG XXX -L}{L-INA sampai dengan tanggal -L} <%=DateUtil.getDateStr(pol.getDtPeriodEnd(), "d ^^ yyyy")%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA SURETY akan membayar kepada OBLIGEE Uang Muka atau sisa Uang Muka yang berdasarkan kontrak belum dikembalikan oleh PRINCIPAL, selambat-lambatnya 30 (tiga puluh) hari kalender setelah menerima tuntutan penagihan (Klaim) dari OBLIGEE. -L} </fo:block></fo:table-cell>
                        </fo:table-row>
