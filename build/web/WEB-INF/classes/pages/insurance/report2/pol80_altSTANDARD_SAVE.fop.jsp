...
<%
            ...
            Date tglJWaktuS = null;
            Date tglJWaktuE = null;
            BigDecimal insuredObj = new BigDecimal(0);
            String jenKred = "";
...
//String desc = pol.getStKreasiTypeDesc().replaceAll(pol.getStKreasiTypeDesc().substring(0,4)," ");
            ...
            for (int j = 0; j < objects.size(); j++) {
                ...
                noKredit = obj.getStReference7();

                noKTP = obj.getStReference3();

                kerja = obj.getStReference4Desc();

                tglLahir = obj.getDtReference1();

                tglPK = obj.getDtReference4();

                cover = obj.getStReference10();

                tglStnc = obj.getDtReference5();

                tglJWaktuS = obj.getDtReference2();

                tglJWaktuE = obj.getDtReference3();

                insuredObj = obj.getDbObjectInsuredAmount();

                jenKred = obj.getStReference9Desc();
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1" force-page-count="no-force">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="16pt" font-family="TAHOMA"
                      ...
                      text-align="center"
                      padding-top="0pt">
                {L-INA ASURANSI KREDIT PRODUKTIF -L}{L-ENG CREDIT PRODUCTIVE INSURANCE -L}
            </fo:block>
            ...
            <% if (objects.size() == 1) {%>
            <fo:block font-size="<%=fontsize%>" text-align="justify">
                Beradasarkan Surat Permohonan Penutupan Asuransi (SPPA) No. (<%=noKredit%>) untuk dan atas nama pertanggungan kredit DEBITUR :
            </fo:block>
            <% } else {%>
            <fo:block font-size="<%=fontsize%>" text-align="justify">
                Beradasarkan Surat Permohonan Penutupan Asuransi (SPPA) No. (Terlampir) untuk dan atas nama pertanggungan kredit DEBITUR :
            </fo:block>
            <% }%>
            ...
            <fo:block font-size="<%=fontsize%>" text-align="justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block >{L-ENG Member-L}{L-INA Nama-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block >:</fo:block></fo:table-cell>
                            <% if (objects.size() == 1) {%>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block >Jangka Waktu Pertanggungan</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block >:</fo:block></fo:table-cell>
                            <% if (objects.size() == 1) {%>
                            <fo:table-cell ><fo:block ><%=DateUtil.getDateStr(tglJWaktuS, "dd ^^ yyyy")%> - <%=DateUtil.getDateStr(tglJWaktuE, "dd ^^ yyyy")%></fo:block></fo:table-cell>
                            <% } else {%>
                            <fo:table-cell ><fo:block >{L-ENG See Attached-L}{L-INA Terlampir-L} </fo:block></fo:table-cell>
                            <% }%>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block >No. Perjanjian Kredit</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block >:</fo:block></fo:table-cell>
                            <% if (objects.size() == 1) {%>
                            <fo:table-cell ><fo:block ><%=JSPUtil.printX(noKredit)%></fo:block></fo:table-cell>
                            <% } else {%>
                            <fo:table-cell ><fo:block >{L-ENG See Attached-L}{L-INA Terlampir-L} </fo:block></fo:table-cell>
                            <% }%>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block >Nilai Pertanggungan</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block >:</fo:block></fo:table-cell>
                            <% if (objects.size() == 1) {%>
                            <fo:table-cell ><fo:block ><%=JSPUtil.printX(insuredObj, 2)%></fo:block></fo:table-cell>
                            <% } else {%>
                            <fo:table-cell ><fo:block >{L-ENG See Attached-L}{L-INA Terlampir-L} </fo:block></fo:table-cell>
                            <% }%>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block >Jenis Kredit</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block >:</fo:block></fo:table-cell>
                            <% if (objects.size() == 1) {%>
                            <fo:table-cell ><fo:block ><%=JSPUtil.printX(jenKred)%></fo:block></fo:table-cell>
                            <% } else {%>
                            <fo:table-cell ><fo:block >{L-ENG See Attached-L}{L-INA Terlampir-L} </fo:block></fo:table-cell>
                            <% }%>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block >:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block >Menjamin kerugian dan atau kepentingan yang diderita oleh tertanggung akibat penerima kredit (peserta) tidak mampu memenuhi kewajibannya (wanprestasi) sesuai perjanjian kredit akibat peserta Asuransi Meninggal Dunia.</fo:block></fo:table-cell>
                            <%--<%if (cover != null) {%>
            ...
            <fo:block font-size="<%=fontsize%>" text-align="justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-column-spanned="5"><fo:block text-align="justify">Pertanggungan ini tunduk pada syarat-syarat umum polis Asuransi Kredit Produktif dan ketentuan-ketentuan lainnya yang tercantum didalam atau terlekat dalam Polis ini.</fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center"><%=JSPUtil.xmlEscape(cl.getStDescription())%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="3">
                                ...
                                <fo:block font-size="<%=fontsize%>" wrap-option="yes-wrap" linefeed-treatment="preserve" text-align="justify"
                                    ...
                                    <%=JSPUtil.xmlEscape(cl.getStWordingNew().replaceAll("%S%", pol.getEntity().getStEntityName()))%>
                                </fo:block>
                                <% } else {%>
                                <fo:block font-size="<%=fontsize%>" wrap-option="yes-wrap" linefeed-treatment="preserve" text-align="justify"
                                          white-space-treatment="preserve" white-space-collapse="false">
                                    <%=JSPUtil.xmlEscape(cl.getStWording().replaceAll("%S%", pol.getEntity().getStEntityName()))%>
                                </fo:block>
                                <% }%>
