                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.add(obj.getDbObjectPremiTotalAmount(),obj.getDbReference9()), 2)%><fo:inline color="white">.</fo:inline></fo:block></fo:table-cell>
                        </fo:table-row>
