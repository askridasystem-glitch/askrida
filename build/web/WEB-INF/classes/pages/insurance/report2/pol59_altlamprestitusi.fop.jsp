    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" >{L-ENG Time (Year) -L}{L-INA Lama (Tahun) -L}</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>   
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < objects.size(); i++) {
                                        ...
                                        if (BDUtil.isZeroOrNull(obj.getDbObjectPremiTotalAmount())) {
                                            continue;
                                        }
                                        //premiTotal = BDUtil.add(premiTotal, obj.getDbObjectPremiTotalBeforeCoinsuranceAmount());

                                        DTOList objectsCov = obj.getCoverRestitusi();
                                        for (int k = 0; k < objectsCov.size(); k++) {
                                            InsurancePolicyCoverView cov = (InsurancePolicyCoverView) objectsCov.get(k);

                                            premiTotal = BDUtil.add(premiTotal, BDUtil.add(cov.getDbPremi(), cov.getDbPremiNew()));
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.negate(BDUtil.add(cov.getDbPremi(), cov.getDbPremiNew())), 0)%></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" ></fo:block></fo:table-cell>
                        </fo:table-row>                        
            ...
            <fo:block font-size="6pt"
                      ...
                      text-align="left" >
                Print Date : <%=JSPUtil.print(DateUtil.getDateStr(new Date(), "dd/MM/yyyy HH:mm:ss"))%> PrintStamp:<%=pol.getStPrintCode()%> PrintCode:<%=pol.getStPrintStamp()%> Page:<fo:page-number/>
