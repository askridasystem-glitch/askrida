                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block padding-top="5pt" text-align="center" line-height="5mm" >{L-ENG Coverage -L}{L-INA Jaminan -L}</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="0.5pt" border-left-style="solid"><fo:block text-align="end"  line-height="5mm"><%=JSPUtil.printX((BigDecimal) objects.getTotal("refn2"), 0)%></fo:block></fo:table-cell>
