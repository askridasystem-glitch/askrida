                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG Interest Insured -L}{L-INA Nama Pertangguungan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Business -L}{L-INA Penggunaan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Location of Risk -L}{L-INA Lokasi Risiko -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Post Code -L}{L-INA Kode Pos -L}</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="2"><fo:block text-align="center">{L-ENG Sum Insured -L}{L-INA H. Pertanggungan -L}</fo:block></fo:table-cell>
                            <fo:table-cell ></fo:table-cell>
                            <fo:table-cell number-columns-spanned="2"><fo:block text-align="center">{L-ENG Premium -L}{L-INA Premi -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="2"><fo:block text-align="center"><%=JSPUtil.print(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                            <fo:table-cell ></fo:table-cell>
                            <fo:table-cell number-columns-spanned="2"><fo:block text-align="center"><%=JSPUtil.print(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getDesc("stReference4"))%></fo:block></fo:table-cell>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                %>
                                                <fo:table-row>
                                                    <fo:table-cell><fo:block text-align="start"><%=JSPUtil.printX(insuredDesc)%></fo:block></fo:table-cell>
                                            ...
                                            <fo:table-body>
                                                ...
                                                <% DTOList cover = obj.getCoverage();
                                                                                        for (int k = 0; k < cover.size(); k++) {
                                                                                            ...
                                                                                            String coverDesc = new String("");

                                                                                            if (cov.getStDescription() != null) {
                                                                                                coverDesc = cov.getStDescription() + " " + cov.getStInsuranceCoverDesc();
                                                                                            } else {
                                                                                                coverDesc = cov.getStInsuranceCoverDesc();
                                                                                            }
                                                %>
                                                <fo:table-row>
                                                    <fo:table-cell><fo:block text-align="start"><%=JSPUtil.printX(coverDesc)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="5"></fo:table-cell>
                            <fo:table-cell number-columns-spanned="2"><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbInsuredAmount(), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ></fo:table-cell>
                            <fo:table-cell number-columns-spanned="2"><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbPremiTotal(), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
