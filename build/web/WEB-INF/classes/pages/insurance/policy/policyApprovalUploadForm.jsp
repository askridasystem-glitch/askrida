<%@page import="com.webfin.insurance.model.PolicyApprovalUploadHeaderView"%>
<%@ page import="com.webfin.gl.form.GLJournalForm,
         ...
         com.webfin.insurance.form.PolicyApprovalUploadForm,
...
<%@ taglib prefix="c" uri="crux" %><c:frame title="UPLOAD PERSETUJUAN POLIS" >
    <%
                ...
                final PolicyApprovalUploadForm form = (PolicyApprovalUploadForm) request.getAttribute("FORM");

                final PolicyApprovalHeaderView header = form.getTitipan();
        ...
        <tr>
            <td>
                <table cellpadding=2 cellspacing=1>
                        ...
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                <tr>
                                    <td>
                                        <table cellpadding=2 cellspacing=1>
                                            <c:field name="titipan.stInsurancePolicyApprovalUploadID" width="150" caption="Upload Group ID" type="string" readonly="true" presentation="standard" />
                    ...
                    <tr>
                        <td>
                            Jumlah Data Terupload : <%=form.getDetails().size()%>
                        </td>
                    </tr>
                            ...
                            <table>
                                ...
                                <c:listbox name="details"  paging="true" >
                                    ...
                                    <c:listcol title="Keterangan" >
                                        <c:field name="details.[$index$].stDescription" width="300" caption="Deskripsi" type="string" readonly="false" />
                                    </c:listcol>
                                    <c:listcol title="Total Premi" >
                                        <c:field name="details.[$index$].dbPremiTotal" width="150" caption="Total Premi" type="money16.2" readonly="false" />
                                    </c:listcol>
                                    <c:listcol title="Tanggal STNC" >
                                        <c:field name="details.[$index$].dtTanggalStnc" width="150" caption="Total Premi" type="date" readonly="false" />
                                    </c:listcol>
                                    <%--
