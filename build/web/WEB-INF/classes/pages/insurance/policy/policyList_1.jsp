...
<% } %>--%>
        ...
        <tr>
            <td>
               ...
               <%if(form.isEnableRenewalNonAKS()){%>&nbsp;&nbsp;&nbsp; No Polis Sebelumnya <%}%>  <c:field name="stPolicyNoRenewal" width="180" type="string" show="<%=form.isEnableRenewalNonAKS()%>" />
            ...
            <tr>
                <td>
                   ...
                   --%> <c:button show="<%=form.isEnableSuperEdit()%>"  text="{L-ENGReApprove-L}{L-INAApprove Ulang-L}" event="clickReApproval" />
                    ...
                    <c:button show="<%=form.isEnableSuperEdit()%>"  text="CREATE ENDORSE RI" event="createEndorsemenRIByData2" />
                    ...
                    <c:button show="<%=form.isEnableSuperEdit()%>"  text="prose endorse H2H sulsel" event="createEndorsemenKomisiByData" />
