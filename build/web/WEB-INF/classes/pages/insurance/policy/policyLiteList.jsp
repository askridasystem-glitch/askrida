...
<%@ taglib prefix="c" uri="crux" %><c:frame title="Lite Version">
    <%
    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr> 
            <td>                                                                 
                ...
                <c:button show="<%=form.isCanApprove()%>"  text="{L-ENGApproval-L}{L-INASetujui-L}" event="clickApprovalLite" />
                <c:button show="<%=form.isCanApprove() && !reas%>"  text="{L-ENGReject-L}{L-INATolak-L}" event="clickReject" />

                <c:button show="<%=form.IsCanReverse()%>"  text="{L-ENGReverse-L}{L-INAReverse-L}" event="clickReverseUW" />
