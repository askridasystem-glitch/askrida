...
<%@ taglib prefix="c" uri="crux" %><c:frame title="Claim Monitoring (Auto Refresh Every 5 Minutes)">
    <%
    ...
    <table cellpadding=2 cellspacing=1>
        <tr>
            <td>
                <c:evaluate when="<%=showFilter%>" >
                    <img style="cursor:hand" src="/fin/images/show filter.png" onclick="mform.action_event.value='showFilter';mform.submit();" />
                </c:evaluate>
                <c:evaluate when="<%=!showFilter%>" >
                    <img style="cursor:hand" src="/fin/images/hide filter.png" onclick="mform.action_event.value='hideFilter';mform.submit();" />
                </c:evaluate>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <c:listbox name="listClaimMonitoring" autofilter="true" selectable="true" paging="true" view="com.webfin.insurance.model.InsurancePolicyView" >
                    <%
               ...
               <c:listcol align="right" name="dbClaimAmountApproved" title="{L-ENGClaim Approved-L}{L-INAKlaim Disetujui-L}" />
                    ...
                    <c:listcol filterable="true" name="stCreateWho" title="Create By" />
