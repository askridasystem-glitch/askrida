<%@ page import="com.webfin.reinsurance.form.ReinsuranceValidationUploadList,
         com.crux.util.Tools,
         com.webfin.reinsurance.model.ReinsuranceValidationHeaderView"%>
<%@ taglib prefix="c" uri="crux" %><c:frame title="VALIDASI REASURANSI" >

    <%
                ReinsuranceValidationUploadList form = (ReinsuranceValidationUploadList) request.getAttribute("FORM");
    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr>
            <td>
                ...
                <c:listbox name="list" selectable="true" paging="true" view="com.webfin.reinsurance.model.ReinsuranceValidationHeaderView" autofilter="true">
                    <c:listcol name="stInsurancePolicyReinsuranceValidationID" title="ID" selectid="memorialID"/>
        ...
        <tr>
            <td>
                ...
                <c:button show="<%=form.isCanProcess()%>" text="Proses" event="prosesValidasiReasByNoRecap" confirm="Yakin ingin diproses ?" />
            </td> 
        </tr>
    </table>
