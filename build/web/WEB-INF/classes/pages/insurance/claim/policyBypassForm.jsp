...
final boolean isBypassValidationMode = form.isBypassValidationMode();
...
<tr>
        ...
        <table cellpadding=2 cellspacing=1>       
           ...
           <tr>
                ...
                <td>
                    ...
                    readonly="<%=!isBypassValidationMode%>" type="date" overrideRO="true" />
                </td>
            </tr>
            <c:field width="500" rows="3" caption="{L-ENGNotes-L}{L-INACatatan-L}" name="policy.stPaymentNotes" type="string"
                     readonly="<%=!isBypassValidationMode%>" overrideRO="true" presentation="standard"/>
            <c:field name="policy.stCheckingFlag" type="check" readonly="<%=!isBypassValidationMode%>" overrideRO="true" caption="Bypass Validasi" presentation="standard" />
        </table> 
        <br>
        <br>
    ...
    <c:tabpage name="TAB_POLICY_DOCUMENTS">
        <c:fieldcontrol when="<%=form.isBypassValidationMode()%>" readonly="false">
        <table cellpadding=2 cellspacing=1 class=header width="100%">
            <tr>
                <td>
                    DOCUMENTS
...
<tr>
    <td align=center>
        ...
        <%if(form.isBypassValidationMode()){%>
            <c:button show="true" text="Simpan Bypass" event="btnSaveBypassValidation"/>
        <%}%>
