   ...
   <tr>
      <td>
         <c:listbox autofilter="true" name="list" selectable="true" paging="true" view="com.webfin.entity.model.EntityView" >
            ...
            <c:listcol filterable="true" name="stCustomerStatus" title="{L-ENGStatus-L}{L-INAStatus-L}" />
            <c:listcol filterable="true" name="stGLCode" title="{L-ENGGL Code-L}{L-INAGL Code-L}" />
         </c:listbox>
      </td>
   </tr>
   <tr>
      <td>
         ...
         <c:button  text="Cek Customer" event="clickCheck" />
      </td>
   </tr>
</table>
</c:frame>