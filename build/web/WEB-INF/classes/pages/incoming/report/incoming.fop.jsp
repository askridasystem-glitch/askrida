...
<%
   ...
   final IncomingView incoming = (IncomingView)request.getAttribute("INCOMING");
  ...
  <fo:page-sequence master-reference="only" initial-page-number="1">
   ...
   <!-- ROW -->
      ...
      <fo:block font-size="<%=fontsize%>">
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
           ...
           <fo:table-row>
             ...
             <fo:table-cell ><fo:block><%= incoming.getStRefNo()%></fo:block></fo:table-cell>
           </fo:table-row>

           <fo:table-row>
             <fo:table-cell ><fo:block>{L-ENG Sender-L}{L-INA Pengirim-L}</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block><%=incoming.getStSender()%></fo:block></fo:table-cell>
           </fo:table-row>
           
           <fo:table-row>
             <fo:table-cell ><fo:block>{L-ENG Sender-L}{L-INA Pengirim-L}</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block><%=incoming.getStSenderName()%></fo:block></fo:table-cell>
           </fo:table-row>
           <fo:table-row>
             <fo:table-cell ><fo:block>{L-ENG Title-L}{L-INA Judul-L}</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(incoming.getStSubject())%></fo:block></fo:table-cell>
           </fo:table-row>
           <fo:table-row>
             <fo:table-cell ><fo:block>{L-ENG Date-L}{L-INA Tanggal Surat-L}</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block><%=DateUtil.getDateStr(incoming.getDtLetterDate(),"d ^^ yyyy")%></fo:block></fo:table-cell>
           </fo:table-row>
           <fo:table-row>
        ...
        white-space-treatment="preserve" white-space-collapse="false"><%=JSPUtil.xmlEscape(incoming.getStNote())%></fo:block></fo:table-cell>
           </fo:table-row>
         </fo:table-body>
       </fo:table>
       </fo:block>
