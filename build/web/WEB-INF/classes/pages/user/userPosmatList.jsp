...
<table cellpadding=2 cellspacing=1>
   ...
   <tr>
      <td>
         <c:button  text="CREATE USER" event="clickCreate"/>
         <c:button  text="EDIT USER" event="clickEdit" />
         <c:button  text="VIEW USER" event="clickView" />
         <c:button  text="DELETE USER" event="clickDelete"  />
         <c:button  text="CHANGE PASSWORD" event="clickChangePassword" />
      </td>
   </tr>
</table>
</c:frame>