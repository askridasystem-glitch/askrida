...
<%@ taglib prefix="c" uri="crux" %><c:frame title="JURNAL PEMBINAAN BISNIS">
<%
   ...
   <table cellpadding=2 cellspacing=1>
      ...
      <tr>
         <td>
            ...
            <c:listbox name="pbList" paging="true" >
               <%
      ...
      <tr>
         <td>
            <%=jspUtil.getButtonNormal("crt","Create","openDialog('so.ctl?EVENT=PB_GL_ENTRY_ADD', 900,550,refreshcb);")%>
            <%=jspUtil.getButtonNormal("edt","Edit","openDialog('so.ctl?EVENT=PB_GL_ENTRY_EDIT&trxhdrid='+f.trxhdrid.value, 900,550,refreshcb);")%>
            <%=jspUtil.getButtonNormal("v","View","openDialog('so.ctl?EVENT=GL_ENTRY_VIEW&trxhdrid='+f.trxhdrid.value, 900,550,refreshcb);")%>
         </td>
      </tr>
   </table>
<script>
