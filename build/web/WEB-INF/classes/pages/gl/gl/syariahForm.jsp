<%@ page import="com.webfin.gl.form.GLJournalForm,
         com.webfin.gl.model.JournalSyariahView,
    ...
    <table cellpadding=2 cellspacing=1>
                    ...
                    <tr>
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                ...
                                <c:field width="200" name="titipan.lgPeriodNo" lov="LOV_MONTH_Period" mandatory="true" caption="Bulan" type="string" presentation="standard"/>
                                <c:field width="200" name="titipan.lgFiscalYear" lov="LOV_GL_Years2" mandatory="true" caption="Tahun" type="string" presentation="standard" readonly="<%=header.getLgFiscalYear() != null%>"/>
                                <c:field name="titipan.stFilePhysic" caption="Upload Excel" type="file" thumbnail="true"
                                         readonly="false" presentation="standard"/>
                                <tr>
                                    <td><c:button show="true" text="Konversi" event="uploadExcelSyariah"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <td align=center>
            <c:evaluate when="<%=!readOnly%>" >
                ...
                <c:button text="Simpan" event="doSaveSyariah" validate="true" confirm="Do you want to save ?" />
