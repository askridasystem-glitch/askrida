   ...
   <table cellpadding=2 cellspacing=1>
      ...
      <tr>
         <td>
            ...
            <c:listbox name="uangMukaKlaimList" paging="true" >
               <%
      ...
      <tr>
         <td>
            <%=jspUtil.getButtonNormal("crt","Create","openDialog('so.ctl?EVENT=FREE_GL_ENTRY_ADD', 750,550,refreshcb);")%>
            <%=jspUtil.getButtonNormal("edt","Edit","openDialog('so.ctl?EVENT=GL_ENTRY_EDIT&trxhdrid='+f.trxhdrid.value, 800,550,refreshcb);")%>
            <%=jspUtil.getButtonNormal("v","View","openDialog('so.ctl?EVENT=GL_ENTRY_VIEW&trxhdrid='+f.trxhdrid.value, 800,550,refreshcb);")%>
         </td>
      </tr>
   </table>
<script>
