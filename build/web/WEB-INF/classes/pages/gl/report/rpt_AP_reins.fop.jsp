                ...
                <fo:table table-layout="fixed">  
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="9">
                                <fo:block font-family="serif" font-weight="bold" font-size="16pt" text-align="center">             
                                    <fo:inline text-decoration="underline">REKAPITULASI UTANG REASURANSI</fo:inline>   
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(subTotalPremiFac, kali),0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(subTotalPremiTreaty, kali),0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(subTotalPremiXL, kali),0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(subTotalClaimCash, kali),0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(subTotalClaimFac, kali),0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(subTotalClaimXL, kali),0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(subTotalDebit, kali),0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(pol.getDbPremiFac(), kali),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Period --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(pol.getDbPremiTreaty(), kali),0)%></fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(pol.getDbPremiXL(), kali),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Period --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(pol.getDbClaimCash(), kali),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Period --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(pol.getDbClaimFac(), kali),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Period --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(pol.getDbClaimXL(), kali),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Period --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(pol.getDbDebit(), kali),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Period --> 
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(t[0], kali),0)%></fo:block></fo:table-cell><!-- Total Premi --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(t[1], kali),0)%></fo:block></fo:table-cell><!-- Total Premi --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(t[2], kali),0)%></fo:block></fo:table-cell><!-- Total Premi --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(t[3], kali),0)%></fo:block></fo:table-cell><!-- Total Premi --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(t[4], kali),0)%></fo:block></fo:table-cell><!-- Total Premi --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(t[5], kali),0)%></fo:block></fo:table-cell><!-- Total Premi --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(t[6], kali),0)%></fo:block></fo:table-cell><!-- Total Premi --> 
                        </fo:table-row>   
