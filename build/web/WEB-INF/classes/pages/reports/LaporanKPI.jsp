            ...
            <tr>
                <td>
                 <table cellpadding=2 cellspacing=1>
                    ...
                    <tr>
                        <td class=row0>Nama Pemeriksa</td>
                        <td class=detail><%=jspUtil.getInputText("nama_pemeriksa",new FieldValidator("nama_pemeriksa", "Nama Pemeriksa","string",200,JSPUtil.MANDATORY),null,200,JSPUtil.MANDATORY)%></td>
                    </tr>
                    <tr>
                        <td class=row1>NIK Pemeriksa</td>
                        <td class=detail><%=jspUtil.getInputText("nik_pemeriksa",new FieldValidator("nik_pemeriksa", "NIK Pemeriksa","string",10,JSPUtil.MANDATORY),null,200,JSPUtil.MANDATORY)%></td>
                    </tr>
                    <tr>
             ...
             <tr>
                <td>
                <%=jspUtil.getButtonSubmit("bGenerate","Tampilkan Laporan KPI")%>
<%--                <%=jspUtil.getButtonNormal("bGenerate","Tampilkan try","window.open('rpt_try.rpt?user_id=admin','','toolbar=yes,location=no,directories=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=640,height=480');")%>--%>
   ...
   <script>
    function processReport(){
         ...
         stUrl=stUrl+"&nama_pemeriksa="+f.nama_pemeriksa.value;
         stUrl=stUrl+"&nik_pemeriksa="+f.nik_pemeriksa.value;
