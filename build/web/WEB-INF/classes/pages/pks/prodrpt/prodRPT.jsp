<%@ page import="com.webfin.pks.form.PKSProductionReportForm,
...
<%@ taglib prefix="c" uri="crux" %><c:frame>
    <%
    final PKSProductionReportForm f = (PKSProductionReportForm) frame.getForm();
                ...
                <table cellpadding=2 cellspacing=1>
                    ...
                    <c:evaluate when="<%=rptSelected%>" >
                        ...
                        <c:evaluate when="<%=PFL_WILAYAH%>" >
                            <c:field name="stWilayah" type="string" width="200" mandatory="false" caption="Wilayah" lov="LOV_Wilayah" loveall="true" presentation="standard" />
                        </c:evaluate>                       
