...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        <%
                    ...
                    BigDecimal premi_bruto = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|ADD=0", "61", "61"));
                    BigDecimal premi_reas = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|ADD=0", "63", "63"));
                    BigDecimal premi_kenaikan = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|ADD=0", "64", "64"));
                    BigDecimal jumlahPendapatanPremi = BDUtil.add(premi_bruto, BDUtil.add(premi_reas, premi_kenaikan));

                    BigDecimal klaim_bruto = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|NEG|ADD=1,BBU", "71", "71"));
                    BigDecimal klaim_reas = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|NEG|ADD=1,BBU", "72", "72"));
                    BigDecimal kenaikan_klaim = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|NEG|ADD=1,BBU", "75", "75"));
                    BigDecimal jumlahBebanKlaim = BDUtil.add(klaim_bruto, klaim_reas);
                    jumlahBebanKlaim = BDUtil.add(jumlahBebanKlaim, kenaikan_klaim);

                    BigDecimal beban_komisi_netto = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|NEG|ADD=BBU", "77", "77"));
                    BigDecimal beban_und_lain = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|NEG|ADD=BBU", "79", "79"));
                    ...
                    BigDecimal investasi = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|ADD=HI", "65", "65"));
                    BigDecimal beban_usaha = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|NEG|ADD=BU", "81", "83"));

                    BigDecimal pajakPenghasilan = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|ADD=4", "90", "90"));
                    BigDecimal pajakPenghasilanTangguhan = BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|ADD=4", "91", "91"));
                    ...
                    BigDecimal penghasilanBeban = BDUtil.add(BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|NEG|ADD=3", "69", "69")), BDUtil.roundUp(glr.getSummaryRangedMutation("BAL|NEG|ADD=3", "89", "89")));
...
%>
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-family="Helvetica" font-weight="bold" text-align="center" line-height="20mm">LABA RUGI HARIAN</fo:block>
