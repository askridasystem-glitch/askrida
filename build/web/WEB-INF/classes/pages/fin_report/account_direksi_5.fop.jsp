                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctFrom, acctTo, groupType, lPeriodFrom, lPeriodTo - 1, lYearFrom, lYearTo), kali), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(glr.getSummaryRangedWithGroupPolTypeOnePeriod("BAL|ADD=0", acctFrom, acctTo, groupType, lPeriodTo, lYearFrom, lYearTo), kali), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctFrom, acctTo, groupType, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo), kali), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="center" <%=style%>><%=JSPUtil.printX("")%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="start" <%=style%>><%=JSPUtil.printX(desc)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(BDUtil.add(glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctFrom, acctFrom, groupType, lPeriodFrom, lPeriodTo - 1, lYearFrom, lYearTo), glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctTo, acctTo, groupType, lPeriodFrom, lPeriodTo - 1, lYearFrom, lYearTo)), kali), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(BDUtil.add(glr.getSummaryRangedWithGroupPolTypeOnePeriod("BAL|ADD=0", acctFrom, acctFrom, groupType, lPeriodTo, lYearFrom, lYearTo), glr.getSummaryRangedWithGroupPolTypeOnePeriod("BAL|ADD=0", acctTo, acctTo, groupType, lPeriodTo, lYearFrom, lYearTo)), kali), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end"  <%=style%>><%=JSPUtil.printX(BDUtil.mul(BDUtil.add(glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctFrom, acctFrom, groupType, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo), glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctTo, acctTo, groupType, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo)), kali), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="center" <%=style%>><%=JSPUtil.printX("")%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="start" <%=style%>><%=JSPUtil.printX(desc)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(BDUtil.add(glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctFrom, acctFrom, groupType, lPeriodFrom, lPeriodTo - 1, lYearFrom, lYearTo), BDUtil.add(glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctTo, acctTo, groupType, lPeriodFrom, lPeriodTo - 1, lYearFrom, lYearTo), glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctTo2, acctTo2, groupType, lPeriodFrom, lPeriodTo - 1, lYearFrom, lYearTo))), kali), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(BDUtil.add(glr.getSummaryRangedWithGroupPolTypeOnePeriod("BAL|ADD=0", acctFrom, acctFrom, groupType, lPeriodTo, lYearFrom, lYearTo), BDUtil.add(glr.getSummaryRangedWithGroupPolTypeOnePeriod("BAL|ADD=0", acctTo, acctTo, groupType, lPeriodTo, lYearFrom, lYearTo), glr.getSummaryRangedWithGroupPolTypeOnePeriod("BAL|ADD=0", acctTo2, acctTo2, groupType, lPeriodTo, lYearFrom, lYearTo))), kali), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end"  <%=style%>><%=JSPUtil.printX(BDUtil.mul(BDUtil.add(glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctFrom, acctFrom, groupType, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo), BDUtil.add(glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctTo, acctTo, groupType, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo), glr.getSummaryRangedWithGroupPolType("BAL|ADD=0", acctTo2, acctTo2, groupType, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo))), kali), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
