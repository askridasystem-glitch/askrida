...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        <%
                    ...
                    BigDecimal laba_rugi_berjalan = BDUtil.negate(BDUtil.sub(laba_rugi_berjalan_kon, laba_rugi_berjalan_sya));
                    ...
                    BigDecimal total_laba_tahun_berjalan = BDUtil.add(laba_rugi_berjalan, kerugian_penurunan);
                ...
                <fo:table table-layout="fixed" border-style="solid" border-width="<%=bw%>">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" ><%=JSPUtil.printX(laba_rugi_berjalan, 0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" ><%=JSPUtil.printX(total_laba, 0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="2pt" border-left-style="solid"><fo:block line-height="10mm" background-color="#C0C0C0" text-align="center" font-size="10pt" font-weight="bold"><%=JSPUtil.printX(total_laba, 0)%></fo:block></fo:table-cell>
                        </fo:table-row>
