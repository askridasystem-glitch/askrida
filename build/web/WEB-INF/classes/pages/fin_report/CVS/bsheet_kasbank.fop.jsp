...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first" initial-page-number="1">
        ...
        glr.setAppDateFrom(form.getAppDateFrom());
        
        BigDecimal a1 = glr.getSummaryRanged2("BAL|ADD=1",form.getStAccountNo().substring(0,5),lPeriodFrom,lPeriodTo-1,lYearFrom,lYearTo);
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-family="Helvetica" font-weight="bold" text-align="center" >BUKU : <%=JSPUtil.printX(form.getStDescription())%> </fo:block>  
            <fo:block font-family="Helvetica" font-weight="bold" text-align="center" >Untuk Bulan : <%=JSPUtil.printX(form.getMonthTitleDescription())%></fo:block>
            ...
            <fo:block font-family="Helvetica" font-size="6pt" display-align="center" border-width="0.1pt">
                ...
                String cwx = (String) cw.get(i);
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>          
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt" ></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt" ></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt" ></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt" ></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX(a1,2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt"></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt"></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="center" font-size="6pt"><%=String.valueOf(j+1)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="center" font-size="6pt"><%=JSPUtil.printX(gli.getDtApplyDate())%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="center" font-size="6pt"><%=gli.getStTransactionNo()%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="center" font-size="6pt"><%=gli.getStAccountNo()%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block font-size="6pt" start-indent="10mm"><%=JSPUtil.xmlEscape(gli.getStDescription())%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX(gli.getDbCredit(),2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX(gli.getDbDebit(),2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX(BDUtil.add(c2, b2),2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        <% } else if (j > 0) { %>
                        <fo:table-row>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="center" font-size="6pt"><%=String.valueOf(j+1)%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX(gli.getDbCredit(),2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX(gli.getDbDebit(),2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt"><%=JSPUtil.printX(BDUtil.add(c1, c2),2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="5" border-left-style="solid"  padding="2pt"><fo:block text-align="center" font-size="6pt" font-weight="bold">SALDO <% if (form.getAppDateFrom()!=null) { %>PER : <% } %> <%=DateUtil.getDateStr(form.getAppDateFrom(),"dd ^^ yyyy")%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt" font-weight="bold"><%=JSPUtil.printX(BDUtil.add(b4, a1),2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt" font-weight="bold"><%=JSPUtil.printX(b3,2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid"  padding="2pt"><fo:block text-align="end" font-size="6pt" font-weight="bold"><%=JSPUtil.printX(BDUtil.add(c1, a1),2)%></fo:block></fo:table-cell>
                        </fo:table-row>
