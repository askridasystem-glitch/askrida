                  ...
                  <td valign=top>
                     <table cellpadding=2 cellspacing=1>
                        ...
                        <c:evaluate when="<%=hasTRX%>">
                            <c:field include="<%=enablePolicyType%>" lov="LOV_PolicyType3" width="200" name="invoice.stAttrPolicyTypeID" caption="Policy Type" changeaction="changeBranch" type="string" presentation="standard" mandatory="true" />
                           ...
                           <c:field name="invoice.stInvoiceNo" width="200" caption="TRANSACTION NO" type="string|64" presentation="standard" mandatory="true" />
                           ...
                           <%--  <c:evaluate when="<%=!custIns%>"> --%>
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <c:field width="200" caption="Customer" name="invoice.stEntityName" type="string" mandatory="true" readonly="true" />
                     ...
                     <table cellpadding=2 cellspacing=1>
                        <c:evaluate when="<%=hasTRX%>">
                           <c:evaluate when="<%=enablePolis%>">
                              ...
                              <c:field name="invoice.stRefID2" caption="Ref 2" type="string" presentation="standard" mandatory="true" />
                           </c:evaluate>
         ...
         <td>
            ...
            <c:evaluate when="<%=hasTRX && hasDetail%>">
               <c:listbox name="details">
                  <%
                     final ARInvoiceDetailView ivx = (ARInvoiceDetailView) current;
                  ...
                  <%
                     if (index.intValue()>=0) {
                        final ARInvoiceDetailView ivd = (ARInvoiceDetailView)form.getDetails().get(index.intValue());
                  %>
