...
<%@ taglib prefix="c" uri="crux" %><c:frame title="TRANSACTION" >
    ...
    <c:evaluate when="<%=!superType%>">
        <table cellpadding=2 cellspacing=1>
                        ...
                        <tr>
                            <td valign=top>
                               ...
                               <c:field name="invoice.stGLARAccountDesc" rows="2" width="200" caption="ACCOUNT" type="string" presentation="standard" readonly="true" />
                                        ...
                                        <c:field width="150" changeaction="onChangeCurrency" name="invoice.stCurrencyCode" caption="CURRENCY" type="string" presentation="standard" lov="LOV_Currency" mandatory="true" />
                                        ...
                                        <c:field width="100" caption="Quartal" lov="LOV_Triwulan" name="invoice.stAttrQuartal" type="string" mandatory="true" presentation="standard"/>
                                        <c:field width="100" caption="Tahun Quartal"  name="invoice.stAttrQuartalYear" type="string" mandatory="true" presentation="standard"/>
                                    </c:evaluate>
                                </table>
                            </td>
                            <td>
                        ...
                        <c:listbox name="details">
                            ...
                            <c:listcol title="" columnClass="detail">
                                ...
                                <c:listcol title="Policy Type">
                                    <c:field name="<%="details.[$index$].stAttrPolicyTypeID"%>" lov="LOV_PolicyTypeInward" caption="Policy Type" width="250" type="string" readonly="true" />
                                </c:listcol>
                            ...
                            <tr>
                                ...
                                <td class=row1>
                                    <c:field name="<%="details.[$index$].details.[" + i + "].stAttrPolicyTypeID"%>" lov="LOV_PolicyTypeInward" caption="Policy Type" width="250" type="string" readonly="false" />
                                </td>

                                <td class=row1>
                                    <c:field name="<%="details.[$index$].details.[" + i + "].stAttrUnderwriting"%>"  caption="U/W Year" type="string" readonly="false" />
                                </td>
                                <td class=row1>
                                    <c:field name="<%="details.[$index$].details.[" + i + "].stRefID0"%>"  lov="LOV_TreatyType" caption="Treaty" type="string" readonly="false" />
                                </td>
                                <td class=row1>
                                    <c:field name="<%="details.[$index$].details.[" + i + "].stDescription"%>" caption="Account" type="string" readonly="<%=enableFixedItem%>" />
                                </td>
            ...
            <tr>
                <td>
                    <c:button text="Recalculate" event="recalculateInwardTreaty" validate="false" />
                    <c:evaluate when="<%=hasTRX && !isApprovedMode%>">
                        <c:button text="Save" event="clickSaveInwardTreaty" validate="true" />
                    </c:evaluate>
