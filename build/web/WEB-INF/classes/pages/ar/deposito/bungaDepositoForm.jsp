                        ...
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                <c:fieldcontrol when="<%=!form.isSaveMode()%>" readonly="true">
                                    ...
                                    <c:field width="200" name="titipan.stYears" lov="LOV_GL_Years3" mandatory="true" caption="Tahun" type="string" presentation="standard"/>
                                    ...
                                    <c:evaluate when="<%=form.isSaveMode() || form.isEditMode()%>" >
