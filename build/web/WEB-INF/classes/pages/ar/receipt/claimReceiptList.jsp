...
%>
   ...
   <tr>
      <td>
         <c:button  text="Create" event="clickCreatePembayaranUangMukaKlaim" />
         <c:button  text="Edit" event="clickEditPembayaranUangMukaKlaim" />
         <c:button  text="View" event="clickViewPembayaranUangMukaKlaim" />
         <c:button  show="<%=form.isEnableSuperEdit()%>" text="Super Edit" event="clickSuperEditPembayaranUangMukaKlaim" />
         <c:button  text="Approve" event="clickApprovePembayaranUangMukaKlaim" />
      </td>
   </tr>
     <tr>
         <td>
