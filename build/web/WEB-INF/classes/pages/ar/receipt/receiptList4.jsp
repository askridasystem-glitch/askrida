...
%>
   ...
   <tr>
      <td>
         <c:button  text="Create" event="clickCreateReas" />
         <c:button  text="Edit" event="clickEditReas" />
         <c:button  text="View" event="clickViewReas" />
         <c:button  show="<%=form.isEnableSuperEdit()%>" text="Super Edit" event="clickSuperEditReas" />
         <c:button  text="Approve" event="clickApproveReas" />
      </td>
   </tr>
     <tr>
         <td>
