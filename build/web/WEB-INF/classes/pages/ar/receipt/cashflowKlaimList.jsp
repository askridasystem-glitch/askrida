<%@ page import="com.webfin.ar.forms.CashflowKlaimListForm,
                com.webfin.ar.model.ARCashflowView,
                com.crux.lang.LanguageManager"%>
<%@ taglib prefix="c" uri="crux" %><c:frame title="Cashflow Pembayaran Klaim" >

<%

   CashflowKlaimListForm form  =(CashflowKlaimListForm) request.getAttribute("FORM");
...
%>
   ...
   <table cellpadding=2 cellspacing=1>
      ...
      <tr>
         ...
         <c:listbox name="list" autofilter="true" selectable="true" paging="true" view="com.webfin.ar.model.ARCashflowView">
            <c:listcol name="stARCashflowID" title="ID" selectid="receiptID"/>
