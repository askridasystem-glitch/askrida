...
<%@ taglib prefix="c" uri="crux" %><c:frame title="SETTLEMENT" >
    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr>
            <td>
                ...
                <c:listbox name="list" autofilter="true" selectable="true" paging="true" view="com.webfin.ar.model.ARReceiptView">
                    ...
                    <c:listcol name="dtReceiptDate" title="Tanggal Bayar" />
        ...
        <tr>
            <td>
                <c:button  text="Buat" event="clickCreatePembayaranPajak" />
                <c:button  text="Ubah" event="clickEditPembayaranPajak" />
                <c:button  text="Lihat" event="clickViewPembayaranPajak" />
                <%--<c:button  show="<%=form.isEnableSuperEdit()%>" text="Super Edit" event="clickSuperEdit" />--%>
                <c:button  show="<%=form.isEnableApprove()%>" text="Setujui" event="clickApprovePembayaranPajak" />
