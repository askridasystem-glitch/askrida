      ...
      <td align=center>
         <c:evaluate when="<%=!readOnly%>" >
            <c:evaluate when="<%=phase>=3%>">
               ...
               <c:button text="Save" event="doSaveReinsurance" validate="true" confirm="Do you want to save ?" />
            </c:evaluate>
         ...
         <c:button text="Approve" event="doApproveReinsurance" confirm="Do you want to approve ?" />
