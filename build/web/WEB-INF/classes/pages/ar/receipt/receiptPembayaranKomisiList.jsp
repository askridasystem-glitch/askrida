...
<%@ taglib prefix="c" uri="crux" %><c:frame title="SETTLEMENT" >
    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr>
            <td>
                <c:button  text="Buat" event="clickCreatePembayaranKomisi" />
                <c:button  text="Ubah" event="clickEditPembayaranKomisi" />
                <c:button  text="Lihat" event="clickViewPembayaranKomisi" />
                <%--<c:button  show="<%=form.isEnableSuperEdit()%>" text="Super Edit" event="clickSuperEdit" />--%>
                <c:button  show="<%=form.isEnableApprove()%>" text="Setujui" event="clickApprovePembayaranKomisi" />
                <c:button  show="<%=form.isEnableSuperEdit()%>" text="Reverse" event="clickReverse" />
                <%--<c:button  text="Proses Data BFEE FOX" event="clickCreatePembayaranBrokerfeeFoxpro2" />
         <c:button  text="Proses Data Komisi Foxpro" event="clickCreatePembayaranKomisiFoxpro2" />--%>
