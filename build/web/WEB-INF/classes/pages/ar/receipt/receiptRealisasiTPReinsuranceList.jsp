...
<%@ taglib prefix="c" uri="crux" %><c:frame title="SETTLEMENT" >
    ...
    <table cellpadding=2 cellspacing=1>
            ...
            <td>
                ...
                <c:listbox name="list" autofilter="true" selectable="true" paging="true" view="com.webfin.ar.model.ARReceiptView">
                    ...
                    <c:listcol filterable="true" name="stReceiptNo" title="No Bukti" />
                     <c:listcol filterable="true" name="stReceiptNo2" title="No Bukti Realisasi" />
        ...
        <tr>
            <td>
                <c:button  text="Buat" event="clickCreateTPReinsurance" />
                <c:button  text="Ubah" event="clickEditTPReinsurance" />
                <c:button  text="Lihat" event="clickViewTPReinsurance" />
                <%--<c:button  show="<%=form.isEnableSuperEdit()%>" text="Super Edit" event="clickSuperEdit" />--%>
                <c:button  show="<%=form.isEnableApprovePolisKhusus()%>" text="Setujui" event="clickApproveTPReinsurance" />
                <c:button  show="<%=form.isEnableApprovePolisKhusus()%>" text="Reverse" event="clickReverseTPReinsurance" />
