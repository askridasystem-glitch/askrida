    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr>
            <td>
                ...
                <c:listbox name="listReadOnly" autofilter="true" selectable="true" paging="true" view="com.webfin.ar.model.ARReceiptView">
...
<script>
   ...
   function dynPrintClickExcel() {
      ...
      if (true) {
         frmx.src='x.fpc?EVENT=AR_RECEIPT_EXCEL&receiptid='+f.receiptID.value+'&settlement=38';
         return;
      }
   }
