...
com.webfin.ar.model.ARInvoiceView"%><html><% final JSPUtil jspUtil = new JSPUtil(request, response); %>
    ...
    <body>
        <form name=f method=POST action="ctl.ctl">
            <input type=hidden name=EVENT value="AR_RECEIPT_SEARCH_CLAIM">
            ...
            <table cellpadding=2 cellspacing=1>
                <tr>
                    <td>
                        <%=jspUtil.getHeader2("SEARCH INVOICE")%>
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        ARInvoiceView iv = (ARInvoiceView) list.get(i);
                            ...
                            <tr class=row<%=i%2%>>
                                ...
                                <td><%=jspUtil.print(iv.getStDLANo())%></td>
                                ...
                                <td><%=jspUtil.printX(iv.getStClaimNo())%></td>
                                <td><%=jspUtil.printX(iv.getStReference3())%></td>
                                <td><%=jspUtil.printX(iv.getStReference4())%></td>
                            </tr>
                            <% } %>
                        </table>
                    </td>
