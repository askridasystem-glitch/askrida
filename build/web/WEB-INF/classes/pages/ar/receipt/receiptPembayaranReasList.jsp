   ...
   <table cellpadding=2 cellspacing=1>
                  ...
                  <td>
                     <table cellpadding=2 cellspacing=1>
                        <tr>
                           ...
                           <c:field caption="{L-ENGShow Pending only-L}{L-INAData Belum Disetujui-L} " name="stNotApproved" type="check" presentation="standard" changeaction="btnSearch" />
                        </tr>
                     </table>
                  </td>
      ...
      <tr>
         ...
         <c:listbox name="list" autofilter="true" selectable="true" paging="true" view="com.webfin.ar.model.ARReceiptView">
            ...
            <c:listcol filterable="true" name="stReceiptNo" title="Receipt No" />
            ...
            <c:listcol filterable="true" name="stCostCenterCode" title="Branch" />
            <c:listcol filterable="true" name="stShortDescription" title="Description" />
            <c:listcol name="dbEnteredAmount" align="right" title="Amount" />
         </c:listbox>
      </td>
   </tr>
   <tr>
      <td>
         <c:button  text="Buat" event="clickCreateReas" />
         <c:button  text="Ubah" event="clickEditReas" />
         <c:button  text="Lihat" event="clickViewReas" />
         <c:button  show="<%=form.isEnableSuperEdit()%>" text="Reverse" event="clickReverseReas" />
         <%--<c:button  show="<%=form.isEnableSuperEdit()%>" text="Super Edit" event="clickSuperEditReas" />--%>
         <c:button  show="<%=form.isEnableApprove()%>" text="Setujui" event="clickApproveReas" />
      </td>
   </tr>
     <tr>
            <td>
