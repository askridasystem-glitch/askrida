...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block-container height="7cm" width="2cm" top="0cm" left="13cm" position="absolute">
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="5"><fo:block font-weight="bold">IDR <%=JSPUtil.printX(tagihBruto2,2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="5"><fo:block font-weight="bold"># <%=NumberSpell.readNumber(JSPUtil.printX(tagihBruto2,2))%> RUPIAH #</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>{L-ENG Date : -L}{L-INA Tgl : -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="start"><%=DateUtil.getDateStr(tglpol,"dd ^^ yyyy")%></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block-container height="1cm" width="14cm" top="6.5cm" left="0cm" padding="1mm" position="absolute">
            ...
            <fo:block-container height="7cm" width="6cm" top="6cm" left="13cm" padding="1mm" position="absolute">
            ...
            <fo:block-container height="2cm" width="10cm" top="9cm" left="0cm" padding="1mm" position="absolute">                
