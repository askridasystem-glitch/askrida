                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-body>   
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")) {
                                            ...
                                            IDRBfee = BDUtil.add(IDRBfee, invoic.getDbBfeeEntered());
                                            IDRReco = BDUtil.add(IDRReco, invoic.getDbRecoEntered());
                                            ...
                                            nonIDRBfee = BDUtil.add(nonIDRBfee, invoic.getDbBfeeEntered());
                                            nonIDRReco = BDUtil.add(nonIDRReco, invoic.getDbRecoEntered());
                                            nonIDRNetto = BDUtil.sub(nonIDRPremi, BDUtil.add(nonIDRComm, nonIDRClaim));
                                            nonIDRNetto = BDUtil.sub(nonIDRNetto, nonIDRBfee);
                                            nonIDRNetto = BDUtil.add(nonIDRNetto, nonIDRReco);
                                        }
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(invoic.getDbBfeeEntered(), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(invoic.getDbRecoEntered(), 2)%></fo:block></fo:table-cell>
                        ...
                        <%
                                        ...
                                        if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")) {
                                            ...
                                            jumlahIDRBfee = BDUtil.add(jumlahIDRBfee, invoic.getDbBfeeEntered());
                                            jumlahIDRReco = BDUtil.add(jumlahIDRReco, invoic.getDbRecoEntered());
                                            ...
                                            jumlahnonIDRBfee = BDUtil.add(jumlahnonIDRBfee, invoic.getDbBfeeEntered());
                                            jumlahnonIDRReco = BDUtil.add(jumlahnonIDRReco, invoic.getDbRecoEntered());
