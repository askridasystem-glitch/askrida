            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Customer-L}{L-INA Tertanggung-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block space-after.optimum="10pt"><%=JSPUtil.xmlEscape(pol.getStAttrPolicyName())%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell >
                                <fo:block space-after.optimum="2pt"><%=JSPUtil.xmlEscape(pol.getStDescription())%></fo:block>
                                <fo:block space-after.optimum="2pt">Pembayaran Klaim Inward <%=pol.getStPolicyTypeDesc().getStDescription()%> - <%=pol.getStRefID0()%></fo:block>
                                <fo:block space-after.optimum="10pt">DOL: <%=DateUtil.getDateStr(pol.getDtReference2(), "d ^^ yyyy")%></fo:block>
                            </fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Invoice No.-L}{L-INA No. Bukti-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block space-after.optimum="10pt"><%= JSPUtil.printX(pol.getStInvoiceNo())%></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="10pt">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell >
                                <fo:block>Jakarta, <%=DateUtil.getDateStr(new Date(), "dd ^^ yyyy")%></fo:block>
                                ...
                                <fo:block text-align="end">
                                    <fo:instream-foreign-object>
                                        <barcode:barcode
                                            ...
                                            message="<%=JSPUtil.printX(pol.getStDLANo())%>" orientation="0">
                                            <barcode:datamatrix> 
