                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>          
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="9">
                                <fo:block font-weight="bold" text-align="center" font-size="10pt">
                                    <% if (form.getDepoDateFrom()!=null || form.getDepoDateTo()!=null) {%> 
                                    Tanggal Deposito : <%=DateUtil.getDateStr(form.getDepoDateFrom(),"dd ^^ yyyy")%> s/d <%=DateUtil.getDateStr(form.getDepoDateTo(),"dd ^^ yyyy")%>
                                    <% } %>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>   
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="5" border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm" font-weight="bold">SUB-TOTAL</fo:block></fo:table-cell>
                        ...
                        <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(keterangan)%></fo:block></fo:table-cell>  </fo:table-row>			
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="5" border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm" font-weight="bold">TOTAL</fo:block></fo:table-cell>
