...
%>
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-family="Helvetica" font-weight="bold" text-align="center">MONITORING PEMBAYARAN (PL 2)</fo:block>
            <fo:block font-family="Helvetica" font-weight="bold" text-align="center" line-height="20mm">Original Currency</fo:block>
                        ...
                        <%
                                    ...
                                    for (int j = 0; j < line.size(); j++) {
                                        ...
                                        for (int k = 0; k < arInvoiceDetail.size(); k++) {
                                            ...
                                            BigDecimal amount = detil.getDbEnteredAmount();
