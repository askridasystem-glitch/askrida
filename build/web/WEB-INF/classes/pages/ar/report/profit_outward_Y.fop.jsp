                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>          
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="14" >
                                <fo:block font-weight="bold">             
                                    LAPORAN PER REASURADUR PREMI REASURANSI PROFIT COMMISSION OUTWARD
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center">Ad Premi</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="center">Less Premi</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>   
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")){
                                ...
                                IDRClaim = BDUtil.add(IDRClaim, invoic.getDbProfitCommEntered());
                                ...
                                nonIDRClaim = BDUtil.add(nonIDRClaim, invoic.getDbProfitCommEntered());
...
--%>    
                        ...
                        if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")){
                                ...
                                jumlahIDRClaim = BDUtil.add(jumlahIDRClaim, invoic.getDbProfitCommEntered());
                                ...
                                jumlahnonIDRClaim = BDUtil.add(jumlahnonIDRClaim, invoic.getDbProfitCommEntered());
