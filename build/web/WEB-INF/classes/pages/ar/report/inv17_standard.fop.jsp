    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">                 
            ...
            <fo:block font-size="16pt" line-height="16pt" color="black" text-align="center" space-after.optimum="5pt">
                <%if(pol.isDLA()){%>DEFINITE INWARD CLAIM <%}else{%> PRELIMINARY INWARD CLAIM <%}%>
            </fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>Facultative</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block space-after.optimum="10pt">100% Claim of Facultative</fo:block></fo:table-cell>             
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
