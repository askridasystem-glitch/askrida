                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")) {
                                            ...
                                            IDRClaim = BDUtil.add(IDRClaim, invoic.getDbClaimEntered());
                                            IDRProfitComm = BDUtil.add(IDRProfitComm, invoic.getDbProfitCommEntered());
                                            IDRFee = BDUtil.add(IDRFee, invoic.getDbFeeEntered());
                                        } else {
                                            nonIDRPremi = BDUtil.add(nonIDRPremi, invoic.getDbPremiEntered());
                                            nonIDRComm = BDUtil.add(nonIDRComm, invoic.getDbCommEntered());
                                            nonIDRClaim = BDUtil.add(nonIDRClaim, invoic.getDbClaimEntered());
                                            nonIDRProfitComm = BDUtil.add(nonIDRProfitComm, invoic.getDbProfitCommEntered());
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(invoic.getDbProfitCommEntered(), 2)%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(invoic.getDbClaimEntered(), 2)%></fo:block></fo:table-cell>
                        ...
                        <%
                                        ...
                                        if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")) {
                                            ...
                                            jumlahIDRClaim = BDUtil.add(jumlahIDRClaim, invoic.getDbClaimEntered());
                                            jumlahIDRProfitComm = BDUtil.add(jumlahIDRProfitComm, invoic.getDbProfitCommEntered());
                                            jumlahIDRFee = BDUtil.add(jumlahIDRFee, invoic.getDbFeeEntered());
                                        } else {
                                            ...
                                            jumlahnonIDRClaim = BDUtil.add(jumlahnonIDRClaim, invoic.getDbClaimEntered());
                                            jumlahnonIDRProfitComm = BDUtil.add(jumlahnonIDRProfitComm, invoic.getDbProfitCommEntered());
