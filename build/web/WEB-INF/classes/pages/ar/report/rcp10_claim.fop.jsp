                        ...
                        for(int j=0;j<line.size();j++){
                            ...
                            if (view.getStAdvancePaymentFlag()!=null) {
                                ...
                                for (int k = 0; k < arInvoiceDetail.size(); k++) {
                                    ...
                                    if(detil.isClaimGross()||detil.isSparepart()||detil.isJBengkel()||detil.isWreck()||detil.isTowingCost()
                                    ||detil.isEXGratia()||detil.isEXGratiaUW()||detil.isIntPayment()||detil.isTJH()) {
