                ...
                <fo:table table-layout="fixed" border-style="solid" border-width="<%=bw%>" >
                    <fo:table-header>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="<%=bw2%>" border-bottom-style="solid" padding="1pt" border-left-style="solid"><fo:block line-height="6mm" text-align="center" font-size="10pt" >Keterangan</fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw2%>" border-bottom-style="solid" padding="1pt" border-left-style="solid" border-right-style="solid"><fo:block line-height="6mm" text-align="center" font-size="10pt" >Nama Bank</fo:block></fo:table-cell>
                        </fo:table-row>
                        
                    </fo:table-header>
                    <%=FOPUtil.printColumnWidth(colW2,38,1,"cm")%>
                    <fo:table-body>    
                        ...
                        <fo:table-row>
                            ...
                            <% } %>
                            <fo:table-cell border-width="<%=bw2%>" padding="2pt"><fo:block text-align="center" font-size="8pt"><%=JSPUtil.printX(receipt2.getDtReceiptDate())%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw2%>" padding="2pt"><fo:block text-align="start" font-size="6pt"><%=JSPUtil.xmlEscape(view2.getStDescription())%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw2%>" border-bottom-style="solid" padding="2pt" number-columns-spanned="3"><fo:block text-align="end" font-size="8pt" ></fo:block></fo:table-cell>
                        </fo:table-row>
