            ...
            <fo:block font-family="Helvetica" font-size="6pt" display-align="center" border-width="0.1pt">
                ...
                <fo:table table-layout="fixed" border-style="solid" border-width="<%=bw%>" >
                    ...
                    <fo:table-body>    
                        ...
                        <fo:table-row>
                            <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="2pt" number-columns-spanned="4"><fo:block text-align="center" font-size="8pt" >JUMLAH</fo:block></fo:table-cell>
