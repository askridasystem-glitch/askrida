                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>          
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center">{L-ENG Treaty -L}{L-INA Treaty -L}</fo:block></fo:table-cell>  
                            ...
                            <fo:table-cell ><fo:block text-align="center">{L-ENG Brokerage -L}{L-INA Brokerage -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="center">{L-ENG Recoveries -L}{L-INA Recoveries -L}</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>   
                        ...
                        <%
                                    ...
                                    BigDecimal jumlahIDRBfee = null;
                                    BigDecimal jumlahIDRReco = null;
                                    ...
                                    BigDecimal jumlahnonIDRBfee = null;
                                    BigDecimal jumlahnonIDRReco = null;
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        Netto = BDUtil.sub(invoic.getDbPremi(), invoic.getDbComm());
                                        Netto = BDUtil.sub(Netto, invoic.getDbFee());
                                        Netto = BDUtil.sub(Netto, invoic.getDbBfee());
                                        Netto = BDUtil.add(Netto, invoic.getDbReco());
                                        ...
                                        if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")) {
                                            ...
                                            IDRBfee = BDUtil.add(IDRBfee, invoic.getDbBfee());
                                            IDRReco = BDUtil.add(IDRReco, invoic.getDbReco());
                                            IDRNetto = BDUtil.sub(IDRPremi, BDUtil.add(IDRComm, IDRClaim));
                                            IDRNetto = BDUtil.sub(IDRNetto, IDRBfee);
                                            IDRNetto = BDUtil.add(IDRNetto, IDRReco);
                                        } else {
                                            ...
                                            nonIDRBfee = BDUtil.add(nonIDRBfee, invoic.getDbBfee());
                                            nonIDRReco = BDUtil.add(nonIDRReco, invoic.getDbReco());
                                            nonIDRNetto = BDUtil.sub(nonIDRPremi, BDUtil.add(nonIDRComm, nonIDRClaim));
                                            nonIDRNetto = BDUtil.sub(nonIDRNetto, nonIDRBfee);
                                            nonIDRNetto = BDUtil.add(nonIDRNetto, IDRReco);
                                        }
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(jumlahIDRBfee, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(jumlahIDRReco, 2)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="9"><fo:block text-align="center"></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(jumlahnonIDRBfee, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(jumlahnonIDRReco, 2)%></fo:block></fo:table-cell>
                        ...
                        <%
                                                            ...
                                                            jumlahnonIDRBfee = null;
                                                            jumlahnonIDRReco = null;
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center">TW.<%=JSPUtil.printX(invoic.getStAttrQuartal())%>/<%=JSPUtil.printX(invoic.getStAttrQuartalYear())%></fo:block></fo:table-cell> 
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(invoic.getDbBfee(), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(invoic.getDbReco(), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(Netto, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%= JSPUtil.printX(new BigDecimal(0), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(Netto, 2)%></fo:block></fo:table-cell>
                        ...
                        <%
                                        ...
                                        if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")) {
                                            ...
                                            jumlahIDRClaim = BDUtil.add(jumlahIDRClaim, invoic.getDbFee());
                                            jumlahIDRBfee = BDUtil.add(jumlahIDRBfee, invoic.getDbBfee());
                                            jumlahIDRReco = BDUtil.add(jumlahIDRReco, invoic.getDbReco());
                                            jumlahIDRNetto = BDUtil.sub(jumlahIDRPremi, BDUtil.add(jumlahIDRComm, jumlahIDRClaim));
                                            jumlahIDRNetto = BDUtil.sub(jumlahIDRNetto, jumlahIDRBfee);
                                            jumlahIDRNetto = BDUtil.add(jumlahIDRNetto, jumlahIDRReco);
                                        } else {
                                            ...
                                            jumlahnonIDRClaim = BDUtil.add(jumlahnonIDRClaim, invoic.getDbFee());
                                            jumlahnonIDRBfee = BDUtil.add(jumlahnonIDRBfee, invoic.getDbBfee());
                                            jumlahnonIDRReco = BDUtil.add(jumlahnonIDRReco, invoic.getDbReco());
                                            jumlahnonIDRNetto = BDUtil.sub(jumlahnonIDRPremi, BDUtil.add(jumlahnonIDRComm, jumlahnonIDRClaim));
                                            jumlahnonIDRNetto = BDUtil.sub(jumlahnonIDRNetto, jumlahnonIDRBfee);
                                            jumlahnonIDRNetto = BDUtil.add(jumlahnonIDRNetto, jumlahnonIDRReco);
                                        }
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(IDRBfee, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(IDRReco, 2)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(nonIDRBfee, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(nonIDRReco, 2)%></fo:block></fo:table-cell>
