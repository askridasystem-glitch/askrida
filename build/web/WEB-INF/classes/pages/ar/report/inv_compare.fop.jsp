                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>          
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">{L-ENG Description -L}{L-INA Keterangan -L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Bukti D</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Tanggal Bunga</fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm">Angka</fo:block></fo:table-cell> 
                        </fo:table-row>    
                    ...
                    <fo:table-body>   
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            t[n] = BDUtil.add(t[n++], depo.getDbAngka());
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(angka,2)%></fo:block></fo:table-cell>
                        </fo:table-row>  
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm" font-size="6pt"><%=JSPUtil.printX(depo.getStNodefo())%></fo:block></fo:table-cell> 
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm" font-size="6pt"><%=JSPUtil.printX(depo.getStBankName())%></fo:block></fo:table-cell> 
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(keterangan)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(depo.getStBuktiD())%></fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(depo.getDtTglBunga())%></fo:block></fo:table-cell> 
                            <% if (depo.getStBuktiD()!=null) { %>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(depo.getDbAngka(),2)%></fo:block></fo:table-cell>  
                            <% } else { %>
                        ...
                        angka   = BDUtil.add(angka,depo.getDbAngka());
                        } %>   
