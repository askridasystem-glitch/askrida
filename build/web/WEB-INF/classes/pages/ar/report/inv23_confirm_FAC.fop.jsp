    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">                 
            ...
            <fo:block font-size="10pt">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block text-align="start">Nomor : <%=JSPUtil.xmlEscape(pol.getStClaimNo())%></fo:block></fo:table-cell>
            ...
            <fo:block font-size="10pt" line-height="10pt" text-align="center" space-after.optimum="10pt">
                <fo:inline font-weight="bold">Perihal : Konfirmasi Klaim <%=pol.getPolicyType().getStDescription()%> - Facultatif</fo:inline>
            </fo:block>
