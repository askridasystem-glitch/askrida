                ...
                <fo:table table-layout="fixed" border-style="solid" >
                    <fo:table-header>
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-bottom-style="solid" padding="1pt"  border-left-style="solid"><fo:block line-height="6mm"  text-align="center" font-size="10pt" >No Rekap</fo:block></fo:table-cell>
                        </fo:table-row>
                    </fo:table-header>
                    
                    <%=FOPUtil.printColumnWidth(colW,19,2,"cm")%>
                    <fo:table-body>    
                         ...
                         */
                            ...
                            for (int l = 0; l < arInvoiceView.size(); l++) {
                                ...
                                for (int m = 0; m < insPolicyView.size(); m++) {
                                    ...
                                    noRekap1 = insPol.getStReference3();
                                    noRekap3 = insPol.getStReference4();
                        ...
                        coinsurer = obj.getStReference8();
                        if (coinsurer.equalsIgnoreCase("94")) {
                        noRekap1 = insPol.getParentPolicy().getStReference3();
                        } else {
                        noRekap1 = insPol.getParentPolicy().getStReference4();
                        }
                        } else {
                        noRekap1 = insPol.getParentPolicy().getStReference3();
                        }
                         ...
                         */
                                ...
                                if (coinsurer!=null) {
                                    ...
                                    /*
                                    if (coinsurer.equalsIgnoreCase("96")) {
                                        if(noRekap1!=null){
                                            noRekap = noRekap1;
                                        }else if(noRekap1==null){
                                            noRekap = noRekap3;
                        ...
                        %>
                        <fo:table-row>
                            <fo:table-cell padding="2pt" border-left-style="solid"><fo:block line-height="6mm" text-align="center" font-size="8pt"><%=j+1%>.</fo:block></fo:table-cell>
                            <fo:table-cell padding="2pt" border-left-style="solid"><fo:block line-height="6mm" text-align="center" font-size="8pt"><%=JSPUtil.printX(no_lkp)%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell padding="2pt" border-left-style="solid"><fo:block line-height="6mm" text-align="start" font-size="7pt"><%=JSPUtil.printX(name)%></fo:block></fo:table-cell>
                            <fo:table-cell padding="2pt" border-left-style="solid"><fo:block line-height="6mm" text-align="end" font-size="8pt"><%=JSPUtil.printX(claimGrossTotal,2)%></fo:block></fo:table-cell>
                            <fo:table-cell padding="2pt" border-left-style="solid"><fo:block line-height="6mm" text-align="center" font-size="5pt"><%=JSPUtil.printX(noRekap)%></fo:block></fo:table-cell>
                        </fo:table-row  >
                        <%
                        }
                        %> 
                        ...
                        <fo:table-row  >
                            ...
                            <fo:table-cell border-bottom-style="solid" padding="2pt"><fo:block text-align="end" font-size="8pt" font-weight="bold"><%=JSPUtil.printX(claimGrossJumlah,2)%></fo:block></fo:table-cell>
