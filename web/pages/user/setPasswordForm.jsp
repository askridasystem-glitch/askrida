   ...
   <tr>
      <td>
         <table cellpadding=2 cellspacing=1>
            ...
            <c:field width="200" name="stPasswdConfirm" mandatory="true" caption="Retype-Password" type="password" presentation="standard" />
         </table>
      </td>
   </tr>
   <tr>
      <td align=center>
         <c:button text="Submit"  event="doSave" validate="true"  />
