            ...
            <tr>
                ...
                <td>
                    <table cellpadding=2 cellspacing=1>
                        ...
                        <%--<c:field name="ref1" caption="{L-ENGBranch-L}{L-INACabang-L}" width="200" lov="LOV_CostCenter" type="string" presentation="standard" readonly="<%=f.getRef1()!=null%>" changeaction="select_comission" />
                        --%>
                    </table>
                </td>
            </tr>
