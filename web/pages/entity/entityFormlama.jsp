...
<%@ taglib prefix="c" uri="crux" %><c:frame title="EntityForm" >
<%
         ...
         <table cellpadding=2 cellspacing=1>
            <tr>
               <td>
                  ...
                  <c:field lov="LOV_Branch" mandatory="true" readonly="<%=ent.getStCostCenterCode()!=null%>" changeaction="onChangeBranch" name="entity.stCostCenterCode" caption="Branch Author" type="string|32"  presentation="standard" />
                  ...
                  <c:field lov="LOV_CustomerClass" mandatory="true" changeaction="onClassChange"  name="entity.stEntityClass" caption="Customer Class" type="string|32"  presentation="standard" />
                  <c:field lov="LOV_CustCategory1" mandatory="true" name="entity.stCategory1" caption="Category" type="string"  presentation="standard" />
                  ...
                  <c:field lov="VS_ENT_CUST_STATUS" name="entity.stCustomerStatus" caption="Customer Status" type="string|255"  presentation="standard" />
                  ...
                  <c:field name="entity.stShortName" mandatory="true" caption="Short Name" width="200" type="string|128"  presentation="standard"/>
