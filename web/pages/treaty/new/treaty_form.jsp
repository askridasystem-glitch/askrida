<%@ page import="com.webfin.master.treaty.form.TreatyMasterForm,
...
<%
   TreatyMasterForm form = (TreatyMasterForm) request.getAttribute("FORM");

   boolean policyTypeSelected = form.getStPolicyTypeID()!=null;

   InsuranceTreatyView tre = form.getTre();
   
   boolean enableEdit = form.isEnableEdit();

   boolean enableApprove = form.isEnableApprove();
   ...
   <c:evaluate when="<%=policyTypeSelected%>" >
         ...
         <td>
            <table cellpadding=2 cellspacing=1>
               <tr>
                  <td>
                     <table cellpadding=2 cellspacing=1>
                        <c:field name="tre.stInsuranceTreatyID" caption="Treaty ID" type="string" presentation="standard" readonly="true" show="<%=tre.getStInsuranceTreatyID()!=null%>" />
                        ...
                        <c:field name="tre.stTreatyName" width="200" caption="Name" type="string" presentation="standard" readonly="false" />
                        <c:field name="tre.stProportionalFlag" caption="Proportional" type="check" presentation="standard" readonly="false" />
                        <c:field name="tre.stRetrocessionFlag" caption="Retrocession" type="check" presentation="standard" readonly="false" />
                     </table>
                  </td>
                  <td>
                     <table cellpadding=2 cellspacing=1>
                        <c:field name="tre.dtTreatyPeriodStart" caption="Period Start" type="date" presentation="standard" readonly="false" />
                        <c:field name="tre.dtTreatyPeriodEnd" caption="Period End" type="date" presentation="standard" readonly="false" />
                        <c:field name="tre.dbTreatyPriority" caption="Priority" type="money5.0" presentation="standard" readonly="false" />

                                                
                        <c:field name="tre.stActiveFlag" caption="Active" type="check" presentation="standard" readonly="true" />
                        <c:field name="tre.stReference1" caption="Reference 1" type="string" presentation="standard" readonly="false" />
                        <c:field popuplov="true" lov="LOV_COMPANYGROUP" width="250" mandatory="true" name="tre.stCompanyGroupID" caption="{L-ENGCompany Group-L}{L-INAGrup Perusahaan-L}" type="string|255"  presentation="standard" />
                       <%-- <c:field popuplov="true" lov="LOV_RiskCategory2" width="250" mandatory="true" name="tre.stInsuranceRiskCategoryCode" caption="Kode Resiko" type="string|255"  presentation="standard" />--%>
                     </table>
                  </td>
                  <td>
                      <table cellpadding=2 cellspacing=1>
                          <c:field name="tre.stApprovedFlag1" caption="Approval Operator" type="check" presentation="standard" readonly="true" />
                        <c:field name="tre.stApprovedFlag2" caption="Approval Kepala Bagian" type="check" presentation="standard" readonly="true" />
                        <c:field name="tre.stApprovedFlag3" caption="Approval Kepala Divisi" type="check" presentation="standard" readonly="true" />
                        <c:field name="tre.stApprovedFlag4" caption="Aktivasi TI" type="check" presentation="standard" readonly="true" />
         ...
         <td>
            ...
            <c:evaluate when="<%=!form.isDrillMode()%>" >
               <c:listbox name="details" paging="true" >
                  ...
                  <c:listcol title="Drill" ><c:button text="Members" event="drillToggle" clientEvent="<%="f.detailIndex.value="+index%>" /></c:listcol>
                  <c:listcol title="Treaty Type" ><c:field width="150" name="details.[$index$].stTreatyTypeID" type="string" caption="Treaty Type" lov="LOV_TreatyType" /></c:listcol>
                  <c:listcol title="Treaty Limit" ><c:field width="150" name="details.[$index$].dbTreatyLimit" type="money16.2" caption="Treaty Limit" /></c:listcol>
      ...
      <tr>
         <td align=center>           
            ...
            <c:button show="<%=enableApprove%>" text="Setujui" event="save" />
