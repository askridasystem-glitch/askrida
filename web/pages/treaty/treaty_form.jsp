                  ...
                  <td rowspan="4" valign="top">
                      <table cellpadding=2 cellspacing=1>
                          <c:field name="tre.stReference1" caption="Reference 1" type="string" presentation="standard" readonly="false" />
                            ...
                            <c:field lov="VS_MAIPARK_ZONE" width="250" mandatory="false" name="tre.stEarthquakeZone" caption="Zona Gempa" type="string|255"  presentation="standard" />
                      </table>
                  </td>
               </tr>
            </table>
         ...
         <td>
            ...
            <c:evaluate when="<%=!form.isDrillMode()%>" >
               <c:listbox name="details" paging="true" >
                  ...
                  <c:listcol title="Treaty Type" ><c:field width="150" name="details.[$index$].stTreatyTypeID" type="string" caption="Treaty Type" lov="LOV_TreatyType" mandatory="true" /></c:listcol>
