...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        <%
                    ...
                    DTOList ftl = FlexTableManager.getInstance().getFlexTable4("RKAPADM", form.getYearFrom());
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < ftl.size(); i++) {
                                        ...
                                        if (isATOT) {
                                            ...
                                            a831424 = BDUtil.add(BDUtil.roundUp(glr.getSummaryRanged("BAL|ADD=0", "8314", "8314", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo)), BDUtil.roundUp(glr.getSummaryRanged("BAL|ADD=0", "8324", "8324", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo)));
                        ...
                        <%
                                                                ...
                                                                if (isATOT5) {
                                                                    ...
                                                                    BigDecimal amt3 = BDUtil.roundUp(glr.getSummaryRanged("BAL|ADD=0", acctFrom, acctTo, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
