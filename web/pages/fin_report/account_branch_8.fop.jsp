...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        <%
                    ...
                    DTOList ftl = FlexTableManager.getInstance().getFlexTable2("RKAPUW");
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < ftl.size(); i++) {
                                        ...
                                        if (isATOT) {
                                            atot1 = BDUtil.roundUp(BDUtil.add(glr.getSummaryRangedBranch("BAL|ADD=0", "61", "64", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo), glr.getSummaryRangedBranch("BAL|ADD=0", "71", "79", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo)));
                                        }
                        ...
                        <%
                                                                ...
                                                                if (isAAAC) {
                                                                    ...
                                                                    BigDecimal amt1 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", acctFrom, acctFrom, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                                                    BigDecimal amt2 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", acctTo, acctTo, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.sub(rkap, amount), 0)%></fo:block></fo:table-cell>--%>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(amount, 0)%></fo:block></fo:table-cell>
                        </fo:table-row>
