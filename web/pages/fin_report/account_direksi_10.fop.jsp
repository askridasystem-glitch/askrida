...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        <%
                    ...
                    DTOList ftl = FlexTableManager.getInstance().getFlexTable4("RKAPPEM", form.getYearFrom());
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < ftl.size(); i++) {
                                        ...
                                        if (isATOT) {
                                            ...
                                            A8116 = BDUtil.roundUp(glr.getSummaryRanged("BAL|ADD=0", "8116", "8116", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
