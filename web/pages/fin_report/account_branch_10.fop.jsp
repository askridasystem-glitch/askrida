                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    BigDecimal A8116 = new BigDecimal(0);
                                    ...
                                    for (int i = 0; i < ftl.size(); i++) {
                                        ...
                                        if (isATOT) {
                                            A8111 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "8111", "8111", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A8112 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "8112", "8112", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A8113 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "8113", "8113", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A8114 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "8114", "8114", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A81190 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "81190", "81193", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A8190 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "8190", "8190", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A8191 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "8191", "8191", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A8116 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "8116", "8116", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            ...
                                            promosi = BDUtil.add(promosi, A8116);
                                        }
                        ...
                        <%
                                                                ...
                                                                if (isATOT1) {
                                                                    ...
                                                                    BigDecimal amt3 = new BigDecimal(0);
                                                                    if (negative) {
                                                                        amt3 = BDUtil.sub(amt3, promosi);
                                                                    } else {
                                                                        amt3 = BDUtil.add(amt3, BDUtil.mul(promosi, kali));
                                                                    }
                                                                    ...
                                                                    BigDecimal amount = BDUtil.mul(promosi, kali);
                        ...
                        <%
                                                                ...
                                                                if (isATOT2) {
                                                                    ...
                                                                    BigDecimal amt3 = new BigDecimal(0);
                                                                    if (negative) {
                                                                        amt3 = BDUtil.sub(amt3, sarana);
                                                                    } else {
                                                                        amt3 = BDUtil.add(amt3, BDUtil.mul(sarana, kali));
                                                                    }
                                                                    ...
                                                                    BigDecimal amount = BDUtil.mul(sarana, kali);
