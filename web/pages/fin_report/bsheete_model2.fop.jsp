...
<% if (form.isClAccNo()) {%><fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="2pt"><fo:block line-height="10mm"  background-color="#C0C0C0"  text-align="center" font-size="10pt" font-weight="bold">ACCOUNT</fo:block></fo:table-cell><% }%>
          ...
          <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="2pt"><fo:block line-height="10mm"  background-color="#C0C0C0"  text-align="center" font-size="10pt" font-weight="bold">SALDO DB</fo:block></fo:table-cell>
          <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="2pt"><fo:block line-height="10mm"  background-color="#C0C0C0"  text-align="center" font-size="10pt" font-weight="bold">SALDO CR</fo:block></fo:table-cell>
        </fo:table-row>
...
<%
   ...
   for (int i = 0; i < ftl.size(); i++) {
      ...
      if (isACTD) {
         ...
         DTOList glInfos = glr.getGLInfo(flg+"|BAL|DB|COLSET=1",acctFrom,acctTo,lPeriodFrom,lPeriodTo,lYearFrom,lYearTo);
         DTOList glInfos1 = glr.getGLInfo(flg+"|BAL|CR|COLSET=2",acctFrom,acctTo,lPeriodFrom,lPeriodTo,lYearFrom,lYearTo);
      ...
      %>
        <fo:table-row>
          ...
          <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style1%>><%=JSPUtil.printX(glr.getSummaryRanged("BAL|DB|ADD=TOT1,TOT2,TOT3,TOT4,TOT5|COLSET=1",acctFrom,acctTo,lPeriodFrom,lPeriodTo,lYearFrom,lYearTo),2)%></fo:block></fo:table-cell>
          <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style1%>><%=JSPUtil.printX(glr.getSummaryRanged("BAL|CR|ADD=TOT1,TOT2,TOT3,TOT4,TOT5|COLSET=2",acctFrom,acctTo,lPeriodFrom,lPeriodTo,lYearFrom,lYearTo),2)%></fo:block></fo:table-cell>
        </fo:table-row>
      <%
      }
