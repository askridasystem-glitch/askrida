...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        <%
                    ...
                    DTOList ftl = FlexTableManager.getInstance().getFlexTable3("RKAPUW", form.getPeriodTo(), form.getYearFrom());
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    BigDecimal A61Sya = new BigDecimal(0);
                                    BigDecimal A63Sya = new BigDecimal(0);
                                    BigDecimal A664Sya = new BigDecimal(0);
                                    BigDecimal A665Sya = new BigDecimal(0);
                                    BigDecimal A640Sya = new BigDecimal(0);
                                    BigDecimal A650Sya = new BigDecimal(0);
                                    BigDecimal A717Sya = new BigDecimal(0);
                                    BigDecimal A724Sya = new BigDecimal(0);
                                    BigDecimal A751Sya = new BigDecimal(0);
                                    BigDecimal A752Sya = new BigDecimal(0);
                                    BigDecimal A771Sya = new BigDecimal(0);
                                    ...
                                    for (int i = 0; i < ftl.size(); i++) {
                                        ...
                                        boolean isAAAC = "AAAC".equalsIgnoreCase(opCode);
                                        ...
                                        if (isATOT) {
                                            atot1 = BDUtil.add(BDUtil.roundUp(glr.getSummaryRanged("BAL|ADD=0", "61", "64", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo)), BDUtil.roundUp(glr.getSummaryRanged("BAL|ADD=0", "71", "79", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo)));

                                            A61Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "61", "61", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A63Sya = BDUtil.roundUp(glr.getSummaryRangedExcludedSyariah("BAL|ADD=0", "63", "63", "638", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));

                                            A664Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "664", "664", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A665Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "665", "665", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));

                                            A640Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "640", "640", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A650Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "650", "650", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));

                                            A717Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "717", "717", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A724Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "724", "724", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));

                                            A751Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "751", "751", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A752Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "752", "752", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A771Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "7711", "7712", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                        ...
                        <%
                                                             ...
                                                             if (isAAAC) {
                                                                 ...
                                                                 BigDecimal amt1 = BDUtil.roundUp(glr.getSummaryRanged("BAL|ADD=0", acctFrom, acctFrom, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                                                 BigDecimal amt2 = BDUtil.roundUp(glr.getSummaryRanged("BAL|ADD=0", acctTo, acctTo, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));

                                                                 BigDecimal amount = BDUtil.mul(BDUtil.add(amt1, amt2), kali);
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.sub(rkapsya, amount), 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(BDUtil.div(amount, rkap), new BigDecimal(100)), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <%
                                                             ...
                                                             if (isATOT1) {
                                                                 ...
                                                                 BigDecimal retensi = BDUtil.sub(A61Sya, A63Sya);
                                                                 BigDecimal cadangan = BDUtil.sub(A665Sya, A664Sya);
                                                                 BigDecimal cad_premi = BDUtil.add(retensi, cadangan);

                                                                 BigDecimal diterima = BDUtil.sub(A640Sya, A650Sya);
                                                                 diterima = BDUtil.sub(A771Sya, diterima);
                                                                 BigDecimal klaim = BDUtil.sub(A717Sya, A724Sya);
                                                                 BigDecimal penurunan = BDUtil.sub(A751Sya, A752Sya);

                                                                 BigDecimal cad_klaim = BDUtil.add(diterima, klaim);
                                                                 cad_klaim = BDUtil.add(cad_klaim, penurunan);

                                                                 BigDecimal total = BDUtil.sub(cad_premi, cad_klaim);

                                                                 BigDecimal amt3 = BDUtil.add(amount, total);
                        %>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.sub(rkapsya, amt3), 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(BDUtil.div(amt3, rkapsya), new BigDecimal(100)), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <%
                                                             ...
                                                             if (isATOT2) {
                                                                 ...
                                                                 BigDecimal amt3 = BDUtil.add(amount, A61Sya);
                        %>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(amt3, 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.sub(rkapsya, amt3), 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(BDUtil.div(amt3, rkap), new BigDecimal(100)), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <%
                                                             ...
                                                             if (isATOT3) {
                                                                 ...
                                                                 BigDecimal amt3 = BDUtil.sub(A61Sya, A63Sya);
                                                                 amt3 = BDUtil.add(amt3, amount);
                        %>
                        ...
                        <%
                                                             ...
                                                             if (isATOT4) {
                                                                 ...
                                                                 BigDecimal amt3 = BDUtil.sub(A665Sya, A664Sya);
                                                                 amt3 = BDUtil.sub(amount, amt3);
                        %>
                        ...
                        <%
                                                             ...
                                                             if (isATOT5) {
                                                                 ...
                                                                 BigDecimal retensi = BDUtil.sub(A61Sya, A63Sya);
                                                                 BigDecimal cadangan = BDUtil.sub(A665Sya, A664Sya);
                                                                 BigDecimal amt3 = BDUtil.add(retensi, cadangan);
                                                                 amt3 = BDUtil.add(amount, amt3);
                        %>
                        ...
                        <%
                                                             ...
                                                             if (isATOT6) {
                                                                 ...
                                                                 BigDecimal amt3 = BDUtil.sub(A640Sya, A650Sya);
                                                                 amt3 = BDUtil.add(amount, amt3);
                        %>
                        ...
                        <%
                                                             ...
                                                             if (isATOT7) {
                                                                 ...
                                                                 BigDecimal diterima = BDUtil.sub(A640Sya, A650Sya);
                                                                 BigDecimal amt3 = BDUtil.sub(A771Sya, diterima);
                                                                 amt3 = BDUtil.add(amount, amt3);
                        %>
                        ...
                        <%
                                                             ...
                                                             if (isATOT8) {
                                                                 ...
                                                                 BigDecimal klaim = BDUtil.sub(A717Sya, A724Sya);
                                                                 BigDecimal amt3 = BDUtil.add(amount, klaim);
                        %>
                        ...
                        <%
                                                             ...
                                                             if (isATOT9) {
                                                                 ...
                                                                 BigDecimal penurunan = BDUtil.sub(A751Sya, A752Sya);
                                                                 BigDecimal amt3 = BDUtil.add(amount, penurunan);
                        %>
                        ...
                        <%
                                                             ...
                                                             if (isATOT10) {
                                                                 ...
                                                                 BigDecimal total = BDUtil.add(diterima, klaim);
                                                                 total = BDUtil.add(total, penurunan);
                        ...
                        <%
                                                             ...
                                                             if (isATOT11) {
                                                                 ...
                                                                 BigDecimal amt3 = BDUtil.add(amount, A771Sya);
                        %>
