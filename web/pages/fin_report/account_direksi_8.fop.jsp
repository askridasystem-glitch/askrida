...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        <%
                    ...
                    DTOList ftl = FlexTableManager.getInstance().getFlexTable4("RKAPUW", form.getYearFrom());
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < ftl.size(); i++) {
                                        ...
                                        if (isATOT) {
                                            atot1 = BDUtil.roundUp(BDUtil.add(glr.getSummaryRanged("BAL|ADD=0", "61", "64", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo), glr.getSummaryRanged("BAL|ADD=0", "71", "79", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo)));
                                        }
