...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        <%
                    ...
                    DTOList ftl = FlexTableManager.getInstance().getFlexTable3("RKAPIN", form.getPeriodTo(), form.getYearFrom());
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    BigDecimal A6580 = new BigDecimal(0);
                                    ...
                                    BigDecimal A6511Sya = new BigDecimal(0);
                                    BigDecimal A6512Sya = new BigDecimal(0);
                                    BigDecimal A6551Sya = new BigDecimal(0);
                                    BigDecimal A6580Sya = new BigDecimal(0);
                                    ...
                                    for (int i = 0; i < ftl.size(); i++) {
                                        ...
                                        if (isATOT) {
                                            ...
                                            A6580 = BDUtil.roundUp(glr.getSummaryRanged("BAL|ADD=0", "6580", "6580", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            ...
                                            A6511Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "6511", "6511", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A6580Sya = BDUtil.roundUp(glr.getSummaryRangedSyariah("BAL|ADD=0", "6580", "6580", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));

                                            jumlah = BDUtil.add(deposito, A6570);
                                            jumlah = BDUtil.add(jumlah, A6580);
                                            ...
                                            jumlah = BDUtil.sub(jumlah, A6511Sya);
                                            jumlah = BDUtil.sub(jumlah, A6580Sya);
                        ...
                        <%
                                                                ...
                                                                if (isACTT) {
                                                                    ...
                                                                    if (negative) {
                                                                        sisa3 = BDUtil.add(rkapsya, amt3);
                                                                    } else {
                                                                        sisa3 = BDUtil.sub(rkapsya, amt3);
                                                                    }
                        ...
                        <%
                                                                ...
                                                                if (isATOT1) {
                                                                    ...
                                                                    BigDecimal amt3 = BDUtil.sub(deposito, amtsya);
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="start" <%=style%>><%=JSPUtil.printX(desc)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(rkapsya)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(amt3, kali), 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.sub(rkapsya, BDUtil.mul(amt3, kali)), 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(pct)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <%
                                                                ...
                                                                if (isATOT2) {
                                                                    ...
                                                                    BigDecimal amt3 = BDUtil.add(obligasi, amtsya);
                                                                    ...
                                                                    String amt = JSPUtil.printX(BDUtil.mul(amt3, kali), 0);
                                                                    if (negative) {
                                                                        amt = "(" + amt + ")";
                                                                    }

                                                                    String amount = JSPUtil.printX(BDUtil.add(rkapsya, BDUtil.mul(amt3, kali)), 0);
                                                                    //if (negative) {
                                                                    //    amt3 = "(" + amt3 + ")";
                                                                    //}
                        %>
                        ...
                        <%
                                                                ...
                                                                if (isATOT3) {
                                                                    ...
                                                                    //amt3 = BDUtil.add(amt3, jumlah);

                                                                    BigDecimal pct3 = BDUtil.div(BDUtil.mul(jumlah, kali), rkapsya, 5);
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.sub(rkapsya, BDUtil.mul(jumlah, kali)), 0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(pct)%></fo:block></fo:table-cell>
                        </fo:table-row>                        
