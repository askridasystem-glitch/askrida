...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        <%
                    ...
                    DTOList ftl = FlexTableManager.getInstance().getFlexTable2("RKAPIN");
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < ftl.size(); i++) {
                                        ...
                                        if (isATOT) {
                                            A651112 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "65111", "65112", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A6561 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "6561", "6561", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A6543 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "6543", "6543", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A6531 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "6531", "6531", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A6545 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "6545", "6545", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));

                                            A6570 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "6570", "6570", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A658 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "658", "658", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A6590 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "6590", "6590", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A651213 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "6512", "6513", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A65122 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "65122", "65122", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                            A6551 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", "6551", "6551", lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                        ...
                        <%
                                                                ...
                                                                if (isACTT) {
                                                                    ...
                                                                    BigDecimal amt1 = BDUtil.roundUp(glr.getSummaryRangedBranch("BAL|ADD=0", acctFrom, acctTo, lPeriodFrom, lPeriodTo, lYearFrom, lYearTo));
                                                                    BigDecimal amt3 = new BigDecimal(0);
                                                                    ...
                                                                    String sisa = JSPUtil.printX(sisa4, 2);
                                                                    if (BDUtil.lesserThanZero(sisa3)) {
                                                                        sisa = "(" + sisa + ")";
                                                                    }
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(deposito, kali), 0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <%
                                                                ...
                                                                if (isATOT2) {
                                                                    ...
                                                                    String amt3 = JSPUtil.printX(BDUtil.add(rkap, BDUtil.mul(obligasi, kali)), 0);
                                                                    //if (negative) {
                                                                    //    amt3 = "(" + amt3 + ")";
                                                                    //}
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" <%=style%>><%=JSPUtil.printX(BDUtil.mul(jumlah, kali), 0)%></fo:block></fo:table-cell>
                        </fo:table-row>                        
                        ...
                        <%
                                                                ...
                                                                if (isATOT4) {
                                                                    ...
                                                                    String amt3 = JSPUtil.printX(BDUtil.add(rkap, BDUtil.mul(reksadana, kali)), 0);
                                                                    //if (negative) {
                                                                    //    amt3 = "(" + amt3 + ")";
                                                                    //}
