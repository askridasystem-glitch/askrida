    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr>
            <td>
                ...
                <c:listbox name="listSubrogasi" selectable="true" paging="true" view="com.webfin.insurance.model.UploadSubrogasiHeaderView" autofilter="true">
        ...
        <tr>
            <td>       
                <c:button show="true" text="Buat" event="clickCreateSubrogasi" />
                <c:button show="true" text="Ubah" event="clickEditSubrogasi" />
                <c:button text="Lihat" event="clickViewSubrogasi" />
                <c:button show="true" text="Setujui" event="clickApprovalSubrogasi" />
                <c:button show="true" text="Proses Subrogasi" event="processSubrogasi" confirm="Yakin ingin diproses subrogasi ?" />
            </td> 
        </tr>
    </table>
