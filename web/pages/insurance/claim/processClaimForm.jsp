    ...
    <table cellpadding=2 cellspacing=1>
                            ...
                            <table cellpadding=2 cellspacing=1>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        &nbsp;<c:button show="true" text="Konversi" event="btnUploadExcelProcessKlaim"/> 
                        ...
                        <td>
                            ...
                            <table>
                                ...
                                <c:listbox name="details"  paging="true" >
                                    ...
                                    <c:listcol title="Biaya Survey" >
                                        <c:field name="details.[$index$].dbSurveyCostAmount" width="150" caption="Survey" mandatory="true" type="money16.2" readonly="false" />
                                    </c:listcol>
                                    <c:listcol title="PPN" >
                                        <c:field name="details.[$index$].dbPPNAmount" width="150" caption="Survey" mandatory="true" type="money16.2" readonly="false" />
                                    </c:listcol>
                                    <c:listcol title="Catatan Survey" >
                                        <c:field name="details.[$index$].stSurveyNotes" width="250" caption="Approved" mandatory="false" type="string" readonly="false" />
                                    </c:listcol>
                                    <c:listcol title="Surveyor" >
                                        <c:field name="details.[$index$].stSurveyorEntID" lov="LOV_EntityOnly" popuplov="true" width="180" caption="Approved" mandatory="false" type="string" readonly="false" />
                                    </c:listcol>
                                    ...
                                    <c:listcol title="Approved By" >
                                        <c:field name="details.[$index$].stApprovedWho" lov="LOV_User" width="180" caption="Approved" mandatory="false" type="string" readonly="false" />
                                    </c:listcol>
                                    <c:listcol title="Jenis Proses" >
                                        <c:field name="details.[$index$].stProcessType" width="150" caption="Proses" mandatory="true" type="string" readonly="true" />
                                    </c:listcol>
                                    <c:listcol title="Catatan Tolak" >
                                        <c:field name="details.[$index$].stRejectNotes" width="250" caption="Tolak" mandatory="false" type="string" readonly="false" />
                                    </c:listcol>
                                </c:listbox>
                            </table>
        ...
        <tr>
            <td align=center>
                    ...
                    <c:button show="<%=!form.isApproveMode() && !form.isViewMode()%>" text="Hitung Ulang" event="recalculateProcess" validate="true" />
                    <c:button show="<%=!form.isApproveMode() && !form.isViewMode()%>" text="Simpan" event="doSaveProcess" validate="true" confirm="Do you want to save ?" />
                    <c:button show="<%=form.isApproveMode()%>" text="{L-ENGApprove-L}{L-INASetujui-L}" event="doApproveProcess" confirm="Yakin ingin di setujui" validate="true"/>
