    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr>
            <td>
                ...
                <c:listbox name="list" selectable="true" paging="true" view="com.webfin.insurance.model.UploadClaimHeaderView" autofilter="true">
        ...
        <tr>
            <td>
                ...
                <c:button show="<%=form.isCanApprove()%>" text="Proses Klaim" event="createClaimPLAByNoRecap" confirm="Yakin ingin diproses ?" />
            </td> 
        </tr>
    </table>
