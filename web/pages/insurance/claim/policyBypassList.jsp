...
<%@ taglib prefix="c" uri="crux" %><c:frame title="Bypass Validasi Klaim" >
    <%
    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr>
            <td>
               ...
               <c:button show="<%=form.isEnableInputBypassValidasi()%>"  text="Bypass Validasi Klaim" event="clickEditBypassValidasiKlaim" />
               <c:button show="true"  text="{L-ENGView-L}{L-INALihat-L}" event="clickViewBypassValidasi" />
