...
java.util.Date,
com.webfin.insurance.form.ProductionClaimReportForm"%><?xml version="1.0" encoding="utf-8"?>
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="13pt" line-height="12pt" text-align="center">{L-ENG Preliminary Loss Advice R/I Causes-L}{L-INA Register Klaim Sementara Reasuransi per Kejadian-L}</fo:block>
            ...
            <fo:block font-size="7pt" line-height="8pt" >
                ...
                a.prod_name,j.treaty_type,a.create_who,i.claim_amount,m.cause_desc
                from ins_policy a
                ...
                inner join ins_clm_cause m on m.ins_clm_caus_id = a.claim_cause
                ...
                where a.status IN ('CLAIM') and a.effective_flag = 'Y' 
                ...
                */
                ...
                " a.insured_amount as tsi_polis,i.tsi_amount,i.premi_amount,m.cause_desc,"+
                ...
                12,
                new int [] {3,5,8,10,8,8,8,8,8,4,10,6},
                30,
                "cm"
                ) {
                ...
                case 8: return h.getFieldValueByFieldNameST("cause_desc");
                case 9: return h.getFieldValueByFieldNameST("treaty_type");
                case 10: return h.getFieldValueByFieldNameST("prod_name");
                case 11: return h.getFieldValueByFieldNameST("create_who");
                }
                return "?";
                }
