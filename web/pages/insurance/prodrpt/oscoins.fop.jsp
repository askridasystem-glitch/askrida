                ...
                <fo:table table-layout="fixed">  
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="8">
                                <fo:block font-family="serif" font-weight="bold" font-size="20pt" text-align="center">             
                                    LAPORAN OUTSTANDING KOASURANSI
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>      
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center">SUBTOTAL</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbReference2(),0)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>   
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center">TOTAL</fo:block></fo:table-cell>
