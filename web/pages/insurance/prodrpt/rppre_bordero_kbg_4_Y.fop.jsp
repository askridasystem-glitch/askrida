                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>    
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            int n = 0;
                            t[n] = BDUtil.add(t[n++], BDUtil.mul(pol.getDbPremiNetto(), pol.getDbCurrencyRate()));
                            t[n] = BDUtil.add(t[n++], BDUtil.mul(pol.getDbNDComm1(), pol.getDbCurrencyRate()));
                            t[n] = BDUtil.add(t[n++], pol.getDbPremiBase());
                            
                            totalNETTO = BDUtil.sub(pol.getDbPremiNetto(), pol.getDbNDComm1());
                            t[n] = BDUtil.add(t[n++], BDUtil.mul(totalNETTO, pol.getDbCurrencyRate()));
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block text-align="start">: <%=JSPUtil.printX(bordero)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block text-align="start">: <%= DateUtil.getDateStr(form.getPolicyDateTo(), "^^ yyyy")%></fo:block></fo:table-cell>
                        </fo:table-row>
                        
                        <fo:table-row>
                            <fo:table-cell ><fo:block text-align="start">{L-ENG CLASS OF BUSINESS -L}{L-INA JENIS POLIS -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="start">: MARINE CARGO
                            </fo:block></fo:table-cell>
                        </fo:table-row>
                        
                        <fo:table-row>
                            <fo:table-cell ><fo:block text-align="start">{L-ENG REMARKS -L}{L-INA KETERANGAN -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="start">: WPC 30 days after bordereaux date</fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="12pt">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>    
                        ...
                        <fo:table-row>
                            <fo:table-cell ></fo:table-cell>  
                            <fo:table-cell ><fo:block text-align="start">{L-ENG R/I Comm -L}{L-INA Komisi -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="start">:</fo:block></fo:table-cell>
