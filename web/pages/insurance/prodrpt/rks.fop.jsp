        ...
        <fo:flow flow-name="xsl-region-body"> 
            ...
            <fo:block font-size="8pt"> 
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-column column-width="60mm"/><!-- Name of Insured --> 
                    ...
                    <fo:table-header>   
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="10">
                                <fo:block font-family="serif" font-weight="bold" font-size="20pt" text-align="center">             
                                    {L-ENG PLA (Preliminary Loss Advice)-L}{L-INA LKS (Laporan Klaim Sementara)-L}
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center">{L-ENG PLA Date -L}{L-INA Tanggal LKS -L}</fo:block></fo:table-cell><!-- Entry Date --> 
                            ...
                            <fo:table-cell ><fo:block text-align="center">{L-ENG Object -L}{L-INA Objek -L}</fo:block></fo:table-cell><!-- Total Sum Insured --> 
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>   
                            ...
                            <% if(pol.getDtPLADate()!=null) {%>             
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(pol.getDtPLADate())%></fo:block></fo:table-cell>    <!-- No --><!-- Entry Date -->
                            <% } %>
