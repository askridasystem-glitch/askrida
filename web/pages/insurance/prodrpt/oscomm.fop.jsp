                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header> 
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="14">
                                <fo:block font-family="serif" font-weight="bold" font-size="16pt" text-align="center">
                                    ...
                                    Tanggal Produksi : <%=JSPUtil.printX(form.getPolicyDateFrom())%> S/D <%=JSPUtil.printX(form.getPolicyDateTo())%>
                                    <% } %>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="17">
                                <fo:block font-weight="bold">
                                    Cabang : <%=JSPUtil.printX(form.getCostCenter(form.getStBranch()).getStDescription())%>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        <% } %>
                        ...
                        <fo:table-row>  
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Adm. Cost -L}{L-INA Biapol-L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Stamp Fee -L}{L-INA Biamat-L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Tag. Bruto -L}{L-INA Tag. Bruto-L}</fo:block></fo:table-cell>  
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Total Comm-L}{L-INA Komisi-L}</fo:block></fo:table-cell>  
                            ...
                            <fo:table-cell border-left-style="solid" border-right-style="solid" padding="2pt"><fo:block text-align="center">{L-ENG O/S Comm-L}{L-INA Hutang Komisi-L}</fo:block></fo:table-cell>  	
                        </fo:table-row>   
                    ...
                    <fo:table-body>      
                        ...
                        BigDecimal subTotalTabrut = null;
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            TotalComm = BDUtil.add(pol.getDbNDComm1(),pol.getDbNDComm2());
                            TotalComm = BDUtil.add(TotalComm, pol.getDbNDBrok1());
                            TotalComm = BDUtil.add(TotalComm, pol.getDbNDHFee());
                            t[n] = BDUtil.add(t[n++], TotalComm); //total tagihan komisi
                            
                            TotalTax = BDUtil.add(pol.getDbNDTaxComm1(), pol.getDbNDTaxComm2());
                            TotalTax = BDUtil.add(TotalTax, pol.getDbNDTaxBrok1());
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalPremi,0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalBPol,0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalBMat,0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalTabrut,0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalFeeBase,0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalDisc,0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(subTotalComm,subTotalTaxComm),0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalTaxComm,0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalNetto,0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(subTotalOutsComm,0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        subTotalTabrut 	= BDUtil.add(subTotalTabrut,TotalPremiBruto);
                        subTotalDisc 	= BDUtil.add(subTotalDisc,pol.getDbNDDisc1());
                        subTotalComm 	= BDUtil.add(subTotalComm,TotalComm);
                        subTotalTaxComm	= BDUtil.add(subTotalTaxComm,TotalTax);
                        subTotalNetto 	= BDUtil.add(subTotalNetto,TotalPremiNetto);
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[0],0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[1],0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[2],0)%>  </fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[8],0)%></fo:block></fo:table-cell> 
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[3],0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[4],0)%></fo:block></fo:table-cell>
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(t[6], t[7]),0)%></fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[7],0)%></fo:block></fo:table-cell>   
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[9],0)%></fo:block></fo:table-cell>    
                            <fo:table-cell border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[10],0)%></fo:block></fo:table-cell>  
                        </fo:table-row>   
