        ...
        <fo:flow flow-name="xsl-region-body"> 
            ...
            <fo:block font-size="8pt"> 
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-column column-width="46mm"/><!-- The Insured -->
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(TotalComm,0)%></fo:block></fo:table-cell>    <!-- No --><!-- HFee 1 --> 
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getStProducerID())%></fo:block></fo:table-cell>    <!-- No --><!-- Broker 1 --> 
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getStCreateWho())%></fo:block></fo:table-cell>    <!-- No --><!-- Broker 1 --> 
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(t[9],0)%></fo:block></fo:table-cell><!-- Total Disc --> 
                            <fo:table-cell ></fo:table-cell>    
                            <fo:table-cell ></fo:table-cell> 
                        </fo:table-row>   
