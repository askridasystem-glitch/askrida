...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="13pt" line-height="12pt" text-align="center">{L-ENG Register of Premium List per Cover-L}{L-INA Register Produksi Premi per Cover-L}</fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG Cover Type -L}{L-INA Cover Type -L}</fo:block></fo:table-cell>
