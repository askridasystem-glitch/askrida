        ...
        <fo:table table-layout="fixed">  
         ...
         <fo:table-body>   
           <fo:table-row>   
             ...
             <fo:table-cell ><fo:block text-align="center">{L-ENG Create Date-L}{L-INA Tgl. Entry-L}</fo:block></fo:table-cell>  
             <fo:table-cell ><fo:block text-align="center">{L-ENG Policy ID-L}{L-INA ID Polis-L}</fo:block></fo:table-cell>  
             ...
             <fo:table-cell ><fo:block text-align="center">{L-ENG Post Code -L}{L-INA Kode Pos -L}</fo:block></fo:table-cell>  
             <fo:table-cell ><fo:block text-align="center">{L-ENG Entity ID-L}{L-INA Kode Agen-L}</fo:block></fo:table-cell>  
             ...
             <fo:table-cell ><fo:block text-align="center">{L-ENG Policy Type-L}{L-INA Jenis Ass-L}</fo:block></fo:table-cell>  
             ...
             <fo:table-cell><fo:block text-align ="center">Paid Premi </fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">AP Comis </fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">AP Comis P </fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">AP Brok </fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">AP Brok P </fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Obj Ref1</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Obj Ref2</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Obj Ref3</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Obj Ref4</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Obj Ref5</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Obj Ref6</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Obj Ref7</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Risk Code</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Risk Location</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Risk Card No</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Obj Insured Amt</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Obj Premi Amt</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Obj Claim Amt</fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="center">Ratio</fo:block></fo:table-cell>
...
%>   
            <fo:table-row>   
             ...
             <fo:table-cell ><fo:block><%=JSPUtil.printX(pol.getDtCreateDate())%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block><%=JSPUtil.printX(pol.getStPolicyID())%></fo:block></fo:table-cell>
             ...
             <fo:table-cell ><fo:block><%=DateUtil.getDateStr(pol.getDtPeriodStart())%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block><%=DateUtil.getDateStr(pol.getDtPeriodEnd())%></fo:block></fo:table-cell>
             ...
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getStObjectDescription())%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDPremiRate1(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDPremiRate2(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDPremiRate3(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDPremiRate4(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDPremi1(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDPremi2(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDPremi3(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDPremi4(),2)%></fo:block></fo:table-cell>
             ...
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDDisc1Pct(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDDisc1(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDDisc2Pct(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDDisc2(),2)%></fo:block></fo:table-cell>
             ...
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDHFeePct(),2)%></fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="end"><%=JSPUtil.printX(pol.getDbNDHFee(),2)%></fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getDbPremiPaid(),2)%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getDbAPComis(),2)%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getDbAPComisP(),2)%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getDbAPBrok(),2)%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getDbAPBrokP(),2)%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getAttribute("obj_ref1"))%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getAttribute("obj_ref2"))%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getAttribute("obj_ref3"))%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getAttribute("obj_ref4"))%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getAttribute("obj_ref5"))%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getAttribute("obj_ref6"))%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getAttribute("obj_ref7"))%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getAttribute("riskcode"))%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getAttribute("risk_location"))%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="end"><%=JSPUtil.printX(pol.getAttribute("riskcardno"))%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="end"><%=JSPUtil.printX(pol.getDbAttribute("obj_insured_amount"),2)%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="end"><%=JSPUtil.printX(pol.getDbAttribute("obj_premi_total"),2)%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="end"><%=JSPUtil.printX(pol.getDbAttribute("obj_claim_amount"),2)%> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align ="end"><%=JSPUtil.printX(BDUtil.getPctFromRate(BDUtil.div(pol.getDbAttribute("obj_claim_amount"),pol.getDbAttribute("obj_premi_total"))),2)%> </fo:block></fo:table-cell>
