                ...
                <fo:table table-layout="fixed"> 
                    ...
                    <fo:table-body> 
                        ...
                        while (regit.hasNext()) {
                            ...
                            {final Iterator it = custcategory.getIterator();
                             while (it.hasNext()) {
                                 ...
                                 final InsurancePolicyView vpol = (InsurancePolicyView)amountMap.get(kode+"/"+cod);
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            jml_inward = pol.getDbPremiBase();
                            
                            if (jml_inward==null) jml_inward=BDUtil.zero;
                        ...
                        <fo:table-row> 
                            ...
                            %> 
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.add((BigDecimal) tot, jml_inward),0)%></fo:block></fo:table-cell> 
                            
                            <% }} %> 
                            
                            
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.add((BigDecimal) tot_jumlah, jml_inward),0)%></fo:block></fo:table-cell> 
                        </fo:table-row> 
                        --%>
                        <!-- GARIS DALAM KOLOM --> 
                        ...
                        <fo:table-row> 
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell> 
                            <fo:table-cell ><fo:block>TOTAL</fo:block></fo:table-cell> 
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.add((BigDecimal) tot,(BigDecimal) jml_inward),0)%></fo:block></fo:table-cell> 
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell> 
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell> 
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell> 
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX((BigDecimal) jml_inward,0)%></fo:block></fo:table-cell> 
