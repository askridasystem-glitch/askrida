...
%>
   <table border=1 cellpadding=2 cellspacing=1>
      <tr>
         <td>
            Print Report<c:field width="150" name="stPrintForm" type="string" lov="VS_PROD_PRINTING" readonly="<%=!f.isEnableSelectForm()%>"  changeaction="chgform" /> in <c:field name="stLang" type="string" lov="LOV_LANG" />
            <br>
            <br>
         </td>
      </tr>
                  ...
                  <c:field width="450" caption="Report" changeaction="onChangeReport" lov="LOV_MARKETINGREPORT" name="stReport"  descfield="stReportDesc" type="string" presentation="standard" >
            ...
            <td>
               <table border=1 cellpadding=2 cellspacing=1>
                  ...
                  <c:evaluate when="<%=PFL_ENTRY_DATE%>" >
                     <tr>
                        ...
                        <td>
                           ...
                           To <c:field name="entryDateTo" type="date" caption="Entry Date To" />
                        </td>
                     </tr>
                  </c:evaluate>
                  ...
                  <c:evaluate when="<%=PFL_POLICY_CLASS%>" >
                     <c:field width="300" changeaction="onChangePolicyTypeGroup" lov="LOV_PolicyTypeGroup" caption="Policy Class" name="stPolicyTypeGroupID" type="string" mandatory="<%=PFM_POLICY_CLASS%>" presentation="standard" loveall="true"/>
