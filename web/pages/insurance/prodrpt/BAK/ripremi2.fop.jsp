...
%>
  ...
  <fo:page-sequence master-reference="only" initial-page-number="1">
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="12pt" line-height="12pt" text-align="center">xxReinsurance Premium for  <%=form.getStPolicyTypeID()==null?"ALL":form.getStPolicyTypeDesc()%> policy type</fo:block>
...
<%
   ...
   sqa.addSelect(
           "f.pol_no, coalesce(d.short_name, d.ent_name) as ent_name, a.premi_amount, a.ricomm_amt as comission, a.premi_amount-ricomm_amt as netto"); 
   sqa.addQuery( 
           "   from ins_pol_ri a\n" + 
   ...
   String q =
           "select pol_no, ent_name, sum(premi_amount) as premi_amount, sum(comission) as comission, sum(netto) as netto from (" + 
           sqa.getSQL()+
