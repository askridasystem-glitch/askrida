  ...
  <fo:page-sequence master-reference="only" initial-page-number="1">
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="18pt" line-height="16pt" space-after.optimum="2pt"
            ...
            text-align="center"
            padding-top="10pt">
       {L-ENG Expired Date Report (per Category)-L}{L-INA Laporan Polis Jatuh Tempo (per Kategori)-L}
      </fo:block>
      ...
      <fo:block font-size="18pt" line-height="16pt" space-after.optimum="2pt"
            ...
            text-align="center"
            padding-top="10pt">
         From : <%=JSPUtil.printX(form.getExpirePeriodFrom())%>{L-ENG up to-L}{L-INA s/d-L} <%=JSPUtil.printX(form.getExpirePeriodTo())%>
      </fo:block>
      ...
      <fo:block font-size="10pt">
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
            ...
            <fo:table-row>
             <fo:table-cell ><fo:block>{L-ENG Category-L}{L-INA Kategori -L}</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block><%=JSPUtil.printX(form.getStCustCategory1Desc())%></fo:block></fo:table-cell>
           </fo:table-row>
        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
           <fo:table-row>
             ...
             <fo:table-cell ><fo:block text-align="center">{L-ENG Total Tax-L}{L-INA Jumlah Pajak-L}</fo:block></fo:table-cell>
...
%>
            <fo:table-row>
             ...
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalItemAmount("HFEE"),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalItemAmount("BROKR"),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTotalItemAmount("BROKR"),2)%></fo:block></fo:table-cell>


             <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbPremiNetto(),2)%></fo:block></fo:table-cell>
             <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(pol.getStProducerID())%></fo:block></fo:table-cell>
