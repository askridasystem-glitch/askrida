...
ref-id="end-of-document"/>
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="13pt" line-height="12pt" text-align="center">{L-ENG R/I Coverage Premium-L}{L-INA Premi Reas Per Cover-L}</fo:block>
...
/*
select a.policy_date,a.pol_no,k.ent_name as reasuradur,m.insured_amount,m.premi,l.group_name,a.prod_name,n.description,m.cover_category,j.treaty_type
from ins_policy a
...
inner join ins_pol_cover_ri m on m.ins_pol_ri_id = i.ins_pol_ri_id
inner join ins_cover n on n.ins_cover_id = m.ins_cover_id
...
*/
   ...
   sqa.addSelect(
           " a.policy_date,a.pol_no,k.ent_name,m.insured_amount,m.premi,a.insured_amount as tsi_polis,"+
           " l.group_name,a.prod_name,n.description,m.cover_category,j.treaty_type,a.create_who ");   
    sqa.addQuery(
           "   from ins_policy a"+
			"	left join ent_master b on b.ent_id = a.entity_id"+
			"	inner join ins_pol_obj c on c.pol_id=a.pol_id"+
   ...
   tot.setFieldValueByFieldName("premi", r.getTotal("premi"));
   ...
   final FOPTableSource fopTableSource = new FOPTableSource(
           11,
           new int [] {3,5,8,8,10,8,8,8,4,10,6},
           27,
           "cm"
   ) {
      ...
      public Object getColumnValue(int rowNo, int columnNo) {
         ...
         switch(columnNo) {
            ...
            case 3: return h.getFieldValueByFieldNameBD("tsi_polis");
            case 4: return h.getFieldValueByFieldNameST("ent_name");
            case 5: return h.getFieldValueByFieldNameBD("insured_amount");
            case 6: return h.getFieldValueByFieldNameBD("premi");
            case 7: return h.getFieldValueByFieldNameST("description");
            case 8: return h.getFieldValueByFieldNameST("cover_category");
