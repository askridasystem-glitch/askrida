                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-body>      
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            outstandingPremi = BDUtil.sub(pol.getDbTotalDue(), pol.getDbPremiPaid());
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(t[10],t[11]),0)%></fo:block></fo:table-cell>
