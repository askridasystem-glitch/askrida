                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="11"></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Name of Principal</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Vessel Name</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Period Start</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Period End</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Total Sum Insured</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Kurs</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Reinsurance Share</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Reinsurance Premium</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">Commission</fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm">Net Premium</fo:block></fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(totalTSI, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="2" border-width="0.5pt" border-left-style="solid"></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(totalTSIREAS, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(totalPREMI_RI, 2)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(pol.getStReference7())%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(pol.getDbCurrencyRate(), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbTsiReas(), 2)%></fo:block></fo:table-cell>
                        ...
                        <%
                                        totalTSI = BDUtil.add(totalTSI, pol.getDbInsuredAmount());
                                        totalTSIREAS = BDUtil.add(totalTSIREAS, pol.getDbTsiReas());
                                        totalPREMI = BDUtil.add(totalPREMI, pol.getDbPremiTotal());
                                        totalPREMI_RI = BDUtil.add(totalPREMI_RI, pol.getDbPremiNetto());
                                        totalKOMISI = BDUtil.add(totalKOMISI, pol.getDbNDComm1());
                                        totalNETTO = BDUtil.add(totalNETTO, pol.getDbPremiBase());
                                    }%>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="13">
                                <fo:block border-width="0.15pt" border-style="solid" line-height="0.15pt"></fo:block>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(t[4], 2)%></fo:block></fo:table-cell>
                        </fo:table-row> 
