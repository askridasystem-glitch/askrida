                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block font-family="tahoma" font-weight="bold"><%=DateUtil.getDateStr(form.getPolicyDateTo(),"^^ yyyy")%></fo:block></fo:table-cell>
                        </fo:table-row>
                        
                        <fo:table-row>
                            <fo:table-cell><fo:block font-family="tahoma" font-weight="bold">NO. REK</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-family="tahoma" font-weight="bold">:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-family="tahoma" font-weight="bold"><%= JSPUtil.printX(form.getStNumber()) %>/<%= JSPUtil.printX(entity.getStShortName()) %>.<%= JSPUtil.printX(entity.getStRefEntityID()) %>/AK.21/<%=DateUtil.getMonthRomawi(form.getPolicyDateTo())%>/<%=DateUtil.getYear2Digit(form.getPolicyDateTo())%></fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-body>
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            final RegionView reg = pol.getCcCode(pol.getStRegionID());
                            
                            final EntityView ent = pol.getEntity2(pol.getStEntityID());
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(reg.getStDescription())%></fo:block></fo:table-cell>     
                        </fo:table-row> 
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(t[2],0)%> <fo:inline color="white">.</fo:inline></fo:block></fo:table-cell><!-- Total Premi --> 
