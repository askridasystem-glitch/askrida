                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header> 
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG No. Temporary Policy-L}{L-INA No. Polis Sementara-L}</fo:block></fo:table-cell>  
                            ...
                            <fo:table-cell border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG O/S Premium-L}{L-INA O/S Premi-L}</fo:block></fo:table-cell> 		
                        </fo:table-row>
                    ...
                    <fo:table-body>      
                        ...
                        BigDecimal subTotalPremiOuts = null;
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            String polTemp = pol.getTemporaryPolicy().getStPolicyNo();
                            ...
                            String no_polisTemp_cetak = polTemp.substring(0,4)+"-"+polTemp.substring(4,8)+"-"+polTemp.substring(8,12)+"-"+polTemp.substring(12,16)+"-"+polTemp.substring(16,18);
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.add(subTotalPremi, BDUtil.add(subTotalBPol,subTotalBMat)),0)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(no_polisTemp_cetak)%></fo:block></fo:table-cell>
                        ...
                        subTotalNetto 	= BDUtil.add(subTotalNetto,pol.getDbTotalDue());
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.add(t[0],BDUtil.add(t[1],t[2])),0)%></fo:block></fo:table-cell>
