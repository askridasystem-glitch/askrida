        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="10pt" space-after.optimum="10pt">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="5"><fo:block text-align="center">{L-ENG REINSURANCE PREMIUM NOTE-L}{L-INA REINSURANCE PREMIUM NOTE-L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="5"><fo:block text-align="center">        	 
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>NP/<%= JSPUtil.printX(form.getStPolicyTypeGroupID()) %>/04R/<%=DateUtil.getMonth2Digit(form.getPolicyDateFrom())%>-<%=DateUtil.getYear2Digit(form.getPolicyDateFrom())%></fo:block></fo:table-cell>
                            <fo:table-cell></fo:table-cell>
                        </fo:table-row>
                        <fo:table-row>
                            <fo:table-cell></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><% if(form.getPeriodFrom()!=null){ %>
            ...
            <fo:block font-size="8pt" text-align="left">
                Herewith confirmed, that your share in this Treaty is as follow :
            </fo:block> 
            ...
            <fo:block font-size="8pt" line-height="10pt" space-after.optimum="10pt">
                ...
                sqa.addSelect("h.description as pol_type_desc,sum(e.premi_amount*a.ccy_rate) as premi_amt, "+
                ...
                String q = sqa.getSQL()+" group by h.description";
                ...
                case 3: return h.getFieldValueByFieldNameBD("komisi");
                case 4: return h.getFieldValueByFieldNameBD("netto");
                }
                return "?";
                }
                ...
                switch(columnNo) {
                case 0: return "No";
                case 1: return "Type of Bonds";
                case 2: return "Premium";
                case 3: return "Comission";
                case 4: return "Nett";
                }
                return "?";
                }
