...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="13pt" line-height="12pt" text-align="center">{L-ENG Register of Premium List Reinsurance per Cover-L}{L-INA Register Produksi Premi Reasuransi per Cover-L}</fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG Reinsurer -L}{L-INA Reasedur -L}</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG Coverage -L}{L-INA Coverage -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Main / Ext -L}{L-INA Main / Ext -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                for (int j = 0; j < objects.size(); j++) {
                                                    ...
                                                    int m = 0;
                                                    t[m] = BDUtil.add(t[m++], obj.getDbObjectInsuredAmount());
                                                %>
                                                <fo:table-row>
                                                                                    ...
                                                                                    <fo:block font-size="10pt">
                                                                                        <fo:table table-layout="fixed">
                                                                                            ...
                                                                                            <fo:table-body>
                                                                                                ...
                                                                                                <% 
                                                                                                DTOList reins = trd.getShares();
                                                                                                
                                                                                                for (int h = 0; h < reins.size(); h++) {
                                                                                                InsurancePolicyReinsView rei = (InsurancePolicyReinsView) reins.get(h);
                                                                                                
                                                                                                DTOList coverreins = rei.getCoverage();
                                                                                                
                                                                                                for(int g = 0; g < coverreins.size(); g++) {
                                                                                                InsurancePolicyCoverReinsView cov = (InsurancePolicyCoverReinsView) coverreins.get(g);
                                                                                                
                                                                                                final EntityView entity = cov.getEntityName(cov.getStMemberEntityID());
                                                                                                
                                                                                                int n = 0;
                                                                                                y[n] = BDUtil.add(y[n++], cov.getDbInsuredAmount());
                                                                                                y[n] = BDUtil.add(y[n++], cov.getDbPremi());
                                                                                                %>			       
                                                                                                
                                                                                                <fo:table-row>
                                                                                                    <fo:table-cell><fo:block><%=JSPUtil.printX(entity.getStEntityName())%></fo:block></fo:table-cell>
                                                                                                    ...
                                                                                                    <fo:table-cell></fo:table-cell>
                                                                                                    <fo:table-cell><fo:block><%=JSPUtil.printX(cov.getStInsuranceCoverDesc())%></fo:block></fo:table-cell>
                                                                                                    <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(cov.getStCoverCategory())%></fo:block></fo:table-cell>
                                                                                                </fo:table-row> 
