    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:static-content flow-name="xsl-region-after">
            <fo:block text-align="end"
                      ...
                      line-height="12pt" 
                      font-style="bold">
                rppre_premium_note - PT. Asuransi Bangun Askrida
            </fo:block>
            <fo:block text-align="end"
                ...
                final FOPTableSource fopTableSource = new FOPTableSource(
                    ...
                    public String getColumnHeader(int columnNo) {
                        switch(columnNo) {
                            ...
                            case 2: return "{L-ENG Premium -L}{L-INA Premi -L}";
                            case 3: return "{L-ENG Comission -L}{L-INA Komisi -L}";
                            case 4: return "{L-ENG Nett -L}{L-INA Netto -L}";
                        }
                        return "?";
                    }
