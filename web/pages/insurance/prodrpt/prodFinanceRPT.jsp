...
<%@ taglib prefix="c" uri="crux" %><c:frame>
    ...
    final boolean PFL_PERIOD_MONTH = StringTools.indexOf(((String) r1.get("PERIOD_MONTH")),"O")>=0;
    ...
    final boolean PFL_PER_DATE = StringTools.indexOf(((String) r1.get("PER_DATE")),"O")>=0;
    final boolean PFL_CREATE_DATE = StringTools.indexOf(((String) r1.get("CREATE_DATE")),"O")>=0;
    final boolean PFL_PAYMENTPREMI_DATE = StringTools.indexOf(((String) r1.get("PAYMENTPREMI_DATE")),"O")>=0;
    final boolean PFL_DLA_NO = StringTools.indexOf(((String) r1.get("DLA_NO")),"O")>=0;
    ...
    final boolean PFM_PER_DATE = StringTools.indexOf(((String) r1.get("PER_DATE")),"M")>=0;
    final boolean PFL_TRIWULAN = StringTools.indexOf(((String) r1.get("TRIWULAN")),"O")>=0;
    final boolean PFM_CREATE_DATE = StringTools.indexOf(((String) r1.get("CREATE_DATE")),"M")>=0;
    final boolean PFM_PAYMENTPREMI_DATE = StringTools.indexOf(((String) r1.get("PAYMENTPREMI_DATE")),"M")>=0;
    final boolean PFM_DLA_NO = StringTools.indexOf(((String) r1.get("DLA_NO")),"M")>=0;
            ...
            <td>
                <table cellpadding=2 cellspacing=1>
                    ...
                    <c:evaluate when="<%=rptSelected%>" >
                        ...
                        <c:evaluate when="<%=PFL_PAYMENTPREMI_DATE%>" >      
                            <tr>
                                <td>Payment Premi Date</td>
                                <td>:</td>
                                <td>
                                    <c:field name="paymentPremiDateFrom" type="date" caption="Payment From"  />
                                    To <c:field name="paymentPremiDateTo" type="date" caption="Payment To" />
                                </td>
                            </tr>
                        </c:evaluate>
                        ...
                        <c:evaluate when="<%=PFL_CREATE_DATE%>" >
                            <tr>
                                <td>Create Date</td>
                                <td>:</td>
                                <td>
                                    <c:field name="createDateFrom" type="date" caption="Rest From"  />
                                    To <c:field name="createDateTo" type="date" caption="Rest To" />
                                </td>
                            </tr>
                        </c:evaluate> 
                        ...
                        <c:evaluate when="<%=PFL_REINS_REKAP%>" >
                           <%-- <c:field name="stReinsID" type="string" descfield="stReinsName" width="200" popuplov="true" lov="LOV_RekapReins" mandatory="false" caption="No. Rekap Reins" presentation="standard"/>--%>
                            <c:field name="stReinsID" type="string" descfield="stReinsName" width="200" popuplov="true" lov="LOV_GLClosing" mandatory="false" caption="No. Rekap Reins" presentation="standard"/>
                        </c:evaluate>
                        ...
                        <c:evaluate when="<%=PFL_DLA_NO%>" >
                            <c:field name="stDlaNo" type="string" width="200" mandatory="false" caption="PLA/DLA No" presentation="standard" />
                        </c:evaluate>
                        ...
                        <c:evaluate when="<%=PFL_PERIOD_MONTH%>" >
                            <c:field name="stPeriodMonth" type="string" descfield="stPeriodMonthDesc" width="200" lov="LOV_MONTH_Period" mandatory="false" caption="Periode" presentation="standard" loveall="true"/>
                        </c:evaluate>
                        ...
                        <c:evaluate when="<%=PFL_POLCREDIT%>" >
                            <c:field name="stPolCredit" type="string" width="200" caption="Policy Type" lov="LOV_POL_CREDIT" mandatory="false" presentation="standard"/>
                        </c:evaluate>
                        <c:evaluate when="<%=PFL_TAX%>" >
                            <c:field name="stTax" descfield="stTaxDesc" type="string" width="200" mandatory="true" caption="Tax" lov="LOV_TaxType" loveall="true" presentation="standard" />
                        </c:evaluate>  
