                ...
                <fo:table table-layout="fixed">  
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="9">
                                <fo:block font-family="serif" font-weight="bold" font-size="16pt" text-align="center">
                                    ...
                                    Tanggal Panjar : <%=JSPUtil.printX(form.getPaymentDateFrom())%> S/D <%=JSPUtil.printX(form.getPaymentDateTo())%>
                                    <% } %>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>      
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="start"><%=JSPUtil.printX(pol.getEntity2(pol.getStEntityID()).getStEntityName())%></fo:block></fo:table-cell>
