                ...
                <fo:table table-layout="fixed">  
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="14">
                                <fo:block font-family="tahoma" font-weight="bold" font-size="20pt" text-align="center">             
                                    DETIL PRODUKSI PER CABANG ASURANSI 100%
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(pol.getCostCenter(pol.getStCostCenterCode()).getStDescription())%></fo:block></fo:table-cell>    <!-- No --><!-- Period --> 
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbBrok(),0)%></fo:block></fo:table-cell> 
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDFeeBase1(),0)%></fo:block></fo:table-cell>  <!-- No --><!-- Broker 1 -->    <!-- No --><!-- Broker 1 --> 
