    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:static-content flow-name="xsl-region-before">
            ...
            <fo:block text-align="end"
                      ...
                      line-height="12pt" 
                      font-style="bold">
                rppre_risk - PT. Asuransi Bangun Askrida
            </fo:block>
            <fo:block text-align="end"
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="8pt" line-height="10pt" space-after.optimum="10pt">
                ...
                sqa.addSelect("	* from ( select "+
                "	a.pol_id,a.pol_no,a.policy_date,a.cust_name,b.ref1,substr(b.ref7d,1,12) as ref7d,b.ins_risk_cat_id,c.ins_risk_cat_code,c.description,cekrisk(substr(b.ref7d,1,12),substr(c.description,1,12)) as cekrisk"
                );
                ...
                case 4: return h.getFieldValueByFieldNameST("ref1");
                case 5: return h.getFieldValueByFieldNameST("ref7d");
