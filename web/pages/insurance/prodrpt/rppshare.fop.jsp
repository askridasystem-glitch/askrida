...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="13pt" line-height="12pt" text-align="center">{L-ENG Register of Premium List Per Share-L}{L-INA Register Produksi Premi Per Saham-L}</fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG Comm R/I -L}{L-INA Comm R/I -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body> 
                                                ...
                                                for (int j = 0; j < objects.size(); j++) {
                                                    ...
                                                    t[m] = BDUtil.add(t[m++], obj.getDbObjectPremiTotalAmount());
                                                %>
                                                                ...
                                                                <fo:table table-layout="fixed">
                                                                    ...
                                                                    <fo:table-body> 
                                                                        ...
                                                                        for (int k = 0; k < poltreaty.size(); k++) {
                                                                            ...
                                                                            int n=0;
                                                                            y[n] = BDUtil.add(y[n++], trd.getDbTSIAmount());
                                                                            y[n] = BDUtil.add(y[n++], trd.getDbPremiAmount());
                                                                            y[n] = BDUtil.add(y[n++], trd.getDbComission());
                                                                        
                                                                        %>						
                                                                        
                                                                        <fo:table-row>
                                                                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(trd.getDbTreatyLimitRatio())%>%</fo:block></fo:table-cell>
                                                                            ...
                                                                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(trd.getDbComission(),2)%></fo:block></fo:table-cell>
                                                                        </fo:table-row>
