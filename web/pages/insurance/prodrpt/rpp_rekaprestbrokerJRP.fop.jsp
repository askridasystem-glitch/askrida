                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>   
                            ...
                            <% } %>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(BDUtil.negate(pol.getDbReference4()),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Discount --> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(BDUtil.mul(BDUtil.negate(pol.getDbReference4()), rate1),0)%></fo:block></fo:table-cell>    <!-- No --><!-- Discount --> 
