                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-body>
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            if (pol.getStStatus().equalsIgnoreCase("CLAIM ENDORSE")) {
                                t[n] = BDUtil.add(t[n++], pol.getDbClaimAmountEndorse());
                                claimAmount = pol.getDbClaimAmountEndorse();
                            } else {
                                t[n] = BDUtil.add(t[n++], pol.getDbClaimAmount());
                                claimAmount = pol.getDbClaimAmount();
                            }
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDTaxComm1(),2)%></fo:block></fo:table-cell>    
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(claimAmount,2)%></fo:block></fo:table-cell> 
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbNDTaxComm1(),2)%></fo:block></fo:table-cell>    
                            <fo:table-cell ><fo:block ></fo:block></fo:table-cell> 
