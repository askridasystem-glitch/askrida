                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header> 
                        ...
                        <fo:table-row>  
                            ...
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Claim Amount-L}{L-INA Nilai Klaim-L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG Claim Paid-L}{L-INA Klaim Dibayar-L}</fo:block></fo:table-cell>  
                            <fo:table-cell border-left-style="solid" border-right-style="solid" padding="2pt"><fo:block text-align="center">{L-ENG O/S Claim-L}{L-INA Hutang Klaim-L}</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-left-style="solid" border-right-style="solid" padding="2pt"><fo:block text-align="center">{L-ENG O/S Claim Netto-L}{L-INA Hutang Klaim Netto-L}</fo:block></fo:table-cell>
                        </fo:table-row>   
                    ...
                    <fo:table-body>      
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            t[n] = BDUtil.add(t[n++], pol.getDbTax()); //total tagihan komisi
                            t[n] = BDUtil.add(t[n++], BDUtil.sub(pol.getDbClaimAmountApproved(),pol.getDbTax())); //total tagihan komisi
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(subTotalClaimPaid,0)%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(subTotalClaimNetto,0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <%
                        subTotalClaim 		= null;
                        subTotalClaimPaid	= null;
                        subTotalOutsClaim 	= null;
                        subTotalTax = null;
                        subTotalClaimNetto = null;
                            }%>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(pol.getDbClaimAmountApproved(),pol.getDbTax()),0)%></fo:block></fo:table-cell>
                        </fo:table-row>  
                        
                        <% 
                        subTotalClaim       = BDUtil.add(subTotalClaim,pol.getDbClaimAmountApproved());
                        subTotalClaimPaid   = BDUtil.add(subTotalClaimPaid,pol.getDbTotalDue());
                        subTotalOutsClaim   = BDUtil.add(subTotalOutsClaim,pol.getDbAPComisP());
                        subTotalTax         = BDUtil.add(subTotalTax,pol.getDbTax());
                        subTotalClaimNetto  = BDUtil.add(subTotalClaimNetto,BDUtil.sub(pol.getDbClaimAmountApproved(),pol.getDbTax()));
                        } %>    
