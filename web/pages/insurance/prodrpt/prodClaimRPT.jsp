<%@ page import="com.webfin.insurance.form.ProductionClaimReportForm,
...
<%@ taglib prefix="c" uri="crux" %><c:frame>
    <%
                final ProductionClaimReportForm f = (ProductionClaimReportForm) frame.getForm();
                ...
                final boolean PFL_USIA = StringTools.indexOf(((String) r1.get("USIA")), "O") >= 0;
                ...
                final boolean PFM_USIA = StringTools.indexOf(((String) r1.get("USIA")), "M") >= 0;
                    ...
                    <c:evaluate when="<%=rptSelected%>" >
                        ...
                        <c:evaluate when="<%=PFL_ENTRY_DATE%>" >
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <c:field name="entryDateFrom" type="date" caption="Entry From"  />
                                    To <c:field name="entryDateTo" type="date" caption="Entry To" />
                                </td>
                            </tr>
                        </c:evaluate>    
                        ...
                        <c:evaluate when="<%=PFL_ITEM_CLAIM%>" >
                            <c:field name="stItemClaimID" type="string" descfield="stItemClaimName" width="200" loveall="true" lov="LOV_ClaimItem" mandatory="false" caption="Item Claim" presentation="standard" />
                        </c:evaluate>  
                        ...
                        <c:evaluate when="<%=PFL_USIA%>" >
                            <tr>
                                <td>Usia</td>
                                <td>:</td>
                                <td>
                                    <c:field name="usiaFrom" type="string" caption="Usia dari"  />
                                    sampai <c:field name="usiaTo" type="string" caption="Usia sampai" />
                                </td>
                            </tr>
                        </c:evaluate>
                    </c:evaluate>
