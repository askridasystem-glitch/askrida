        ...
        <fo:flow flow-name="xsl-region-body"> 
            ...
            <fo:block font-size="8pt"> 
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-column column-width="20mm"/><!-- Entry Date --> 
                    <fo:table-column column-width="35mm"/><!-- Police Date -->
                    <fo:table-column column-width="35mm"/><!-- Police Date -->
                    <fo:table-column column-width="45mm"/><!-- Police Date -->
                    <fo:table-column column-width="30mm"/><!-- Police Date -->
                    <fo:table-column column-width="25mm"/><!-- Police Date -->
                    ...
                    <fo:table-header>   
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center">cabang</fo:block></fo:table-cell><!-- No --> 
                            <fo:table-cell ><fo:block text-align="center">dla no</fo:block></fo:table-cell><!-- No --> 
                            <fo:table-cell ><fo:block text-align="center">no polis</fo:block></fo:table-cell><!-- No --> 
                            <fo:table-cell ><fo:block text-align="center">nama</fo:block></fo:table-cell><!-- No --> 
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        if (i > 0) {
                                            ...
                                            String beban1 = pol2.getStSPPANo();
                                            String beban2 = pol.getStSPPANo();
                                            if (Tools.isEqual(beban1, beban2)) {
                                                bebanKlaim = new BigDecimal(0);
                                            } else if (!Tools.isEqual(beban1, beban2)) {
                                                bebanKlaim = pol.getDbNDComm1();
                                            }
                                        }
                                        if (i == 0) {
                                            bebanKlaim = pol.getDbNDComm1();
                                        }
                                        t[n] = BDUtil.add(t[n++], bebanKlaim);
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="start"><%=JSPUtil.printX(custName)%></fo:block></fo:table-cell>
                            <% if (bebanKlaim != null) {%>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(bebanKlaim, 2)%></fo:block></fo:table-cell>
                            <% } else {%>
                        ...
                        <fo:table-row>   
                            <fo:table-cell number-columns-spanned="6"><fo:block text-align="center">TOTAL</fo:block></fo:table-cell><!-- Name of Insured --> 
