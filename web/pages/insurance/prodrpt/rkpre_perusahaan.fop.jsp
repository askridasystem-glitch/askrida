...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="12pt" line-height="12pt" text-align="center">{L-ENG Definity Loss Advice R/I for <%=form.getStPolicyTypeID()==null?"ALL":form.getStPolicyTypeDesc()%>-L}{L-INA Register Klaim Pasti R/I for <%=form.getStPolicyTypeID()==null?"ALL":form.getStPolicyTypeDesc()%>-L}</fo:block>
