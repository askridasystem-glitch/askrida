    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
                        ...
                        <fo:table-row>
                            <fo:table-cell>
                                <fo:block font-size="12pt" line-height="12pt" text-align="center" space-after.optimum="5pt">	 
                                    PEMBAGIAN PREMI KEPADA REINSURER Untuk Bulan <%=DateUtil.getDateStr(form.getPolicyDateFrom(),"^^ ")%>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="8pt" line-height="10pt" space-after.optimum="10pt">
                ...
                sqa.addSelect("f.ent_name as cust_name,coalesce(sum(e.premi_amount*a.ccy_rate),0) as premi_amt,e.ricomm_rate as persen, "+
                ...
                String q = "select cust_name,sum(premi_amt) as premi_amt, persen,sum(komisi) as komisi,sum(premi_amt-komisi) as netto from ( "+
                sqa.getSQL()+" group by f.ent_name,e.ricomm_rate "+
                ") x group by cust_name,persen" ;
                ...
                case 3: return h.getFieldValueByFieldNameBD("persen");
                case 4: return h.getFieldValueByFieldNameBD("komisi");
                ...
                case 2: return "Premi Reasuransi";
                case 3: return "Komisi Reas (%)";
                case 4: return "Jumlah Komisi";
                case 5: return "Netto";
                }
                return "?";
                }
