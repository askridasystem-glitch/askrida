...
String desc = pol.getStKreasiTypeDesc().replaceAll("24 -"," ");
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <% } else { %>             
                            <fo:table-cell ><fo:block >{L-ENG See Attached (<%= JSPUtil.printX(pol.getStKreasiTypeDesc()) %>)-L}{L-INA Terlampir (<%= JSPUtil.printX(pol.getStKreasiTypeDesc()) %>)-L} </fo:block></fo:table-cell>
                            <% } %>
                        </fo:table-row>
