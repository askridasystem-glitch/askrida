            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block space-before.optimum="8pt" space-after.optimum="5pt"><fo:inline font-weight="bold">PT. Asuransi Bangun Askrida</fo:inline> berkedudukan di Pusat Niaga Cempaka Mas M.1/36, Jl. Letjen Soeprapto, Jakarta Pusat 10640 yang selanjutnya disebut <fo:inline font-weight="bold">PENJAMIN</fo:inline></fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA berkedudukan di -L}<%=pol.getStCustomerAddress()%> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                        </fo:table-row>
