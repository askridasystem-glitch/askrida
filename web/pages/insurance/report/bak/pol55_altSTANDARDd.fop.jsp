        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell><fo:block space-after.optimum="5pt"><%=JSPUtil.printX(obj.getStReference2())%></fo:block></fo:table-cell>
           </fo:table-row>
       ...
       <fo:block font-size="<%=fontsize%>" text-align = "justify">
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
            ...
            <fo:table-row>
             <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Nomor :  -L}<%= pol.getStPolicyNo()%></fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Tanggal :  -L}<%=DateUtil.getDateStr(pol.getDtPolicyDate(),"d ^^ yyyy")%></fo:block></fo:table-cell>
           </fo:table-row>
         ...
         <fo:table-column column-width="100mm"/>
          <fo:table-body>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStRiskDetailDescription("stReference4"))%></fo:block></fo:table-cell>
           </fo:table-row>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=DateUtil.getDateStr(pol.getDtPeriodStart(),"d ^^ yyyy")%> {L-ENG XXX -L}{L-INA s/d -L}<%=DateUtil.getDateStr(pol.getDtPeriodEnd(),"d ^^ yyyy")%>(XXX {L-ENG XXX) -L}{L-INA hari sejak tanggal penerbitan Bank Garansi)</fo:block></fo:table-cell>
           </fo:table-row>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getDbInsuredAmount(),2)%> {L-ENG XXX -L}{L-INA (Terbilang : -L}<%=NumberSpell.readNumber(JSPUtil.printX(pol.getDbInsuredAmount(),2),"RUPIAH",NumberSpell.INDONESIA)%>)</fo:block></fo:table-cell>

           </fo:table-row>

            <fo:table-row>
             <fo:table-cell><fo:block></fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA No. /Tgl. Jaminan / SPK / Und. Lelang -L} </fo:block></fo:table-cell>
             <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
         ...
         <fo:table-column column-width="30mm"/>
          <fo:table-body>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(obj.getDbReference3())%></fo:block></fo:table-cell>
           </fo:table-row>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(obj.getDbReference4())%></fo:block></fo:table-cell>
           </fo:table-row>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(obj.getDbReference5())%></fo:block></fo:table-cell>
           </fo:table-row>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell><fo:block><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
             <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.add(obj.getDbReference3(),BDUtil.add(obj.getDbReference4(),obj.getDbReference5())))%>
         ...
         <fo:table-column column-width="170mm"/>
          <fo:table-body>
           ...
           <fo:table-row>
            ...
            <fo:table-row>
             <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Hasil penerimaan Jasa Jaminan, Biaya Administrasi dan Bea Materai tersebut harap di kreditkan ke rekening -L} xxx {L-ENG XXX -L}{L-INA di -L} xxx {L-ENG XXX -L}{L-INAuntuk keuntungan PT. Asuransi Bangun Askrida, dengan rincian sebagai berikut : -L}</fo:block></fo:table-cell>
           </fo:table-row>
        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block> </fo:block></fo:table-cell>
             <fo:table-cell><fo:block font-size="<%=fontsize%>" text-align = "center"> Cabang <%= JSPUtil.printX(pol.getStCostCenterDesc())%> </fo:block></fo:table-cell>
           </fo:table-row>


            <fo:table-row>
             <fo:table-cell ><fo:block space-before.optimum="50pt"></fo:block></fo:table-cell>
           </fo:table-row>	
                    ...
                    <fo:table-row>
                      ...
                      <fo:table-cell ></fo:table-cell>
                      <fo:table-cell number-columns-spanned="1" >
                           <fo:block border-width="0.3pt" border-style="solid" border-before-precedence="0" line-height="0.15pt" space-after.optimum="0.5pt"></fo:block>
                      </fo:table-cell>
                    </fo:table-row>
