...
ref-id="end-of-document"/>
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="<%=fontsize%>" font-family="TAHOMA" line-height="5pt" space-after.optimum="10pt"
            color="black"
            text-align="center"
            padding-top="10pt">
       ...
       <fo:block font-size="<%=fontsize%>" font-family="TAHOMA" line-height="5pt" space-after.optimum="20pt"
            ...
            text-align="center"
            padding-top="1pt">
       {L-ENG Period : -L}{L-INA Jangka Waktu : -L}<%=DateUtil.getDateStr(pol.getDtPeriodStart(),"d ^^ yyyy")%> s/d <%=DateUtil.getDateStr(pol.getDtPeriodEnd(),"d ^^ yyyy")%></fo:block>
        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
           ...
           <fo:table-row>
             ...
             <fo:table-cell><fo:block text-align="center">{L-ENG Period -L}{L-INA Jangka Waktu -L}</fo:block></fo:table-cell>
...
%>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block text-align="center"><%=DateUtil.getDateStr(obj.getDtReference1())%> - <%=DateUtil.getDateStr(obj.getDtReference2())%></fo:block></fo:table-cell>
...
<% DTOList suminsured = obj.getSuminsureds();
 ...
 %>
            <fo:table-row>
             <fo:table-cell><fo:block><%=JSPUtil.printX(insuredDesc)%></fo:block></fo:table-cell>
...
<% }%>
                    ...
                    <fo:table-row>
                      ...
                      <fo:table-cell number-columns-spanned="3"><fo:block text-align="center"><%= JSPUtil.printX(pol.getStCostCenterDesc())%><%if(tanpaTanggal){%>, {L-ENG On-L}{L-INA pada tanggal-L} <%=DateUtil.getDateStr(pol.getDtPolicyDate(),"d ^^ yyyy")%><%}%></fo:block></fo:table-cell>
                    </fo:table-row>
