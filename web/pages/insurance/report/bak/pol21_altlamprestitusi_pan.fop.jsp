                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>   
                        ...
                        for (int i = 0; i < objects.size(); i++) {
                            ...
                            premiTotal4 = BDUtil.add(premiTotal4,BDUtil.mul(obj.getDbReference6(), rate4));
                        %>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" ><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.mul(BDUtil.negate(obj.getDbReference6()), rate3),0)%></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.mul(BDUtil.negate(obj.getDbReference6()), rate4),0)%></fo:block></fo:table-cell>
                        </fo:table-row>
