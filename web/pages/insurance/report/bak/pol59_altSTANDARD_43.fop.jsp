    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">\
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="<%=fontsize%>" text-align="justify">
                ...
                Perjanjian Kredit (PK)/<fo:inline font-style="italic">Offering Letter</fo:inline> 
                <% if (objects.size()>1) { %>
                nomor (<fo:inline font-weight="bold">Terlampir</fo:inline>) tanggal (<fo:inline font-weight="bold">Terlampir</fo:inline>) atas Debitur :
                <% } else { %>
                nomor (<fo:inline font-weight="bold"><%=JSPUtil.printX(noKredit)%></fo:inline>) tanggal (<fo:inline font-weight="bold"><%=DateUtil.getDateStr(tglPK,"dd ^^ yyyy")%></fo:inline>) atas Debitur :
                <% } %>
            </fo:block>
