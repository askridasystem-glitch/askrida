...
<% } %>
      ...
      <fo:block font-size="16pt" font-family="TAHOMA" line-height="16pt" color="black" text-align="center">
       {L-ENG CO-INSURANCE SLIP-L}{L-INA SLIP KO-ASURANSI-L}
      </fo:block>

      <fo:block font-size="<%=fontsize%>" font-family="TAHOMA" line-height="16pt" space-after.optimum="10pt" color="black" text-align="center"> NO. <%=JSPUtil.printX(ciSlipNo)%>
      </fo:block>
...
<%
   ...
   for (int m = 0; m < covers.size(); m++) {
      ...
      %>
                     <fo:table-row>
                        <fo:table-cell ><fo:block space-after.optimum="10pt"><%=cov.getStInsuranceCoverDesc()%></fo:block></fo:table-cell>
                        <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
...
<% } %>
          ...
          <%-- <fo:table-row>
             ...
             <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
             <fo:table-cell ><fo:block><%=JSPUtil.print(ci.getDbPremiRatePct(),2)%>%</fo:block></fo:table-cell>
           </fo:table-row>--%>
