            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-column-spanned="3"><fo:block space-before.optimum="5pt"></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>14.</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>16.</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>18.</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>19.</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>21.</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>22.</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>23.</fo:block></fo:table-cell>
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(pol.getStCostCenterDesc())%>, <%=DateUtil.getDateStr(pol.getDtDLADate(),"d ^^ yyyy")%></fo:block></fo:table-cell>
                        </fo:table-row>
