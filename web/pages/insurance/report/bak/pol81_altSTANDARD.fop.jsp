...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Address of Insured-L}{L-INA Alamat Tertanggung-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
            ...
            <%
                        String InsuredBussiness = null;
                        String ObjectLocation = null;
                        String PolicyWording = null;
                        String ContractionClass = null;
                        String Occupation = null;

                        final DTOList obj = pol.getObjects();

                        for (int k = 0; k < obj.size(); k++) {
                            InsurancePolicyObjectView objx = (InsurancePolicyObjectView) obj.get(k);
                            InsurancePolicyObjDefaultView io = (InsurancePolicyObjDefaultView) objx;

                            if (obj.size() == 1) {

                                InsuredBussiness = io.getStReference6();
                                ObjectLocation = io.getStReference5();
                                PolicyWording = io.getStReference8();
                                ContractionClass = io.getStReference4();

                                if (io.getStRiskCategoryCode1() != null) {
                                    Occupation = JSPUtil.printX(io.getStRiskCategoryCode1());
                                    if (io.getStRiskCategoryCode2() != null) {
                                        Occupation = "/" + JSPUtil.printX(io.getStRiskCategoryCode2());
                                    }
                                    if (io.getStRiskCategoryCode3() != null) {
                                        Occupation = "/" + JSPUtil.printX(io.getStRiskCategoryCode3());
                                    }
                                }

                            } else if (obj.size() > 1) {

                                InsuredBussiness = "Terlampir";
                                ObjectLocation = "Terlampir";
                                PolicyWording = "Terlampir";
                                ContractionClass = "Terlampir";
                                Occupation = "Terlampir";
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>Jenis Bisnis Tertanggung</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(InsuredBussiness)%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block>Lokasi Obyek Pertanggungan</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(ObjectLocation)%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block>Wording Polis</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(PolicyWording)%></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>Kelas Konstruksi</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(ContractionClass)%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block>Okupasi</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(Occupation)%></fo:block></fo:table-cell>
                        </fo:table-row>
 ...
 %>
      ...
      <% } %>
            ...
            <!-- GARIS -->
            <fo:block border-width="0.15pt" border-style="solid" border-before-precedence="10" line-height="0.50pt" text-align="justify" space-after.optimum="5pt"></fo:block>

            <fo:block font-size="<%=fontsize%>" space-before.optimum="5pt" text-align="center">
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Interest Insured-L}{L-INA Objek Pertanggungan-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                            ...
                                            <fo:table-body>
                                                <%
                                                                     ...
                                                                     for (int j = 0; j < suminsureds.size(); j++) {
                                                                         ...
                                                                         if (tsi.getStInsuranceTSIID().equalsIgnoreCase("109")) {
                                                                             continue;
                                                                         }
                                                %>

                                                <fo:table-row>
                                                    <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(tsi.getStDescription())%></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(tsi.getStTSICategoryDescription())%></fo:block></fo:table-cell>
                                                </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Coverage-L}{L-INA Luas Jaminan -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="start"><%=JSPUtil.xmlEscape(objx.getStReference10())%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Perils Excluded -L}{L-INA Perils yang Dikecualikan -L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="start"><%=JSPUtil.xmlEscape(objx.getStReference16())%></fo:block></fo:table-cell>
                        </fo:table-row>
                                            ...
                                            <fo:table-body>
                                                <%
                                                                     ...
                                                                     for (int j = 0; j < suminsureds.size(); j++) {
                                                                         ...
                                                                         int n = 0;
                                                                         t[n] = BDUtil.add(t[n++], tsi.getDbInsuredAmount());
                                                %>
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Indemnity Period -L}{L-INA Masa Ganti Rugi-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Time Excess -L}{L-INA Excess Waktu-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                        </fo:table-row>
