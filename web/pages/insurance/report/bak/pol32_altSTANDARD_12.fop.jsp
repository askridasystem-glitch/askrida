    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">\
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="<%=fontsize%>" text-align="center">
                NASABAH DAN / ATAU AHLI WARIS SAH YANG DITUNJUK 
            </fo:block>
            
            <fo:block space-before.optimum="5pt" space-after.optimum="5pt" text-align="justify"></fo:block>
            
            <fo:block font-size="<%=fontsize%>">
            Jangka waktu pertanggungan : <fo:inline font-weight="bold"><%=DateUtil.getDateStr(pol.getDtPeriodStart(),"d ^^ yyyy")%></fo:inline> Sesuai PKS terlampir <fo:inline font-weight="bold"><%=DateUtil.getDateStr(pol.getDtPeriodEnd(),"d ^^ yyyy")%></fo:inline></fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center"><%= JSPUtil.printX(pol.getStCostCenterDesc()) %>, <fo:inline font-weight="bold"><%=DateUtil.getDateStr(pol.getDtPolicyDate(),"d ^^ yyyy")%></fo:inline></fo:block></fo:table-cell>
                        </fo:table-row>
