    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <%
                        ...
                        final DTOList objectsz = pol.getObjects();

                        for (int x = 0; x < objectsz.size(); x++) {
                            InsurancePolicyObjDefaultView objz = (InsurancePolicyObjDefaultView) objectsz.get(x);

                            DTOList coinz = pol.getCoins2();

                            for (int z = 0; z < coinz.size(); z++) {
                                InsurancePolicyCoinsView ciz = (InsurancePolicyCoinsView) coinz.get(z);

                                if (ciz.isHoldingCompany()) {
                                    continue;
                                }

                                EntityView reasuradur = ciz.getEntity();
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block><%= reasuradur.getStEntityName().toUpperCase()%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG ADDRESS-L}{L-INA ALAMAT-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%= reasuradur.getStAddress()%></fo:block></fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        <%
                             ...
                             for (int j = 0; j < objects2.size(); j++) {
                                 ...
                                 } else if (pol.getStPolicyTypeGroupID().equalsIgnoreCase("30")) {
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Your Claim-L}{L-INA Klaim Saudara-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(ciz.getDbClaimAmount(), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
