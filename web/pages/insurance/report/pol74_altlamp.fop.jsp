                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            <fo:table-cell number-columns-spanned="6" border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" >SUBTOTAL</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="6" border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" >TOTAL</fo:block></fo:table-cell>
