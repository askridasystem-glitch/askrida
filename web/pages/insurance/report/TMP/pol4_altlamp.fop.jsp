  ...
  <fo:page-sequence master-reference="only" initial-page-number="1">
    ...
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="16pt" font-family="TAHOMA" line-height="5pt" space-after.optimum="5pt"
            ...
            text-align="center"
            padding-top="10pt">
       {L-ENG List of Attachement PA Kreasi -L}{L-INA Lampiran Polis PA Kreasi -L}
      </fo:block>
        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
           ...
           <fo:table-row>
             ...
             <fo:table-cell><fo:block>{L-ENG ID No. -L}{L-INA No. Pengenal -L}</fo:block></fo:table-cell>
             ...
             <fo:table-cell><fo:block>{L-ENG Time -L}{L-Jangka -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Type -L}{L-INA Jenis -L}</fo:block></fo:table-cell>
