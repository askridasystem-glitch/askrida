  ...
  <fo:layout-master-set> 
    ...
    <fo:simple-page-master master-name="all" 
      ...
      <fo:region-body margin-top="0cm" margin-bottom="0cm"
       column-count="2" column-gap="2.2in"/> 
	  ...
	  <fo:table-cell number-columns-spanned="3">
		<fo:block space-after.optimum="10pt">
            ...
            <fo:table-row>   
             ...
             <fo:table-cell ><fo:block text-align="center">:</fo:block></fo:table-cell>    <!-- No --><!-- Entry Date -->
      		 <fo:table-cell ><fo:block ><%= JSPUtil.printX(String.valueOf(i+1)) %></fo:block></fo:table-cell>    <!-- No --><!-- Police Date --> 
            </fo:table-row>   
            
            <fo:table-row>   
             <fo:table-cell ><fo:block font-weight="bold">NAMA</fo:block></fo:table-cell>    <!-- No --><!-- No --> 
             <fo:table-cell ><fo:block text-align="center">:</fo:block></fo:table-cell>    <!-- No --><!-- Entry Date -->
      		 <fo:table-cell ><fo:block font-size="8pt"><%= JSPUtil.printX(obj.getStReference1()) %></fo:block></fo:table-cell>    <!-- No --><!-- Police Date --> 
            </fo:table-row>
            
            <fo:table-row>   
             <fo:table-cell ><fo:block font-weight="bold">PERIODE</fo:block></fo:table-cell>    <!-- No --><!-- No --> 
             <fo:table-cell ><fo:block text-align="center">:</fo:block></fo:table-cell>    <!-- No --><!-- Entry Date -->
      		 <fo:table-cell ><fo:block ><%= JSPUtil.printX(obj.getDtReference2()) %> s/d <%= JSPUtil.printX(obj.getDtReference3()) %></fo:block></fo:table-cell>    <!-- No --><!-- Police Date --> 
            </fo:table-row>
            
             <fo:table-row>
	  <fo:table-cell number-columns-spanned="3">
		<fo:block space-after.optimum="85pt">
		</fo:block>
      </fo:table-cell>
     </fo:table-row>
