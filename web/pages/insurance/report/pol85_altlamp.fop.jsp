                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG SPPB No. -L}{L-INA No. SPPB -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG SPPB Date -L}{L-INA Tanggal SPPB -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Bank Name -L}{L-INA Nama Bank -L}</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(i+1)%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell><fo:block text-align="start"><%=JSPUtil.printX(obj.getStReference3Desc())%></fo:block></fo:table-cell>
