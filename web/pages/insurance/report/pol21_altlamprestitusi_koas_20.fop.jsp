    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            for (int k = 0; k < coins.size(); k++) {
                ...
                } else if (coi.getStEntityID().equalsIgnoreCase("7")) {
                    rate2 = BDUtil.getRateFromPct(coi.getDbSharePct());
                } else if (coi.getStEntityID().equalsIgnoreCase("115")) {
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" >SARLINA</fo:block></fo:table-cell>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm" >AJN</fo:block></fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>   
                        ...
                        for (int i = 0; i < objects.size(); i++) {
                            ...
                            if(BDUtil.isZeroOrNull(obj.getDbReference6())) continue;
                            
                            premiTotal = BDUtil.add(premiTotal,obj.getDbReference6());
                            premiTotal1 = BDUtil.add(premiTotal1,BDUtil.mul(obj.getDbReference6(), rate1));
                            premiTotal2 = BDUtil.add(premiTotal2,BDUtil.mul(obj.getDbReference6(), rate2));
                            premiTotal3 = BDUtil.add(premiTotal3,BDUtil.mul(obj.getDbReference6(), rate3));
                        %>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" ><%=JSPUtil.printX(obj.getStReference15())%> </fo:block></fo:table-cell>
                            
                            <% if (obj.getStReference4().equalsIgnoreCase("0")) { %>            
                            ...
                            <% }  else { %>            
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" ><%=JSPUtil.printX(BDUtil.mul(new BigDecimal(Integer.parseInt(obj.getStReference4())),new BigDecimal(12)))%></fo:block></fo:table-cell>
                            <% } %>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.negate(obj.getDbObjectInsuredAmount()),0)%></fo:block></fo:table-cell>
                            
                            <% if (obj.getDbReference12()!=null) { %>             
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(obj.getDbReference12(),0)%></fo:block></fo:table-cell>
                            <% }  else { %> 
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.negate(BDUtil.mul(obj.getDbObjectInsuredAmount(),BDUtil.getRateFromMile(obj.getDbReference5()))),0)%></fo:block></fo:table-cell>
                            <% } %>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" ><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.negate(obj.getDbReference6()),0)%></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" ><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.mul(BDUtil.negate(obj.getDbReference6()), rate1),0)%></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" ><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.mul(BDUtil.negate(obj.getDbReference6()), rate2),0)%></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(BDUtil.mul(BDUtil.negate(obj.getDbReference6()), rate3),0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="0.5pt" ><fo:block text-align="end"  line-height="5mm"></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="0.5pt" ><fo:block text-align="end"  line-height="5mm"></fo:block></fo:table-cell> 
                            <fo:table-cell  border-width="0.5pt" border-left-style="solid"><fo:block text-align="end"  line-height="5mm"><%=JSPUtil.printX(BDUtil.negate(premiTotal),0)%></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="0.5pt" border-left-style="solid"><fo:block text-align="end"  line-height="5mm"><%=JSPUtil.printX(BDUtil.negate(premiTotal1),0)%></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="0.5pt" border-left-style="solid"><fo:block text-align="end"  line-height="5mm"><%=JSPUtil.printX(BDUtil.negate(premiTotal2),0)%></fo:block></fo:table-cell>
