...
<%
            ...
            boolean status = "DIRECT".equalsIgnoreCase(pol.getStCoverTypeCode());
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Coinsurance-L}{L-INA Koasuransi-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                                            ...
                                            <fo:table-body>
                                                ...
                                                <% final DTOList coins = pol.getCoins2();
                                                     for (int w = 0; w < coins.size(); w++) {
                                                         InsurancePolicyCoinsView coi = (InsurancePolicyCoinsView) coins.get(w);

                                                         final EntityView koas = coi.getEntity();

                                                %>           
                                                <fo:table-row>
                                                    <fo:table-cell ><fo:block><%= JSPUtil.printX(koas.getStEntityName())%></fo:block></fo:table-cell>
                                                    ...
                                                    <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(coi.getDbAmount(), 2)%></fo:block></fo:table-cell>
                                                </fo:table-row>
                                                <% }%>
                                                ...
                                                <fo:table-row>
                                                    ...
                                                    <fo:table-cell ><fo:block font-weight="bold" text-align="end">100.00 %</fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block font-weight="bold" text-align="end"><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                                                    <fo:table-cell ><fo:block font-weight="bold" text-align="end"><%=JSPUtil.printX(pol.getDbInsuredAmount(), 2)%></fo:block></fo:table-cell>
                                                </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block space-after.optimum="5pt">TSI Spreading</fo:block></fo:table-cell>
                        </fo:table-row>
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <%
...

                                                        {
                                                            ...
                                                            for (int j = 0; j < treatyDetails.size(); j++) {
                                                                ...
                                                                final boolean nonXOL = trd.getTreatyDetail().getTreatyType().isNonXOL();
                                                                ...
                                                                //   calculator.add("PRESPTOT",trd.getDbPremiAmount());
                                                ...
                                                <fo:table-row>
                                                    ...
                                                    <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">{L-ENG Reinsurer-L}{L-INA Reinsurer-L}</fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">{L-ENG Share-L}{L-INA Share-L}</fo:block></fo:table-cell>
                                                    ...
                                                    <fo:table-cell border-width="0.5pt" ><fo:block text-align="center" line-height="5mm">{L-ENG TSI Reinsurer-L}{L-INA TSI Reinsurer-L}</fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">{L-ENG Rate-L}{L-INA Rate-L}</fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" border-right-style="solid"><fo:block text-align="center" line-height="5mm">{L-ENG Premi Reinsurer-L}{L-INA Premi Reinsurer-L}</fo:block></fo:table-cell>
                                                </fo:table-row>
                                                ...
                                                <fo:table-row>                  
                                                    <fo:table-cell ><fo:block ></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block line-height="5mm"><fo:inline color="white">.</fo:inline> <%=JSPUtil.printX(trd.getStTreatyClassDesc())%></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block line-height="5mm">
                                                            <fo:block font-size="8pt">
                                                                <fo:table table-layout="fixed">
                                                                    <fo:table-column column-width="30mm"/>
                                                                    <fo:table-column column-width="15mm"/>
                                                                    ...
                                                                    <fo:table-body>
                                                                        ...
                                                                        <%
                                                                                                                                ...
                                                                                                                                for (int k = 0; k < shares.size(); k++) {
                                                                                                                                    ...
                                                                                                                                    //      calculator.add("PRESPTOT",trd.getDbPremiAmount());
                                                                                                                                    int n = 0;
                                                                                                                                    t[n] = BDUtil.add(t[n++], ri.getDbTSIAmount());
                                                                                                                                    t[n] = BDUtil.add(t[n++], ri.getDbPremiAmount());

                                                                        %>

                                                                        <fo:table-row>
                                                                            <fo:table-cell ><fo:block><fo:inline color="white">.</fo:inline> <%= JSPUtil.printX(reasuradur.getStShortName())%></fo:block></fo:table-cell> 
                                                                            <% if (ri.getDbSharePct() != null) {%>
                                                                            <fo:table-cell ><fo:block text-align="end"><%= JSPUtil.printX(ri.getDbSharePct(), 2)%> <%= JSPUtil.printX(pol.getStRateMethodDesc())%> </fo:block></fo:table-cell>
                                                                            <% } else {%>
                                                                            ...
                                                                            <% if (ri.getDbPremiRate() != null) {%>
                                                                            <fo:table-cell ><fo:block text-align="end"><%= JSPUtil.printX(ri.getDbPremiRate(), 2)%> <%= JSPUtil.printX(pol.getStRateMethodDesc())%> </fo:block></fo:table-cell>
                                                                            <% } else {%>
                                                                            <fo:table-cell ><fo:block text-align="center">-</fo:block></fo:table-cell> 
                                                                            <% }%>
                                                                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                                                                            <fo:table-cell border-width="0.5pt" border-right-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(ri.getDbPremiAmount(), 2)%> </fo:block></fo:table-cell>
                                                                        </fo:table-row>
                                                    ...
                                                    <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" ><fo:block text-align="center" line-height="5mm"></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" ><fo:block text-align="center" line-height="5mm"></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="0.5pt" border-right-style="solid"><fo:block text-align="center" line-height="5mm"></fo:block></fo:table-cell>
                                                </fo:table-row>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell number-column-spanned="9">
...
final DTOList shares = trd.getShares();
            ...
            for (int k = 0; k < shares.size(); k++) {
               ...
               calculator.add("PRESPTOT",ri.getDbPremiAmount());
 %>

                  <fo:table-row>
                   <fo:table-cell ><fo:block font-size="8pt"><%= JSPUtil.printX(reasuradur.getStEntityName()) %></fo:block></fo:table-cell> 
                   <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>                 
                   <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                   <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(ri.getDbPremiAmount(),2)%></fo:block></fo:table-cell>
                  </fo:table-row>
...
<% } %>
               ...
               <fo:table-row>
                   ...
                   <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                   <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                   <fo:table-cell ><fo:block text-align="end" space-after.optimum="10pt"><%=JSPUtil.printX(calculator.getBD("PRESPTOT"),2)%></fo:block></fo:table-cell>
                  </fo:table-row>
