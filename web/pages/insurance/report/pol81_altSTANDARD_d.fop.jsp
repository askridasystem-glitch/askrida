            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                for (int i = 0; i < objects.size(); i++) {
                                                    ...
                                                    address = io.getStReference3();
                                                    wording = io.getStReference4();
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Risk Code-L}{L-INA Kode Risiko-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Electricity-L}{L-INA Penerangan-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell >
                                <fo:list-block space-after.optimum="5pt">
                                    ...
                                    <fo:list-item>
                                        ...
                                        <fo:list-item-body start-indent="body-start()">
                                            <fo:block font-size="<%=fontsize%>">
                                                <fo:inline text-decoration="none">terlampir</fo:inline>
                                            </fo:block>
                                        </fo:list-item-body>
                                    </fo:list-item>
                                    <% } %>
