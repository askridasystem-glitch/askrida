                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG Occupation -L}{L-INA Penggunaan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Class Construction -L}{L-INA Kelas Konstruksi -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Building Category -L}{L-INA Kategori Bangunan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Zone -L}{L-INA Zona -L}</fo:block></fo:table-cell>
