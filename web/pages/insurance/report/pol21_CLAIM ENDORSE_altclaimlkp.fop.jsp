                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    String amtTotal = null;
                                    for (int i = 0; i < claimItems.size(); i++) {
                                        InsurancePolicyItemsView ci = (InsurancePolicyItemsView) claimItems.get(i);

                                        if (ci.getStInsItemID().equalsIgnoreCase("61") || ci.getStInsItemID().equalsIgnoreCase("62") || ci.getStInsItemID().equalsIgnoreCase("63") || ci.getInsItem().getStInsuranceItemID().equalsIgnoreCase("46")) {
                                            continue;
                                        }
                                        ...
                                        if (Tools.compare(amt3, BDUtil.zero) < 0) {
                                            amt2 = BDUtil.negate(amt3);
                                            amtTotal = JSPUtil.printX(amt2, 2);
                                            amtTotal = "(" + amtTotal + ")";
                                        } else {
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>: <%= pol.getStCurrencyCode()%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(amtTotal)%></fo:block></fo:table-cell>
                        </fo:table-row>
