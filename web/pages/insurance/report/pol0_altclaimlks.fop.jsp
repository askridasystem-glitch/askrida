...
<%
            ...
            boolean lks = pol.isStatusClaimPLA();
...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="12pt" line-height="10pt" space-before.optimum="5pt" space-after.optimum="10pt" color="black" text-align="center"> NO. <%=pol.getStPLANo()%></fo:block>
                    ...
                    <fo:table-body>
                        <%
                                    ...
                                    for (int j = 0; j < objects2.size(); j++) {
                                        ...
                                        if (pol.getStPolicyTypeID().equalsIgnoreCase("60")) {
                                            objectName = obj.getStReference3Desc();
                                        } else {
                                            objectName = obj.getStReference1();
                                        }
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=coinsName%></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <%
                        ...
                        String namaKadivPNC = "ADE IRWAN MUNTACO";
                        String jabatanKadivPNC = "Pimpinan";
                        String divisiKadivPNC = "HEAD OFFICE";
                        ...
                        for (int k = 0; k < claimItems.size(); k++) {
                            ...
                            //31okt2018
                            /*if (pol.getStEntityID().equalsIgnoreCase("1752,1020501,1020502,1020503")) {
                            namaKadivPNC = "ADE IRWAN MUNTACO";
                            jabatanKadivPNC = "Pimpinan";
                            divisiKadivPNC = "HEAD OFFICE";
                            } else {*/
                            if (isSubrogasi) {
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell >
                                ...
                                <fo:block text-align="center"><%=JSPUtil.printX(divisiKadivPNC)%>,</fo:block>
                                <% } else {%>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell >
                                <%if (pol.getStEntityID().equalsIgnoreCase("1752")
                                             ...
                                             || pol.getStEntityID().equalsIgnoreCase("1020502")
                                             || pol.getStEntityID().equalsIgnoreCase("1020503")) {%>
                                <fo:block text-align="center"><fo:inline text-decoration="underline"><%=namaKadivPNC%></fo:inline></fo:block>
                                <fo:block text-align="center"><%=jabatanKadivPNC%></fo:block>
                                <% } else {%>
                                <%--<%if (isKreditKreasi) {%>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(divisiKabag)%>,</fo:block></fo:table-cell>
                        </fo:table-row>
