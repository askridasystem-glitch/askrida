                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="9">
                                <fo:block font-size="16pt" text-align="center" space-after.optimum="10pt">
                                    {L-ENG List of Attachement Kredit Insurance-L}{L-INA Lampiran Polis Asuransi Kredit-L}
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" >{L-ENG Work-L}{L-INA Pekerjaan-L}</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" >{L-ENG Credit No.-L}{L-INA No. Perj. Kredit-L}</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm" >Restitusi</fo:block></fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    BigDecimal subTotalRest = new BigDecimal(0);
                        ...
                        <fo:table-row space-before.optimum="5pt">
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(subTotalRest, 2)%><fo:inline color="white">.</fo:inline></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" ><%=JSPUtil.printX(obj.getStReference3())%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" ><%=JSPUtil.printX(obj.getStReference7Desc())%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" font-size="8pt"><%=JSPUtil.printX(obj.getDtReference2())%> - <%=JSPUtil.printX(obj.getDtReference3())%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" font-size="7pt"><%=JSPUtil.printX(obj.getStReference4())%></fo:block></fo:table-cell>
                            ...
                            <%--<fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(obj.getDbObjectPremiTotalAmount(), 2)%><fo:inline color="white">.</fo:inline></fo:block></fo:table-cell>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <%
                                                                                        DTOList cover = obj.getCoverRestitusi();

                                                                                        for (int j = 0; j < cover.size(); j++) {
                                                                                            InsurancePolicyCoverView cov = (InsurancePolicyCoverView) cover.get(j);

                                                                                            int n = 0;
                                                                                            t[n] = BDUtil.add(t[n++], cov.getDbPremi());
                                                                                            t[n] = BDUtil.add(t[n++], cov.getDbPremiNew());

                                                %>

                                                <fo:table-row>
                                                    <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(cov.getDbPremi(), 2)%><fo:inline color="white">.</fo:inline></fo:block></fo:table-cell>
                                                    <fo:table-cell border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(cov.getDbPremiNew(), 2)%><fo:inline color="white">.</fo:inline></fo:block></fo:table-cell>
                                                </fo:table-row>

                                                <%
                                                                                            subTotalPremi = BDUtil.add(subTotalPremi, cov.getDbPremi());
                                                                                            subTotalRest = BDUtil.add(subTotalRest, cov.getDbPremiNew());
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(t[0], 2)%><fo:inline color="white">.</fo:inline></fo:block> </fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(t[1], 2)%><fo:inline color="white">.</fo:inline></fo:block> </fo:table-cell>
                        </fo:table-row>
