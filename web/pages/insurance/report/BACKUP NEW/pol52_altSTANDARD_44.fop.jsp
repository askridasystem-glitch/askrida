                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <%=JSPUtil.printX(pol.getDbInsuredAmount(),2)%> {L-ENG 1. -L}{L-INA Terbilang ( -L}<%=NumberSpell.readNumber(JSPUtil.printX(pol.getDbInsuredAmount(),2))%> <%=JSPUtil.printX(pol.getCurrency().getStCcyDescription())%> )</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>																																																																																																																																																																																
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Maka kami PRINCIPAL dan SURETY dengan ini mengikatkan diri untuk melakukan pembayaran jumlah tersebut diatas dengan baik dan benar bilamana PRINCIPAL tidak memenuhi kewajibannya dalam melaksanakan Pekerjaan yang telah dipercayakan kepadanya atas dasar Surat Penunjukan Pemenang Lelang dari OBLIGEE No.  -L} <%if(obj.getStReference10()!=null){%><%=JSPUtil.printX(obj.getStReference10())%><%}else{%>.......................<%}%>{L-ENG 1. -L}{L-INA tanggal -L} <%if(obj.getDtReference1()!=null){%><%=DateUtil.getDateStr(obj.getDtReference1(),"d ^^ yyyy")%><%}else{%>................<%}%>  {L-ENG 1. -L}{L-INA yang selanjutnya dikukuhkan dalam Kontrak No. -L}<%if(obj.getStReference11()!=null){%><%=JSPUtil.printX(obj.getStReference11())%><% }else{ %>...............<% } %> 
                            tanggal <% if(obj.getDtReference2()!=null) {%><%=DateUtil.getDateStr(obj.getDtReference2(),"d ^^ yyyy")%><% }else{ %>................<% } %> atas pekerjaan <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference12())%></fo:inline> {L-ENG 1. -L}{L-INA antara pihak PRINCIPAL dan OBLIGEE, dan kontrak tersebut merupakan bagian yang tidak terpisahkan dari jaminan ini. -L} </fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA jika PRINCIPAL menyelesaikan pekerjaan tersebut pada waktunya dengan baik dan benar sesuai dengan ketentuan dalam Kontrak; atau -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        
                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG b. -L}{L-INA b. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA jika PRINCIPAL membayar, memperbaiki, dan mengganti pada OBLIGEE semua kerugian dan kerusakan yang sesungguhnya diderita OBLIGEE oleh sebab kegagalan atau kelalaian dari pihak PRINCIPAL dalam melaksanakan Kontrak; -L}</fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA maka jaminan ini menjadi batal dan tidak berlaku; sebaliknya jika tidak maka Jaminan ini tetap berlaku dan efektif mulai tanggal -L} <fo:inline font-weight="bold"><%=DateUtil.getDateStr(pol.getDtPeriodStart(),"d ^^ yyyy")%></fo:inline> {L-ENG XXX -L}{L-INA sampai dengan tanggal -L} <fo:inline font-weight="bold"><%=DateUtil.getDateStr(pol.getDtPeriodEnd(),"d ^^ yyyy")%></fo:inline> {L-ENG XXX -L}{L-INA dan dapat dimintakan perpanjangan oleh PRINCIPAL sampai 14 (empat belas) hari setelah masa Jaminan berakhir. -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Tuntutan penagihan (klaim) atas Surat Jaminan ini dilaksanakan oleh OBLIGEE secara tertulis kepada SURETY segera setelah timbul cidera janji (Wanprestasi/default) oleh pihak PRINCIPAL dalam melaksanakan Kontrak, bukan karena risiko-risiko pemilik -L}</fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3" ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="3" ><fo:block space-after.optimum="40pt"></fo:block></fo:table-cell>
                        </fo:table-row>                          
