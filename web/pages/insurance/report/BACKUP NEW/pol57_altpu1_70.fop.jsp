                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block >Klaim dibayarkan setelah adanya tuntutan tertulis dari <fo:inline ><%= pol.getStCustomerName()%></fo:inline> dan memenuhi ketentuan kontrak</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block >Kepala KPPN yang menerbitkan SP2D uang muka berdasarkan surat kuasa Pemegang Jaminan atas Obligee dapat mengajukan tuntutan/klaim penagihan kepada penjamin sampai dengan berakhirnya masa klaim jaminan uang muka</fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block >6. </fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block >jaminan uang muka bersifat mudah dicairkan dan tidak bersyarat (unconditional)</fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2"><fo:block space-before.optimum="60pt"></fo:block></fo:table-cell>
                            <fo:table-cell>
                                <%if (!isUsingBarcode) {%>
