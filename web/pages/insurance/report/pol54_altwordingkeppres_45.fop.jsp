                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Maka kami TERJAMIN dan PENJAMIN dengan ini mengikatkan diri untuk melakukan pembayaran jumlah tersebut diatas dengan baik dan benar bilamana TERJAMIN tidak memenuhi kewajiban dalam melaksanakan pekerjaan -L}<fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference11())%></fo:inline> {L-ENG XXX -L}{L-INA sebagaimana ditetapkan berdasarkan PHO -L} <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference10())%></fo:inline> {L-ENG XXX -L}{L-INA tanggal -L}<fo:inline font-weight="bold"><%=DateUtil.getDateStr(obj.getDtReference1(), "d ^^ yyyy")%></fo:inline> {L-ENG XXX -L}{L-INA dari PENERIMA JAMINAN. -L}</fo:block></fo:table-cell>
                        </fo:table-row>
