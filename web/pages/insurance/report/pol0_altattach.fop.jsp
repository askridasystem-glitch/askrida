...
<% {%>
    <fo:flow flow-name="xsl-region-body">
      ...
      <fo:block font-size="16pt" font-family="TAHOMA" line-height="5pt" space-after.optimum="5pt"
            ...
            text-align="center"
            padding-top="10pt">
       {L-ENG List of Attachement Motor Vehicle -L}{L-INA Lampiran Polis Kendaraan Bermotor -L}
      </fo:block>
        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
           ...
           <fo:table-row>
             ...
             <fo:table-cell><fo:block>{L-ENG TJH3 -L}{L-INA TJH3 -L}</fo:block></fo:table-cell>
...
%>
            ...
            <fo:table-row>
             ...
             <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(obj.getDbCoverSumInsuredAmount("101"),2)%></fo:block></fo:table-cell>
