            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                for (int i = 0; i < objects.size(); i++) {
                                                    ...
                                                    wording = io.getStReference5Desc();
                                                    postcode = io.getStReference4Desc();
                                                %>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Risk Location-L}{L-INA Lokasi Proyek-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(address)%></fo:block></fo:table-cell>
                        </fo:table-row>                        
                        
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Wording Form-L}{L-INA Jenis Wording-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.xmlEscape(postcode)%></fo:block></fo:table-cell>
                        </fo:table-row>
