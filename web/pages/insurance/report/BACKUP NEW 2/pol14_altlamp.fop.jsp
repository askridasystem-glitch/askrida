                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">Account Officer</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Debitur Name-L}{L-INA Nama Debitur-L}</fo:block></fo:table-cell>
                        ...
                        <%
                        DTOList objects = pol.getObjectsCI();
