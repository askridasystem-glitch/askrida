    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="14pt" font-family="TAHOMA" line-height="5pt" space-after.optimum="5pt"
                      ...
                      text-align="center"
                      padding-top="10pt">
                {L-ENG List of Deductible Attachement -L}{L-INA Lampiran Deductible Polis Asuransi -L} <%=pol.getStPolicyTypeDesc2()%> {L-ENG Insurance -L}{L-INA -L}
            </fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="2"><fo:block text-align="center">{L-ENG Deductible -L}{L-INA Deductible -L}</fo:block></fo:table-cell>
                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <% DTOList cover = obj.getCoverage();
                                                                                        for (int z = 0; z < cover.size(); z++) {
                                                                                            InsurancePolicyCoverView cov = (InsurancePolicyCoverView) cover.get(z);

                                                                                            String desc = cov.getInsuranceCoverage().getStDescription();
                                                                                            String desc2 = cov.getStDescription();

                                                %>
                                                <fo:table-row>
                                                    <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(desc)%> <%=JSPUtil.printX(desc2)%></fo:block></fo:table-cell>
                                                </fo:table-row>
                                                <% }%>
                                            </fo:table-body>
                                        </fo:table>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <% DTOList deduct = obj.getDeductibles();
                                                                                        for (int j = 0; j < deduct.size(); j++) {
                                                                                            InsurancePolicyDeductibleView ded = (InsurancePolicyDeductibleView) deduct.get(j);

                                                                                            String desc = ded.getClaimCause().getStDescription();
                                                                                            String descTSI = ded.getStAutoDesc();

                                                %>
                                                <fo:table-row>
                                                    <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(desc)%></fo:block></fo:table-cell>
                                                    <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(descTSI)%></fo:block></fo:table-cell>
                                                </fo:table-row>
                                                <% }%>             
                                            </fo:table-body>
                                        </fo:table>
