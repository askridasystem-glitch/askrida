    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-size="<%=fontsize%>" text-align="justify" space-after.optimum="10pt">
                I/We, <fo:inline font-weight="bold"><%=JSPUtil.printX(pol.getStCustomerName().toUpperCase())%></fo:inline>, hereby acknowledge that I/We have received the payment of total IDR <fo:inline font-weight="bold"><%= JSPUtil.printX(pol.getDbClaimAmount(), 2)%></fo:inline>,
            ...
            <fo:block font-size="<%=fontsize%>" text-align="justify" space-after.optimum="10pt">
                By issuing this letter, I/We shall release the Insurer from any further actions, suits, claims, and any further expenses related to the claim.
            </fo:block>  
            ...
            <fo:block font-size="<%=fontsize%>">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell >
                                <fo:block text-align="center" font-weight="bold">THE INSURED</fo:block>
                            </fo:table-cell>
