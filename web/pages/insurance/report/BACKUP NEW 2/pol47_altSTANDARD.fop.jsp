                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2"><fo:block >
                                    <fo:inline font-weight="bold">PT. ASURANSI BANGUN ASKRIDA</fo:inline> berkedudukan di <fo:inline font-weight="bold"><%=Parameter.readString("ASKRIDA_ADDRESS")%></fo:inline>.
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>: <fo:inline font-weight="bold"><%=JSPUtil.xmlEscape(pol.getStCustomerAddress())%></fo:inline></fo:block></fo:table-cell>
                        </fo:table-row>
