...
<% {%>
      ...
      <fo:block font-size="16pt" font-family="TAHOMA" line-height="5pt" space-after.optimum="5pt"
            ...
            text-align="center"
            padding-top="10pt">
       {L-ENG List of Attachement Fire Insurance -L}{L-INA Lampiran Polis Kebakaran -L}
      </fo:block>
      ...
      <fo:block font-size="14pt" font-family="TAHOMA" line-height="5pt" space-after.optimum="20pt"
            color="black"
            text-align="center"
            padding-top="10pt">
        ...
        <fo:table table-layout="fixed">
         ...
         <fo:table-body>
           ...
           <fo:table-row>
             ...
             <fo:table-cell><fo:block>{L-ENG Occupation -L}{L-INA Okupasi -L}</fo:block></fo:table-cell>
             ...
             <fo:table-cell><fo:block>{L-ENG Location -L}{L-INA Lokasi -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Description -L}{L-INA Description -L}</fo:block></fo:table-cell>
             <fo:table-cell><fo:block>{L-ENG Postcode -L}{L-INA Kodepos -L}</fo:block></fo:table-cell>
...
<% if (j==0) {%>
            <fo:table-row>
             ...
             <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStRiskDetailDescription("stRiskClass"))%></fo:block></fo:table-cell>
...
%>
       ...
       <fo:block font-size="5pt" space-before.optimum="30pt">
      </fo:block>
