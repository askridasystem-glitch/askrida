...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions">
    ...
    <fo:page-sequence master-reference="only">
        ...
        <fo:flow flow-name="xsl-region-body">
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStReference8().toUpperCase())%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell><fo:block>Jabatan</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStReference9().toUpperCase())%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell><fo:block>Perusahaan</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getEntity(obj.getStReference6()).getStEntityName())%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3">
                                <fo:block space-before.optimum="10pt" space-after.optimum="10pt">
                                    Dengan ini menyatakan bahwa <%=JSPUtil.printX(pol.getStPolicyTypeDesc2())%> atas nama
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell>
                                <fo:block><%=JSPUtil.printX(obj.getStReference10())%></fo:block>
                                <fo:block>Tanggal : <%=DateUtil.getDateStr(obj.getDtReference1(), "dd ^^ yyyy")%></fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getStReference12())%></fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" space-before.optimum="5pt" space-after.optimum="5pt" text-align="justify">Saya bersedia menanggung segala resiko apabila kemudian diketahui bahwa (<%=JSPUtil.printX(pol.getStPolicyTypeDesc2())%>) tersebut diatas adalah <fo:inline font-weight="bold" text-decoration="underline">PALSU</fo:inline>.</fo:block>
            ...
            <fo:block font-size="6pt" space-after.optimum="250pt">
