            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>No. Bond :</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell><fo:block>Nilai :<%=JSPUtil.print(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-INA 1. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA Dengan ini dinyatakan bahwa kami : -L} <fo:inline font-weight="bold"><%=JSPUtil.xmlEscape(obj.getStReference1())%></fo:inline> {L-INA yang beralamat di -L} <%=JSPUtil.printX(obj.getStReference3())%>  {L-INA sebagai Penyedia/Peserta, selanjutnya disebut TERJAMIN, dan -L} <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference6Desc())%></fo:inline> {L-INA yang beralamat di -L}<%=JSPUtil.xmlEscape(obj.getStReference7())%>{L-INA sebagai Penjamin, selanjutnya disebut sebagai PENJAMIN, bertanggung jawab dan dengan tegas terikat pada -L} <fo:inline font-weight="bold"><%=JSPUtil.xmlEscape(pol.getStCustomerName())%></fo:inline> {L-INA yang beralamat di -L} <%=JSPUtil.xmlEscape(pol.getStCustomerAddress())%>{L-INA sebagai Pelaksana Pelelangan Umum, selanjutnya disebut sebagai PENERIMA JAMINAN atas uang sejumlah -L}<%=JSPUtil.print(pol.getStCurrencyCode())%> <%=JSPUtil.printX(pol.getDbInsuredAmount(), 2)%> {L-INA Terbilang ( -L}<%=NumberSpell.readNumber(JSPUtil.printX(pol.getDbInsuredAmount(), 2))%> <%=JSPUtil.printX(pol.getCurrency().getStCcyDescription())%> )</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-INA 2. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA Maka kami TERJAMIN dan PENJAMIN dengan ini mengikatkan diri untuk melakukan pembayaran jumlah tersebut diatas dengan baik dan benar bilamana TERJAMIN tidak memenuhi kewajiban sebagaimana ditetapkan dalam Dokumen Pengadaan -L} <% if (obj.getStReference10() != null) {%> <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference10())%></fo:inline> {L-INA tanggal -L} <%=DateUtil.getDateStr(obj.getDtReference1(), "d ^^ yyyy")%> <% }%> {L-INA untuk pelaksanaan pelelangan pekerjaan -L} <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference11())%></fo:inline> {L-INA yang diselenggarakan oleh PENERIMA JAMINAN. -L}. </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-INA 3. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA Surat jaminan ini berlaku apabila TERJAMIN : -L}</fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA a. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA Menarik kembali penawarannya selama dilaksanakannya pelelangan atau sesudah dinyatakan sebagai pemenang. -L}</fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA b. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA Tidak : -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA (i) -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA Menyerahkan Jaminan Pelaksanaan setelah ditunjuk sebagai Pemenang, -L}</fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA (ii) -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA menandatangani Kontrak, -L}</fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA (iii) -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA Hadir dalam klarifikasi dan/atau verifikasi sebagai calon Pemenang. -L}</fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA c. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA terlibat Korupsi, Kolusi dan Nepotisme (KKN); atau -L}</fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA d. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA melakukan penipuan /pemalsuan atas informasi yang disampaikan dalam Dokumen Penawaran -L}</fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-INA 5. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA PENJAMIN akan membayar kepada PENERIMA JAMINAN sejumlah nilai jaminan tersebut di atas dalam waktu paling lambat 14 (empat belas) hari kerja tanpa syarat (UNCONDITIONAL) setelah menerima tuntutan penagihan secara tertulis dari PENERIMA JAMINAN berdasar Keputusan PENERIMA JAMINAN mengenai pengenaan sanksi akibat TERJAMIN cidera/wanprestasi. -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-INA 6. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA Menunjuk pada pasal 1832 KUH Perdata dengan ini ditegaskan kembali bahwa PENJAMIN melepaskan hak-hak istimewa untuk menuntut supaya harta benda TERJAMIN lebih dahulu disita dan dijual guna dapat melunasi hutangnya sebagaimana dimaksud dalam Pasal 1831 KUH Perdata. -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-INA 7. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-INA Tuntutan pencairan terhadap PENJAMIN berdasarkan Jaminan ini harus sudah diajukan selambat-lambatnya dalam waktu 30 (tiga puluh) hari kalender sesudah berakhirnya masa berlaku Jaminan ini. -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell>
                                ...
                                <fo:block >{L-INA Ditanda tangani serta dibubuhkan materai di -L}
                                    <%= JSPUtil.printX(pol.getStCostCenterDesc())%><%if (!tanpaTanggal) {%>, {L-INA pada tanggal -L} <%=DateUtil.getDateStr(pol.getDtPolicyDate(), "d ^^ yyyy")%><%}%>.</fo:block>
                                    <% } else {%>
                                <fo:block >{L-INA Ditanda tangani serta dibubuhkan materai di -L}
                                    <%= JSPUtil.printX(pol.getCostCenter(pol.getCostCenter(pol.getStCostCenterCode()).getStSubCostCenterCode()).getStDescription())%><%if (!tanpaTanggal) {%>, {L-INA pada tanggal -L} <%=DateUtil.getDateStr(pol.getDtPolicyDate(), "d ^^ yyyy")%><%}%>.</fo:block>
                                    <% }%>
                            </fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-size="<%=fontsize%>" text-align = "center">{L-INA SURETY -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3"><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-size="<%=fontsize%>" text-align = "center">{L-INA PRINCIPAL -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-size="<%=fontsize%>" text-align = "center">{L-INA SURETY -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-INA Biaya Materai -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                        ...
                        <% if (tanpaPrincipal) {%>
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-INA Administrasi -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block>{L-INA Jumlah -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>:</fo:block></fo:table-cell>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>KNOW ALL MEN BY THIS PRESENT, that we: <fo:inline font-weight="bold"><%=JSPUtil.xmlEscape(obj.getStReference1())%></fo:inline> <%=JSPUtil.printX(obj.getStReference3())%>, as Bidder, hereinafter called THE PRINCIPAL and <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference6Desc())%></fo:inline> <%=JSPUtil.printX(obj.getStReference7())%> as Surety, hereinafter called THE SURETY, are held and firmly bound unto <fo:inline font-weight="bold"><%=JSPUtil.xmlEscape(pol.getStCustomerName())%></fo:inline> <%=pol.getStCustomerAddress()%>, called THE OBLIGEE, in the amount of <%=JSPUtil.print(pol.getStCurrencyCode())%> <%=JSPUtil.printX(pol.getDbInsuredAmount(), 2)%> in words: <%=NumberSpell.readNumber(JSPUtil.printX(pol.getDbInsuredAmount(), 2), pol.getStCurrencyCode())%> <%=JSPUtil.printX(pol.getCurrency().getStCcyDescription())%>. </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>For the payment of which sum, well and truly to be made, we THE PRINCIPAL and THE SURETY bind ourselves, our successors and assignees, jointly and severally, firmly by this presents that if THE PRINCIPAL falls to fulfill this obligation as specified in the Documents for the Bidding for <fo:inline font-weight="bold"><%=JSPUtil.printX(obj.getStReference11())%></fo:inline>, for which the bid is to held by THE OBLIGEE. </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>NOW THERE FOR, the conditions of this obligation are: </fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>If THE PRINCIPAL withdraw his bid during the period of bid validity specified in the Form of Bid, or </fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>(ii)</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>If THE PRINCIPAL, having been notified of the acceptance of this Bid by THE OBLIGEE during the period on Bid validity; </fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>Fails or refuses to execute the Form of Contract Agreement, in accordance with the Instructions to Bidders, if required, or </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>Fails or refuses to furnish the Performance Security in accordance with the instructions to Bidders.</fo:block></fo:table-cell>
                        </fo:table-row>
            ...
            <fo:block font-size="<%=fontsize%>" text-align = "justify">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>Then this obligation shall remain in full force and effect as from <%=DateUtil.getDateStr(pol.getDtPeriodStart(), "d ^^ yyyy")%> up to <%=DateUtil.getDateStr(pol.getDtPeriodEnd(), "d ^^ yyyy")%> otherwise the default by THE PRINCIPAL.</fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>Any claim on this bond as result of the default by THE PRINCIPAL from the documents for bidding shall be made in written application by THE OBLIGEE promptly after such default arises. THE SURETY shall pay to the full amount of this Bid Bond unconditionally not later than 30 (thirty) calendar days after having received a written claim based on THE OBLIGEE's Decree concerning the default by THE PRINCIPAL. </fo:block></fo:table-cell>
                        </fo:table-row>
...
<%--
            ...
            <fo:block font-size="6pt" space-after.optimum="50pt">
                <%if (!tanpaTanggal) {%>
