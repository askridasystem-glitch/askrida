                                        ...
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    ...
                                                    <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                                                    <fo:table-cell >
                                                        <fo:block><%=JSPUtil.printX(ded.getStAutoDesc().replace(".000.00 null", ".00"))%></fo:block>
                                                        <fo:block><%=JSPUtil.xmlEscape(desc)%></fo:block>
                                                    </fo:table-cell>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="3"><fo:block text-align="center"><%=JSPUtil.xmlEscape(desc)%></fo:block></fo:table-cell>
                        </fo:table-row>
