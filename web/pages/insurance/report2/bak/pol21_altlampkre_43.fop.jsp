            ...
            <fo:block font-size="<%=fontsize%>" font-family="TAHOMA">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>         
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Condition Insured-L}{L-INA Kondisi Pertanggungan-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.print(pol.getStKreasiTypeDesc().substring(0, 17))%></fo:block></fo:table-cell>
                        </fo:table-row>
