...
<%
            ...
            String desc = pol.getStKreasiTypeDesc();
            desc = desc.replaceAll("20 -", "");
            if (desc.endsWith("JIWASRAYA")) {
                desc = desc.replaceAll("JIWASRAYA", "");
            }
            ...
            <fo:block font-size="<%=fontsize%>" font-family="TAHOMA">
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>         
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block>{L-ENG Credit Plafon-L}{L-INA Jenis Pertanggungan-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                        ...
                        <%
                                    ...
                                    DTOList cover1 = obj2.getCoverage();

                                    for (int r = 0; r < cover1.size(); r++) {

                                        InsurancePolicyCoverView cov = (InsurancePolicyCoverView) cover1.get(r);
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block padding-top="5pt" text-align="center" line-height="5mm" >{L-ENG Sum Insured -L}{L-INA Harga Pertanggungan -L}</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block padding-top="5pt" text-align="center" line-height="5mm" >{L-ENG Coverage -L}{L-INA Perluasan Jaminan -L}</fo:block></fo:table-cell>
                        </fo:table-row>
