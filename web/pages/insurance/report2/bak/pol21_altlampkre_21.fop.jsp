        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <%
                        ...
                        for (int k = 0; k < coins.size(); k++) {
                            ...
                            if (!coi.getStPositionCode().equalsIgnoreCase("LDR")) {
                                continue;
                            }
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < objects.size(); i++) {
                                        ...
                                        for (int j = 0; j < suminsureds.size(); j++) {
                                            ...
                                            /*
                                            String nama = obj.getStReference1();
                                            String cetak_nama = null;
                                            if(nama.length()<15)
                                            cetak_nama = nama.substring(0,nama.length());
                                            else
                                            cetak_nama = nama.substring(0,15);
   ...
   <%
   		...
   		subTotalPremi = null;
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(obj.getDbObjectInsuredAmount(), 0)%></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid" border-right-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(obj.getDbReference6(), 0)%></fo:block></fo:table-cell>
                            <fo:table-cell  border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" ></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="end"  line-height="5mm"><%=JSPUtil.printX((BigDecimal) objects.getTotal("refn6"), 0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>= <%=JSPUtil.print(pol.getStCurrencyCode())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX((BigDecimal) objects.getTotal("refn6"), 0)%></fo:block></fo:table-cell>
                        </fo:table-row>
