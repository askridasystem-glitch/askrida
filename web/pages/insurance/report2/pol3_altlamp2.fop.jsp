                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG Type of Vehicle -L}{L-INA Merek / Jenis -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Police No. -L}{L-INA No. Polisi -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Year -L}{L-INA Tahun -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Chassis No. -L}{L-INA No. Rangka -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Engine No. -L}{L-INA No. Mesin -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Name -L}{L-INA Nama -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Period Start -L}{L-INA Tanggal Awal -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Period End -L}{L-INA Tanggal Akhir -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG TSI Kasko -L}{L-INA TSI Kasko -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Premi Kasko -L}{L-INA Premi Kasko -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG TSI TJH -L}{L-INA TSI TJH -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Premi TJH -L}{L-INA Premi TJH -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Premi Lainnya -L}{L-INA Premi Lainnya -L}</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < objects.size(); i++) {
                                        ...
                                        coverage = obj.getStCoverageDesc();
                                        deductible = obj.getStDeductibleDesc();

                        %>

                        <fo:table-row>
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(String.valueOf(i + 1))%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getDesc("stReference2"))%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell><fo:block text-align="center"><%=JSPUtil.printX(obj.getStReference9())%></fo:block></fo:table-cell>
                                    ...
                                    <fo:block font-size="<%=fontsize%>">
                                        <fo:table table-layout="fixed">
                                            ...
                                            <fo:table-body> 
                                                ...
                                                <%
                                                                                        DTOList cover = obj.getCoverVehicle();

                                                                                        for (int j = 0; j < cover.size(); j++) {
                                                                                            InsurancePolicyCoverView cov = (InsurancePolicyCoverView) cover.get(j);

                                                                                            int n = 0;
                                                                                            t[n] = BDUtil.add(t[n++], cov.getDbInsuredAmount());
                                                                                            t[n] = BDUtil.add(t[n++], cov.getDbRate());
                                                                                            t[n] = BDUtil.add(t[n++], cov.getDbPremi());
                                                                                            t[n] = BDUtil.add(t[n++], cov.getDbPremiNew());
                                                                                            t[n] = BDUtil.add(t[n++], cov.getDbPremiNot());
                                                                                            t[n] = BDUtil.add(t[n++], cov.getDbPremiTotal());

                                                %>         			   

                                                <fo:table-row>

                                                    <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(cov.getDbInsuredAmount(), 2)%></fo:block></fo:table-cell>
                                                    <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(cov.getDbRate(), 2)%></fo:block></fo:table-cell>
                                                    <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(cov.getDbPremi(), 2)%></fo:block></fo:table-cell>
                                                    <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(cov.getDbPremiNew(), 2)%></fo:block></fo:table-cell>
                                                    <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(cov.getDbPremiNot(), 2)%></fo:block></fo:table-cell>
                                                    <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(cov.getDbPremiTotal(), 2)%></fo:block></fo:table-cell>
                                                </fo:table-row> 
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block ><%=JSPUtil.printX(coverage)%></fo:block></fo:table-cell >
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell ><fo:block >{L-ENG Deductible -L}{L-INA Resiko Sendiri -L}</fo:block></fo:table-cell >
                            <fo:table-cell ><fo:block text-align="center">:</fo:block></fo:table-cell >
                            <fo:table-cell ><fo:block ><%=JSPUtil.printX(deductible)%></fo:block></fo:table-cell >
                        </fo:table-row>
