                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG Occupation -L}{L-INA Penggunaan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Class Construction -L}{L-INA Kelas Konstruksi -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Building Category -L}{L-INA Kategori Bangunan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Zone -L}{L-INA Zona -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Year of Built -L}{L-INA Tahun Pembuatan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Risk Location -L}{L-INA Alamat Resiko -L}</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getDesc("stReference3"))%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell><fo:block><%=JSPUtil.printX(obj.getDesc("stReference9"))%></fo:block></fo:table-cell>
