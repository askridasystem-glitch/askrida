                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Maka kami PRINCIPAL dan SURETY dengan ini mengikatkan diri untuk melakukan pembayaran jumlah tersebut di atas dengan baik dan benar bilamana pihak PRINCIPAL tidak memenuhi kewajibannya dalam pemeliharaan pekerjaan yang telah dipercayakan kepadanya atas dasar kontrak pekerjaan dari OBLIGEE No.  -L} <%=JSPUtil.printX(obj.getStReference10())%>{L-ENG 1. -L}{L-INA tanggal -L} <%=DateUtil.getDateStr(obj.getDtReference1(), "d ^^ yyyy")%> {L-ENG XXX -L}{L-INA antara pihak PRINCIPAL dan pihak OBLIGEE, dan jaminan pemeliharaan ini merupakan bagian yang tidak terpisahkan dari kontrak tersebut. -L} </fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Adapun ketentuan dari Surat Jaminan ini adalah jika PRINCIPAL : -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Memelihara pekerjaan tersebut dengan baik dan benar sesuai dengan ketentuan dalam kontrak; atau -L}</fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG b. -L}{L-INA b. -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Membayar, memperbaiki, dan mengganti pada OBLIGEE semua kerugian dan kerusakan yang mungkin diderita OBLIGEE oleh sebab kegagalan atau kelalaian dari pihak PRINCIPAL dalam melaksanakan kontrak; -L}</fo:block></fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA maka jaminan ini tidak berlaku lagi; jika tidak maka jaminan ini tetap berlaku dari tanggal -L} <%=DateUtil.getDateStr(pol.getDtPeriodStart(), "d ^^ yyyy")%> {L-ENG XXX -L}{L-INA sampai dengan tanggal -L} <%=DateUtil.getDateStr(pol.getDtPeriodEnd(), "d ^^ yyyy")%> {L-ENG XXX -L}{L-INA dan dapat dimintakan perpanjangannya oleh PRINCIPAL sampai 14 (empat belas) hari setelah masa jainan berakhir.-L} </fo:block></fo:table-cell>
                        </fo:table-row>
