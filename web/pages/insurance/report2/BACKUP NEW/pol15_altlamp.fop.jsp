                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG Vassels Name-L}{L-INA Nama Kapal-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Type-L}{L-INA Jenis Kapal-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Constraction-L}{L-INA Konstruksi Kapal-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Year of Built-L}{L-INA Tahun Pembuatan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG GRT -L}{L-INA GRT Kapal-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Class-L}{L-INA Kelas-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block>{L-ENG Flag -L}{L-INA GRT Bendera-L}</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell >
                                ...
                                <fo:block text-align="center">{L-ENG Signed at-L}{L-INA Dibuat di-L} 
                                    ...
                                    <% } else {%>
                                <fo:block text-align="center">{L-ENG Signed at-L}{L-INA Dibuat di-L} 
                                    <%= JSPUtil.printX(pol.getCostCenter(pol.getCostCenter(pol.getStCostCenterCode()).getStSubCostCenterCode()).getStDescription())%><%= JSPUtil.printX(pol.getCostCenter(pol.getCostCenter(pol.getStCostCenterCode()).getStSubCostCenterCode()).getStDescription())%><%if (!tanpaTanggal) {%>, {L-ENG On-L}{L-INA pada tanggal-L} <%=DateUtil.getDateStr(pol.getDtPolicyDate(), "d ^^ yyyy")%><%}%></fo:block>
                                    <% }%>
