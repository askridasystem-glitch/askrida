                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="center">{L-ENG Interest Insured-L}{L-INA Yang Dipertanggungkan-L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="center">{L-ENG Business-L}{L-INA Jenis Usaha-L}</fo:block></fo:table-cell>
                            ...
                            <fo:table-cell><fo:block text-align="end">{L-ENG Total Sum Insured -L}{L-INA Total H. Pertanggungan -L}</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end">{L-ENG Premium -L}{L-INA Premi -L}</fo:block></fo:table-cell>
                        </fo:table-row>
