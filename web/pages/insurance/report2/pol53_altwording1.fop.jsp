                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block> Jaminan ini berlaku apabila : </fo:block></fo:table-cell>
                        </fo:table-row>            

                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell><fo:block> TERJAMIN tidak memenuhi kewajibannya melakukan pembayaran kembali kepada PENERIMA JAMINAN senulai uang Muka yang wajib dibayar menurut Dokumen Kontrak </fo:block></fo:table-cell>
                        </fo:table-row>
...
<%--
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block>{L-ENG XXX -L}{L-INA Kepada KPPN Padang (yang menerbitkan SP2D uang muka), berdasarkan surat kuasa Pemegang Jaminan atau Obligee dapat mengajukan tuntutan klaim penagihan kepada Penjamin sampai dengan berakhirnya masa klaim Jaminan Uang Muka. -L}</fo:block></fo:table-cell>
                        </fo:table-row>--%>
                        ...
                        <fo:table-row>
                            <fo:table-cell><fo:block> </fo:block></fo:table-cell>
                            <fo:table-cell>
                                <fo:block > {L-ENG XXX -L}{L-INA Dikeluarkan di -L}  <%= JSPUtil.printX(pol.getCostCenter(pol.getCostCenter(pol.getStCostCenterCode()).getStSubCostCenterCode()).getStDescription())%> {L-ENG XXX -L}{L-INA ditanda tangani serta dibubuhkan materai -L}
            ...
            <fo:block font-size="6pt" space-after.optimum="140pt">
