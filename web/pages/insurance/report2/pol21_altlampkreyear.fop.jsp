                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell number-columns-spanned="7" ><fo:block>:  <%= no_polis_cetak%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2" ><fo:block>{L-ENG Policy Date-L}{L-INA Tanggal Polis-L}</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="7" ><fo:block>:  <%=JSPUtil.print(pol.getDtPolicyDate())%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2" ><fo:block>{L-ENG On Behalf of-L}{L-INA Atas Nama-L}</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="7" ><fo:block>:  <%=pol.getStCustomerName()%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="2" ><fo:block>{L-ENG Credit Plafon-L}{L-INA Plafon Kredit-L}</fo:block></fo:table-cell>
                            <fo:table-cell number-columns-spanned="7" ><fo:block>:  <%=JSPUtil.print(pol.getStKreasiTypeDesc())%></fo:block></fo:table-cell>
                        </fo:table-row>

                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="9"><fo:block space-before.optimum="5pt" ></fo:block></fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>   
                        ...
                        <%
                                    ...
                                    DTOList objects = pol.getObjects_Year();
                                    ...
                                    for (int i = 0; i < objects.size(); i++) {
                                        ...
                                        if (i > 0) {
                                            ...
                                            String tanggal = obj.getStReference6();
                                            String tanggal2 = obj2.getStReference6();
                                            if (!tanggal.equalsIgnoreCase(tanggal2)) {
                                                pn++;
