            ...
            <%
                                if (isAttached) {
                                    ...
                                    for (int i = 0; i < objects.size(); i++) {
                                        ...
                                        debitur = Integer.toString(objects.size());
                                    }
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block>:</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block><%=JSPUtil.printX(debitur)%> {L-ENG Object - See Attached-L}{L-INA Objek Pertanggungan - Lihat Lampiran -L}</fo:block></fo:table-cell>
                        </fo:table-row>
