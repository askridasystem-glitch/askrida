                ...
                <fo:table table-layout="fixed">
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="9">
                                <fo:block font-size="16pt" text-align="center" space-after.optimum="10pt">
                                    {L-ENG List of Attachement Investment Credit Insurance-L}{L-INA Lampiran Polis Asuransi Kredit Investasi-L}
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="start" line-height="5mm" font-size="8pt"><fo:inline color="white">.</fo:inline><%=JSPUtil.printX(obj.getStReference1())%></fo:block></fo:table-cell>
