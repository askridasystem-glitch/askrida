                ...
                <fo:table table-layout="fixed">
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="9">
                                <fo:block font-size="16pt" text-align="center" space-after.optimum="10pt">
                                    {L-ENG List of Attachement Credit Productive Insurance-L}{L-INA Lampiran Polis Asuransi Kredit Produktif-L}
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < objects.size(); i++) {
                                        ...
                                        if (obj.getStPolicyObjectRefID() != null) {
                                            ...
                                            System.out.print("################### :" + obj.getDtReference3());
                                            System.out.print("@@@@@@@@@@@@@@@@@@@ :" + polObj.getDtReference3());
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" ><%=JSPUtil.printX(obj.getStReference4Desc())%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="center" line-height="5mm" font-size="7pt"><%=JSPUtil.printX(obj.getStReference7())%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-left-style="solid"><fo:block text-align="end" line-height="5mm" ><%=JSPUtil.printX(pol.getDbInsuredAmountEndorse(), 2)%><fo:inline color="white">.</fo:inline></fo:block> </fo:table-cell>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block font-size="<%=fontsize%>" text-align = "center" >
                                    <%if (pol.getParaf() != null) {%><fo:leader leader-length="10mm"/><%}%>
                                    <%=JSPUtil.printX(pol.getUser(pol.getUserIDSign()).getStJobPosition()).toUpperCase()%>
                                    <%if (pol.getParaf() != null) {%>
                                    <fo:external-graphic content-height="scale-to-fit" height="0.3in" content-width="0.3in" scaling="non-uniform" overflow="hidden" src="url(<%=pol.getUser(pol.getParaf()).getParafFile().getStFilePath()%>)"  />
                                    <%}%>
                                </fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                        </fo:table-row>
