   ...
   <body>
      <form name=f method=POST action="ctl.ctl" onsubmit="return dovalidate();">
         ...
         <table cellpadding=2 cellspacing=1>
            <tr>
               <td>
                  <%=jspUtil.getHeaderOnly("JURNAL UANG MUKA KOMISI")%>
               </td>
            </tr>
            <tr>
               ...
               <td>
                  <table cellpadding=2 cellspacing=1>
                     <tr class=header>
                        ...
                        <td>DEBIT</td>
                        <td>CREDIT</td>
                        <td><%=ro?"":jspUtil.getButtonNormal("crt","+","submitEvent('COMIS_GL_ENTRY_ADD_LINE')")%></td>
                     </tr>
<%
...
%>
                     <tr class=row<%=i%2%>>
                        ...
                        <td><%=!allowDelete?"":jspUtil.getButtonNormal("bx","-","document.all.rn.value="+i+";submitEvent('COMIS_ENTRY_DEL_LINE')")%></td>
                     </tr>
...
<% if (!ro) {%>
            <tr>
               <td align=center>
                  <%=jspUtil.getButtonSubmit("bsave","Save","dialogReturn('yay');f.EVENT.value='COMIS_GL_ENTRY_SAVE'")%>
