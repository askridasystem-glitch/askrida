    ...
    <table cellpadding=2 cellspacing=1>
                    ...
                    <tr>
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                ...
                                <tr>
                                    <td><c:button show="true" text="Konversi" event="uploadExcelCashBank"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            ...
                            <c:listbox name="details" paging="true" >
                                ...
                                <c:listcol title="Keterangan" >
                                    <c:field name="details.[$index$].stDescription" width="400" mandatory="true" caption="Deskripsi" type="string" readonly="false" />
                                </c:listcol>
                                <c:listcol title="Polis" >
                                    <c:field name="details.[$index$].stPolicyNo" width="150" caption="Deskripsi" type="string" readonly="false" />
                                </c:listcol>
        ...
        <td align=center>
            <c:evaluate when="<%=!readOnly%>" >
                ...
                <c:button text="Simpan" event="doSaveCashBank" validate="true" confirm="Do you want to save ?" />
