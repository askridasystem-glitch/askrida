...
<%@ taglib prefix="c" uri="crux" %><c:frame title="UPLOAD JOURNAL KAS BANK" >
    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr>
            <td>
                ...
                <c:listbox name="cashbankList" selectable="true" paging="true" view="com.webfin.gl.model.JournalView" autofilter="true">
        ...
        <tr>
            <td>
                <c:button  text="Upload Excel" event="clickUploadCashBank" />
            </td>
        </tr>
    </table>
