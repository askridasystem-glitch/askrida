    ...
    <table cellpadding=2 cellspacing=1>
        <tr>
            <td>
                <table cellpadding=2 cellspacing=1>
                    ...
                    <tr>
                        <td>
                            <c:button show="true" text="Konversi" event="uploadExcelNoper"/>
                        </td>
                    </tr>
                        ...
                        <td>
                            ...
                            <c:listbox name="details" >
                                ...
                                <c:listcol title="Noper" >
                                    <c:field name="details.[$index$].stNoper" width="100" mandatory="true" caption="Deskripsi" type="string" readonly="false" />
                                </c:listcol>
                                ...
                                <c:listcol title="ID" >
                                    <c:field name="details.[$index$].stAccountID" width="100" mandatory="true" caption="Deskripsi" type="string" readonly="false" />
                                </c:listcol>
                            </c:listbox>
                        </td>
                    </tr>
        ...
        <td align=center>
            <c:evaluate when="<%=!readOnly%>" >
                <c:button text="Simpan" event="doSaveNoper" validate="true" confirm="Do you want to save ?" />
