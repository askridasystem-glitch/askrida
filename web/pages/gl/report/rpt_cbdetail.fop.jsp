...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        SQLAssembler sqa = form.getSQACashBank();
        
        sqa.clearOrder();
        sqa.addOrder("trx_id asc");
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block font-weight="bold" text-align="center" line-height="20mm">DAFTAR MUTASI</fo:block>
	...
	<fo:table-footer>
		<fo:table-row>
	      <fo:table-cell border-width="<%=bw%>" padding="2pt"  column-span="2"><fo:block line-width="100mm"  background-color="#C0C0C0"  text-align="center" font-size="10pt" font-weight="bold"><fo:page-number/></fo:block></fo:table-cell>
          <fo:table-cell border-width="<%=bw%>" padding="2pt" border-bottom-style="solid" border-left-style="solid"><fo:block text-align="center" font-size="10pt" font-weight="bold">Total Perhalaman</fo:block></fo:table-cell>
          <fo:table-cell border-width="<%=bw%>" padding="2pt"  border-bottom-style="solid" border-left-style="solid"><fo:block text-align="center" font-size="10pt" font-weight="bold"><fo:retrieve-marker retrieve-class-name="tes" /></fo:block></fo:table-cell>
          <fo:table-cell border-width="<%=bw%>" padding="2pt"  border-bottom-style="solid" border-left-style="solid"><fo:block text-align="center" font-size="10pt" font-weight="bold"></fo:block></fo:table-cell>
          <fo:table-cell border-width="<%=bw%>" padding="2pt"  border-bottom-style="solid" border-left-style="solid"><fo:block text-align="center" font-size="10pt" font-weight="bold"></fo:block></fo:table-cell>
		  <fo:table-cell border-width="<%=bw%>" padding="2pt"  border-bottom-style="solid" border-left-style="solid"><fo:block text-align="center" font-size="10pt" font-weight="bold"></fo:block></fo:table-cell>
	...
	--%>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row  >
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="2pt"><fo:block text-align="start" font-size="8pt"><%=JSPUtil.print(jv.getStTransactionNo())%></fo:block></fo:table-cell>
