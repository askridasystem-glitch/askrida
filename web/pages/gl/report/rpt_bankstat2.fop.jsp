<%@ page import="com.webfin.gl.form.GLListForm,
                 ...
                 com.webfin.gl.util.GLUtil,
                 com.crux.util.ListUtil"%><?xml version="1.0" ?>
...
<%
   ...
   sqa2.addOrder("applydate asc");

   sqa2.addClause("a.trx_hdr_id=c.trx_hdr_id and not(a.trx_id=c.trx_id)");

   sqa2.setPar(sqa.getPar());

   DTOList list = sqa2.getList(JournalView.class);
   ...
   for (int i = 0; i < list.size(); i++) {
      ...
      %>
         <fo:table-row  >
             ...
             <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="1pt"  border-left-style="solid"><fo:block line-height="5mm"   text-align="start" font-size="8pt" font-weight=""><%=JSPUtil.printX(jv.getStTransactionNo())%></fo:block></fo:table-cell>
             <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="1pt"  border-left-style="solid"><fo:block line-height="5mm"   text-align="start" font-size="8pt" font-weight=""><%=JSPUtil.printX(jv.getDtApplyDate())%></fo:block></fo:table-cell>
             ...
             <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="1pt" border-left-style="solid"><fo:block line-height="5mm"   text-align="start" font-size="8pt" font-weight=""><%=JSPUtil.printX(jv.getStAccountNo())%></fo:block></fo:table-cell>
             <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="1pt"  border-left-style="solid"><fo:block line-height="5mm"   text-align="end" font-size="8pt" font-weight=""><%=JSPUtil.printX(jv.getDbDebit(),2)%></fo:block></fo:table-cell>
             <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="1pt"  border-left-style="solid"><fo:block line-height="5mm"   text-align="end" font-size="8pt" font-weight=""><%=JSPUtil.printX(jv.getDbCredit(),2)%></fo:block></fo:table-cell>
             <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="1pt"  border-left-style="solid"><fo:block line-height="5mm"   text-align="end" font-size="8pt" font-weight=""><%=JSPUtil.printX(jv.getDbBalance(),2)%></fo:block></fo:table-cell>
         </fo:table-row  >
