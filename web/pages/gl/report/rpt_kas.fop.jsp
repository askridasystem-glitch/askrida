                ...
                <fo:table table-layout="fixed">  
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="4">
                                <fo:block font-family="serif" font-weight="bold" font-size="16pt" text-align="center">             
                                    <fo:inline text-decoration="underline">POSISI KAS</fo:inline>   
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block ><%=JSPUtil.printX(pol.getStDescription())%> <%=pol.getCostCenter().getStDescription().toUpperCase()%></fo:block></fo:table-cell>    <!-- No --><!-- Period --> 
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" border-right-style="solid"><fo:block text-align="end"><%=JSPUtil.printX(pol.getDbBalance(),0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" border-right-style="solid"><fo:block text-align="end"><%=JSPUtil.printX(t[0],0)%></fo:block></fo:table-cell> 
                        </fo:table-row>   
