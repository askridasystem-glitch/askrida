                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>  
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3">
                                <fo:block font-family="serif" font-weight="bold" font-size="12pt" text-align="center">             
                                    KLAIM KOASURANSI <%=JSPUtil.printX(form.getPeriodTitleDescription().toUpperCase())%>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG REASURADUR -L}{L-INA REASURADUR -L}</fo:block></fo:table-cell><!-- Entry Date -->
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="center">{L-ENG TOTAL -L}{L-INA JUMLAH -L}</fo:block></fo:table-cell><!-- Policy No. --> 
                        </fo:table-row> 
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>   
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block text-align="center"><%=String.valueOf(i+1)%></fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" ><fo:block ><%=JSPUtil.printX(pol.getStTransactionNo())%></fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" padding="2pt" border-right-style="solid"><fo:block text-align="end" ><%=JSPUtil.printX(pol.getDbDebit(),0)%></fo:block></fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid" padding="2pt" ><fo:block text-align="end"><%=JSPUtil.printX(t[0],0)%></fo:block></fo:table-cell><!-- Total Premi --> 
                        </fo:table-row>   
