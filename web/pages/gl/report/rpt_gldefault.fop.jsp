...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        SQLAssembler sqa = form.getSQARECAP();
        
        sqa.addGroup("date_trunc('day',a.create_date),a.trx_no,d.value_string,substr(b.accountno,1,5),substr(b.accountno,13,3),c.details_size order by a.trx_no,substr(b.accountno,1,5) ");
                ...
                <fo:table table-layout="fixed" border-style="solid" border-width="<%=bw%>">
                    ...
                    <fo:table-body>
                        ...
                        for (int i = 0; i < list.size(); i++) {
                            ...
                            if (jv.getStPolicyID()!=null) {
                                if(jv.getStPolicyID().equalsIgnoreCase("1")) {
                                    description = Parameter.readStringAccounts("ACCOUNT_"+jv.getStAccountNo().substring(0,5));
                                } else {
                                    description = Parameter.readStringAccounts("ACCOUNT_"+jv.getStAccountNo().substring(0,5))+" Gab. "+jv.getStPolicyID()+" Polis ";
                                }
                            } else if (jv.getStPolicyID()==null){
                                description = jv.getStDescription();
                            }
                        ...
                        <fo:table-row  >
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="2pt"><fo:block text-align="end" font-size="8pt"><%=JSPUtil.print(debit,2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="2pt"><fo:block text-align="end" font-size="8pt"><%=JSPUtil.print(credit,2)%></fo:block></fo:table-cell>
                        </fo:table-row  >
                        ...
                        <fo:table-row  >
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt"><fo:block text-align="end" font-size="8pt" font-weight="bold"><%=JSPUtil.print(totalDebit,2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt"><fo:block text-align="end" font-size="8pt" font-weight="bold"><%=JSPUtil.print(totalCredit,2)%></fo:block></fo:table-cell>
                        </fo:table-row  >
