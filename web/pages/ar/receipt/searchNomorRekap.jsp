            ...
            <tr>
               <td>
                  <table cellpadding=2 cellspacing=1>
                     ...
                     <tr>
                        <td align="left">
                            <%=jspUtil.getButtonEvent("Search","AR_RECEIPT_SEARCH_NOMOR_REKAP")%>
                        </td>
                     </tr>
                  </table>
               </td>
...
%>
                     <tr class=row<%=i%2%>>
                        ...
                        <td><%=jspUtil.print(iv.getDbEnteredAmount(),2)%></td>
                        <td><%=jspUtil.print(iv.getDbAmountSettled(),2)%></td>
...
<script>
   ...
   function selectInvoiceBruto(o,p,q) {
      dialogReturn({NO_SURAT_HUTANG:o,TGL_MULAI:p,TGL_AKHIR:q,BRUTO:'Y'});
      window.close();
   }
</script>