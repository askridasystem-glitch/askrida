...
<%@ taglib prefix="c" uri="crux" %><c:frame title="PENGAJUAN ANGGARAN" >
    <%
    ...
    <table cellpadding=2 cellspacing=1>     
        ...
        <tr>
            <td>
                <c:listbox name="proposallist" autofilter="true" paging="true" selectable="true" view="com.webfin.ar.model.ARRequestFee" >
                    <%
        ...
        <tr>
            <td>
                <c:button text="Buat" event="clickCreateProposal" />
                <c:button text="Ubah" event="clickEditProposal" />
                <c:button text="Lihat" event="clickViewProposal" />
            </td>
        </tr>
        <tr>
            <td>
                <c:button show="<%=form.isCanApprove()%>" text="Validasi" event="clickValidasi" />
                <c:button show="<%=form.isOwnerAdm() || form.isOwnerPms() || form.isOwnerUmum()%>" text="Setujui Pemilik" event="clickAppProposal" />
            </td>
        </tr>
        <tr>
            <td>
                ...
                <c:button show="<%=form.isCanApproveDireksi()%>" text="Setujui Direksi" event="clickAppProposal" />
            </td>
        </tr>
        <%--
        <tr>
