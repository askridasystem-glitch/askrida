    ...
    <table cellpadding=2 cellspacing=1>
        ...
        <tr>
            <td>
                ...
                <%-- <c:button  text="Proses Data Foxpro" event="clickCreatePembayaranDataFoxpro2" />
         <c:button  text="Proses Data Koas Foxpro" event="clickCreatePembayaranDataFoxproKoas" />
         <c:button  text="Proses Data Komisi Foxpro" event="clickCreatePembayaranKomisiFoxpro2" />
         <c:button  text="Proses Jurnal Ulang" event="jurnalUlang" /> --%>
            </td>
        </tr>
        <tr>
            <td>
