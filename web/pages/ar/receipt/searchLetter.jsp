...
%>
   <body>
      <form name=f method=POST action="ctl.ctl">
         <input type=hidden name=EVENT value="AR_RECEIPT_SEARCH_LETTER">
               ...
               <td>
                  <table cellpadding=2 cellspacing=1>
                     <tr>
                        ...
                        <td>:</td>
                        <td><%=jspUtil.getInputText("key",new FieldValidator("Search No","string",50),key,200,JSPUtil.MANDATORY)%></td>
                     </tr>
                  </table>
               </td>
            </tr>
...
%>
                     <tr class=row<%=i%2%>>
                        ...
                        <td><%=jspUtil.print(iv.getStAttrPolicyName())%></td>
                        <td align=right><%=jspUtil.print(iv.getDbAttrPolicyTSI())%></td>
                     </tr>
<% } %>
                  </table>
               </td>
