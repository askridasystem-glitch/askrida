...
%>
   ...
   <tr>
      <td>
         <c:button  text="Buat" event="clickCreatePajak" />
         <c:button  text="Ubah" event="clickEditPajak" />
         <c:button  text="Lihat" event="clickViewPajak" />
         <c:button  show="<%=form.isEnableApprove()%>" text="Setujui" event="clickApprovePajak" />
