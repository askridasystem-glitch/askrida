...
<c:frame>
    <%
                ...
                if (bunga.getStReceiptClassID() != null) {
                    ...
                    <tr>
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                ...
                                <c:field lov="LOV_ReceiptClass" width="230" name="bunga.stReceiptClassID" mandatory="true" caption="{L-ENGMethod-L}{L-INAMetode-L}" changeaction="refresh"
                                         type="string" presentation="standard" >
                                    <c:param name="custcat" value="<%=method%>"/>
                                </c:field>
                                <c:field name="bunga.stMonths" type="string" caption="{L-ENGMonth-L}{L-INABulan Transaksi-L}" lov="LOV_MONTH_Period" mandatory="true" presentation="standard" readonly="<%=bunga.getStMonths() != null%>" changeaction="selectMonth"/>
                                <c:field name="bunga.stYears" type="string" caption="{L-ENGBulan-L}{L-INATahun Transaksi-L}" lov="LOV_GL_Years2" mandatory="true" presentation="standard" readonly="<%=bunga.getStYears() != null%>" changeaction="setDate"/>
                                ...
                                <c:field width="200" caption="{L-ENGNo. Bukti B-L}{L-INANo. Bukti B-L}" name="bunga.stNoBuktiB" type="string"
                                         readonly="true" presentation="standard"/>
                                <c:field lov="LOV_CompType" width="230" mandatory="true" name="bunga.stCompanyType" caption="{L-ENGCompany Type-L}{L-INAJenis Perusahaan-L}" type="string"  presentation="standard" changeaction="refresh" >
                                ...
                                <%--
                                <c:field lov="LOV_ReceiptClass" width="230" name="bunga.stReceiptClassID" caption="{L-ENGMethod-L}{L-INAMetode-L}" mandatory="true" changeaction="refresh"
                                         type="string" presentation="standard" >
                                    <c:param name="custcat" value="<%=method%>"/>
                                </c:field>
                                <c:field lov="LOV_CompType" width="230" name="bunga.stCompanyType" caption="{L-ENGCompany Type-L}{L-INAJenis Perusahaan-L}" type="string|255" mandatory="true" presentation="standard"/>
                                ...
                                --%>
                                <c:field width="200" lov="LOV_AccountInvestment" popuplov="true" clientchangeaction="selectEntity2()"
                                         caption="{L-ENGAkun Bank-L}{L-INAAkun Bank-L}" name="bunga.stEntityID" descfield="bunga.stAccountBank" type="string" mandatory="true" presentation="standard">
                                    <c:param name="param" value="<%="122|" + bunga.getStCostCenterCode() + "|" + bunga.getStCompanyType()%>"/>
                                </c:field>  <%--
                                <c:field width="200" lov="LOV_AccountInvestment" popuplov="true" clientchangeaction="selectEntity2()"
                                         caption="{L-ENGAkun Bank-L}{L-INAAkun Bank-L}" name="bunga.stEntityID" descfield="bunga.stAccountBank" type="string" mandatory="true" presentation="standard">
                                    <c:param name="bank" value="<%=bunga.getStCostCenterCode()%>"/>
                        ...
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                <tr>
                                    ...
                                    <c:field width="100" caption="Type" lov="LOV_OnCall" name="bunga.stKodedepo" type="string" readonly="true" presentation="standard"/>
                                    ...
                                    <c:field width="50" caption="{L-ENGRate-L}{L-INAPersentase Bunga-L}" name="bunga.dbPersen" readonly="true" type="money16.2" presentation="standard"/>
