            ...
            <td>
                <table cellpadding=2 cellspacing=1>
                    <tr>
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                <c:field width="200" lov="LOV_CostCenter" caption="{L-ENGBranch-L}{L-INACabang-L}" name="pencairan.stCostCenterCode" type="string"
                                mandatory="true" readonly="<%=pencairan.getStCostCenterCode() != null%>" presentation="standard" changeaction="refresh"/>
                                <c:field lov="LOV_ReceiptClass" width="230" name="pencairan.stReceiptClassID" mandatory="true" caption="{L-ENGMethod-L}{L-INAMetode-L}" changeaction="refresh" type="string" readonly="<%=pencairan.getStReceiptClassID() != null%>" presentation="standard" />
                                ...
                                <c:field width="200" caption="{L-ENGNo. Rekening Bilyet-L}{L-INANo. Rekening Bilyet-L}" name="pencairan.stNoRekening" type="string"
                                         readonly="true" presentation="standard"/>
                                <c:field lov="LOV_CompType" width="230" mandatory="true" name="pencairan.stCompanyType" caption="{L-ENGCompany Type-L}{L-INAJenis Perusahaan-L}" type="string" readonly="<%=pencairan.getStCompanyType() != null%>"  presentation="standard" changeaction="refresh" />
                                ...
                                <c:field caption="Keterangan" width="200" name="pencairan.stDepoName" type="string" readonly="true" presentation="standard"/>
                                <c:field width="200" caption="{L-ENGAkun Bank-L}{L-INAAkun Bank-L}" name="pencairan.stAccountBank" readonly="true" type="string" mandatory="true" presentation="standard"/>
                                <c:field caption="Nama Bank" width="200" name="pencairan.stBankName" type="string" readonly="true" presentation="standard"/>
                                <c:field width="200" caption="Realisasi Pembayaran" name="pencairan.stRealisasiNobuk" type="string" presentation="standard"/>
                            </table>
                        </td>
                        ...
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                <tr>
                                    ...
                                    <c:field caption="{L-ENG Tanggal Cair-L}{L-INA Tanggal Cair-L}" name="pencairan.dtTglCair" type="date" presentation="standard" mandatory="true" readonly="true"/>
                                    ...
                                    <c:field width="150" caption="Jenis" name="pencairan.stType" type="string" presentation="standard" mandatory="true" lov="LOV_INVPENCAIRAN" readonly="true"/>
                                    <c:field width="150" caption="Nominal" name="pencairan.dbPinalty" type="money16.2" presentation="standard" readonly="true"/>
                                </tr>
                            </table>
                        </td>
                    </tr>
