...
<%@ taglib prefix="c" uri="crux" %><c:frame title="PEMBENTUKAN DEPOSITO" >
    ...
    <table cellpadding=2 cellspacing=1>     
                ...
                <table cellpadding=2 cellspacing=1>
                    <tr>
                        <td>
                            ...
                            <c:field width="200" caption="{L-ENGDeposito-L}{L-INADeposito-L}" lov="LOV_DEPOSITO" name="stType" type="string" presentation="standard" changeaction="refresh" />
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td>
                <c:listbox name="list" autofilter="true" paging="true" selectable="true" view="com.webfin.ar.model.ARInvestmentDepositoView" >
                    <%
                    ...
                    <c:listcol name="stCurrency" title="Valuta" />
                    <c:listcol name="dbCurrencyRate" title="Kurs" />
                    <c:listcol name="dbNominal" title="Nominal" />
                    <c:listcol filterable="true" name="stCreateWho" title="User ID" />
                    <c:listcol filterable="true" name="stCreateName" title="User Name" />
                    <c:listcol name="stJournalStatus" title="Ket" />
        ...
        <tr>
            <td>
                ...
                <c:button text="Upload Bilyet" event="clickInputIzinTiket" />
                <c:button text="Edit Bilyet Rekening" event="clickEditBilyet" />
            </td>
        </tr>  
        <tr>
            <td>
                ...
                <c:evaluate when="<%=admin%>" >
                    <c:button text="Super Edit" event="clickSuperEdit" validate="true"/>
                </c:evaluate>
            </td>
        </tr>
        <tr>
            <td>
                <c:button text="{L-ENGCreate-L}{L-INABuat-L} Pencairan" event="clickCreateCair" />
                <c:button text="{L-ENGView-L}{L-INALihat-L} Pencairan" event="clickViewCair" />
            </td>
        </tr>
        <tr>
            <td>
                <c:button text="{L-ENGCreate-L}{L-INABuat-L} Bunga" event="clickCreateBunga" />
                <c:button text="{L-ENGView-L}{L-INALihat-L} Bunga" event="clickViewBunga" />
            </td>
        </tr>
    </table>
