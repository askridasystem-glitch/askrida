...
<%@ taglib prefix="c" uri="crux" %><c:frame title="PENCAIRAN DEPOSITO" >
    ...
    <table cellpadding=2 cellspacing=1> 
                ...
                <table cellpadding=2 cellspacing=1>                    
                    ...
                    <tr>
                        <td>
                            ...
                            <c:field caption="{L-ENGShow Pending only-L}{L-INAPencairan Belum Disetujui-L} " name="stEffectiveFlag" type="check" presentation="standard" changeaction="refresh" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td>
                <c:listbox name="list" autofilter="true" paging="true" selectable="true" view="com.webfin.ar.model.ARInvestmentPencairanView" >
        ...
        <tr>
            <td>
                <c:button text="{L-ENGCreate-L}{L-INABuat Pencairan-L}" event="clickCreate" />
