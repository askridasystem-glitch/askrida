                    ...
                    <tr>
                        <td>
                            <table cellpadding=2 cellspacing=1>
                                ...
                                <c:field width="200" caption="{L-ENGNo. Bilyet-L}{L-INANo. Bilyet-L}" name="deposito.stNodefo" type="string" readonly="true"
                                         presentation="standard"/>
                                <c:field width="200" caption="{L-ENGNo. Rekening Bilyet-L}{L-INANo. Rekening Bilyet (Sambung)-L}" name="deposito.stNoRekening" type="string" readonly="true"
                                         presentation="standard"/>
