...
<c:frame>
    <%
                ...
                System.out.print("########### " + deposito.getStCostCenterCode());
    %>
            ...
            <c:evaluate when="<%=phase >= 3%>">
                <td align=center>
                    <c:evaluate when="<%=!ro%>" >
                        ...
                        <c:evaluate when="<%=!form.isBungaMode()%>" >
                            <c:button text="{L-ENGSave-L}{L-INASimpan-L}" event="save" confirm="Yakin Mau Disimpan ?" validate="true"/>
                        </c:evaluate>
                        <c:evaluate when="<%=form.isBungaMode()%>" >
                            <c:button text="{L-ENGSave-L}{L-INASimpan-L} Trial" event="saveBunga2" confirm="Yakin Mau Disimpan ?" validate="true"/>
                        </c:evaluate>
