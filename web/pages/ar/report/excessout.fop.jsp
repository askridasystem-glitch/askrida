                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>          
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="13">
                                <fo:block font-weight="bold">             
                                    REKAPITULASI PREMI REASURANSI OUTWARD EXCESS OF LOSS TREATY / REASURADUR
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center">{L-ENG ORG Premium -L}{L-INA Premi ORG-L}</fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="center">{L-ENG IDR Premium -L}{L-INA Premi IDR-L}</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>   
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="7"><fo:block text-align="center">SUBTOTAL PREMI EXCESS OF LOSS : </fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="7"><fo:block text-align="center">TOTAL PREMI EXCESS OF LOSS : </fo:block></fo:table-cell>
