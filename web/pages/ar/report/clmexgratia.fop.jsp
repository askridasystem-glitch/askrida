                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-header>
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="10">
                                <fo:block font-weight="bold">
                                    REKAPITULASI KLAIM EX-GRATIA PEMASARAN
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block text-align="center">Nilai TSI</fo:block></fo:table-cell>
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        int n = 0;
                                        t[n] = BDUtil.add(t[n++], BDUtil.mul(invoic.getDbAmount(),invoic.getDbCurrencyRate()));
