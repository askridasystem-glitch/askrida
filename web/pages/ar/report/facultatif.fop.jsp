                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-body>   
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")) {
                                            ...
                                            IDRFee = BDUtil.sub(IDRFee, invoic.getDbFee());
                                            IDRNetto = BDUtil.sub(IDRPremi, BDUtil.add(IDRComm, IDRFee));
                                        } else {
                                            nonIDRTSI = BDUtil.add(nonIDRTSI, BDUtil.mul(invoic.getDbAttrPolicyTSI(), invoic.getDbCurrencyRate()));
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(invoic.getDbPremi(), BDUtil.add(invoic.getDbComm(), invoic.getDbFee())), 2)%></fo:block></fo:table-cell>
                        ...
                        <%
                                        ...
                                        if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")) {
                                            ...
                                            jumlahIDRFee = BDUtil.sub(jumlahIDRFee, invoic.getDbFee());
                                            jumlahIDRNetto = BDUtil.sub(jumlahIDRPremi, BDUtil.add(jumlahIDRComm, jumlahIDRFee));
                                        } else {
                                            jumlahnonIDRTSI = BDUtil.add(jumlahnonIDRTSI, BDUtil.mul(invoic.getDbAttrPolicyTSI(), invoic.getDbCurrencyRate()));
