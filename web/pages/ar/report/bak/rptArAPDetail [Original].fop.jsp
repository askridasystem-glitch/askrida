...
<%
   ...
   sqa.addQuery(
           "   from ar_invoice a\n" +
           "      inner join gl_je_detail f on f.ref_trx_type = 'INV' and f.ref_trx_no = a.ar_invoice_id\n" +
   ...
   final FOPTableSource fopTableSource = new FOPTableSource(
      ...
      public Object getColumnValue(int rowNo, int columnNo) {
         ...
         switch(columnNo) {
            ...
            case 2: return JSPUtil.printX(h.getFieldValueByFieldNameST("cust_name"));
            case 3: return JSPUtil.printX(h.getFieldValueByFieldNameST("ent_name"));
            ...
            case 9: return JSPUtil.printX(h.getFieldValueByFieldNameST("description"));
