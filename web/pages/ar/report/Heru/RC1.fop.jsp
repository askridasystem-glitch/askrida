...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first"> 
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            for(int j=0;j<line.size();j++){
                ...
                for (int k = 0; k < arInvoiceDetail.size(); k++) {
                    ...
                    if(detil.isDiscount2())
                        diskonTotal = BDUtil.add(diskonTotal,detil.getDbAmount());
            ...
            <fo:block-container height="1cm" width="4cm" top="3.2cm" left="16.5cm" padding="1mm" position="absolute">
            ...
            <fo:block-container height="1cm" width="4cm" top="3.7cm" left="16.5cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="8pt">
                    <%= JSPUtil.printX(policyType) %>
                </fo:block>
            </fo:block-container>   
            
            <fo:block-container height="1cm" width="14cm" top="5.7cm" left="5.5cm" padding="1mm" position="absolute">
            ...
            <fo:block-container height="1cm" width="14cm" top="6.7cm" left="5.5cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt">
            ...
            <fo:block-container height="1cm" width="14cm" top="8cm" left="5.5cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt" font-weight="bold">
                    # <%=NumberSpell.readNumber(JSPUtil.printX(tagihBruto2,2))%> RUPIAH #
                </fo:block>
            </fo:block-container>
            
            <fo:block-container height="1cm" width="5cm" top="9cm" left="9.5cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt">
                    F<%=JSPUtil.printX(nopol.substring(2,4)+""+nopol.substring(10,12)+""+nopol.substring(0,2)+""+nopol.substring(4,6)+""+nopol.substring(12,16))%>
                </fo:block>
            </fo:block-container>
            ...
            <fo:block-container height="1cm" width="5cm" top="9cm" left="14cm" padding="1mm" position="absolute">
                <fo:block space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt" text-align="end">
                    <%=DateUtil.getDateStr(insPol.getDtPolicyDate(),"dd ^^ yyyy")%>
                </fo:block>          
            </fo:block-container>         
            
            <fo:block-container height="1cm" width="14cm" top="10cm" left="3.5cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt">
            ...
            <fo:block-container height="1cm" width="11cm" top="11cm" left="3.5cm" padding="1mm" position="absolute">
                <fo:table>
            ...
            <fo:block-container height="1cm" width="11cm" top="11.5cm" left="3.5cm" padding="1mm" position="absolute">
                <fo:table>
                    <fo:table-column column-width="3cm"/>
                    <fo:table-column column-width="1cm"/>
                    <fo:table-column column-width="2.5cm"/>
            ...
            <fo:block-container height="1cm" width="11cm" top="12cm" left="3.5cm" padding="1mm" position="absolute">
                <fo:table>
                    <fo:table-column column-width="3cm"/>
                    <fo:table-column column-width="1cm"/>
                    <fo:table-column column-width="2.5cm"/>
            ...
            <fo:block-container height="1cm" width="11cm" top="12.5cm" left="3.5cm" padding="1mm" position="absolute">
                <fo:table>
                    <fo:table-column column-width="3cm"/>
                    <fo:table-column column-width="1cm"/>
                    <fo:table-column column-width="2.5cm"/>
            ...
            <fo:block-container height="1cm" width="3cm" top="12.2cm" left="15.3cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt">
                    <%= JSPUtil.printX(branch) %>,
                </fo:block>
            </fo:block-container>
            
            <fo:block-container height="1cm" width="2cm" top="12.6cm" left="15.3cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt">
                    #######
                </fo:block>
            </fo:block-container>      
            
            <fo:block-container height="1cm" width="3cm" top="12.4cm" left="17cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt">
            ...
            <fo:block-container height="1cm" width="0.5cm" top="12.4cm" left="20.7cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt">
                    <% if (form.getDtReceipt()!=null) { %>
            ...
            <fo:block-container height="1cm" width="5cm" top="13.2cm" left="1.5cm" padding="1mm" position="absolute">
                <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt" font-weight="bold">
                    IDR <%=JSPUtil.printX(tagihBruto2,2)%>
                </fo:block>
            </fo:block-container>  
            
            <% if (koda.equalsIgnoreCase("1")) { %>
            <fo:block-container height="7cm" width="6cm" top="13cm" left="15.3cm" padding="1mm" position="absolute">
                <fo:block text-align="center" line-height="14pt">
                    <fo:external-graphic
                        content-height="scale-to-fit"
                        height="0.65in" content-width="0.65in"
