                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>         
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="15">
                                <fo:block font-weight="bold">             
                                    REKAPITULASI PREMI REASURANSI EXCESS OF LOSS TREATY / REASURADUR
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="center">{L-ENG Installment -L}{L-INA Cicilan -L}</fo:block></fo:table-cell>  
                    ...
                    <fo:table-body>   
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="8"><fo:block text-align="center">SUBTOTAL PREMI EXCESS OF LOSS : </fo:block></fo:table-cell>
...
--%>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell ><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.sub(invoic.getDbPremiEntered(), invoic.getDbCommEntered()),2)%></fo:block></fo:table-cell>  
                        ...
                        if (invoic.getStCurrencyCode().equalsIgnoreCase("IDR")){
                                ...
                                jumlahIDRNetto = BDUtil.sub(jumlahIDRPremi, jumlahIDRComm);
                        }else {
                                ...
                                jumlahnonIDRNetto = BDUtil.sub(jumlahnonIDRPremi, jumlahnonIDRComm);
                        }
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="8"><fo:block text-align="center">TOTAL PREMI EXCESS OF LOSS : </fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="center">IDR</fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(jumlahIDRPremi,2)%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(jumlahIDRComm,2)%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(jumlahIDRNetto,2)%></fo:block></fo:table-cell>
