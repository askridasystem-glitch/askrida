    ...
    <fo:page-sequence master-reference="only" initial-page-number="1">
        ...
        <fo:flow flow-name="xsl-region-body">                 
            ...
            <fo:block font-size="10pt" line-height="10pt" text-align="center" space-after.optimum="10pt">
                <fo:inline font-weight="bold">Perihal : Konfirmasi Klaim <%=pol.getPolicyType().getStDescription()%> - <%=JSPUtil.printX(pol.getTreatyType(pol.getStRefID0()).getStInsuranceTreatyTypeName())%></fo:inline>
            </fo:block>
                ...
                <fo:table table-layout="fixed">
                    ...
                    <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell  border-left-style="solid" padding="2pt"><fo:block text-align="center">DOL</fo:block></fo:table-cell>
                        ...
                        <%
                                    ...
                                    BigDecimal amount_entered = null;
                                    ...
                                    for (int i = 0; i < details.size(); i++) {
                                        ...
                                        amount_entered = io.getDbEnteredAmount();
                        %>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell border-right-style="solid" padding="2pt"><fo:block text-align="end"><%= JSPUtil.printX(io.getDbEnteredAmount(), 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
                                ...
                                <fo:block text-align="start">
                                    <fo:instream-foreign-object>
                                        <barcode:barcode
                                            ...
                                            message="<%=DateUtil.getDateStr(new Date(), "d-MMM-yyyy hh:mm:ss")%>_<%=JSPUtil.printX(amount_entered, 0)%>" orientation="0">
                                            <barcode:datamatrix> 
