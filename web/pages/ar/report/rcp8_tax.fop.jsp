...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    <fo:page-sequence master-reference="first">
        ...
        for(int m = 0; m < tax.size(); m++){
            ...
            taxDesc = view.getStInvoiceNo().substring(7,12);
        }
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="13">
                                <fo:block font-weight="bold" font-size="12pt" text-align="center">             
                                    LAPORAN PEMBAYARAN PAJAK <%=JSPUtil.printX(receipt.getStTaxCode())%> <%--<%=JSPUtil.printX(taxDesc.toUpperCase())%>--%>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
