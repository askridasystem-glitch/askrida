                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="17">
                                <fo:block font-weight="bold">
                                    REKAPITULASI KLAIM INWARD TREATY
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                    ...
                    <fo:table-body>
                        ...
                        <%
                                    ...
                                    for (int i = 0; i < l.size(); i++) {
                                        ...
                                        t[n] = BDUtil.add(t[n++], invoic.getDbAttrPolicyTSI());
                                        t[n] = BDUtil.add(t[n++], invoic.getDbClaimAmountTotal());
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell ><fo:block text-align="start"><%=JSPUtil.printX(invoic.getStDLANo())%></fo:block></fo:table-cell>
                            ...
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(invoic.getStCurrencyCode())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(invoic.getDbClaimAmountTotal(), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(invoic.getStCurrencyCode())%></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(invoic.getDbEnteredAmount(), 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block text-align="center"><%=JSPUtil.printX(invoic.getStCurrencyCode())%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(subTSITotal, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(subKlaim, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(subOR, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(subTSI, 2)%></fo:block></fo:table-cell>
                            <fo:table-cell ><fo:block></fo:block></fo:table-cell>
                            <fo:table-cell><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.zero, 2)%></fo:block></fo:table-cell>
                        </fo:table-row>
