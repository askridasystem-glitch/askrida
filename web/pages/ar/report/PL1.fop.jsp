                ...
                <fo:table table-layout="fixed" border-style="solid" border-width="<%=bw%>" >
                    ...
                    <fo:table-body> 
                        ...
                        <fo:table-row >
                            ...
                            <fo:table-cell border-width="<%=bw%>" padding="2pt"><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(commissionPlusTax,konversi),2)%></fo:block></fo:table-cell>
                            <fo:table-cell border-width="<%=bw%>" padding="2pt"><fo:block text-align="end"><%=JSPUtil.printX(BDUtil.mul(taxTotal,konversi),2)%></fo:block></fo:table-cell>
                        ...
                        <fo:table-row >
                            ...
                            <fo:table-cell border-width="<%=bw%>" border-bottom-style="solid" padding="2pt"><fo:block text-align="end" font-weight="bold"><%=JSPUtil.printX(BDUtil.mul(taxJumlah,konversi),2)%></fo:block></fo:table-cell>
