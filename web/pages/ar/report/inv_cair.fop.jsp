                ...
                <fo:table table-layout="fixed">  
                    ...
                    <fo:table-header>          
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="8">
                                <fo:block font-weight="bold" text-align="center" font-size="10pt">
                                    <% if (form.getCairDateFrom()!=null || form.getCairDateTo()!=null) {%> 
                                    Tanggal Pencairan : <%=DateUtil.getDateStr(form.getCairDateFrom(),"dd ^^ yyyy")%> s/d <%=DateUtil.getDateStr(form.getCairDateTo(),"dd ^^ yyyy")%>
                                    <% } %>
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm">{L-ENG Pencairan Date -L}{L-INA Tanggal Pencairan -L}</fo:block></fo:table-cell>  
                    ...
                    <fo:table-body>   
                        ...
                        for (int i = 0; i < l.size(); i++) {
                            ...
                            int n=0;
                            t[n] = BDUtil.add(t[n++], cair.getDbNominal());
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="4" border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm" font-weight="bold">SUB-TOTAL</fo:block></fo:table-cell>
                        ...
                        <fo:table-row>   
                            ...
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(cair.getStNodefo())%></fo:block></fo:table-cell> 
                            <% if (cair.getStKodedepo().equalsIgnoreCase("1")) { %>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(cair.getStHari())%> Hari</fo:block></fo:table-cell> 
                            <% } else { %>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(cair.getStBulan())%> Bulan</fo:block></fo:table-cell> 
                            <% } %>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(cair.getDtTglCair())%></fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="end" line-height="5mm"><%=JSPUtil.printX(cair.getDbNominal(),2)%></fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(cair.getStBankName())%></fo:block></fo:table-cell> 
                            <fo:table-cell border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(cair.getDbBunga())%></fo:block></fo:table-cell> 
                            <% if (cair.getStKeterangan()!=null) { %>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm"><%=JSPUtil.printX(cair.getStKeterangan())%></fo:block></fo:table-cell> 
                            <% } else { %>
                            <fo:table-cell border-width="0.5pt" border-left-style="solid" border-right-style="solid"><fo:block text-align="center" line-height="5mm"></fo:block></fo:table-cell> 
                            <% } %>
                        </fo:table-row>			
                        
                        <%                         
                        nominal 	= BDUtil.add(nominal,cair.getDbNominal());
                        } %>   
                        ...
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="4" border-width="0.5pt" border-left-style="solid"><fo:block text-align="center" line-height="5mm" font-weight="bold">TOTAL</fo:block></fo:table-cell>
