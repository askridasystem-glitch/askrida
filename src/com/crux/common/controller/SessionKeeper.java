/***********************************************************************
 * Module:  com.crux.common.controller.SessionKeeper
...
public class SessionKeeper implements HttpSessionListener {
   ...
   public void invalidate() {
      ...
      while (keys.hasNext()) {
         ...
         int timeout = 20;//20 minute auto logout

         if(uv.getStSessionTimeout()!=null)
             timeout = Integer.parseInt(uv.getStSessionTimeout());

         if (t-s.getLastAccessedTime()>timeout*60*1000) { // timeout in 20 mins
            del.add(s);
         }
      }
