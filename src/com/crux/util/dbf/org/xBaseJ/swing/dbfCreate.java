package com.crux.util.dbf.org.xBaseJ.swing;
/**
...
import com.crux.util.dbf.org.xBaseJ.DBF;
import com.crux.util.dbf.org.xBaseJ.xBaseJException;
import com.crux.util.dbf.org.xBaseJ.awt.dbfFileFilter;
import com.crux.util.dbf.org.xBaseJ.fields.CharField;
import com.crux.util.dbf.org.xBaseJ.fields.DateField;
import com.crux.util.dbf.org.xBaseJ.fields.Field;
import com.crux.util.dbf.org.xBaseJ.fields.FloatField;
import com.crux.util.dbf.org.xBaseJ.fields.LogicalField;
import com.crux.util.dbf.org.xBaseJ.fields.MemoField;
import com.crux.util.dbf.org.xBaseJ.fields.NumField;
import com.crux.util.dbf.org.xBaseJ.fields.PictureField;
...

{
    ...
    public void actionPerformed(ActionEvent ae) {
       ...
       if (ae.getSource() == menuOpen)
          {
		   ...
		   DBF dbf = new DBF(fname);
                   ...
                   setTitle("Create dBase File: "+fil.getName());
                    if (dbf.getVersion() == com.crux.util.dbf.org.xBaseJ.DBF.DBASEIV || dbf.getVersion() == com.crux.util.dbf.org.xBaseJ.DBF.DBASEIV_WITH_MEMO) {
		       menuType.setText("Type: dBaseIV");
		       typeIV.setState(true);
		       typeIII.setState(false);
		       typeFP.setState(false);
    	            }
                  else if (dbf.getVersion() == com.crux.util.dbf.org.xBaseJ.DBF.DBASEIII || dbf.getVersion() == com.crux.util.dbf.org.xBaseJ.DBF.DBASEIII_WITH_MEMO) {
   		       menuType.setText("Type: dBaseIII");
		       typeIV.setState(false);
		       typeIII.setState(true);
		       typeFP.setState(false);
      	          }
                 else if (dbf.getVersion() == com.crux.util.dbf.org.xBaseJ.DBF.FOXPRO_WITH_MEMO) {
       ...
       if (ae.getSource() == menuCreate) {
           ...
           int type = -1;
           if (typeIII.getState()) type = com.crux.util.dbf.org.xBaseJ.DBF.DBASEIII;
           if (typeFP.getState()) type = com.crux.util.dbf.org.xBaseJ.DBF.FOXPRO_WITH_MEMO;
           else type = com.crux.util.dbf.org.xBaseJ.DBF.DBASEIV;
           try {
...
class dbfCreateModel extends AbstractTableModel
    ...
    public void create(File fil, int dbfType)
		  ...
		  for (i = 0; i < getRowCount(); i++)
		    {
			 ...
			 decpoints = (String) getValueAt(i, 3);
			 ...
			 else if (typed.compareTo("Picture") == 0)
 		     {
				 ...
				 flds[i] = pf;
				 dbfType = com.crux.util.dbf.org.xBaseJ.DBF.FOXPRO_WITH_MEMO;
			 }
		 }

		 DBF dbf = new DBF(fil.getAbsolutePath(), dbfType, true);
