package com.crux.util.dbf.org.xBaseJ;
/**
...
import com.crux.util.dbf.org.xBaseJ.indexes.Index;
import com.crux.util.dbf.org.xBaseJ.indexes.MDX;
import com.crux.util.dbf.org.xBaseJ.indexes.MDXFile;
import com.crux.util.dbf.org.xBaseJ.indexes.NDX;
...
public class DBF extends Object {
	...
	*/
	...
	public DateField getField2(String name)
		throws xBaseJException, ArrayIndexOutOfBoundsException {
		short i;
		DateField tField;

		for (i = 0; i < fldcount; i++) {
			tField = (DateField) fld_root.elementAt(i);
			if (name.toUpperCase().compareTo(tField.getName().toUpperCase())
				== 0) {
				return tField;
			}
        ...
        public NumField getFieldNum(String name)
		throws xBaseJException, ArrayIndexOutOfBoundsException {
		short i;
		NumField tField;

		for (i = 0; i < fldcount; i++) {
			tField = (NumField) fld_root.elementAt(i);
			if (name.toUpperCase().compareTo(tField.getName().toUpperCase())
				== 0) {
				return tField;
			}
