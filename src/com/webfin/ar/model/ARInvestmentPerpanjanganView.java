/***********************************************************************
 * Module:  com.webfin.ar.model.ARInvestmentPerpanjanganView
...
public class ARInvestmentPerpanjanganView extends DTO {

    private final static transient LogManager logger = LogManager.getInstance(ARInvestmentPerpanjanganView.class);
    public static String tableName = "ar_inv_perpanjangan";
    public static String comboFields[] = {"ar_depo_id", "bukti_b", "nodefo", "jumlah", "persen"};
    /*
        ...
        try {
            if (pencairan == null) {
                pencairan = ListUtil.getDTOListFromQuery(
                        "select * from ar_inv_pencairan where ar_depo_id = ? and deleted is null",
        ...
        try {
            if (bunga == null) {
                bunga = ListUtil.getDTOListFromQuery(
                        "select * from ar_inv_bunga where ar_depo_id = ? and delete_flag is null order by ar_bunga_id ",
                        new Object[]{stARDepoID},
     ...
     * @return the stPersen
     */
    public String getStPersen() {
        return stPersen;
    }

    /**
     * @param stPersen the stPersen to set
     */
    public void setStPersen(String stPersen) {
        this.stPersen = stPersen;
    }
}
