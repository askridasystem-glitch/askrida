...
public class ARCashflowDetailsView extends DTO implements RecordAudit {
   /*
...
(
   ...
   */
   ...
   public static String tableName = "ar_cashflow_details";

   public static String fieldMap[][] = {
      {"stARCashflowDetailID","ar_cashflow_dtl_id*pk*nd"},
      {"stInvoiceID","ar_invoice_id"},
      {"dbAmount","amount"},
      {"dbEnteredAmount","amount_entered"},
      {"stARCashflowID","ar_cashflow_id"},
   ...
   private String stARCashflowDetailID;
   ...
   public String getStARCashflowDetailID() {
        return stARCashflowDetailID;
    }

    public void setStARCashflowDetailID(String stARCashflowDetailID) {
        this.stARCashflowDetailID = stARCashflowDetailID;
    }
   ...
   private ARCashflowDetailsView getOldReceiptLines() {
      return (ARCashflowDetailsView) getOld();
   }
   ...
   public BigDecimal getDbOutstandingAmount() {
      final ARCashflowDetailsView old = getOldReceiptLines();
  ...
  private DTOList arInvoice;
   ...
   public String getStArInvoiceClaim() {
    ...
    private DTOList loadDetails(String receiptLineType) throws Exception {
        if (stARCashflowID!=null)
            return ListUtil.getDTOListFromQuery(
                    "select * from  ar_cashflow_details where ar_cashflow_id = ? and line_type = ? and ar_invoice_id = ? order by ar_cashflow_dtl_id",
                    new Object [] {stARCashflowID, receiptLineType, stInvoiceID},
    ...
    private DTOList loadDetailsTitipan(String receiptLineType) throws Exception {
        if (stARCashflowID!=null)
            return ListUtil.getDTOListFromQuery(
                    "select * from  ar_cashflow_details where ar_cashflow_id = ? and line_type = ? and ar_rcl_ref_id = ?",
                    new Object [] {stARCashflowID, receiptLineType, stARCashflowDetailID},
                    ARCashflowDetailsView.class
                    );
