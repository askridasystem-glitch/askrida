/***********************************************************************
 * Module:  com.webfin.ar.model.ARRequestDocumentsView
...
public class ARRequestDocumentsView extends DTO implements RecordAudit {
  
   public static String tableName = "ar_request_documents";

   public static String comboFields[] = {"doc_in_id","file_physic"};
