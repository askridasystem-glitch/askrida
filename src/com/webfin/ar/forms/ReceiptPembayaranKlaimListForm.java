...
public class ReceiptPembayaranKlaimListForm extends Form {
   ...
   public ReceiptPembayaranKlaimListForm() {
      filter = new ARReceiptFilter();
      filter.activate();
   }

   public void clickCreate() throws Exception {
      final ReceiptPembayaranKlaimForm form = (ReceiptPembayaranKlaimForm)newForm("receiptpembayaranklaimform", this);
