...
public class ReceiptPembayaranKlaimForm extends Form {
   ...
   public ReceiptPembayaranKlaimForm() {
   }
   ...
   */
   ...
   public void masterEdit(String receiptID) throws Exception {
      ...
      if("3".equalsIgnoreCase(receipt.getStReceiptClassID())||
        ...
        "47".equalsIgnoreCase(receipt.getStReceiptClassID()))
   ...
   public void doSave() throws Exception {
      ...
      else if("34".equalsIgnoreCase(receipt.getStARSettlementID())) getRemoteAccountReceivable().savePembayaranRealisasiUangMukaKlaim(receipt);
      else if("40".equalsIgnoreCase(receipt.getStARSettlementID())) getRemoteAccountReceivable().savePembayaranKlaimSentralisasi(receipt);
      else if("47".equalsIgnoreCase(receipt.getStARSettlementID())) getRemoteAccountReceivable().savePembayaranKlaim(receipt);
...
*/
   ...
   public void doSavePembayaranPajak() throws Exception {
    ...
    public void onNewUangMukaKlaim(BigDecimal amount) throws Exception {
      ...
      BigDecimal amt = BDUtil.mul(policy.getDbClaimAmount(), policy.getDbCurrencyRateClaim());//policy.isStatusClaimDLA()?policy.getDbClaimAmountApproved():policy.getDbClaimAmountEstimate();
      ...
      rcl.setStCurrencyCode(policy.getStClaimCurrency());
      rcl.setDbCurrencyRate(policy.getDbCurrencyRateClaim());
    ...
    public void setDate() throws Exception{
        ...
        Date tglProd = DateUtil.getDate(date);
        DateTime rcpDate = new DateTime(tglProd);
        DateTime tglAkhirBulan = rcpDate.dayOfMonth().withMaximumValue();

        if(receipt.getStARSettlementID().equalsIgnoreCase("34"))
                receipt.setDtReceiptDate(tglAkhirBulan.toDate());
    ...
    public void uploadKonversi() throws Exception {
        if (receipt.getStARSettlementID().equalsIgnoreCase("10")||receipt.getStARSettlementID().equalsIgnoreCase("40")) {
            uploadExcel();
        } else if (receipt.getStARSettlementID().equalsIgnoreCase("34")) {
            uploadExcelRealisasi();
        }
