...
public class EntityAddressView extends DTO implements RecordAudit {
   /*
...
(
   ...
   */
   ...
   public static String tableName = "ent_address";
   ...
   public static String fieldMap[][] = {
      ...
      {"stSubRegionName","sub_region_name"},
   };

   public static String comboFields[] = {"index","address"};
   ...
   private String stSubRegionName;
   ...
   public boolean isPrimary() {
    ...
    /**
     * @return the stSubRegionName
     */
    public String getStSubRegionName() {
        return stSubRegionName;
    }

    /**
     * @param stSubRegionName the stSubRegionName to set
     */
    public void setStSubRegionName(String stSubRegionName) {
        this.stSubRegionName = stSubRegionName;
    }
