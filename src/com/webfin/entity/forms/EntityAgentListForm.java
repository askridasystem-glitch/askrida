/***********************************************************************
 * Module:  com.webfin.entity.forms.EntityAgentListForm
...
public class EntityAgentListForm extends Form {
    ...
    public void clickCreate() throws Exception {
        final EntityAgentForm form = (EntityAgentForm) super.newForm("agen_group_form", this);

        form.createNew();

        form.select_approval();
