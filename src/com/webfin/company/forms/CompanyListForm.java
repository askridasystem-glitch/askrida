...
import com.webfin.company.model.CompanyView;
import com.webfin.company.forms.CompanyListForm;

import javax.ejb.CreateException;
import javax.naming.NamingException;
import java.rmi.RemoteException;

public class CompanyListForm extends Form {
   ...
   public DTOList getList() throws Exception {
      ...
      list = sqa.getList(CompanyView.class);
   ...
   public void clickCreate() throws Exception {
      final CompanyMasterForm form = (CompanyMasterForm) super.newForm("company_edit", this);
   ...
   public void clickEdit() throws Exception {
      ...
      form.setAttribute("vs_code",companyid);
