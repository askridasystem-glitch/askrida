/***********************************************************************
 * Module:  com.webfin.insurance.model.AcceptanceObjectView
...
import com.webfin.insurance.model.InsuranceClaimLossView;
...
public abstract class AcceptanceObjectView extends DTO implements RecordAudit {
    ...
    private final static transient LogManager logger = LogManager.getInstance(AcceptanceObjectView.class);
    ...
    public AcceptanceView getPolicy() throws Exception {
        return policy;
    }
 ...
 */
    ...
    public void validateRateOJK() throws Exception{
        ...
        AcceptanceObjDefaultView objx = new AcceptanceObjDefaultView();
...
//        logger.logWarning("########## KODE RESIKO NIH limit 3 : "+rc.getDbTreatyLimit3());
    ...
    public void validateBolehKomisi(AcceptanceObjDefaultView obj) throws Exception {
...
//                            if(!policy.isStatusRenewal()) throw new RuntimeException("Diskon hanya boleh saat polis perpanjangan");
    ...
    private PeriodBaseView getPeriodBase() {
        AcceptanceObjDefaultView objx = (AcceptanceObjDefaultView) this;
    ...
    public void validateHighestRateOJK() throws Exception{
        ...
        if(policy.isStatusEndorse() || policy.isStatusClaim() || policy.isStatusClaimEndorse() || policy.isStatusEndorseRI() || policy.isStatusHistory() || policy.isStatusInward())
            return;
...
//                System.out.println("#################################################################");
    ...
    public DTOList getSpreading() {
        loadSpreading();
        return spreading;
    }

    public void loadSpreading() {
        try {
            if (spreading==null) {
                spreading = ListUtil.getDTOListFromQuery(
                        "select * from  ins_upload_reins where ins_pol_obj_id = ? and status is null",
                        new Object [] {getStPolicyObjectID()},
    ...
    public boolean isDepreciationMethod() {
        return Tools.isYes(getStReference11()) && policy.getPolicyType().getStPolicyTypeID().equalsIgnoreCase("3");
    }
    ...
    public DTOList getDetailDocuments() {
        if (detailDocuments == null && policy.getStPolicyTypeID() != null)
            detailDocuments = loadDetailDocuments(policy.getStPolicyTypeID(), getStPolicyObjectID(), "ACCEPT");
    ...
    private static DTOList loadDetailDocuments(String poltype, String stPolicyObjectID, String documentClass) {
        try {
            ...
            final DTOList l = ListUtil.getDTOListFromQuery(
                    ...
                    "      left join ins_pol_acceptance_documents b on  b.document_class=a.document_class and b.ins_pol_obj_id=? and b.ins_document_type_id=a.ins_document_type_id" +
                    "   where " +
                    "      a.pol_type_id=? " +
                    "      and a.document_class=? ",
                    new Object[]{stPolicyObjectID, poltype, documentClass},
                    AcceptanceDocumentView.class
                    );

            for (int i = 0; i < l.size(); i++) {
                AcceptanceDocumentView docs = (AcceptanceDocumentView) l.get(i);
