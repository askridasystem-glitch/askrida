...
public class ReinsuranceValidationHeaderView  extends DTO implements RecordAudit  {

    /*
     *
     * CREATE TABLE ins_policy_reins_validation_header
(
  ins_policy_reins_vld_id bigint NOT NULL,
  ...
  CONSTRAINT ins_policy_reins_validation_header_pkey PRIMARY KEY (ins_policy_reins_vld_id)
)
     */

    public static String tableName = "ins_policy_reins_validation_header";

    public transient static String fieldMap[][] = {
        {"stInsurancePolicyReinsuranceValidationID", "ins_policy_reins_vld_id*pk*nd"},
   ...
   public void reCalculate() {
    ...
    public void generateRecapNo()throws Exception {
       ...
       String orderNo = StringTools.leftPad(String.valueOf(IDFactory.createNumericID("REINS_VLD"  + month2Digit + year2Digit + ccCode, 1)), '0', 4);
