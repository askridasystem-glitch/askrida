...
public class CreditHandler extends DefaultCustomHandler {
    ...
    public void calculate(InsurancePolicyView policy, InsurancePolicyObjectView objx, boolean validate){
         try {
            ...
            if(!policy.isStatusHistory() && !policy.isStatusEndorse() && !policy.isStatusClaim() && !policy.isStatusClaimEndorse()){
                ...
                int jangkaWaktuTahun = DateUtil.getYearBetween(obj.getDtReference2(), obj.getDtReference3());

                DateTime periodeAwal = new DateTime(obj.getDtReference2());
                DateTime bulanPOJK20 = new DateTime(DateUtil.getDate("13/12/2024"));

                if(!policy.isKreditFLPP() && !policy.isKreditTapera()){
                    ...
                    if(periodeAwal.isAfter(bulanPOJK20))
                            throw new RuntimeException("Asuransi kredit Debitur "+obj.getStReference1()+" tidak bisa diinput");
                }
            ...
            if(obj.getStReference11()==null)
             ...
             if(!policy.isStatusHistory() && !policy.isStatusEndorse() && !policy.isStatusClaim() && !policy.isStatusClaimEndorse()){
                 ...
                 if(!policy.isBypassValidation()){
                        ...
                        if(!persetujuanPusat){
                            int jangkaWaktuTahun = DateUtil.getYearBetween(obj.getDtReference2(), obj.getDtReference3());
                            int usiaSaatJTempo = Integer.parseInt(obj.getStReference2()) + jangkaWaktuTahun;

                            if(usiaSaatJTempo > 75)
                                throw new RuntimeException("Usia Saat Jatuh Tempo (X+N) Debitur "+obj.getStReference1()+" Tidak Boleh Melebihi 75 Tahun");
                        }
    ...
    private void calculateSimulasiPOJK20(InsurancePolicyObjDefaultView obj, InsurancePolicyView policy) throws Exception{
        ...
        int tahun = DateUtil.getYearBetween(obj.getDtReference7(), obj.getDtReference8());
        ...
        getKomposisiPremiSerbaguna(String.valueOf(jumlahPolis), obj, policy);
        ...
        if(jumlahPolis == 1){
            ...
            obj.setDtReference10(DateUtil.addYear(obj.getDtReference2(), sisa));

            //obj.setDbReference12(new BigDecimal(100)); //share pct polis ke 1
            ...
            obj.setDbReference14(obj.getDbReference11()); //premi 100 polis ke 1
            obj.setDbReference15(BDUtil.sub(obj.getDbReference14(), obj.getDbReference13()));//premi sisa polis ke 1
        }
        ...
        if(jumlahPolis == 2){
            ...
            //obj.setDbReference12(new BigDecimal(60));//share pct polis ke 1
            obj.setDbReference12(getPctKomposisi1());
            obj.setDbReference13(BDUtil.mul(premi100, BDUtil.getRateFromPct(obj.getDbReference12()), 0));//premi polis ke 1
            obj.setDbReference14(premi100); //premi 100 polis ke 1
            obj.setDbReference15(BDUtil.sub(obj.getDbReference14(), obj.getDbReference13()));//premi sisa polis ke 1
            ...
            //obj.setDbReference16(new BigDecimal(40));//share pct polis ke 2
            obj.setDbReference16(getPctKomposisi2());
            obj.setDbReference17(BDUtil.mul(premi100, BDUtil.getRateFromPct(obj.getDbReference16()), 0));//premi polis ke 2
            obj.setDbReference18(BDUtil.sub(premi100, obj.getDbReference13()));//premi 100 polis ke 2
            obj.setDbReference19(BDUtil.sub(obj.getDbReference18(), obj.getDbReference17()));//premi sisa polis ke 2
        ...
        if(jumlahPolis == 3){
            ...
            //obj.setDbReference16(new BigDecimal(30));//share pct polis ke 2
            obj.setDbReference16(getPctKomposisi2());
            obj.setDbReference17(BDUtil.mul(premi100, BDUtil.getRateFromPct(obj.getDbReference16()), 0));//premi polis ke 2
            obj.setDbReference18(BDUtil.sub(premi100, obj.getDbReference13()));//premi 100 polis ke 2
            obj.setDbReference19(BDUtil.sub(obj.getDbReference18(), obj.getDbReference17()));//premi sisa polis ke 2
            ...
            //obj.setDbReference20(new BigDecimal(10));//share pct polis ke 3
            obj.setDbReference20(getPctKomposisi3());
            obj.setDbReference21(BDUtil.mul(premi100, BDUtil.getRateFromPct(obj.getDbReference20()), 0));//premi polis ke 3
            obj.setDbReference22(BDUtil.sub(obj.getDbReference18(), obj.getDbReference17()));//premi 100 polis ke 3
            obj.setDbReference23(BDUtil.sub(obj.getDbReference22(), obj.getDbReference21()));//premi sisa polis ke 3
        }
        ...
        if(jumlahPolis == 4){
            ...
            obj.setDtReference9(obj.getDtReference2());
            obj.setDtReference10(DateUtil.addYear(obj.getDtReference2(), 5));
            //obj.setDbReference12(new BigDecimal(50));//share pct polis ke 1
            obj.setDbReference12(getPctKomposisi1());
            obj.setDbReference13(BDUtil.mul(premi100, BDUtil.getRateFromPct(obj.getDbReference12()), 0));//premi polis ke 1
            obj.setDbReference14(obj.getDbReference11()); //premi 100 polis ke 1
            obj.setDbReference15(BDUtil.sub(obj.getDbReference14(), obj.getDbReference13()));//premi sisa polis ke 1
            ...
            //obj.setDbReference20(new BigDecimal(15));//share pct polis ke 3
            obj.setDbReference20(getPctKomposisi3());
            obj.setDbReference21(BDUtil.mul(premi100, BDUtil.getRateFromPct(obj.getDbReference20()), 0));//premi polis ke 3
            obj.setDbReference22(BDUtil.sub(obj.getDbReference18(), obj.getDbReference17()));//premi 100 polis ke 3
            obj.setDbReference23(BDUtil.sub(obj.getDbReference22(), obj.getDbReference21()));//premi sisa polis ke 3
            ...
            //obj.setDbReference24(new BigDecimal(5));//share pct polis ke 4
            obj.setDbReference24(getPctKomposisi4());
            obj.setDbReference25(BDUtil.mul(premi100, BDUtil.getRateFromPct(obj.getDbReference24()), 0));//premi polis ke 4
            obj.setDbReference26(BDUtil.sub(obj.getDbReference22(), obj.getDbReference21()));//premi 100 polis ke 4
            obj.setDbReference27(BDUtil.sub(obj.getDbReference26(), obj.getDbReference25()));//premi sisa polis ke 4
        }
    ...
    public void getKomposisiPremiSerbaguna(String jumlah, InsurancePolicyObjDefaultView obj, InsurancePolicyView policy) throws Exception{
            ...
            if(!persetujuanPusat){
                ...
                final SQLUtil S = new SQLUtil();
                    try {
                        ...
                        String sql =  " select rate1, rate2, rate3, rate4"+
                                      " from ins_rates_big "+
                                      "  where rate_class = 'CREDIT_PROSENTASE' and ref1 = ? "+
                                      "  and period_start <= ? and period_end >= ? "+
                                      "  and active_flag = 'Y'";
                        ...
                        PS.setString(n++, jumlah); //jumlah polis
                        S.setParam(n++, obj.getDtReference2()); //period start
                        S.setParam(n++, obj.getDtReference2()); //period end
