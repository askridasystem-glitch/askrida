...
public class CreditSerbagunaHandler extends DefaultCustomHandler {
    ...
    public void calculate(InsurancePolicyView policy, InsurancePolicyObjectView objx, boolean validate){
         try {
            ...
            if(obj.getStReference11()==null)
             ...
             if(!policy.isStatusHistory() && !policy.isStatusEndorse() && !policy.isStatusClaim() && !policy.isStatusClaimEndorse() && !policy.isStatusRenewal()){
    ...
    private void recalculateRestitusi(InsurancePolicyView policy, InsurancePolicyObjDefaultView obj) throws Exception{
        ...
        if(policy.isStatusEndorse() && obj.getDtReference5()!=null) {
                ...
                //BULAN BERJALAN SESUAI PK
                tglAwalKredit = new DateTime(obj.getDtReference7());
                bulanBerjalanM = Months.monthsBetween(tglAwalKredit, tglLunas);
                ...
                //jangka waktu sesuai PK
                DateTime startDatePK = new DateTime(obj.getDtReference7());
                DateTime endDatePK = new DateTime(obj.getDtReference8());

                m = Months.monthsBetween(startDatePK, endDatePK);
    ...
    private void calculateSimulasiPOJK20(InsurancePolicyObjDefaultView obj, InsurancePolicyView policy) throws Exception{
        ...
        logger.logDebug("####################### jumlah periode polis = "+ jumlahPolis);
