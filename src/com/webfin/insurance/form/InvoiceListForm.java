...
public class InvoiceListForm extends Form {
    ...
    public DTOList getList() throws Exception {
        ...
        if (trxId!=null) {
            sqa.addClause("(a.ar_trx_type_id = ? or a.ar_trx_type_id in (select ar_trx_type_id from ar_trx_type where parent_trx_id = ?))");
            sqa.addPar(trxId);
            sqa.addPar(trxId);
        }
...
//      }
    ...
    public void clickReApproval() throws Exception {
        ...
        listPolicy = ListUtil.getDTOListFromQuery(
                ...
                " where a.ar_trx_type_id in (1,3,20) " +
                " and a.invoice_no in ('J07121300147','J07121300148','J07121300149','J07121300150'," +
                " 'J07121300151','J13121300008','J13121300009','J13121300010','J13121300011','J13121300012'," +
                " 'J13121300013','J13121300016','J13121300017','J13121300019','J13121300020','J13121300021'," +
                " 'J13121300022','J13121300023','J13121300024','J13121300027','J13121300028','J13121300029'," +
                " 'J13121300124','J13121300125','J13121300152') " +
                //" and a.ar_invoice_id in (12687,12893,12894,12895,12896," +
                //" 12897,12973,12973,12974) " +
                //" and date_trunc('day',a.mutation_date) >= '2013-09-01 00:00:00' " +
                //" and date_trunc('day',a.mutation_date) <= '2013-09-30 00:00:00' "+
        ...
        for (int i = 0; i < listPolicy.size(); i++) {
            ...
            getRemoteAccountReceivable().saveSaldoAwalInward(polis);
    ...
    public void clickUpdateKursBulanan() throws Exception {
    ...
    public void clickCreateInwardFacUpload() throws Exception {

        final InvoiceForm iv = (InvoiceForm) newForm("inwardfacultativeuploadform", this);
