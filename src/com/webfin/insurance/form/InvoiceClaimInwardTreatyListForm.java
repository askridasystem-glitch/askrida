...
public class InvoiceClaimInwardTreatyListForm extends Form {
   ...
   public DTOList getList() throws Exception {
      ...
      if (trxId!=null) {
         sqa.addClause("(ar_trx_type_id in (?,?) or ar_trx_type_id in (select ar_trx_type_id from ar_trx_type where parent_trx_id = ?))");
         sqa.addPar(trxId);
         sqa.addPar("2");
         sqa.addPar(trxId);
      }
...
//      }
   ...
   public InvoiceClaimInwardTreatyListForm() {
   }
   ...
   public void clickCreate() throws Exception {
      ...
      final InvoiceClaimInwardTreatyForm iv = (InvoiceClaimInwardTreatyForm) newForm("invoiceclaiminwardtreatyform", this);
   ...
   public void clickCreateSuratHutang() throws Exception {
      ...
      final InvoiceClaimInwardTreatyForm iv = (InvoiceClaimInwardTreatyForm) newForm("surathutangform", this);
   ...
   public void clickCreateFromInward() throws Exception {
      final InvoiceClaimInwardTreatyForm iv = (InvoiceClaimInwardTreatyForm) newForm("invoiceclaiminwardtreatyform", this);

      iv.editCreateFromInward(invoiceid);
