...
public class PolicyParentListForm extends Form {
   ...
   public DTOList getList() throws Exception {
	...
	//	javax.swing.JOptionPane.showMessageDialog(null,sqa.getSQL(),"Claim",javax.swing.JOptionPane.CLOSED_OPTION );
      ...
      list=sqa.getList(InsurancePolicyParentView.class);
      //javax.swing.JOptionPane.showMessageDialog(null,sqa.getSQL(),"Claim",javax.swing.JOptionPane.CLOSED_OPTION );
   ...
   public PolicyParentListForm() {
   }

   public void clickCreate() throws Exception {
      final PolicyParentForm form = (PolicyParentForm)newForm("policy_parent_edit",this);
   ...
   public void clickEdit() throws Exception {
      ...
      final InsurancePolicyParentView pol = (InsurancePolicyParentView) DTOPool.getInstance().getDTO(InsurancePolicyParentView.class, policyID);
   ...
   public void parent() {
      ...
      editFilter.add(FinCodec.PolicyStatus.PARENT);
