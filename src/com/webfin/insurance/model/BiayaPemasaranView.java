/***********************************************************************
 * Module: com.webfin.insurance.model.BiayaPemasaranView
...
//        final String methodCode = Tools.getDigitRightJustified(getReceiptclass().getStMethodCode(), 1);
    ...
    public void setStNoBuktiBayar(String stNoBuktiBayar) {
     ...
     public void generateNoBuktiBayar() throws Exception {
...
//        String counterKey = DateUtil.getYear2Digit(dtEntryDate) + DateUtil.getMonth2Digit(dtEntryDate);
