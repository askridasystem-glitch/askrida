...
public class InsurancePolicySOADetailView extends DTO implements RecordAudit {
   /*
...
ALTER TABLE ins_gl_closing
   ...
   */
   private final static transient LogManager logger = LogManager.getInstance(InsurancePolicySOADetailView.class);

   public static String tableName = "ins_pol_soa_detail";
   
   //public transient static String comboFields[] = {"closing_id", "no_surat_hutang"};

   public static String fieldMap[][] = {
      {"stSOADetailID","soa_detail_id*pk"},
      {"stSOAID","soa_id"},
   ...
   private String stDLANo;
    ...
    public String getStSOADetailID() {
        return stSOADetailID;
    }

    public void setStSOADetailID(String stSOADetailID) {
        this.stSOADetailID = stSOADetailID;
    }
