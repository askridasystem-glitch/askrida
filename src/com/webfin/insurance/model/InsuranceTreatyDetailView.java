...
public class InsuranceTreatyDetailView extends DTO implements RecordAudit {
   /*
...
ALTER TABLE ins_treaty_detail ADD COLUMN xol_upper numeric;
   ...
   */
   ...
   public static String tableName = "ins_treaty_detail";

   public static String fieldMap[][] = {
      {"stInsuranceTreatyDetailID","ins_treaty_detail_id*pk"},
   ...
   private InsuranceTreatyDetailView parent;
   ...
   public InsuranceTreatyDetailView getParent() {
      return parent;
   }

   public void setParent(InsuranceTreatyDetailView parent) {
      this.parent = parent;
   }
   ...
   public void setStParentIndex(String stParentIndex) {
      ...
      InsuranceTreatyDetailView np = (InsuranceTreatyDetailView) owningList.get(Integer.parseInt(stParentIndex));
      parent=np;
   }
