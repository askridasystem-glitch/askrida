...
public class InsurancePolicyDeductibleView extends DTO implements RecordAudit {
   public static String tableName = "ins_pol_deduct";
   ...
   public void setStDeductTypePer(String stDeductTypePer) {
    ...
    public String getStDescriptionForPolicy() {
      ...
      if (getStDescription()!=null) {
         sz.append(getStDescription()).append(" ");
      }

      return LanguageManager.getInstance().translate(sz.toString());
   }
}
