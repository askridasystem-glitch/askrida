...
public class InsurancePolicyCoverView extends DTO implements RecordAudit {
   /*
...
(
   ...
   */
   ...
   public static String tableName = "ins_pol_cover";
   ...
   public BigDecimal getDbPrevPremiAct() {
      final InsurancePolicyCoverView rc = getRefCover();
   ...
   public InsurancePolicyCoverView getRefCover() {
      return (InsurancePolicyCoverView) DTOPool.getInstance().getDTO(InsurancePolicyCoverView.class, stInsurancePolicyCoverRefID);
   }
