...
public class InsurancePolicySOAView extends DTO implements RecordAudit {
   /*
...
ALTER TABLE ins_gl_closing
   ...
   */
   private final static transient LogManager logger = LogManager.getInstance(InsurancePolicySOAView.class);

   public static String tableName = "ins_gl_soa";
   ...
   public static String fieldMap[][] = {
      ...
      {"stStatus","status"},
      {"dbPremiReinsurance","premi_reins"},
      {"dbComissionReinsurance","comm_reins"},
      {"dbClaimReinsurance","claim_reins"},
   ...
   private String stSOAID;
   private String stSOANo;
   private String stDescription;
   private String stEntityID;
   private String stEntityName;
   private String stStatus;
   private BigDecimal dbPremiReinsurance;
   private BigDecimal dbComissionReinsurance;
   private BigDecimal dbClaimReinsurance;
    ...
    private String stReferenceK0;
    private String stReferenceK1;
    ...
    public String getStReferenceK0() {
        return stReferenceK0;
    }

    public void setStReferenceK0(String stReferenceK0) {
        this.stReferenceK0 = stReferenceK0;
    }

    public String getStReferenceK1() {
        return stReferenceK1;
    }

    public void setStReferenceK1(String stReferenceK1) {
        this.stReferenceK1 = stReferenceK1;
    }
    ...
    public BigDecimal getDbClaimReinsurance() {
        return dbClaimReinsurance;
    }

    public void setDbClaimReinsurance(BigDecimal dbClaimReinsurance) {
        this.dbClaimReinsurance = dbClaimReinsurance;
    }
    ...
    public BigDecimal getDbComissionReinsurance() {
        return dbComissionReinsurance;
    }

    public void setDbComissionReinsurance(BigDecimal dbComissionReinsurance) {
        this.dbComissionReinsurance = dbComissionReinsurance;
    }

    public BigDecimal getDbPremiReinsurance() {
        return dbPremiReinsurance;
    }

    public void setDbPremiReinsurance(BigDecimal dbPremiReinsurance) {
        this.dbPremiReinsurance = dbPremiReinsurance;
    }
    ...
    public String getStSOANo() {
        return stSOANo;
    }

    public void setStSOANo(String stSOANo) {
        this.stSOANo = stSOANo;
    }
    ...
    public String getStSOAID() {
        return stSOAID;
    }

    public void setStSOAID(String stSOAID) {
        this.stSOAID = stSOAID;
    }

    public String getStSOAType() {
        return stSOAType;
    }

    public void setStSOAType(String stSOAType) {
        this.stSOAType = stSOAType;
    }
   private String stSOAType;
...
//                sqa.addClause("a.policy_date > '2016-01-01 00:00:00'");
          ...
          String sql = " select pol_no,pol_id,ins_treaty_detail_id,ins_treaty_shares_id,member_ent_id,member,ri_slip_no,"+
    ...
    private void loadARInvoices() {
        try {
            arinvoices = ListUtil.getDTOListFromQuery(
                    ...
                    + "where a.posted_flag = 'Y' and a.no_surat_hutang = ? "
