...
public class UploadEndorseFireHeaderView  extends DataTeksMasukView{
  ...
  cc_code character varying(32),
    ...
    public static String tableName = "ins_upload_fire_header";
   ...
   public void reCalculate() {
    ...
    public void generateRecapNo()throws Exception {
       ...
       String orderNo = StringTools.leftPad(String.valueOf(IDFactory.createNumericID("UPLEND"  + month2Digit + year2Digit + ccCode, 1)), '0', 4);
