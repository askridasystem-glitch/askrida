/***********************************************************************
 * Module:  com.webfin.insurance.model.InsurancePolicySubrogasiView
...
public class InsurancePolicySubrogasiView extends DTO implements RecordAudit {

    public static String tableName = "ins_pol_subrogasi";
    public static String fieldMap[][] = {
        {"stInsurancePolicySubrogasiID", "ins_pol_subrogasi_id*pk*nd"},
        ...
        {"dbAmountEstimated", "amount_estimated"},};
    private String stInsurancePolicySubrogasiID;
    ...
    private BigDecimal dbAmountEstimated;
    ...
    public String getStInsurancePolicySubrogasiID() {
        return stInsurancePolicySubrogasiID;
    }

    public void setStInsurancePolicySubrogasiID(String stInsurancePolicySubrogasiID) {
        this.stInsurancePolicySubrogasiID = stInsurancePolicySubrogasiID;
    }
...
//    }
    ...
    public String getStClaimCauseDesc() {
        ...
        final InsuranceDocumentTypeView cc = getClaimCause();
    ...
    public InsuranceDocumentTypeView getClaimCause() {
        return (InsuranceDocumentTypeView) DTOPool.getInstance().getDTO(InsuranceDocumentTypeView.class, stInsuranceClaimCauseID);
    }
    ...
    public String getStAutoDesc() {
        ...
        if (dbAmount != null) {
            sz.append(stCurrencyCode).append(' ').append(ConvertUtil.print(dbAmount, 2));
        }
        if (dbPct != null) {
            sz.append(ConvertUtil.print(dbPct, 2)).append(' ').append(LOVManager.getInstance().getDescription(stDeductType, "VS_DEDUCT"));
        }

        if (dbAmountMax != null) {
            sz.append(" Max ").append(stCurrencyCode).append(' ').append(ConvertUtil.print(dbAmountMax, 2));
        }
        if (dbAmountMin != null) {
            sz.append(" Min ").append(stCurrencyCode).append(' ').append(ConvertUtil.print(dbAmountMin, 2));
        }
    ...
    /**
     * @return the dbAmountEstimated
     */
    public BigDecimal getDbAmountEstimated() {
        return dbAmountEstimated;
    }

    /**
     * @param dbAmountEstimated the dbAmountEstimated to set
     */
    public void setDbAmountEstimated(BigDecimal dbAmountEstimated) {
        this.dbAmountEstimated = dbAmountEstimated;
    }
}
