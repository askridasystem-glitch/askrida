...
public class InsurancePolicyObjDefaultView extends InsurancePolicyObjectView {
   /*
...
ALTER TABLE ins_pol_obj ADD COLUMN ins_pol_obj_ref_root_id int8;
   ...
   */
   ...
   public static String fieldMap[][] = {
      ...
      {"stDebiturActive", "debitur_act"},
      {"stPLANo", "pla_no*n"},
      {"stDLANo2", "dla_no2*n"},
      {"stClaimStatus", "claim_status*n"},
      {"dbObjectInsuredAmountEndorse","insured_amount_e"},
      {"stInActiveFlag", "inactive_f"},
...
ALTER TABLE ins_pol_obj ADD COLUMN riskcode varchar(32);
   ...
   */
   ...
   private String stDebiturActive;
   private String stPLANo;
   private String stDLANo2;
   private String stClaimStatus;
   private BigDecimal dbObjectInsuredAmountEndorse;
   private String stInActiveFlag;

    public String getStInActiveFlag() {
        return stInActiveFlag;
    }

    public void setStInActiveFlag(String stInActiveFlag) {
        this.stInActiveFlag = stInActiveFlag;
    }

    public boolean isInActive(){
        return Tools.isYes(stInActiveFlag);
    }

    public BigDecimal getDbObjectInsuredAmountEndorse() {
        return dbObjectInsuredAmountEndorse;
    }

    public void setDbObjectInsuredAmountEndorse(BigDecimal dbObjectInsuredAmountEndorse) {
        this.dbObjectInsuredAmountEndorse = dbObjectInsuredAmountEndorse;
    }
    ...
    public String getStDLANo2() {
        return stDLANo2;
    }

    public void setStDLANo2(String stDLANo2) {
        this.stDLANo2 = stDLANo2;
    }
    ...
    public String getStDebiturActive() {
        return stDebiturActive;
    }

    public void setStDebiturActive(String stDebiturActive) {
        this.stDebiturActive = stDebiturActive;
    }
