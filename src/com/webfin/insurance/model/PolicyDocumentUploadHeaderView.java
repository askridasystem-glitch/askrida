...
public class PolicyDocumentUploadHeaderView  extends DataTeksMasukView{
  ...
  cc_code character varying(32),
    ...
    public static String tableName = "ins_policy_document_upload_header";

    public transient static String fieldMap[][] = {
        {"stInsuranceUploadID", "ins_pol_doc_upload_id*pk*nd"},
        ...
        {"stStatus", "status"},
        {"stDokumenUpload", "dokumen_upload"},
   ...
   private String stDokumenUpload;
   private String stInsuranceDocumentTypeID;
    ...
    public String getStDokumenUpload() {
        return stDokumenUpload;
    }

    public void setStDokumenUpload(String stDokumenUpload) {
        this.stDokumenUpload = stDokumenUpload;
    }
   ...
   public void reCalculate() {
    ...
    public void generateRecapNo()throws Exception {
       ...
       String orderNo = StringTools.leftPad(String.valueOf(IDFactory.createNumericID("UPLDOC"  + month2Digit + year2Digit + ccCode, 1)), '0', 4);
