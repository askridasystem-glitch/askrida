...
public class InsuranceSplitPolicyTSIView extends DTO implements RecordAudit {
...
WITH
   */
   ...
   public static String tableName = "ins_split_pol_tsi";
...
*/
   ...
   public void initializeDefaults() {
    ...
    public InsuranceSplitPolicyTSIView getRefTSI() {
      return (InsuranceSplitPolicyTSIView) DTOPool.getInstance().getDTO(InsuranceSplitPolicyTSIView.class, stInsurancePolicyTSIRefID);
   }
}
