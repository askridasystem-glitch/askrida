...
public class InsuranceSplitPolicyObjDefaultView extends InsuranceSplitPolicyObjectView {
   /*
...
ALTER TABLE ins_pol_obj ADD COLUMN ins_pol_obj_ref_root_id int8;
   ...
   */
   ...
   public static String tableName = "ins_split_pol_obj";
   ...
   public static String fieldMap[][] = {
      ...
      {"dtReference8","refd8"},
      {"dtReference9","refd9"},
      {"dtReference10","refd10"},
      {"dtReference11","refd11"},
      {"dtReference12","refd12"},
        {"dtReference13","refd13"},
        {"dtReference14","refd14"},
        {"dtReference15","refd15"},
        {"dtReference16","refd16"},
        {"dtReference17","refd17"},
        {"dtReference18","refd18"},
        {"dtReference19","refd19"},
        {"dtReference20","refd20"},
        {"dtReference21","refd21"},
        {"dtReference22","refd22"},
        {"dtReference23","refd23"},
      ...
      {"dbReference31","refn31"},
        {"dbReference32","refn32"},
        {"dbReference33","refn33"},
        {"dbReference34","refn34"},
        {"dbReference35","refn35"},
        {"dbReference36","refn36"},
        {"dbReference37","refn37"},
        {"dbReference38","refn38"},
        {"dbReference39","refn39"},
        {"dbReference40","refn40"},
      ...
      {"dbTotalTSI","total_tsi*n"},
      {"stPayment", "payment*n"},
      {"stClaimFlag", "claim_flag"},
      {"stEntityID", "ent_id"},
      ...
      {"dbHandlingFeePct","handling_fee_pct"},
      {"dbBrokerFeePct","brokerage_pct"},
      {"stFeebaseInsItemID", "feebase_ins_item_id"},
      {"stBrokerfeeInsItemID", "brokerfee_ins_item_id"},
      {"stKomisiEntityID", "komisi_ent_id"},
...
ALTER TABLE ins_pol_obj ADD COLUMN riskcode varchar(32);
   ...
   */
   ...
   private BigDecimal dbTotalTSI;
   private String stPayment;
   private String stClaimFlag;
   ...
   private BigDecimal dbHandlingFeePct;
   private BigDecimal dbBrokerFeePct;

   private String stFeebaseInsItemID;
   private String stBrokerfeeInsItemID;
   private String stKomisiEntityID;
   private String stPaymentCompanyID;
    ...
    public String getStKomisiEntityID() {
        return stKomisiEntityID;
    }

    public void setStKomisiEntityID(String stKomisiEntityID) {
        this.stKomisiEntityID = stKomisiEntityID;
    }

    public String getStBrokerfeeInsItemID() {
        return stBrokerfeeInsItemID;
    }

    public void setStBrokerfeeInsItemID(String stBrokerfeeInsItemID) {
        this.stBrokerfeeInsItemID = stBrokerfeeInsItemID;
    }

    public String getStFeebaseInsItemID() {
        return stFeebaseInsItemID;
    }

    public void setStFeebaseInsItemID(String stFeebaseInsItemID) {
        this.stFeebaseInsItemID = stFeebaseInsItemID;
    }
    ...
    public BigDecimal getDbHandlingFeePct() {
        return dbHandlingFeePct;
    }

    public void setDbHandlingFeePct(BigDecimal dbHandlingFeePct) {
        this.dbHandlingFeePct = dbHandlingFeePct;
    }
   ...
   private BigDecimal dbKomisiPct;
    ...
    public void setStClaimFlag(String stClaimFlag) {
        this.stClaimFlag = stClaimFlag;
    }
   ...
   private Date dtReference8;
   private Date dtReference9;
   private Date dtReference10;
   private Date dtReference11;
   ...
   private Date dtReference12;
    private Date dtReference13;
    private Date dtReference14;
    private Date dtReference15;
    private Date dtReference16;
    private Date dtReference17;
    private Date dtReference18;
    private Date dtReference19;
    private Date dtReference20;
    private Date dtReference21;
    private Date dtReference22;
    private Date dtReference23;

    private BigDecimal dbReference31;
    private BigDecimal dbReference32;
    private BigDecimal dbReference33;
    private BigDecimal dbReference34;
    private BigDecimal dbReference35;
    private BigDecimal dbReference36;
    private BigDecimal dbReference37;
    private BigDecimal dbReference38;
    private BigDecimal dbReference39;
    private BigDecimal dbReference40;
   
   private EntityView entity;

   private BigDecimal dbObjectInsuredAmountInduk;

    public BigDecimal getDbReference31() {
        return dbReference31;
    }

    public void setDbReference31(BigDecimal dbReference31) {
        this.dbReference31 = dbReference31;
    }

    public BigDecimal getDbReference32() {
        return dbReference32;
    }

    public void setDbReference32(BigDecimal dbReference32) {
        this.dbReference32 = dbReference32;
    }

    public BigDecimal getDbReference33() {
        return dbReference33;
    }

    public void setDbReference33(BigDecimal dbReference33) {
        this.dbReference33 = dbReference33;
    }

    public BigDecimal getDbReference34() {
        return dbReference34;
    }

    public void setDbReference34(BigDecimal dbReference34) {
        this.dbReference34 = dbReference34;
    }

    public BigDecimal getDbReference35() {
        return dbReference35;
    }

    public void setDbReference35(BigDecimal dbReference35) {
        this.dbReference35 = dbReference35;
    }

    public BigDecimal getDbReference36() {
        return dbReference36;
    }

    public void setDbReference36(BigDecimal dbReference36) {
        this.dbReference36 = dbReference36;
    }

    public BigDecimal getDbReference37() {
        return dbReference37;
    }

    public void setDbReference37(BigDecimal dbReference37) {
        this.dbReference37 = dbReference37;
    }

    public BigDecimal getDbReference38() {
        return dbReference38;
    }

    public void setDbReference38(BigDecimal dbReference38) {
        this.dbReference38 = dbReference38;
    }

    public BigDecimal getDbReference39() {
        return dbReference39;
    }

    public void setDbReference39(BigDecimal dbReference39) {
        this.dbReference39 = dbReference39;
    }

    public BigDecimal getDbReference40() {
        return dbReference40;
    }

    public void setDbReference40(BigDecimal dbReference40) {
        this.dbReference40 = dbReference40;
    }

    public Date getDtReference10() {
        return dtReference10;
    }

    public void setDtReference10(Date dtReference10) {
        this.dtReference10 = dtReference10;
    }

    public Date getDtReference11() {
        return dtReference11;
    }

    public void setDtReference11(Date dtReference11) {
        this.dtReference11 = dtReference11;
    }

    public Date getDtReference12() {
        return dtReference12;
    }

    public void setDtReference12(Date dtReference12) {
        this.dtReference12 = dtReference12;
    }

    public Date getDtReference13() {
        return dtReference13;
    }

    public void setDtReference13(Date dtReference13) {
        this.dtReference13 = dtReference13;
    }

    public Date getDtReference14() {
        return dtReference14;
    }

    public void setDtReference14(Date dtReference14) {
        this.dtReference14 = dtReference14;
    }

    public Date getDtReference15() {
        return dtReference15;
    }

    public void setDtReference15(Date dtReference15) {
        this.dtReference15 = dtReference15;
    }

    public Date getDtReference16() {
        return dtReference16;
    }

    public void setDtReference16(Date dtReference16) {
        this.dtReference16 = dtReference16;
    }

    public Date getDtReference17() {
        return dtReference17;
    }

    public void setDtReference17(Date dtReference17) {
        this.dtReference17 = dtReference17;
    }

    public Date getDtReference18() {
        return dtReference18;
    }

    public void setDtReference18(Date dtReference18) {
        this.dtReference18 = dtReference18;
    }

    public Date getDtReference19() {
        return dtReference19;
    }

    public void setDtReference19(Date dtReference19) {
        this.dtReference19 = dtReference19;
    }

    public Date getDtReference20() {
        return dtReference20;
    }

    public void setDtReference20(Date dtReference20) {
        this.dtReference20 = dtReference20;
    }

    public Date getDtReference21() {
        return dtReference21;
    }

    public void setDtReference21(Date dtReference21) {
        this.dtReference21 = dtReference21;
    }

    public Date getDtReference22() {
        return dtReference22;
    }

    public void setDtReference22(Date dtReference22) {
        this.dtReference22 = dtReference22;
    }

    public Date getDtReference23() {
        return dtReference23;
    }

    public void setDtReference23(Date dtReference23) {
        this.dtReference23 = dtReference23;
    }

    public Date getDtReference8() {
        return dtReference8;
    }

    public void setDtReference8(Date dtReference8) {
        this.dtReference8 = dtReference8;
    }

    public Date getDtReference9() {
        return dtReference9;
    }

    public void setDtReference9(Date dtReference9) {
        this.dtReference9 = dtReference9;
    }

   

    public BigDecimal getDbObjectInsuredAmountInduk() {
        return dbObjectInsuredAmountInduk;
    }

    public void setDbObjectInsuredAmountInduk(BigDecimal dbObjectInsuredAmountInduk) {
        this.dbObjectInsuredAmountInduk = dbObjectInsuredAmountInduk;
    }
   ...
   public String getStCoverageDesc() throws Exception{
    ...
    public boolean isDataTopUp(){
        return "3".equalsIgnoreCase(getStReference22());
    }


    private String stSubrogasiID;

    /**
     * @return the stSubrogasiID
     */
    public String getStSubrogasiID() {
        return stSubrogasiID;
    }

    /**
     * @param stSubrogasiID the stSubrogasiID to set
     */
    public void setStSubrogasiID(String stSubrogasiID) {
        this.stSubrogasiID = stSubrogasiID;
    }

    /**
     * @return the dbTotalTSI
     */
    public BigDecimal getDbTotalTSI() {
        return dbTotalTSI;
    }

    /**
     * @param dbTotalTSI the dbTotalTSI to set
     */
    public void setDbTotalTSI(BigDecimal dbTotalTSI) {
        this.dbTotalTSI = dbTotalTSI;
    }

    /**
     * @return the stPayment
     */
    ...
    /**
     * @param stPayment the stPayment to set
     */
