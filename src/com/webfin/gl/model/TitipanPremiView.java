...
public class TitipanPremiView extends DTO implements RecordAudit {
   /*
...
ALTER TABLE gl_je_detail ADD COLUMN ccy_rate numeric;
   ...
   */
     private final static transient LogManager logger = LogManager.getInstance(TitipanPremiView.class);
...
ALTER TABLE gl_je_detail ADD COLUMN ref_trx_no varchar(32);
   ...
   */
   ...
   public TitipanPremiView getOldJournal() {
      return (TitipanPremiView) getOld();
   }
