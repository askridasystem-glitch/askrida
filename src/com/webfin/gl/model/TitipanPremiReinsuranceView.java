...
public class TitipanPremiReinsuranceView extends DTO implements RecordAudit {
   /*
...
ALTER TABLE gl_je_detail ADD COLUMN ccy_rate numeric;
   ...
   */
     private final static transient LogManager logger = LogManager.getInstance(TitipanPremiReinsuranceView.class);

   public static String tableName = "ar_titipan_premi_reinsurance";
   
   
   public static String comboFields[] = {"trx_id","trx_no","counter","description","pol_no","jumlah"};
...
ALTER TABLE gl_je_detail ADD COLUMN ref_trx_no varchar(32);
   ...
   */
   ...
   public TitipanPremiReinsuranceView getOldJournal() {
      return (TitipanPremiReinsuranceView) getOld();
   }
   ...
   public TitipanPremiReinsuranceView copy() {
      return (TitipanPremiReinsuranceView) ObjectCloner.deepCopy(this);
   }
