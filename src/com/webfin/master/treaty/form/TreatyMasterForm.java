...
public class TreatyMasterForm extends Form {

   private InsuranceTreatyView tre;
   ...
   public InsuranceTreatyView getTre() {
      return tre;
   }
   ...
   public void setTre(InsuranceTreatyView tre) {
      this.tre = tre;
   }

   public void createNew() {
      tre= new InsuranceTreatyView();

      tre.markNew();

      tre.setDetails(new DTOList());

      setTitle("CREATE NEW TREATY");
   ...
   public void edit(String treatyid) {
      tre = (InsuranceTreatyView) DTOPool.getInstance().getDTO(InsuranceTreatyView.class, treatyid);

      tre.markUpdate();

      setTitle("EDIT TREATY");
   ...
   public void newDetail() {
      InsuranceTreatyDetailView d = new InsuranceTreatyDetailView();
