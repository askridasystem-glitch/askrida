/***********************************************************************
 * Module:  com.webfin.master.treaty.form.CashCallListForm
...
public class CashCallListForm extends Form {
   ...
   public DTOList getList() throws Exception {
      ...
      if (list==null) {
         ...
         list.getFilter().orderKey="ins_cashcall_id";
      }
      ...
      list = sqa.getList(InsuranceCashCallView.class);
   ...
   public void clickCreate() throws Exception {
      CashCallMasterForm x = (CashCallMasterForm) FormManager.getInstance().newForm("cashcall_form",this);
   ...
   public void clickApprove1() throws Exception {
      ...
      CashCallMasterForm x = (CashCallMasterForm) FormManager.getInstance().newForm("treaty_form",this);
