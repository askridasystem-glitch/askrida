...
public class ArchiveSearchForm extends Form {
   ...
   public DTOList getEntities() throws Exception {
      if (doSearch!=null) {
         ...
         sqa.addQuery("from archive_letter");
//         if (stInsuranceCompanyFlag!=null) {
//            sqa.addClause("ins_company_flag = ?");
//            sqa.addPar(stInsuranceCompanyFlag);
//         }
         sqa.addSelect("archive_letter.*");
         sqa.addOrder("in_id");

         entities = sqa.getList(ArchiveView.class);
      }
