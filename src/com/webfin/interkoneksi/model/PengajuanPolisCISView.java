...
public class PengajuanPolisCISView extends DTO implements RecordAudit {
    /*
    CREATE TABLE pengajuan_polis_cis
(
  data_id bigint NOT NULL DEFAULT nextval('pengajuan_cis'::regclass),
  ...
  entity_id bigint,
  bisnis character varying(32),
  buatan character varying(32),
  alamat_risiko character varying(255),
  kondisi character varying(128),
  rate numeric,
  premi numeric,
  ...
  deductible_id1 bigint,
  deductible_pct_of_claim1 numeric,
  deductible_min1 numeric,
  deductible_max1 numeric,
  deductible_id2 bigint,
  deductible_pct_of_claim2 numeric,
  deductible_min2 numeric,
  deductible_max2 numeric,
  deductible_id3 bigint,
  deductible_pct_of_claim3 numeric,
  deductible_min3 numeric,
  deductible_max3 numeric,
  deductible_id4 bigint,
  deductible_pct_of_claim4 numeric,
  deductible_min4 numeric,
  deductible_max4 numeric,
  CONSTRAINT pengajuan_polis_cis_pkey PRIMARY KEY (data_id)
)
     */

    public static String tableName = "pengajuan_polis_cis";
    ...
    private String stBisnis;
    private String stBuatan;
    private String stAlamatResiko;
    private String stKondisi;
    ...
    public String getStAlamatResiko() {
        return stAlamatResiko;
    }

    public void setStAlamatResiko(String stAlamatResiko) {
        this.stAlamatResiko = stAlamatResiko;
    }

    public String getStBisnis() {
        return stBisnis;
    }

    public void setStBisnis(String stBisnis) {
        this.stBisnis = stBisnis;
    }

    public String getStBuatan() {
        return stBuatan;
    }

    public void setStBuatan(String stBuatan) {
        this.stBuatan = stBuatan;
    }

    public String getStKondisi() {
        return stKondisi;
    }

    public void setStKondisi(String stKondisi) {
        this.stKondisi = stKondisi;
    }
