...
public class PengajuanPolisKonstruksiView extends DTO implements RecordAudit {
    /*
    CREATE TABLE pengajuan_polis_konstruksi
(
  id_pengajuan_polis bigint NOT NULL DEFAULT nextval('id_pengajuan_polis_kontruksi'::regclass),
  ...
  plafon_kredit numeric,
  jangka_waktu_kredit integer,
  rate_premi numeric,
  premi numeric,
  biaya_admin numeric,
  nomor_rekening_kredit character varying(255),
  tanggal_perjanjian_kredit timestamp without time zone,
  suku_bunga numeric,
  tanggal_realisasi_kredit timestamp without time zone,
  ...
  coverage_penjaminan integer,
  no_pk character varying(225),
  ...
  CONSTRAINT pengajuan_polis_konstruksi_pkey PRIMARY KEY (id_pengajuan_polis)
)
     */

    public static String tableName = "pengajuan_polis_konstruksi";
    ...
    public static String fieldMap[][] = {
        ...
        {"dbPlafonKredit", "plafon_kredit"},
        {"dbRate", "rate_premi"},
        {"dbPremi", "premi"},
        {"dbBiayaAdmin", "biaya_admin"},
        {"stNomorRekKredit", "nomor_rekening_kredit"},
        {"dtTanggalPK", "tanggal_perjanjian_kredit"},
        {"dtTanggalRealisasiKredit", "tanggal_realisasi_kredit"},
        {"dtTanggalJatuhTempo", "tanggal_jatuh_tempo"},
    ...
    private BigDecimal dbPlafonKredit;
    ...
    private Date dtTanggalRealisasiKredit;
    ...
    public BigDecimal getDbPlafonKredit() {
        return dbPlafonKredit;
    }

    public void setDbPlafonKredit(BigDecimal dbPlafonKredit) {
        this.dbPlafonKredit = dbPlafonKredit;
    }
    ...
    public Date getDtTanggalRealisasiKredit() {
        return dtTanggalRealisasiKredit;
    }

    public void setDtTanggalRealisasiKredit(Date dtTanggalRealisasiKredit) {
        this.dtTanggalRealisasiKredit = dtTanggalRealisasiKredit;
    }
