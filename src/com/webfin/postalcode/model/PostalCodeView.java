...
public class PostalCodeView extends DTO implements RecordAudit {
   /*
...
ALTER TABLE s_region_map2 OWNER TO postgres;
   ...
   */
   ...
   public static String tableName = "s_region_map3";

   public static String comboFields[] = {"region_map_id","postal_code", "region_map_desc","building_desc"};
