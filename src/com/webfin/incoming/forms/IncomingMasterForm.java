...
public class IncomingMasterForm extends WebForm {
   private IncomingView entity = null;
...
//            }
   ...
   public IncomingMasterForm() {
   }

   public IncomingView getEntity() {
      return entity;
   }

   public void setEntity(IncomingView entity) {
      this.entity = entity;
   }
