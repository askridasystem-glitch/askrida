...
public class ApprovalBODDistributionView extends DTO implements RecordAudit {
    /*
    ...
    CONSTRAINT pk_incoming_dist PRIMARY KEY (ref_no, id_dist)
    )


    public static String tableName = "incoming_dist";
    ...
    public static String tableName = "approvalbod_dist";
    public static String fieldMap[][] = {
        {"stInID", "in_id"},
        {"stIdDist", "id_dist*pk"},
        {"stReceiver", "receiver"},
